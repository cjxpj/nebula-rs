var Ol=Object.defineProperty;var El=(n,e,t)=>e in n?Ol(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var rn=(n,e,t)=>El(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();/**
* @vue/shared v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Ws(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const on={},Ke=[],se=()=>{},Wr=()=>!1,ts=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),ss=n=>n.startsWith("onUpdate:"),vn=Object.assign,Ys=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},Pl=Object.prototype.hasOwnProperty,W=(n,e)=>Pl.call(n,e),H=Array.isArray,qe=n=>Rt(n)==="[object Map]",Yr=n=>Rt(n)==="[object Set]",Wi=n=>Rt(n)==="[object Date]",B=n=>typeof n=="function",fn=n=>typeof n=="string",ie=n=>typeof n=="symbol",X=n=>n!==null&&typeof n=="object",Zr=n=>(X(n)||B(n))&&B(n.then)&&B(n.catch),Qr=Object.prototype.toString,Rt=n=>Qr.call(n),Al=n=>Rt(n).slice(8,-1),Xr=n=>Rt(n)==="[object Object]",Zs=n=>fn(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,ft=Ws(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),is=n=>{const e=Object.create(null);return t=>e[t]||(e[t]=n(t))},Cl=/-\w/g,On=is(n=>n.replace(Cl,e=>e.slice(1).toUpperCase())),Nl=/\B([A-Z])/g,De=is(n=>n.replace(Nl,"-$1").toLowerCase()),rs=is(n=>n.charAt(0).toUpperCase()+n.slice(1)),ms=is(n=>n?`on${rs(n)}`:""),te=(n,e)=>!Object.is(n,e),Ht=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},no=(n,e,t,s=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:s,value:t})},Qs=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let Yi;const os=()=>Yi||(Yi=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Xs(n){if(H(n)){const e={};for(let t=0;t<n.length;t++){const s=n[t],i=fn(s)?Dl(s):Xs(s);if(i)for(const r in i)e[r]=i[r]}return e}else if(fn(n)||X(n))return n}const Il=/;(?![^(]*\))/g,Ll=/:([^]+)/,Ml=/\/\*[^]*?\*\//g;function Dl(n){const e={};return n.replace(Ml,"").split(Il).forEach(t=>{if(t){const s=t.split(Ll);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function Hn(n){let e="";if(fn(n))e=n;else if(H(n))for(let t=0;t<n.length;t++){const s=Hn(n[t]);s&&(e+=s+" ")}else if(X(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const jl="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Hl=Ws(jl);function eo(n){return!!n||n===""}function Bl(n,e){if(n.length!==e.length)return!1;let t=!0;for(let s=0;t&&s<n.length;s++)t=ni(n[s],e[s]);return t}function ni(n,e){if(n===e)return!0;let t=Wi(n),s=Wi(e);if(t||s)return t&&s?n.getTime()===e.getTime():!1;if(t=ie(n),s=ie(e),t||s)return n===e;if(t=H(n),s=H(e),t||s)return t&&s?Bl(n,e):!1;if(t=X(n),s=X(e),t||s){if(!t||!s)return!1;const i=Object.keys(n).length,r=Object.keys(e).length;if(i!==r)return!1;for(const o in n){const l=n.hasOwnProperty(o),a=e.hasOwnProperty(o);if(l&&!a||!l&&a||!ni(n[o],e[o]))return!1}}return String(n)===String(e)}const to=n=>!!(n&&n.__v_isRef===!0),xn=n=>fn(n)?n:n==null?"":H(n)||X(n)&&(n.toString===Qr||!B(n.toString))?to(n)?xn(n.value):JSON.stringify(n,so,2):String(n),so=(n,e)=>to(e)?so(n,e.value):qe(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[s,i],r)=>(t[bs(s,r)+" =>"]=i,t),{})}:Yr(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>bs(t))}:ie(e)?bs(e):X(e)&&!H(e)&&!Xr(e)?String(e):e,bs=(n,e="")=>{var t;return ie(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let _n;class Fl{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!e&&_n&&(_n.active?(this.parent=_n,this.index=(_n.scopes||(_n.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=_n;try{return _n=this,e()}finally{_n=t}}}on(){++this._on===1&&(this.prevScope=_n,_n=this)}off(){if(this._on>0&&--this._on===0){if(_n===this)_n=this.prevScope;else{let e=_n;for(;e;){if(e.prevScope===this){e.prevScope=this.prevScope;break}e=e.prevScope}}this.prevScope=void 0}}stop(e){if(this._active){this._active=!1;let t,s;for(t=0,s=this.effects.length;t<s;t++)this.effects[t].stop();for(this.effects.length=0,t=0,s=this.cleanups.length;t<s;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function Ul(){return _n}let ln;const _s=new WeakSet;class io{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,_n&&(_n.active?_n.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,_s.has(this)&&(_s.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||oo(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Zi(this),lo(this);const e=ln,t=Bn;ln=this,Bn=!0;try{return this.fn()}finally{ao(this),ln=e,Bn=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)si(e);this.deps=this.depsTail=void 0,Zi(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?_s.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Cs(this)&&this.run()}get dirty(){return Cs(this)}}let ro=0,dt,ht;function oo(n,e=!1){if(n.flags|=8,e){n.next=ht,ht=n;return}n.next=dt,dt=n}function ei(){ro++}function ti(){if(--ro>0)return;if(ht){let e=ht;for(ht=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;dt;){let e=dt;for(dt=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(s){n||(n=s)}e=t}}if(n)throw n}function lo(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function ao(n){let e,t=n.depsTail,s=t;for(;s;){const i=s.prevDep;s.version===-1?(s===t&&(t=i),si(s),zl(s)):e=s,s.dep.activeLink=s.prevActiveLink,s.prevActiveLink=void 0,s=i}n.deps=e,n.depsTail=t}function Cs(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(co(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function co(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===vt)||(n.globalVersion=vt,!n.isSSR&&n.flags&128&&(!n.deps&&!n._dirty||!Cs(n))))return;n.flags|=2;const e=n.dep,t=ln,s=Bn;ln=n,Bn=!0;try{lo(n);const i=n.fn(n._value);(e.version===0||te(i,n._value))&&(n.flags|=128,n._value=i,e.version++)}catch(i){throw e.version++,i}finally{ln=t,Bn=s,ao(n),n.flags&=-3}}function si(n,e=!1){const{dep:t,prevSub:s,nextSub:i}=n;if(s&&(s.nextSub=i,n.prevSub=void 0),i&&(i.prevSub=s,n.nextSub=void 0),t.subs===n&&(t.subs=s,!s&&t.computed)){t.computed.flags&=-5;for(let r=t.computed.deps;r;r=r.nextDep)si(r,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function zl(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let Bn=!0;const uo=[];function re(){uo.push(Bn),Bn=!1}function oe(){const n=uo.pop();Bn=n===void 0?!0:n}function Zi(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=ln;ln=void 0;try{e()}finally{ln=t}}}let vt=0;class Vl{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class ii{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!ln||!Bn||ln===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==ln)t=this.activeLink=new Vl(ln,this),ln.deps?(t.prevDep=ln.depsTail,ln.depsTail.nextDep=t,ln.depsTail=t):ln.deps=ln.depsTail=t,fo(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const s=t.nextDep;s.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=s),t.prevDep=ln.depsTail,t.nextDep=void 0,ln.depsTail.nextDep=t,ln.depsTail=t,ln.deps===t&&(ln.deps=s)}return t}trigger(e){this.version++,vt++,this.notify(e)}notify(e){ei();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{ti()}}}function fo(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let s=e.deps;s;s=s.nextDep)fo(s)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const Ns=new WeakMap,Ae=Symbol(""),Is=Symbol(""),yt=Symbol("");function yn(n,e,t){if(Bn&&ln){let s=Ns.get(n);s||Ns.set(n,s=new Map);let i=s.get(t);i||(s.set(t,i=new ii),i.map=s,i.key=t),i.track()}}function de(n,e,t,s,i,r){const o=Ns.get(n);if(!o){vt++;return}const l=a=>{a&&a.trigger()};if(ei(),e==="clear")o.forEach(l);else{const a=H(n),u=a&&Zs(t);if(a&&t==="length"){const c=Number(s);o.forEach((f,p)=>{(p==="length"||p===yt||!ie(p)&&p>=c)&&l(f)})}else switch((t!==void 0||o.has(void 0))&&l(o.get(t)),u&&l(o.get(yt)),e){case"add":a?u&&l(o.get("length")):(l(o.get(Ae)),qe(n)&&l(o.get(Is)));break;case"delete":a||(l(o.get(Ae)),qe(n)&&l(o.get(Is)));break;case"set":qe(n)&&l(o.get(Ae));break}}ti()}function ze(n){const e=q(n);return e===n?e:(yn(e,"iterate",yt),jn(n)?e:e.map(Un))}function ls(n){return yn(n=q(n),"iterate",yt),n}function ne(n,e){return ge(n)?Ze(Ce(n)?Un(e):e):Un(e)}const Gl={__proto__:null,[Symbol.iterator](){return xs(this,Symbol.iterator,n=>ne(this,n))},concat(...n){return ze(this).concat(...n.map(e=>H(e)?ze(e):e))},entries(){return xs(this,"entries",n=>(n[1]=ne(this,n[1]),n))},every(n,e){return ae(this,"every",n,e,void 0,arguments)},filter(n,e){return ae(this,"filter",n,e,t=>t.map(s=>ne(this,s)),arguments)},find(n,e){return ae(this,"find",n,e,t=>ne(this,t),arguments)},findIndex(n,e){return ae(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return ae(this,"findLast",n,e,t=>ne(this,t),arguments)},findLastIndex(n,e){return ae(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return ae(this,"forEach",n,e,void 0,arguments)},includes(...n){return vs(this,"includes",n)},indexOf(...n){return vs(this,"indexOf",n)},join(n){return ze(this).join(n)},lastIndexOf(...n){return vs(this,"lastIndexOf",n)},map(n,e){return ae(this,"map",n,e,void 0,arguments)},pop(){return it(this,"pop")},push(...n){return it(this,"push",n)},reduce(n,...e){return Qi(this,"reduce",n,e)},reduceRight(n,...e){return Qi(this,"reduceRight",n,e)},shift(){return it(this,"shift")},some(n,e){return ae(this,"some",n,e,void 0,arguments)},splice(...n){return it(this,"splice",n)},toReversed(){return ze(this).toReversed()},toSorted(n){return ze(this).toSorted(n)},toSpliced(...n){return ze(this).toSpliced(...n)},unshift(...n){return it(this,"unshift",n)},values(){return xs(this,"values",n=>ne(this,n))}};function xs(n,e,t){const s=ls(n),i=s[e]();return s!==n&&!jn(n)&&(i._next=i.next,i.next=()=>{const r=i._next();return r.done||(r.value=t(r.value)),r}),i}const Jl=Array.prototype;function ae(n,e,t,s,i,r){const o=ls(n),l=o!==n&&!jn(n),a=o[e];if(a!==Jl[e]){const f=a.apply(n,r);return l?Un(f):f}let u=t;o!==n&&(l?u=function(f,p){return t.call(this,ne(n,f),p,n)}:t.length>2&&(u=function(f,p){return t.call(this,f,p,n)}));const c=a.call(o,u,s);return l&&i?i(c):c}function Qi(n,e,t,s){const i=ls(n),r=i!==n&&!jn(n);let o=t,l=!1;i!==n&&(r?(l=s.length===0,o=function(u,c,f){return l&&(l=!1,u=ne(n,u)),t.call(this,u,ne(n,c),f,n)}):t.length>3&&(o=function(u,c,f){return t.call(this,u,c,f,n)}));const a=i[e](o,...s);return l?ne(n,a):a}function vs(n,e,t){const s=q(n);yn(s,"iterate",yt);const i=s[e](...t);return(i===-1||i===!1)&&li(t[0])?(t[0]=q(t[0]),s[e](...t)):i}function it(n,e,t=[]){re(),ei();const s=q(n)[e].apply(n,t);return ti(),oe(),s}const Kl=Ws("__proto__,__v_isRef,__isVue"),ho=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(ie));function ql(n){ie(n)||(n=String(n));const e=q(this);return yn(e,"has",n),e.hasOwnProperty(n)}class po{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,s){if(t==="__v_skip")return e.__v_skip;const i=this._isReadonly,r=this._isShallow;if(t==="__v_isReactive")return!i;if(t==="__v_isReadonly")return i;if(t==="__v_isShallow")return r;if(t==="__v_raw")return s===(i?r?ia:bo:r?mo:$o).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(s)?e:void 0;const o=H(e);if(!i){let a;if(o&&(a=Gl[t]))return a;if(t==="hasOwnProperty")return ql}const l=Reflect.get(e,t,kn(e)?e:s);if((ie(t)?ho.has(t):Kl(t))||(i||yn(e,"get",t),r))return l;if(kn(l)){const a=o&&Zs(t)?l:l.value;return i&&X(a)?Ms(a):a}return X(l)?i?Ms(l):as(l):l}}class go extends po{constructor(e=!1){super(!1,e)}set(e,t,s,i){let r=e[t];const o=H(e)&&Zs(t);if(!this._isShallow){const u=ge(r);if(!jn(s)&&!ge(s)&&(r=q(r),s=q(s)),!o&&kn(r)&&!kn(s))return u||(r.value=s),!0}const l=o?Number(t)<e.length:W(e,t),a=Reflect.set(e,t,s,kn(e)?e:i);return e===q(i)&&a&&(l?te(s,r)&&de(e,"set",t,s):de(e,"add",t,s)),a}deleteProperty(e,t){const s=W(e,t);e[t];const i=Reflect.deleteProperty(e,t);return i&&s&&de(e,"delete",t,void 0),i}has(e,t){const s=Reflect.has(e,t);return(!ie(t)||!ho.has(t))&&yn(e,"has",t),s}ownKeys(e){return yn(e,"iterate",H(e)?"length":Ae),Reflect.ownKeys(e)}}class Wl extends po{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const Yl=new go,Zl=new Wl,Ql=new go(!0);const Ls=n=>n,It=n=>Reflect.getPrototypeOf(n);function Xl(n,e,t){return function(...s){const i=this.__v_raw,r=q(i),o=qe(r),l=n==="entries"||n===Symbol.iterator&&o,a=n==="keys"&&o,u=i[n](...s),c=t?Ls:e?Ze:Un;return!e&&yn(r,"iterate",a?Is:Ae),vn(Object.create(u),{next(){const{value:f,done:p}=u.next();return p?{value:f,done:p}:{value:l?[c(f[0]),c(f[1])]:c(f),done:p}}})}}function Lt(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function na(n,e){const t={get(i){const r=this.__v_raw,o=q(r),l=q(i);n||(te(i,l)&&yn(o,"get",i),yn(o,"get",l));const{has:a}=It(o),u=e?Ls:n?Ze:Un;if(a.call(o,i))return u(r.get(i));if(a.call(o,l))return u(r.get(l));r!==o&&r.get(i)},get size(){const i=this.__v_raw;return!n&&yn(q(i),"iterate",Ae),i.size},has(i){const r=this.__v_raw,o=q(r),l=q(i);return n||(te(i,l)&&yn(o,"has",i),yn(o,"has",l)),i===l?r.has(i):r.has(i)||r.has(l)},forEach(i,r){const o=this,l=o.__v_raw,a=q(l),u=e?Ls:n?Ze:Un;return!n&&yn(a,"iterate",Ae),l.forEach((c,f)=>i.call(r,u(c),u(f),o))}};return vn(t,n?{add:Lt("add"),set:Lt("set"),delete:Lt("delete"),clear:Lt("clear")}:{add(i){const r=q(this),o=It(r),l=q(i),a=!e&&!jn(i)&&!ge(i)?l:i;return o.has.call(r,a)||te(i,a)&&o.has.call(r,i)||te(l,a)&&o.has.call(r,l)||(r.add(a),de(r,"add",a,a)),this},set(i,r){!e&&!jn(r)&&!ge(r)&&(r=q(r));const o=q(this),{has:l,get:a}=It(o);let u=l.call(o,i);u||(i=q(i),u=l.call(o,i));const c=a.call(o,i);return o.set(i,r),u?te(r,c)&&de(o,"set",i,r):de(o,"add",i,r),this},delete(i){const r=q(this),{has:o,get:l}=It(r);let a=o.call(r,i);a||(i=q(i),a=o.call(r,i)),l&&l.call(r,i);const u=r.delete(i);return a&&de(r,"delete",i,void 0),u},clear(){const i=q(this),r=i.size!==0,o=i.clear();return r&&de(i,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(i=>{t[i]=Xl(i,n,e)}),t}function ri(n,e){const t=na(n,e);return(s,i,r)=>i==="__v_isReactive"?!n:i==="__v_isReadonly"?n:i==="__v_raw"?s:Reflect.get(W(t,i)&&i in s?t:s,i,r)}const ea={get:ri(!1,!1)},ta={get:ri(!1,!0)},sa={get:ri(!0,!1)};const $o=new WeakMap,mo=new WeakMap,bo=new WeakMap,ia=new WeakMap;function ra(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function as(n){return ge(n)?n:oi(n,!1,Yl,ea,$o)}function _o(n){return oi(n,!1,Ql,ta,mo)}function Ms(n){return oi(n,!0,Zl,sa,bo)}function oi(n,e,t,s,i){if(!X(n)||n.__v_raw&&!(e&&n.__v_isReactive)||n.__v_skip||!Object.isExtensible(n))return n;const r=i.get(n);if(r)return r;const o=ra(Al(n));if(o===0)return n;const l=new Proxy(n,o===2?s:t);return i.set(n,l),l}function Ce(n){return ge(n)?Ce(n.__v_raw):!!(n&&n.__v_isReactive)}function ge(n){return!!(n&&n.__v_isReadonly)}function jn(n){return!!(n&&n.__v_isShallow)}function li(n){return n?!!n.__v_raw:!1}function q(n){const e=n&&n.__v_raw;return e?q(e):n}function oa(n){return!W(n,"__v_skip")&&Object.isExtensible(n)&&no(n,"__v_skip",!0),n}const Un=n=>X(n)?as(n):n,Ze=n=>X(n)?Ms(n):n;function kn(n){return n?n.__v_isRef===!0:!1}function pe(n){return xo(n,!1)}function la(n){return xo(n,!0)}function xo(n,e){return kn(n)?n:new aa(n,e)}class aa{constructor(e,t){this.dep=new ii,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:q(e),this._value=t?e:Un(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,s=this.__v_isShallow||jn(e)||ge(e);e=s?e:q(e),te(e,t)&&(this._rawValue=e,this._value=s?e:Un(e),this.dep.trigger())}}function dn(n){return kn(n)?n.value:n}const ca={get:(n,e,t)=>e==="__v_raw"?n:dn(Reflect.get(n,e,t)),set:(n,e,t,s)=>{const i=n[e];return kn(i)&&!kn(t)?(i.value=t,!0):Reflect.set(n,e,t,s)}};function vo(n){return Ce(n)?n:new Proxy(n,ca)}class ua{constructor(e,t,s){this.fn=e,this.setter=t,this._value=void 0,this.dep=new ii(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=vt-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=s}notify(){if(this.flags|=16,!(this.flags&8)&&ln!==this)return oo(this,!0),!0}get value(){const e=this.dep.track();return co(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function fa(n,e,t=!1){let s,i;return B(n)?s=n:(s=n.get,i=n.set),new ua(s,i,t)}const Mt={},Vt=new WeakMap;let Oe;function da(n,e=!1,t=Oe){if(t){let s=Vt.get(t);s||Vt.set(t,s=[]),s.push(n)}}function ha(n,e,t=on){const{immediate:s,deep:i,once:r,scheduler:o,augmentJob:l,call:a}=t,u=A=>i?A:jn(A)||i===!1||i===0?he(A,1):he(A);let c,f,p,g,y=!1,w=!1;if(kn(n)?(f=()=>n.value,y=jn(n)):Ce(n)?(f=()=>u(n),y=!0):H(n)?(w=!0,y=n.some(A=>Ce(A)||jn(A)),f=()=>n.map(A=>{if(kn(A))return A.value;if(Ce(A))return u(A);if(B(A))return a?a(A,2):A()})):B(n)?e?f=a?()=>a(n,2):n:f=()=>{if(p){re();try{p()}finally{oe()}}const A=Oe;Oe=c;try{return a?a(n,3,[g]):n(g)}finally{Oe=A}}:f=se,e&&i){const A=f,Y=i===!0?1/0:i;f=()=>he(A(),Y)}const N=Ul(),M=()=>{c.stop(),N&&N.active&&Ys(N.effects,c)};if(r&&e){const A=e;e=(...Y)=>{const an=A(...Y);return M(),an}}let E=w?new Array(n.length).fill(Mt):Mt;const C=A=>{if(!(!(c.flags&1)||!c.dirty&&!A))if(e){const Y=c.run();if(A||i||y||(w?Y.some((an,Z)=>te(an,E[Z])):te(Y,E))){p&&p();const an=Oe;Oe=c;try{const Z=[Y,E===Mt?void 0:w&&E[0]===Mt?[]:E,g];E=Y,a?a(e,3,Z):e(...Z)}finally{Oe=an}}}else c.run()};return l&&l(C),c=new io(f),c.scheduler=o?()=>o(C,!1):C,g=A=>da(A,!1,c),p=c.onStop=()=>{const A=Vt.get(c);if(A){if(a)a(A,4);else for(const Y of A)Y();Vt.delete(c)}},e?s?C(!0):E=c.run():o?o(C.bind(null,!0),!0):c.run(),M.pause=c.pause.bind(c),M.resume=c.resume.bind(c),M.stop=M,M}function he(n,e=1/0,t){if(e<=0||!X(n)||n.__v_skip||(t=t||new Map,(t.get(n)||0)>=e))return n;if(t.set(n,e),e--,kn(n))he(n.value,e,t);else if(H(n))for(let s=0;s<n.length;s++)he(n[s],e,t);else if(Yr(n)||qe(n))n.forEach(s=>{he(s,e,t)});else if(Xr(n)){for(const s in n)he(n[s],e,t);for(const s of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,s)&&he(n[s],e,t)}return n}/**
* @vue/runtime-core v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Ot(n,e,t,s){try{return s?n(...s):n()}catch(i){cs(i,e,t)}}function zn(n,e,t,s){if(B(n)){const i=Ot(n,e,t,s);return i&&Zr(i)&&i.catch(r=>{cs(r,e,t)}),i}if(H(n)){const i=[];for(let r=0;r<n.length;r++)i.push(zn(n[r],e,t,s));return i}}function cs(n,e,t,s=!0){const i=e?e.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:o}=e&&e.appContext.config||on;if(e){let l=e.parent;const a=e.proxy,u=`https://vuejs.org/error-reference/#runtime-${t}`;for(;l;){const c=l.ec;if(c){for(let f=0;f<c.length;f++)if(c[f](n,a,u)===!1)return}l=l.parent}if(r){re(),Ot(r,null,10,[n,a,u]),oe();return}}pa(n,t,i,s,o)}function pa(n,e,t,s=!0,i=!1){if(i)throw n;console.error(n)}const Rn=[];let Xn=-1;const We=[];let ve=null,Ve=0;const yo=Promise.resolve();let Gt=null;function Et(n){const e=Gt||yo;return n?e.then(this?n.bind(this):n):e}function ga(n){let e=Xn+1,t=Rn.length;for(;e<t;){const s=e+t>>>1,i=Rn[s],r=wt(i);r<n||r===n&&i.flags&2?e=s+1:t=s}return e}function ai(n){if(!(n.flags&1)){const e=wt(n),t=Rn[Rn.length-1];!t||!(n.flags&2)&&e>=wt(t)?Rn.push(n):Rn.splice(ga(e),0,n),n.flags|=1,wo()}}function wo(){Gt||(Gt=yo.then(To))}function $a(n){H(n)?We.push(...n):ve&&n.id===-1?ve.splice(Ve+1,0,n):n.flags&1||(We.push(n),n.flags|=1),wo()}function Xi(n,e,t=Xn+1){for(;t<Rn.length;t++){const s=Rn[t];if(s&&s.flags&2){if(n&&s.id!==n.uid)continue;Rn.splice(t,1),t--,s.flags&4&&(s.flags&=-2),s(),s.flags&4||(s.flags&=-2)}}}function ko(n){if(We.length){const e=[...new Set(We)].sort((t,s)=>wt(t)-wt(s));if(We.length=0,ve){ve.push(...e);return}for(ve=e,Ve=0;Ve<ve.length;Ve++){const t=ve[Ve];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}ve=null,Ve=0}}const wt=n=>n.id==null?n.flags&2?-1:1/0:n.id;function To(n){try{for(Xn=0;Xn<Rn.length;Xn++){const e=Rn[Xn];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),Ot(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Xn<Rn.length;Xn++){const e=Rn[Xn];e&&(e.flags&=-2)}Xn=-1,Rn.length=0,ko(),Gt=null,(Rn.length||We.length)&&To()}}let Nn=null,So=null;function Jt(n){const e=Nn;return Nn=n,So=n&&n.type.__scopeId||null,e}function ma(n,e=Nn,t){if(!e||n._n)return n;const s=(...i)=>{s._d&&Wt(-1);const r=Jt(e);let o;try{o=n(...i)}finally{Jt(r),s._d&&Wt(1)}return o};return s._n=!0,s._c=!0,s._d=!0,s}function ba(n,e){if(Nn===null)return n;const t=hs(Nn),s=n.dirs||(n.dirs=[]);for(let i=0;i<e.length;i++){let[r,o,l,a=on]=e[i];r&&(B(r)&&(r={mounted:r,updated:r}),r.deep&&he(o),s.push({dir:r,instance:t,value:o,oldValue:void 0,arg:l,modifiers:a}))}return n}function Se(n,e,t,s){const i=n.dirs,r=e&&e.dirs;for(let o=0;o<i.length;o++){const l=i[o];r&&(l.oldValue=r[o].value);let a=l.dir[s];a&&(re(),zn(a,t,8,[n.el,l,n,e]),oe())}}function Bt(n,e){if(wn){let t=wn.provides;const s=wn.parent&&wn.parent.provides;s===t&&(t=wn.provides=Object.create(s)),t[n]=e}}function Fn(n,e,t=!1){const s=vc();if(s||Ye){let i=Ye?Ye._context.provides:s?s.parent==null||s.ce?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:void 0;if(i&&n in i)return i[n];if(arguments.length>1)return t&&B(e)?e.call(s&&s.proxy):e}}const _a=Symbol.for("v-scx"),xa=()=>Fn(_a);function va(n,e){return ci(n,null,e)}function Ne(n,e,t){return ci(n,e,t)}function ci(n,e,t=on){const{immediate:s,deep:i,flush:r,once:o}=t,l=vn({},t),a=e&&s||!e&&r!=="post";let u;if(Tt){if(r==="sync"){const g=xa();u=g.__watcherHandles||(g.__watcherHandles=[])}else if(!a){const g=()=>{};return g.stop=se,g.resume=se,g.pause=se,g}}const c=wn;l.call=(g,y,w)=>zn(g,c,y,w);let f=!1;r==="post"?l.scheduler=g=>{Pn(g,c&&c.suspense)}:r!=="sync"&&(f=!0,l.scheduler=(g,y)=>{y?g():ai(g)}),l.augmentJob=g=>{e&&(g.flags|=4),f&&(g.flags|=2,c&&(g.id=c.uid,g.i=c))};const p=ha(n,e,l);return Tt&&(u?u.push(p):a&&p()),p}function ya(n,e,t){const s=this.proxy,i=fn(n)?n.includes(".")?Ro(s,n):()=>s[n]:n.bind(s,s);let r;B(e)?r=e:(r=e.handler,t=e);const o=Pt(this),l=ci(i,r.bind(s),t);return o(),l}function Ro(n,e){const t=e.split(".");return()=>{let s=n;for(let i=0;i<t.length&&s;i++)s=s[t[i]];return s}}const wa=Symbol("_vte"),ka=n=>n.__isTeleport,ys=Symbol("_leaveCb");function ui(n,e){n.shapeFlag&6&&n.component?(n.transition=e,ui(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}function Oo(n,e){return B(n)?vn({name:n.name},e,{setup:n}):n}function Eo(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}function nr(n,e){let t;return!!((t=Object.getOwnPropertyDescriptor(n,e))&&!t.configurable)}const Kt=new WeakMap;function pt(n,e,t,s,i=!1){if(H(n)){n.forEach((w,N)=>pt(w,e&&(H(e)?e[N]:e),t,s,i));return}if(gt(s)&&!i){s.shapeFlag&512&&s.type.__asyncResolved&&s.component.subTree.component&&pt(n,e,t,s.component.subTree);return}const r=s.shapeFlag&4?hs(s.component):s.el,o=i?null:r,{i:l,r:a}=n,u=e&&e.r,c=l.refs===on?l.refs={}:l.refs,f=l.setupState,p=q(f),g=f===on?Wr:w=>nr(c,w)?!1:W(p,w),y=(w,N)=>!(N&&nr(c,N));if(u!=null&&u!==a){if(er(e),fn(u))c[u]=null,g(u)&&(f[u]=null);else if(kn(u)){const w=e;y(u,w.k)&&(u.value=null),w.k&&(c[w.k]=null)}}if(B(a)){re();try{Ot(a,l,12,[o,c])}finally{oe()}}else{const w=fn(a),N=kn(a);if(w||N){const M=()=>{if(n.f){const E=w?g(a)?f[a]:c[a]:y()||!n.k?a.value:c[n.k];if(i)H(E)&&Ys(E,r);else if(H(E))E.includes(r)||E.push(r);else if(w)c[a]=[r],g(a)&&(f[a]=c[a]);else{const C=[r];y(a,n.k)&&(a.value=C),n.k&&(c[n.k]=C)}}else w?(c[a]=o,g(a)&&(f[a]=o)):N&&(y(a,n.k)&&(a.value=o),n.k&&(c[n.k]=o))};if(o){const E=()=>{M(),Kt.delete(n)};E.id=-1,Kt.set(n,E),Pn(E,t)}else er(n),M()}}}function er(n){const e=Kt.get(n);e&&(e.flags|=8,Kt.delete(n))}os().requestIdleCallback;os().cancelIdleCallback;const gt=n=>!!n.type.__asyncLoader,Po=n=>n.type.__isKeepAlive;function Ta(n,e){Ao(n,"a",e)}function Sa(n,e){Ao(n,"da",e)}function Ao(n,e,t=wn){const s=n.__wdc||(n.__wdc=()=>{let i=t;for(;i;){if(i.isDeactivated)return;i=i.parent}return n()});if(us(e,s,t),t){let i=t.parent;for(;i&&i.parent;)Po(i.parent.vnode)&&Ra(s,e,t,i),i=i.parent}}function Ra(n,e,t,s){const i=us(e,n,s,!0);fi(()=>{Ys(s[e],i)},t)}function us(n,e,t=wn,s=!1){if(t){const i=t[n]||(t[n]=[]),r=e.__weh||(e.__weh=(...o)=>{re();const l=Pt(t),a=zn(e,t,n,o);return l(),oe(),a});return s?i.unshift(r):i.push(r),r}}const $e=n=>(e,t=wn)=>{(!Tt||n==="sp")&&us(n,(...s)=>e(...s),t)},Oa=$e("bm"),Co=$e("m"),Ea=$e("bu"),Pa=$e("u"),Aa=$e("bum"),fi=$e("um"),Ca=$e("sp"),Na=$e("rtg"),Ia=$e("rtc");function La(n,e=wn){us("ec",n,e)}const Ma="components";function Da(n,e){return Ha(Ma,n,!0,e)||n}const ja=Symbol.for("v-ndc");function Ha(n,e,t=!0,s=!1){const i=Nn||wn;if(i){const r=i.type;{const l=Sc(r,!1);if(l&&(l===e||l===On(e)||l===rs(On(e))))return r}const o=tr(i[n]||r[n],e)||tr(i.appContext[n],e);return!o&&s?r:o}}function tr(n,e){return n&&(n[e]||n[On(e)]||n[rs(On(e))])}function Ee(n,e,t,s){let i;const r=t,o=H(n);if(o||fn(n)){const l=o&&Ce(n);let a=!1,u=!1;l&&(a=!jn(n),u=ge(n),n=ls(n)),i=new Array(n.length);for(let c=0,f=n.length;c<f;c++)i[c]=e(a?u?Ze(Un(n[c])):Un(n[c]):n[c],c,void 0,r)}else if(typeof n=="number"){i=new Array(n);for(let l=0;l<n;l++)i[l]=e(l+1,l,void 0,r)}else if(X(n))if(n[Symbol.iterator])i=Array.from(n,(l,a)=>e(l,a,void 0,r));else{const l=Object.keys(n);i=new Array(l.length);for(let a=0,u=l.length;a<u;a++){const c=l[a];i[a]=e(n[c],c,a,r)}}else i=[];return i}const Ds=n=>n?Xo(n)?hs(n):Ds(n.parent):null,$t=vn(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>Ds(n.parent),$root:n=>Ds(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>Io(n),$forceUpdate:n=>n.f||(n.f=()=>{ai(n.update)}),$nextTick:n=>n.n||(n.n=Et.bind(n.proxy)),$watch:n=>ya.bind(n)}),ws=(n,e)=>n!==on&&!n.__isScriptSetup&&W(n,e),Ba={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:s,data:i,props:r,accessCache:o,type:l,appContext:a}=n;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return s[e];case 2:return i[e];case 4:return t[e];case 3:return r[e]}else{if(ws(s,e))return o[e]=1,s[e];if(i!==on&&W(i,e))return o[e]=2,i[e];if(W(r,e))return o[e]=3,r[e];if(t!==on&&W(t,e))return o[e]=4,t[e];js&&(o[e]=0)}}const u=$t[e];let c,f;if(u)return e==="$attrs"&&yn(n.attrs,"get",""),u(n);if((c=l.__cssModules)&&(c=c[e]))return c;if(t!==on&&W(t,e))return o[e]=4,t[e];if(f=a.config.globalProperties,W(f,e))return f[e]},set({_:n},e,t){const{data:s,setupState:i,ctx:r}=n;return ws(i,e)?(i[e]=t,!0):s!==on&&W(s,e)?(s[e]=t,!0):W(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(r[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:s,appContext:i,props:r,type:o}},l){let a;return!!(t[l]||n!==on&&l[0]!=="$"&&W(n,l)||ws(e,l)||W(r,l)||W(s,l)||W($t,l)||W(i.config.globalProperties,l)||(a=o.__cssModules)&&a[l])},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:W(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function sr(n){return H(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let js=!0;function Fa(n){const e=Io(n),t=n.proxy,s=n.ctx;js=!1,e.beforeCreate&&ir(e.beforeCreate,n,"bc");const{data:i,computed:r,methods:o,watch:l,provide:a,inject:u,created:c,beforeMount:f,mounted:p,beforeUpdate:g,updated:y,activated:w,deactivated:N,beforeDestroy:M,beforeUnmount:E,destroyed:C,unmounted:A,render:Y,renderTracked:an,renderTriggered:Z,errorCaptured:Gn,serverPrefetch:me,expose:Jn,inheritAttrs:be,components:ke,directives:Kn,filters:tt}=e;if(u&&Ua(u,s,null),o)for(const nn in o){const J=o[nn];B(J)&&(s[nn]=J.bind(t))}if(i){const nn=i.call(t,t);X(nn)&&(n.data=as(nn))}if(js=!0,r)for(const nn in r){const J=r[nn],le=B(J)?J.bind(t,t):B(J.get)?J.get.bind(t,t):se,_e=!B(J)&&B(J.set)?J.set.bind(t):se,qn=mn({get:le,set:_e});Object.defineProperty(s,nn,{enumerable:!0,configurable:!0,get:()=>qn.value,set:En=>qn.value=En})}if(l)for(const nn in l)No(l[nn],s,t,nn);if(a){const nn=B(a)?a.call(t):a;Reflect.ownKeys(nn).forEach(J=>{Bt(J,nn[J])})}c&&ir(c,n,"c");function $n(nn,J){H(J)?J.forEach(le=>nn(le.bind(t))):J&&nn(J.bind(t))}if($n(Oa,f),$n(Co,p),$n(Ea,g),$n(Pa,y),$n(Ta,w),$n(Sa,N),$n(La,Gn),$n(Ia,an),$n(Na,Z),$n(Aa,E),$n(fi,A),$n(Ca,me),H(Jn))if(Jn.length){const nn=n.exposed||(n.exposed={});Jn.forEach(J=>{Object.defineProperty(nn,J,{get:()=>t[J],set:le=>t[J]=le,enumerable:!0})})}else n.exposed||(n.exposed={});Y&&n.render===se&&(n.render=Y),be!=null&&(n.inheritAttrs=be),ke&&(n.components=ke),Kn&&(n.directives=Kn),me&&Eo(n)}function Ua(n,e,t=se){H(n)&&(n=Hs(n));for(const s in n){const i=n[s];let r;X(i)?"default"in i?r=Fn(i.from||s,i.default,!0):r=Fn(i.from||s):r=Fn(i),kn(r)?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):e[s]=r}}function ir(n,e,t){zn(H(n)?n.map(s=>s.bind(e.proxy)):n.bind(e.proxy),e,t)}function No(n,e,t,s){let i=s.includes(".")?Ro(t,s):()=>t[s];if(fn(n)){const r=e[n];B(r)&&Ne(i,r)}else if(B(n))Ne(i,n.bind(t));else if(X(n))if(H(n))n.forEach(r=>No(r,e,t,s));else{const r=B(n.handler)?n.handler.bind(t):e[n.handler];B(r)&&Ne(i,r,n)}}function Io(n){const e=n.type,{mixins:t,extends:s}=e,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=n.appContext,l=r.get(e);let a;return l?a=l:!i.length&&!t&&!s?a=e:(a={},i.length&&i.forEach(u=>qt(a,u,o,!0)),qt(a,e,o)),X(e)&&r.set(e,a),a}function qt(n,e,t,s=!1){const{mixins:i,extends:r}=e;r&&qt(n,r,t,!0),i&&i.forEach(o=>qt(n,o,t,!0));for(const o in e)if(!(s&&o==="expose")){const l=za[o]||t&&t[o];n[o]=l?l(n[o],e[o]):e[o]}return n}const za={data:rr,props:or,emits:or,methods:ct,computed:ct,beforeCreate:Tn,created:Tn,beforeMount:Tn,mounted:Tn,beforeUpdate:Tn,updated:Tn,beforeDestroy:Tn,beforeUnmount:Tn,destroyed:Tn,unmounted:Tn,activated:Tn,deactivated:Tn,errorCaptured:Tn,serverPrefetch:Tn,components:ct,directives:ct,watch:Ga,provide:rr,inject:Va};function rr(n,e){return e?n?function(){return vn(B(n)?n.call(this,this):n,B(e)?e.call(this,this):e)}:e:n}function Va(n,e){return ct(Hs(n),Hs(e))}function Hs(n){if(H(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function Tn(n,e){return n?[...new Set([].concat(n,e))]:e}function ct(n,e){return n?vn(Object.create(null),n,e):e}function or(n,e){return n?H(n)&&H(e)?[...new Set([...n,...e])]:vn(Object.create(null),sr(n),sr(e??{})):e}function Ga(n,e){if(!n)return e;if(!e)return n;const t=vn(Object.create(null),n);for(const s in e)t[s]=Tn(n[s],e[s]);return t}function Lo(){return{app:null,config:{isNativeTag:Wr,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Ja=0;function Ka(n,e){return function(s,i=null){B(s)||(s=vn({},s)),i!=null&&!X(i)&&(i=null);const r=Lo(),o=new WeakSet,l=[];let a=!1;const u=r.app={_uid:Ja++,_component:s,_props:i,_container:null,_context:r,_instance:null,version:Oc,get config(){return r.config},set config(c){},use(c,...f){return o.has(c)||(c&&B(c.install)?(o.add(c),c.install(u,...f)):B(c)&&(o.add(c),c(u,...f))),u},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),u},component(c,f){return f?(r.components[c]=f,u):r.components[c]},directive(c,f){return f?(r.directives[c]=f,u):r.directives[c]},mount(c,f,p){if(!a){const g=u._ceVNode||gn(s,i);return g.appContext=r,p===!0?p="svg":p===!1&&(p=void 0),n(g,c,p),a=!0,u._container=c,c.__vue_app__=u,hs(g.component)}},onUnmount(c){l.push(c)},unmount(){a&&(zn(l,u._instance,16),n(null,u._container),delete u._container.__vue_app__)},provide(c,f){return r.provides[c]=f,u},runWithContext(c){const f=Ye;Ye=u;try{return c()}finally{Ye=f}}};return u}}let Ye=null;const qa=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${On(e)}Modifiers`]||n[`${De(e)}Modifiers`];function Wa(n,e,...t){if(n.isUnmounted)return;const s=n.vnode.props||on;let i=t;const r=e.startsWith("update:"),o=r&&qa(s,e.slice(7));o&&(o.trim&&(i=t.map(c=>fn(c)?c.trim():c)),o.number&&(i=t.map(Qs)));let l,a=s[l=ms(e)]||s[l=ms(On(e))];!a&&r&&(a=s[l=ms(De(e))]),a&&zn(a,n,6,i);const u=s[l+"Once"];if(u){if(!n.emitted)n.emitted={};else if(n.emitted[l])return;n.emitted[l]=!0,zn(u,n,6,i)}}const Ya=new WeakMap;function Mo(n,e,t=!1){const s=t?Ya:e.emitsCache,i=s.get(n);if(i!==void 0)return i;const r=n.emits;let o={},l=!1;if(!B(n)){const a=u=>{const c=Mo(u,e,!0);c&&(l=!0,vn(o,c))};!t&&e.mixins.length&&e.mixins.forEach(a),n.extends&&a(n.extends),n.mixins&&n.mixins.forEach(a)}return!r&&!l?(X(n)&&s.set(n,null),null):(H(r)?r.forEach(a=>o[a]=null):vn(o,r),X(n)&&s.set(n,o),o)}function fs(n,e){return!n||!ts(e)?!1:(e=e.slice(2),e=e==="Once"?e:e.replace(/Once$/,""),W(n,e[0].toLowerCase()+e.slice(1))||W(n,De(e))||W(n,e))}function lr(n){const{type:e,vnode:t,proxy:s,withProxy:i,propsOptions:[r],slots:o,attrs:l,emit:a,render:u,renderCache:c,props:f,data:p,setupState:g,ctx:y,inheritAttrs:w}=n,N=Jt(n);let M,E;try{if(t.shapeFlag&4){const A=i||s,Y=A;M=ee(u.call(Y,A,c,f,g,p,y)),E=l}else{const A=e;M=ee(A.length>1?A(f,{attrs:l,slots:o,emit:a}):A(f,null)),E=e.props?l:Za(l)}}catch(A){mt.length=0,cs(A,n,1),M=gn(we)}let C=M;if(E&&w!==!1){const A=Object.keys(E),{shapeFlag:Y}=C;A.length&&Y&7&&(r&&A.some(ss)&&(E=Qa(E,r)),C=Qe(C,E,!1,!0))}return t.dirs&&(C=Qe(C,null,!1,!0),C.dirs=C.dirs?C.dirs.concat(t.dirs):t.dirs),t.transition&&ui(C,t.transition),M=C,Jt(N),M}const Za=n=>{let e;for(const t in n)(t==="class"||t==="style"||ts(t))&&((e||(e={}))[t]=n[t]);return e},Qa=(n,e)=>{const t={};for(const s in n)(!ss(s)||!(s.slice(9)in e))&&(t[s]=n[s]);return t};function Xa(n,e,t){const{props:s,children:i,component:r}=n,{props:o,children:l,patchFlag:a}=e,u=r.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&a>=0){if(a&1024)return!0;if(a&16)return s?ar(s,o,u):!!o;if(a&8){const c=e.dynamicProps;for(let f=0;f<c.length;f++){const p=c[f];if(Do(o,s,p)&&!fs(u,p))return!0}}}else return(i||l)&&(!l||!l.$stable)?!0:s===o?!1:s?o?ar(s,o,u):!0:!!o;return!1}function ar(n,e,t){const s=Object.keys(e);if(s.length!==Object.keys(n).length)return!0;for(let i=0;i<s.length;i++){const r=s[i];if(Do(e,n,r)&&!fs(t,r))return!0}return!1}function Do(n,e,t){const s=n[t],i=e[t];return t==="style"&&X(s)&&X(i)?!ni(s,i):s!==i}function nc({vnode:n,parent:e,suspense:t},s){for(;e;){const i=e.subTree;if(i.suspense&&i.suspense.activeBranch===n&&(i.suspense.vnode.el=i.el=s,n=i),i===n)(n=e.vnode).el=s,e=e.parent;else break}t&&t.activeBranch===n&&(t.vnode.el=s)}const jo={},Ho=()=>Object.create(jo),Bo=n=>Object.getPrototypeOf(n)===jo;function ec(n,e,t,s=!1){const i={},r=Ho();n.propsDefaults=Object.create(null),Fo(n,e,i,r);for(const o in n.propsOptions[0])o in i||(i[o]=void 0);t?n.props=s?i:_o(i):n.type.props?n.props=i:n.props=r,n.attrs=r}function tc(n,e,t,s){const{props:i,attrs:r,vnode:{patchFlag:o}}=n,l=q(i),[a]=n.propsOptions;let u=!1;if((s||o>0)&&!(o&16)){if(o&8){const c=n.vnode.dynamicProps;for(let f=0;f<c.length;f++){let p=c[f];if(fs(n.emitsOptions,p))continue;const g=e[p];if(a)if(W(r,p))g!==r[p]&&(r[p]=g,u=!0);else{const y=On(p);i[y]=Bs(a,l,y,g,n,!1)}else g!==r[p]&&(r[p]=g,u=!0)}}}else{Fo(n,e,i,r)&&(u=!0);let c;for(const f in l)(!e||!W(e,f)&&((c=De(f))===f||!W(e,c)))&&(a?t&&(t[f]!==void 0||t[c]!==void 0)&&(i[f]=Bs(a,l,f,void 0,n,!0)):delete i[f]);if(r!==l)for(const f in r)(!e||!W(e,f))&&(delete r[f],u=!0)}u&&de(n.attrs,"set","")}function Fo(n,e,t,s){const[i,r]=n.propsOptions;let o=!1,l;if(e)for(let a in e){if(ft(a))continue;const u=e[a];let c;i&&W(i,c=On(a))?!r||!r.includes(c)?t[c]=u:(l||(l={}))[c]=u:fs(n.emitsOptions,a)||(!(a in s)||u!==s[a])&&(s[a]=u,o=!0)}if(r){const a=q(t),u=l||on;for(let c=0;c<r.length;c++){const f=r[c];t[f]=Bs(i,a,f,u[f],n,!W(u,f))}}return o}function Bs(n,e,t,s,i,r){const o=n[t];if(o!=null){const l=W(o,"default");if(l&&s===void 0){const a=o.default;if(o.type!==Function&&!o.skipFactory&&B(a)){const{propsDefaults:u}=i;if(t in u)s=u[t];else{const c=Pt(i);s=u[t]=a.call(null,e),c()}}else s=a;i.ce&&i.ce._setProp(t,s)}o[0]&&(r&&!l?s=!1:o[1]&&(s===""||s===De(t))&&(s=!0))}return s}const sc=new WeakMap;function Uo(n,e,t=!1){const s=t?sc:e.propsCache,i=s.get(n);if(i)return i;const r=n.props,o={},l=[];let a=!1;if(!B(n)){const c=f=>{a=!0;const[p,g]=Uo(f,e,!0);vn(o,p),g&&l.push(...g)};!t&&e.mixins.length&&e.mixins.forEach(c),n.extends&&c(n.extends),n.mixins&&n.mixins.forEach(c)}if(!r&&!a)return X(n)&&s.set(n,Ke),Ke;if(H(r))for(let c=0;c<r.length;c++){const f=On(r[c]);cr(f)&&(o[f]=on)}else if(r)for(const c in r){const f=On(c);if(cr(f)){const p=r[c],g=o[f]=H(p)||B(p)?{type:p}:vn({},p),y=g.type;let w=!1,N=!0;if(H(y))for(let M=0;M<y.length;++M){const E=y[M],C=B(E)&&E.name;if(C==="Boolean"){w=!0;break}else C==="String"&&(N=!1)}else w=B(y)&&y.name==="Boolean";g[0]=w,g[1]=N,(w||W(g,"default"))&&l.push(f)}}const u=[o,l];return X(n)&&s.set(n,u),u}function cr(n){return n[0]!=="$"&&!ft(n)}const di=n=>n==="_"||n==="_ctx"||n==="$stable",hi=n=>H(n)?n.map(ee):[ee(n)],ic=(n,e,t)=>{if(e._n)return e;const s=ma((...i)=>hi(e(...i)),t);return s._c=!1,s},zo=(n,e,t)=>{const s=n._ctx;for(const i in n){if(di(i))continue;const r=n[i];if(B(r))e[i]=ic(i,r,s);else if(r!=null){const o=hi(r);e[i]=()=>o}}},Vo=(n,e)=>{const t=hi(e);n.slots.default=()=>t},Go=(n,e,t)=>{for(const s in e)(t||!di(s))&&(n[s]=e[s])},rc=(n,e,t)=>{const s=n.slots=Ho();if(n.vnode.shapeFlag&32){const i=e._;i?(Go(s,e,t),t&&no(s,"_",i,!0)):zo(e,s)}else e&&Vo(n,e)},oc=(n,e,t)=>{const{vnode:s,slots:i}=n;let r=!0,o=on;if(s.shapeFlag&32){const l=e._;l?t&&l===1?r=!1:Go(i,e,t):(r=!e.$stable,zo(e,i)),o=e}else e&&(Vo(n,e),o={default:1});if(r)for(const l in i)!di(l)&&o[l]==null&&delete i[l]},Pn=fc;function lc(n){return ac(n)}function ac(n,e){const t=os();t.__VUE__=!0;const{insert:s,remove:i,patchProp:r,createElement:o,createText:l,createComment:a,setText:u,setElementText:c,parentNode:f,nextSibling:p,setScopeId:g=se,insertStaticContent:y}=n,w=(d,h,$,b=null,x=null,m=null,S=void 0,T=null,k=!!h.dynamicChildren)=>{if(d===h)return;d&&!rt(d,h)&&(b=_(d),En(d,x,m,!0),d=null),h.patchFlag===-2&&(k=!1,h.dynamicChildren=null);const{type:v,ref:D,shapeFlag:O}=h;switch(v){case ds:N(d,h,$,b);break;case we:M(d,h,$,b);break;case Ft:d==null&&E(h,$,b,S);break;case cn:ke(d,h,$,b,x,m,S,T,k);break;default:O&1?Y(d,h,$,b,x,m,S,T,k):O&6?Kn(d,h,$,b,x,m,S,T,k):(O&64||O&128)&&v.process(d,h,$,b,x,m,S,T,k,I)}D!=null&&x?pt(D,d&&d.ref,m,h||d,!h):D==null&&d&&d.ref!=null&&pt(d.ref,null,m,d,!0)},N=(d,h,$,b)=>{if(d==null)s(h.el=l(h.children),$,b);else{const x=h.el=d.el;h.children!==d.children&&u(x,h.children)}},M=(d,h,$,b)=>{d==null?s(h.el=a(h.children||""),$,b):h.el=d.el},E=(d,h,$,b)=>{[d.el,d.anchor]=y(d.children,h,$,b,d.el,d.anchor)},C=({el:d,anchor:h},$,b)=>{let x;for(;d&&d!==h;)x=p(d),s(d,$,b),d=x;s(h,$,b)},A=({el:d,anchor:h})=>{let $;for(;d&&d!==h;)$=p(d),i(d),d=$;i(h)},Y=(d,h,$,b,x,m,S,T,k)=>{if(h.type==="svg"?S="svg":h.type==="math"&&(S="mathml"),d==null)an(h,$,b,x,m,S,T,k);else{const v=d.el&&d.el._isVueCE?d.el:null;try{v&&v._beginPatch(),me(d,h,x,m,S,T,k)}finally{v&&v._endPatch()}}},an=(d,h,$,b,x,m,S,T)=>{let k,v;const{props:D,shapeFlag:O,transition:L,dirs:j}=d;if(k=d.el=o(d.type,m,D&&D.is,D),O&8?c(k,d.children):O&16&&Gn(d.children,k,null,b,x,ks(d,m),S,T),j&&Se(d,null,b,"created"),Z(k,d,d.scopeId,S,b),D){for(const sn in D)sn!=="value"&&!ft(sn)&&r(k,sn,null,D[sn],m,b);"value"in D&&r(k,"value",null,D.value,m),(v=D.onVnodeBeforeMount)&&Qn(v,b,d)}j&&Se(d,null,b,"beforeMount");const G=cc(x,L);G&&L.beforeEnter(k),s(k,h,$),((v=D&&D.onVnodeMounted)||G||j)&&Pn(()=>{try{v&&Qn(v,b,d),G&&L.enter(k),j&&Se(d,null,b,"mounted")}finally{}},x)},Z=(d,h,$,b,x)=>{if($&&g(d,$),b)for(let m=0;m<b.length;m++)g(d,b[m]);if(x){let m=x.subTree;if(h===m||Wo(m.type)&&(m.ssContent===h||m.ssFallback===h)){const S=x.vnode;Z(d,S,S.scopeId,S.slotScopeIds,x.parent)}}},Gn=(d,h,$,b,x,m,S,T,k=0)=>{for(let v=k;v<d.length;v++){const D=d[v]=T?fe(d[v]):ee(d[v]);w(null,D,h,$,b,x,m,S,T)}},me=(d,h,$,b,x,m,S)=>{const T=h.el=d.el;let{patchFlag:k,dynamicChildren:v,dirs:D}=h;k|=d.patchFlag&16;const O=d.props||on,L=h.props||on;let j;if($&&Re($,!1),(j=L.onVnodeBeforeUpdate)&&Qn(j,$,h,d),D&&Se(h,d,$,"beforeUpdate"),$&&Re($,!0),v&&(!d.dynamicChildren||d.dynamicChildren.length!==v.length)&&(k=0,S=!1,v=null),(O.innerHTML&&L.innerHTML==null||O.textContent&&L.textContent==null)&&c(T,""),v?Jn(d.dynamicChildren,v,T,$,b,ks(h,x),m):S||J(d,h,T,null,$,b,ks(h,x),m,!1),k>0){if(k&16)be(T,O,L,$,x);else if(k&2&&O.class!==L.class&&r(T,"class",null,L.class,x),k&4&&r(T,"style",O.style,L.style,x),k&8){const G=h.dynamicProps;for(let sn=0;sn<G.length;sn++){const en=G[sn],hn=O[en],bn=L[en];(bn!==hn||en==="value")&&r(T,en,hn,bn,x,$)}}k&1&&d.children!==h.children&&c(T,h.children)}else!S&&v==null&&be(T,O,L,$,x);((j=L.onVnodeUpdated)||D)&&Pn(()=>{j&&Qn(j,$,h,d),D&&Se(h,d,$,"updated")},b)},Jn=(d,h,$,b,x,m,S)=>{for(let T=0;T<h.length;T++){const k=d[T],v=h[T],D=k.el&&(k.type===cn||!rt(k,v)||k.shapeFlag&198)?f(k.el):$;w(k,v,D,null,b,x,m,S,!0)}},be=(d,h,$,b,x)=>{if(h!==$){if(h!==on)for(const m in h)!ft(m)&&!(m in $)&&r(d,m,h[m],null,x,b);for(const m in $){if(ft(m))continue;const S=$[m],T=h[m];S!==T&&m!=="value"&&r(d,m,T,S,x,b)}"value"in $&&r(d,"value",h.value,$.value,x)}},ke=(d,h,$,b,x,m,S,T,k)=>{const v=h.el=d?d.el:l(""),D=h.anchor=d?d.anchor:l("");let{patchFlag:O,dynamicChildren:L,slotScopeIds:j}=h;j&&(T=T?T.concat(j):j),d==null?(s(v,$,b),s(D,$,b),Gn(h.children||[],$,D,x,m,S,T,k)):O>0&&O&64&&L&&d.dynamicChildren&&d.dynamicChildren.length===L.length?(Jn(d.dynamicChildren,L,$,x,m,S,T),(h.key!=null||x&&h===x.subTree)&&Jo(d,h,!0)):J(d,h,$,D,x,m,S,T,k)},Kn=(d,h,$,b,x,m,S,T,k)=>{h.slotScopeIds=T,d==null?h.shapeFlag&512?x.ctx.activate(h,$,b,S,k):tt(h,$,b,x,m,S,k):Be(d,h,k)},tt=(d,h,$,b,x,m,S)=>{const T=d.component=xc(d,b,x);if(Po(d)&&(T.ctx.renderer=I),yc(T,!1,S),T.asyncDep){if(x&&x.registerDep(T,$n,S),!d.el){const k=T.subTree=gn(we);M(null,k,h,$),d.placeholder=k.el}}else $n(T,d,h,$,x,m,S)},Be=(d,h,$)=>{const b=h.component=d.component;if(Xa(d,h,$))if(b.asyncDep&&!b.asyncResolved){nn(b,h,$);return}else b.next=h,b.update();else h.el=d.el,b.vnode=h},$n=(d,h,$,b,x,m,S)=>{const T=()=>{if(d.isMounted){let{next:O,bu:L,u:j,parent:G,vnode:sn}=d;{const Yn=Ko(d);if(Yn){O&&(O.el=sn.el,nn(d,O,S)),Yn.asyncDep.then(()=>{Pn(()=>{d.isUnmounted||v()},x)});return}}let en=O,hn;Re(d,!1),O?(O.el=sn.el,nn(d,O,S)):O=sn,L&&Ht(L),(hn=O.props&&O.props.onVnodeBeforeUpdate)&&Qn(hn,G,O,sn),Re(d,!0);const bn=lr(d),Wn=d.subTree;d.subTree=bn,w(Wn,bn,f(Wn.el),_(Wn),d,x,m),O.el=bn.el,en===null&&nc(d,bn.el),j&&Pn(j,x),(hn=O.props&&O.props.onVnodeUpdated)&&Pn(()=>Qn(hn,G,O,sn),x)}else{let O;const{el:L,props:j}=h,{bm:G,m:sn,parent:en,root:hn,type:bn}=d,Wn=gt(h);Re(d,!1),G&&Ht(G),!Wn&&(O=j&&j.onVnodeBeforeMount)&&Qn(O,en,h),Re(d,!0);{hn.ce&&hn.ce._hasShadowRoot()&&hn.ce._injectChildStyle(bn,d.parent?d.parent.type:void 0);const Yn=d.subTree=lr(d);w(null,Yn,$,b,d,x,m),h.el=Yn.el}if(sn&&Pn(sn,x),!Wn&&(O=j&&j.onVnodeMounted)){const Yn=h;Pn(()=>Qn(O,en,Yn),x)}(h.shapeFlag&256||en&&gt(en.vnode)&&en.vnode.shapeFlag&256)&&d.a&&Pn(d.a,x),d.isMounted=!0,h=$=b=null}};d.scope.on();const k=d.effect=new io(T);d.scope.off();const v=d.update=k.run.bind(k),D=d.job=k.runIfDirty.bind(k);D.i=d,D.id=d.uid,k.scheduler=()=>ai(D),Re(d,!0),v()},nn=(d,h,$)=>{h.component=d;const b=d.vnode.props;d.vnode=h,d.next=null,tc(d,h.props,b,$),oc(d,h.children,$),re(),Xi(d),oe()},J=(d,h,$,b,x,m,S,T,k=!1)=>{const v=d&&d.children,D=d?d.shapeFlag:0,O=h.children,{patchFlag:L,shapeFlag:j}=h;if(L>0){if(L&128){_e(v,O,$,b,x,m,S,T,k);return}else if(L&256){le(v,O,$,b,x,m,S,T,k);return}}j&8?(D&16&&Ln(v,x,m),O!==v&&c($,O)):D&16?j&16?_e(v,O,$,b,x,m,S,T,k):Ln(v,x,m,!0):(D&8&&c($,""),j&16&&Gn(O,$,b,x,m,S,T,k))},le=(d,h,$,b,x,m,S,T,k)=>{d=d||Ke,h=h||Ke;const v=d.length,D=h.length,O=Math.min(v,D);let L;for(L=0;L<O;L++){const j=h[L]=k?fe(h[L]):ee(h[L]);w(d[L],j,$,null,x,m,S,T,k)}v>D?Ln(d,x,m,!0,!1,O):Gn(h,$,b,x,m,S,T,k,O)},_e=(d,h,$,b,x,m,S,T,k)=>{let v=0;const D=h.length;let O=d.length-1,L=D-1;for(;v<=O&&v<=L;){const j=d[v],G=h[v]=k?fe(h[v]):ee(h[v]);if(rt(j,G))w(j,G,$,null,x,m,S,T,k);else break;v++}for(;v<=O&&v<=L;){const j=d[O],G=h[L]=k?fe(h[L]):ee(h[L]);if(rt(j,G))w(j,G,$,null,x,m,S,T,k);else break;O--,L--}if(v>O){if(v<=L){const j=L+1,G=j<D?h[j].el:b;for(;v<=L;)w(null,h[v]=k?fe(h[v]):ee(h[v]),$,G,x,m,S,T,k),v++}}else if(v>L)for(;v<=O;)En(d[v],x,m,!0),v++;else{const j=v,G=v,sn=new Map;for(v=G;v<=L;v++){const An=h[v]=k?fe(h[v]):ee(h[v]);An.key!=null&&sn.set(An.key,v)}let en,hn=0;const bn=L-G+1;let Wn=!1,Yn=0;const st=new Array(bn);for(v=0;v<bn;v++)st[v]=0;for(v=j;v<=O;v++){const An=d[v];if(hn>=bn){En(An,x,m,!0);continue}let Zn;if(An.key!=null)Zn=sn.get(An.key);else for(en=G;en<=L;en++)if(st[en-G]===0&&rt(An,h[en])){Zn=en;break}Zn===void 0?En(An,x,m,!0):(st[Zn-G]=v+1,Zn>=Yn?Yn=Zn:Wn=!0,w(An,h[Zn],$,null,x,m,S,T,k),hn++)}const Ji=Wn?uc(st):Ke;for(en=Ji.length-1,v=bn-1;v>=0;v--){const An=G+v,Zn=h[An],Ki=h[An+1],qi=An+1<D?Ki.el||qo(Ki):b;st[v]===0?w(null,Zn,$,qi,x,m,S,T,k):Wn&&(en<0||v!==Ji[en]?qn(Zn,$,qi,2):en--)}}},qn=(d,h,$,b,x=null)=>{const{el:m,type:S,transition:T,children:k,shapeFlag:v}=d;if(v&6){qn(d.component.subTree,h,$,b);return}if(v&128){d.suspense.move(h,$,b);return}if(v&64){S.move(d,h,$,I);return}if(S===cn){s(m,h,$);for(let O=0;O<k.length;O++)qn(k[O],h,$,b);s(d.anchor,h,$);return}if(S===Ft){C(d,h,$);return}if(b!==2&&v&1&&T)if(b===0)T.persisted&&!m[ys]?s(m,h,$):(T.beforeEnter(m),s(m,h,$),Pn(()=>T.enter(m),x));else{const{leave:O,delayLeave:L,afterLeave:j}=T,G=()=>{d.ctx.isUnmounted?i(m):s(m,h,$)},sn=()=>{const en=m._isLeaving||!!m[ys];m._isLeaving&&m[ys](!0),T.persisted&&!en?G():O(m,()=>{G(),j&&j()})};L?L(m,G,sn):sn()}else s(m,h,$)},En=(d,h,$,b=!1,x=!1)=>{const{type:m,props:S,ref:T,children:k,dynamicChildren:v,shapeFlag:D,patchFlag:O,dirs:L,cacheIndex:j,memo:G}=d;if(O===-2&&(x=!1),T!=null&&(re(),pt(T,null,$,d,!0),oe()),j!=null&&(h.renderCache[j]=void 0),D&256){h.ctx.deactivate(d);return}const sn=D&1&&L,en=!gt(d);let hn;if(en&&(hn=S&&S.onVnodeBeforeUnmount)&&Qn(hn,h,d),D&6)Te(d.component,$,b);else{if(D&128){d.suspense.unmount($,b);return}sn&&Se(d,null,h,"beforeUnmount"),D&64?d.type.remove(d,h,$,I,b):v&&!v.hasOnce&&(m!==cn||O>0&&O&64)?Ln(v,h,$,!1,!0):(m===cn&&O&384||!x&&D&16)&&Ln(k,h,$),b&&Fe(d)}const bn=G!=null&&j==null;(en&&(hn=S&&S.onVnodeUnmounted)||sn||bn)&&Pn(()=>{hn&&Qn(hn,h,d),sn&&Se(d,null,h,"unmounted"),bn&&(d.el=null)},$)},Fe=d=>{const{type:h,el:$,anchor:b,transition:x}=d;if(h===cn){Ue($,b);return}if(h===Ft){A(d);return}const m=()=>{i($),x&&!x.persisted&&x.afterLeave&&x.afterLeave()};if(d.shapeFlag&1&&x&&!x.persisted){const{leave:S,delayLeave:T}=x,k=()=>S($,m);T?T(d.el,m,k):k()}else m()},Ue=(d,h)=>{let $;for(;d!==h;)$=p(d),i(d),d=$;i(h)},Te=(d,h,$)=>{const{bum:b,scope:x,job:m,subTree:S,um:T,m:k,a:v}=d;ur(k),ur(v),b&&Ht(b),x.stop(),m&&(m.flags|=8,En(S,d,h,$)),T&&Pn(T,h),Pn(()=>{d.isUnmounted=!0},h)},Ln=(d,h,$,b=!1,x=!1,m=0)=>{for(let S=m;S<d.length;S++)En(d[S],h,$,b,x)},_=d=>{if(d.shapeFlag&6)return _(d.component.subTree);if(d.shapeFlag&128)return d.suspense.next();const h=p(d.anchor||d.el),$=h&&h[wa];return $?p($):h};let P=!1;const R=(d,h,$)=>{let b;d==null?h._vnode&&(En(h._vnode,null,null,!0),b=h._vnode.component):w(h._vnode||null,d,h,null,null,null,$),h._vnode=d,P||(P=!0,Xi(b),ko(),P=!1)},I={p:w,um:En,m:qn,r:Fe,mt:tt,mc:Gn,pc:J,pbc:Jn,n:_,o:n};return{render:R,hydrate:void 0,createApp:Ka(R)}}function ks({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function Re({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function cc(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function Jo(n,e,t=!1){const s=n.children,i=e.children;if(H(s)&&H(i))for(let r=0;r<s.length;r++){const o=s[r];let l=i[r];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=i[r]=fe(i[r]),l.el=o.el),!t&&l.patchFlag!==-2&&Jo(o,l)),l.type===ds&&(l.patchFlag===-1&&(l=i[r]=fe(l)),l.el=o.el),l.type===we&&!l.el&&(l.el=o.el)}}function uc(n){const e=n.slice(),t=[0];let s,i,r,o,l;const a=n.length;for(s=0;s<a;s++){const u=n[s];if(u!==0){if(i=t[t.length-1],n[i]<u){e[s]=i,t.push(s);continue}for(r=0,o=t.length-1;r<o;)l=r+o>>1,n[t[l]]<u?r=l+1:o=l;u<n[t[r]]&&(r>0&&(e[s]=t[r-1]),t[r]=s)}}for(r=t.length,o=t[r-1];r-- >0;)t[r]=o,o=e[o];return t}function Ko(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:Ko(e)}function ur(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}function qo(n){if(n.placeholder)return n.placeholder;const e=n.component;return e?qo(e.subTree):null}const Wo=n=>n.__isSuspense;function fc(n,e){e&&e.pendingBranch?H(n)?e.effects.push(...n):e.effects.push(n):$a(n)}const cn=Symbol.for("v-fgt"),ds=Symbol.for("v-txt"),we=Symbol.for("v-cmt"),Ft=Symbol.for("v-stc"),mt=[];let In=null;function F(n=!1){mt.push(In=n?null:[])}function dc(){mt.pop(),In=mt[mt.length-1]||null}let kt=1;function Wt(n,e=!1){kt+=n,n<0&&In&&e&&(In.hasOnce=!0)}function Yo(n){return n.dynamicChildren=kt>0?In||Ke:null,dc(),kt>0&&In&&In.push(n),n}function z(n,e,t,s,i,r){return Yo(U(n,e,t,s,i,r,!0))}function Zo(n,e,t,s,i){return Yo(gn(n,e,t,s,i,!0))}function Yt(n){return n?n.__v_isVNode===!0:!1}function rt(n,e){return n.type===e.type&&n.key===e.key}const Qo=({key:n})=>n??null,Ut=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?fn(n)||kn(n)||B(n)?{i:Nn,r:n,k:e,f:!!t}:n:null);function U(n,e=null,t=null,s=0,i=null,r=n===cn?0:1,o=!1,l=!1){const a={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&Qo(e),ref:e&&Ut(e),scopeId:So,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:s,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:Nn};return l?(Zt(a,t),r&128&&n.normalize(a)):t&&(a.shapeFlag|=fn(t)?8:16),kt>0&&!o&&In&&(a.patchFlag>0||r&6)&&a.patchFlag!==32&&In.push(a),a}const gn=hc;function hc(n,e=null,t=null,s=0,i=null,r=!1){if((!n||n===ja)&&(n=we),Yt(n)){const l=Qe(n,e,!0);return t&&Zt(l,t),kt>0&&!r&&In&&(l.shapeFlag&6?In[In.indexOf(n)]=l:In.push(l)),l.patchFlag=-2,l}if(Rc(n)&&(n=n.__vccOpts),e){e=pc(e);let{class:l,style:a}=e;l&&!fn(l)&&(e.class=Hn(l)),X(a)&&(li(a)&&!H(a)&&(a=vn({},a)),e.style=Xs(a))}const o=fn(n)?1:Wo(n)?128:ka(n)?64:X(n)?4:B(n)?2:0;return U(n,e,t,s,i,o,r,!0)}function pc(n){return n?li(n)||Bo(n)?vn({},n):n:null}function Qe(n,e,t=!1,s=!1){const{props:i,ref:r,patchFlag:o,children:l,transition:a}=n,u=e?mc(i||{},e):i,c={__v_isVNode:!0,__v_skip:!0,type:n.type,props:u,key:u&&Qo(u),ref:e&&e.ref?t&&r?H(r)?r.concat(Ut(e)):[r,Ut(e)]:Ut(e):r,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:l,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==cn?o===-1?16:o|16:o,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:a,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&Qe(n.ssContent),ssFallback:n.ssFallback&&Qe(n.ssFallback),placeholder:n.placeholder,el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return a&&s&&ui(c,a.clone(c)),c}function gc(n=" ",e=0){return gn(ds,null,n,e)}function $c(n,e){const t=gn(Ft,null,n);return t.staticCount=e,t}function Le(n="",e=!1){return e?(F(),Zo(we,null,n)):gn(we,null,n)}function ee(n){return n==null||typeof n=="boolean"?gn(we):H(n)?gn(cn,null,n.slice()):Yt(n)?fe(n):gn(ds,null,String(n))}function fe(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:Qe(n)}function Zt(n,e){let t=0;const{shapeFlag:s}=n;if(e==null)e=null;else if(H(e))t=16;else if(typeof e=="object")if(s&65){const i=e.default;i&&(i._c&&(i._d=!1),Zt(n,i()),i._c&&(i._d=!0));return}else{t=32;const i=e._;!i&&!Bo(e)?e._ctx=Nn:i===3&&Nn&&(Nn.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else if(B(e)){if(s&65){Zt(n,{default:e});return}e={default:e,_ctx:Nn},t=32}else e=String(e),s&64?(t=16,e=[gc(e)]):t=8;n.children=e,n.shapeFlag|=t}function mc(...n){const e={};for(let t=0;t<n.length;t++){const s=n[t];for(const i in s)if(i==="class")e.class!==s.class&&(e.class=Hn([e.class,s.class]));else if(i==="style")e.style=Xs([e.style,s.style]);else if(ts(i)){const r=e[i],o=s[i];o&&r!==o&&!(H(r)&&r.includes(o))?e[i]=r?[].concat(r,o):o:o==null&&r==null&&!ss(i)&&(e[i]=o)}else i!==""&&(e[i]=s[i])}return e}function Qn(n,e,t,s=null){zn(n,e,7,[t,s])}const bc=Lo();let _c=0;function xc(n,e,t){const s=n.type,i=(e?e.appContext:n.appContext)||bc,r={uid:_c++,vnode:n,type:s,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Fl(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Uo(s,i),emitsOptions:Mo(s,i),emit:null,emitted:null,propsDefaults:on,inheritAttrs:s.inheritAttrs,ctx:on,data:on,props:on,attrs:on,slots:on,refs:on,setupState:on,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=Wa.bind(null,r),n.ce&&n.ce(r),r}let wn=null;const vc=()=>wn||Nn;let Qt,Fs;{const n=os(),e=(t,s)=>{let i;return(i=n[t])||(i=n[t]=[]),i.push(s),r=>{i.length>1?i.forEach(o=>o(r)):i[0](r)}};Qt=e("__VUE_INSTANCE_SETTERS__",t=>wn=t),Fs=e("__VUE_SSR_SETTERS__",t=>Tt=t)}const Pt=n=>{const e=wn;return Qt(n),n.scope.on(),()=>{n.scope.off(),Qt(e)}},fr=()=>{wn&&wn.scope.off(),Qt(null)};function Xo(n){return n.vnode.shapeFlag&4}let Tt=!1;function yc(n,e=!1,t=!1){e&&Fs(e);const{props:s,children:i}=n.vnode,r=Xo(n);ec(n,s,r,e),rc(n,i,t||e);const o=r?wc(n,e):void 0;return e&&Fs(!1),o}function wc(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,Ba);const{setup:s}=t;if(s){re();const i=n.setupContext=s.length>1?Tc(n):null,r=Pt(n),o=Ot(s,n,0,[n.props,i]),l=Zr(o);if(oe(),r(),(l||n.sp)&&!gt(n)&&Eo(n),l){if(o.then(fr,fr),e)return o.then(a=>{dr(n,a)}).catch(a=>{cs(a,n,0)});n.asyncDep=o}else dr(n,o)}else nl(n)}function dr(n,e,t){B(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:X(e)&&(n.setupState=vo(e)),nl(n)}function nl(n,e,t){const s=n.type;n.render||(n.render=s.render||se);{const i=Pt(n);re();try{Fa(n)}finally{oe(),i()}}}const kc={get(n,e){return yn(n,"get",""),n[e]}};function Tc(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,kc),slots:n.slots,emit:n.emit,expose:e}}function hs(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(vo(oa(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in $t)return $t[t](n)},has(e,t){return t in e||t in $t}})):n.proxy}function Sc(n,e=!0){return B(n)?n.displayName||n.name:n.name||e&&n.__name}function Rc(n){return B(n)&&"__vccOpts"in n}const mn=(n,e)=>fa(n,e,Tt);function el(n,e,t){try{Wt(-1);const s=arguments.length;return s===2?X(e)&&!H(e)?Yt(e)?gn(n,null,[e]):gn(n,e):gn(n,null,e):(s>3?t=Array.prototype.slice.call(arguments,2):s===3&&Yt(t)&&(t=[t]),gn(n,e,t))}finally{Wt(1)}}const Oc="3.5.39";/**
* @vue/runtime-dom v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Us;const hr=typeof window<"u"&&window.trustedTypes;if(hr)try{Us=hr.createPolicy("vue",{createHTML:n=>n})}catch{}const tl=Us?n=>Us.createHTML(n):n=>n,Ec="http://www.w3.org/2000/svg",Pc="http://www.w3.org/1998/Math/MathML",ue=typeof document<"u"?document:null,pr=ue&&ue.createElement("template"),Ac={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,s)=>{const i=e==="svg"?ue.createElementNS(Ec,n):e==="mathml"?ue.createElementNS(Pc,n):t?ue.createElement(n,{is:t}):ue.createElement(n);return n==="select"&&s&&s.multiple!=null&&i.setAttribute("multiple",s.multiple),i},createText:n=>ue.createTextNode(n),createComment:n=>ue.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>ue.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,s,i,r){const o=t?t.previousSibling:e.lastChild;if(i&&(i===r||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),t),!(i===r||!(i=i.nextSibling)););else{pr.innerHTML=tl(s==="svg"?`<svg>${n}</svg>`:s==="mathml"?`<math>${n}</math>`:n);const l=pr.content;if(s==="svg"||s==="mathml"){const a=l.firstChild;for(;a.firstChild;)l.appendChild(a.firstChild);l.removeChild(a)}e.insertBefore(l,t)}return[o?o.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},Cc=Symbol("_vtc");function Nc(n,e,t){const s=n[Cc];s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const gr=Symbol("_vod"),Ic=Symbol("_vsh"),Lc=Symbol(""),Mc=/(?:^|;)\s*display\s*:/;function Dc(n,e,t){const s=n.style,i=fn(t);let r=!1;if(t&&!i){if(e)if(fn(e))for(const o of e.split(";")){const l=o.slice(0,o.indexOf(":")).trim();t[l]==null&&ut(s,l,"")}else for(const o in e)t[o]==null&&ut(s,o,"");for(const o in t){o==="display"&&(r=!0);const l=t[o];l!=null?Hc(n,o,!fn(e)&&e?e[o]:void 0,l)||ut(s,o,l):ut(s,o,"")}}else if(i){if(e!==t){const o=s[Lc];o&&(t+=";"+o),s.cssText=t,r=Mc.test(t)}}else e&&n.removeAttribute("style");gr in n&&(n[gr]=r?s.display:"",n[Ic]&&(s.display="none"))}const $r=/\s*!important$/;function ut(n,e,t){if(H(t))t.forEach(s=>ut(n,e,s));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const s=jc(n,e);$r.test(t)?n.setProperty(De(s),t.replace($r,""),"important"):n[s]=t}}const mr=["Webkit","Moz","ms"],Ts={};function jc(n,e){const t=Ts[e];if(t)return t;let s=On(e);if(s!=="filter"&&s in n)return Ts[e]=s;s=rs(s);for(let i=0;i<mr.length;i++){const r=mr[i]+s;if(r in n)return Ts[e]=r}return e}function Hc(n,e,t,s){return n.tagName==="TEXTAREA"&&(e==="width"||e==="height")&&fn(s)&&t===s}const br="http://www.w3.org/1999/xlink";function _r(n,e,t,s,i,r=Hl(e)){s&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(br,e.slice(6,e.length)):n.setAttributeNS(br,e,t):t==null||r&&!eo(t)?n.removeAttribute(e):n.setAttribute(e,r?"":ie(t)?String(t):t)}function xr(n,e,t,s,i){if(e==="innerHTML"||e==="textContent"){t!=null&&(n[e]=e==="innerHTML"?tl(t):t);return}const r=n.tagName;if(e==="value"&&r!=="PROGRESS"&&!r.includes("-")){const l=r==="OPTION"?n.getAttribute("value")||"":n.value,a=t==null?n.type==="checkbox"?"on":"":String(t);(l!==a||!("_value"in n))&&(n.value=a),t==null&&n.removeAttribute(e),n._value=t;return}let o=!1;if(t===""||t==null){const l=typeof n[e];l==="boolean"?t=eo(t):t==null&&l==="string"?(t="",o=!0):l==="number"&&(t=0,o=!0)}try{n[e]=t}catch{}o&&n.removeAttribute(i||e)}function Ge(n,e,t,s){n.addEventListener(e,t,s)}function Bc(n,e,t,s){n.removeEventListener(e,t,s)}const vr=Symbol("_vei");function Fc(n,e,t,s,i=null){const r=n[vr]||(n[vr]={}),o=r[e];if(s&&o)o.value=s;else{const[l,a]=Vc(e);if(s){const u=r[e]=Kc(s,i);Ge(n,l,u,a)}else o&&(Bc(n,l,o,a),r[e]=void 0)}}const Uc=/(Once|Passive|Capture)$/,zc=/^on:?(?:Once|Passive|Capture)$/;function Vc(n){let e,t;for(;(t=n.match(Uc))&&!zc.test(n);)e||(e={}),n=n.slice(0,n.length-t[1].length),e[t[1].toLowerCase()]=!0;return[n[2]===":"?n.slice(3):De(n.slice(2)),e]}let Ss=0;const Gc=Promise.resolve(),Jc=()=>Ss||(Gc.then(()=>Ss=0),Ss=Date.now());function Kc(n,e){const t=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=t.attached)return;const i=t.value;if(H(i)){const r=s.stopImmediatePropagation;s.stopImmediatePropagation=()=>{r.call(s),s._stopped=!0};const o=i.slice(),l=[s];for(let a=0;a<o.length&&!s._stopped;a++){const u=o[a];u&&zn(u,e,5,l)}}else zn(i,e,5,[s])};return t.value=n,t.attached=Jc(),t}const yr=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,qc=(n,e,t,s,i,r)=>{const o=i==="svg";e==="class"?Nc(n,s,o):e==="style"?Dc(n,t,s):ts(e)?ss(e)||Fc(n,e,t,s,r):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Wc(n,e,s,o))?(xr(n,e,s),!n.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&_r(n,e,s,o,r,e!=="value")):n._isVueCE&&(Yc(n,e)||n._def.__asyncLoader&&(/[A-Z]/.test(e)||!fn(s)))?xr(n,On(e),s,r,e):(e==="true-value"?n._trueValue=s:e==="false-value"&&(n._falseValue=s),_r(n,e,s,o))};function Wc(n,e,t,s){if(s)return!!(e==="innerHTML"||e==="textContent"||e in n&&yr(e)&&B(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="sandbox"&&n.tagName==="IFRAME"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const i=n.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return yr(e)&&fn(t)?!1:e in n}function Yc(n,e){const t=n._def.props;if(!t)return!1;const s=On(e);return Array.isArray(t)?t.some(i=>On(i)===s):Object.keys(t).some(i=>On(i)===s)}const wr=n=>{const e=n.props["onUpdate:modelValue"]||!1;return H(e)?t=>Ht(e,t):e};function Zc(n){n.target.composing=!0}function kr(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const Rs=Symbol("_assign");function Tr(n,e,t){return e&&(n=n.trim()),t&&(n=Qs(n)),n}const Qc={created(n,{modifiers:{lazy:e,trim:t,number:s}},i){n[Rs]=wr(i);const r=s||i.props&&i.props.type==="number";Ge(n,e?"change":"input",o=>{o.target.composing||n[Rs](Tr(n.value,t,r))}),(t||r)&&Ge(n,"change",()=>{n.value=Tr(n.value,t,r)}),e||(Ge(n,"compositionstart",Zc),Ge(n,"compositionend",kr),Ge(n,"change",kr))},mounted(n,{value:e}){n.value=e??""},beforeUpdate(n,{value:e,oldValue:t,modifiers:{lazy:s,trim:i,number:r}},o){if(n[Rs]=wr(o),n.composing)return;const l=(r||n.type==="number")&&!/^0\d/.test(n.value)?Qs(n.value):n.value,a=e??"";if(l===a)return;const u=n.getRootNode();(u instanceof Document||u instanceof ShadowRoot)&&u.activeElement===n&&n.type!=="range"&&(s&&e===t||i&&n.value.trim()===a)||(n.value=a)}},Xc=["ctrl","shift","alt","meta"],nu={stop:n=>n.stopPropagation(),prevent:n=>n.preventDefault(),self:n=>n.target!==n.currentTarget,ctrl:n=>!n.ctrlKey,shift:n=>!n.shiftKey,alt:n=>!n.altKey,meta:n=>!n.metaKey,left:n=>"button"in n&&n.button!==0,middle:n=>"button"in n&&n.button!==1,right:n=>"button"in n&&n.button!==2,exact:(n,e)=>Xc.some(t=>n[`${t}Key`]&&!e.includes(t))},eu=(n,e)=>{if(!n)return n;const t=n._withMods||(n._withMods={}),s=e.join(".");return t[s]||(t[s]=(i,...r)=>{for(let o=0;o<e.length;o++){const l=nu[e[o]];if(l&&l(i,e))return}return n(i,...r)})},tu=vn({patchProp:qc},Ac);let Sr;function su(){return Sr||(Sr=lc(tu))}const iu=(...n)=>{const e=su().createApp(...n),{mount:t}=e;return e.mount=s=>{const i=ou(s);if(!i)return;const r=e._component;!B(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const o=t(i,!1,ru(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function ru(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function ou(n){return fn(n)?document.querySelector(n):n}const zt=pe(localStorage.getItem("theme")!=="light");va(()=>{const n=zt.value?"dark":"light";document.documentElement.setAttribute("data-theme",n),localStorage.setItem("theme",n)});function lu(){function n(){zt.value=!zt.value}return{isDark:zt,toggle:n}}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */const Je=typeof document<"u";function sl(n){return typeof n=="object"||"displayName"in n||"props"in n||"__vccOpts"in n}function au(n){return n.__esModule||n[Symbol.toStringTag]==="Module"||n.default&&sl(n.default)}const K=Object.assign;function Os(n,e){const t={};for(const s in e){const i=e[s];t[s]=Vn(i)?i.map(n):n(i)}return t}const bt=()=>{},Vn=Array.isArray;function Rr(n,e){const t={};for(const s in n)t[s]=s in e?e[s]:n[s];return t}const il=/#/g,cu=/&/g,uu=/\//g,fu=/=/g,du=/\?/g,rl=/\+/g,hu=/%5B/g,pu=/%5D/g,ol=/%5E/g,gu=/%60/g,ll=/%7B/g,$u=/%7C/g,al=/%7D/g,mu=/%20/g;function pi(n){return n==null?"":encodeURI(""+n).replace($u,"|").replace(hu,"[").replace(pu,"]")}function bu(n){return pi(n).replace(ll,"{").replace(al,"}").replace(ol,"^")}function zs(n){return pi(n).replace(rl,"%2B").replace(mu,"+").replace(il,"%23").replace(cu,"%26").replace(gu,"`").replace(ll,"{").replace(al,"}").replace(ol,"^")}function _u(n){return zs(n).replace(fu,"%3D")}function xu(n){return pi(n).replace(il,"%23").replace(du,"%3F")}function vu(n){return xu(n).replace(uu,"%2F")}function St(n){if(n==null)return null;try{return decodeURIComponent(""+n)}catch{}return""+n}const yu=/\/$/,wu=n=>n.replace(yu,"");function Es(n,e,t="/"){let s,i={},r="",o="";const l=e.indexOf("#");let a=e.indexOf("?");return a=l>=0&&a>l?-1:a,a>=0&&(s=e.slice(0,a),r=e.slice(a,l>0?l:e.length),i=n(r.slice(1))),l>=0&&(s=s||e.slice(0,l),o=e.slice(l,e.length)),s=Ru(s??e,t),{fullPath:s+r+o,path:s,query:i,hash:St(o)}}function ku(n,e){const t=e.query?n(e.query):"";return e.path+(t&&"?")+t+(e.hash||"")}function Or(n,e){return!e||!n.toLowerCase().startsWith(e.toLowerCase())?n:n.slice(e.length)||"/"}function Tu(n,e,t){const s=e.matched.length-1,i=t.matched.length-1;return s>-1&&s===i&&Xe(e.matched[s],t.matched[i])&&cl(e.params,t.params)&&n(e.query)===n(t.query)&&e.hash===t.hash}function Xe(n,e){return(n.aliasOf||n)===(e.aliasOf||e)}function cl(n,e){if(Object.keys(n).length!==Object.keys(e).length)return!1;for(var t in n)if(!Su(n[t],e[t]))return!1;return!0}function Su(n,e){return Vn(n)?Er(n,e):Vn(e)?Er(e,n):(n==null?void 0:n.valueOf())===(e==null?void 0:e.valueOf())}function Er(n,e){return Vn(e)?n.length===e.length&&n.every((t,s)=>t===e[s]):n.length===1&&n[0]===e}function Ru(n,e){if(n.startsWith("/"))return n;if(!n)return e;const t=e.split("/"),s=n.split("/"),i=s[s.length-1];(i===".."||i===".")&&s.push("");let r=t.length-1,o,l;for(o=0;o<s.length;o++)if(l=s[o],l!==".")if(l==="..")r>1&&r--;else break;return t.slice(0,r).join("/")+"/"+s.slice(o).join("/")}const xe={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Vs=function(n){return n.pop="pop",n.push="push",n}({}),Ps=function(n){return n.back="back",n.forward="forward",n.unknown="",n}({});function Ou(n){if(!n)if(Je){const e=document.querySelector("base");n=e&&e.getAttribute("href")||"/",n=n.replace(/^\w+:\/\/[^\/]+/,"")}else n="/";return n[0]!=="/"&&n[0]!=="#"&&(n="/"+n),wu(n)}const Eu=/^[^#]+#/;function Pu(n,e){return n.replace(Eu,"#")+e}function Au(n,e){const t=document.documentElement.getBoundingClientRect(),s=n.getBoundingClientRect();return{behavior:e.behavior,left:s.left-t.left-(e.left||0),top:s.top-t.top-(e.top||0)}}const ps=()=>({left:window.scrollX,top:window.scrollY});function Cu(n){let e;if("el"in n){const t=n.el,s=typeof t=="string"&&t.startsWith("#"),i=typeof t=="string"?s?document.getElementById(t.slice(1)):document.querySelector(t):t;if(!i)return;e=Au(i,n)}else e=n;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.scrollX,e.top!=null?e.top:window.scrollY)}function Pr(n,e){return(history.state?history.state.position-e:-1)+n}const Gs=new Map;function Nu(n,e){Gs.set(n,e)}function Iu(n){const e=Gs.get(n);return Gs.delete(n),e}function Lu(n){return typeof n=="string"||n&&typeof n=="object"}function ul(n){return typeof n=="string"||typeof n=="symbol"}let un=function(n){return n[n.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",n[n.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",n[n.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",n[n.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",n[n.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",n}({});const fl=Symbol("");un.MATCHER_NOT_FOUND+"",un.NAVIGATION_GUARD_REDIRECT+"",un.NAVIGATION_ABORTED+"",un.NAVIGATION_CANCELLED+"",un.NAVIGATION_DUPLICATED+"";function nt(n,e){return K(new Error,{type:n,[fl]:!0},e)}function ce(n,e){return n instanceof Error&&fl in n&&(e==null||!!(n.type&e))}const Mu=["params","query","hash"];function Du(n){if(typeof n=="string")return n;if(n.path!=null)return n.path;const e={};for(const t of Mu)t in n&&(e[t]=n[t]);return JSON.stringify(e,null,2)}function ju(n){const e={};if(n===""||n==="?")return e;const t=(n[0]==="?"?n.slice(1):n).split("&");for(let s=0;s<t.length;++s){const i=t[s].replace(rl," "),r=i.indexOf("="),o=St(r<0?i:i.slice(0,r)),l=r<0?null:St(i.slice(r+1));if(o in e){let a=e[o];Vn(a)||(a=e[o]=[a]),a.push(l)}else e[o]=l}return e}function Ar(n){let e="";for(let t in n){const s=n[t];if(t=_u(t),s==null){s!==void 0&&(e+=(e.length?"&":"")+t);continue}(Vn(s)?s.map(i=>i&&zs(i)):[s&&zs(s)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+t,i!=null&&(e+="="+i))})}return e}function Hu(n){const e={};for(const t in n){const s=n[t];s!==void 0&&(e[t]=Vn(s)?s.map(i=>i==null?null:""+i):s==null?s:""+s)}return e}const Bu=Symbol(""),Cr=Symbol(""),gs=Symbol(""),gi=Symbol(""),Js=Symbol("");function ot(){let n=[];function e(s){return n.push(s),()=>{const i=n.indexOf(s);i>-1&&n.splice(i,1)}}function t(){n=[]}return{add:e,list:()=>n.slice(),reset:t}}function ye(n,e,t,s,i,r=o=>o()){const o=s&&(s.enterCallbacks[i]=s.enterCallbacks[i]||[]);return()=>new Promise((l,a)=>{const u=p=>{p===!1?a(nt(un.NAVIGATION_ABORTED,{from:t,to:e})):p instanceof Error?a(p):Lu(p)?a(nt(un.NAVIGATION_GUARD_REDIRECT,{from:e,to:p})):(o&&s.enterCallbacks[i]===o&&typeof p=="function"&&o.push(p),l())},c=r(()=>n.call(s&&s.instances[i],e,t,u));let f=Promise.resolve(c);n.length<3&&(f=f.then(u)),f.catch(p=>a(p))})}function As(n,e,t,s,i=r=>r()){const r=[];for(const o of n)for(const l in o.components){let a=o.components[l];if(!(e!=="beforeRouteEnter"&&!o.instances[l]))if(sl(a)){const u=(a.__vccOpts||a)[e];u&&r.push(ye(u,t,s,o,l,i))}else{let u=a();r.push(()=>u.then(c=>{if(!c)throw new Error(`Couldn't resolve component "${l}" at "${o.path}"`);const f=au(c)?c.default:c;o.mods[l]=c,o.components[l]=f;const p=(f.__vccOpts||f)[e];return p&&ye(p,t,s,o,l,i)()}))}}return r}function Fu(n,e){const t=[],s=[],i=[],r=Math.max(e.matched.length,n.matched.length);for(let o=0;o<r;o++){const l=e.matched[o];l&&(n.matched.find(u=>Xe(u,l))?s.push(l):t.push(l));const a=n.matched[o];a&&(e.matched.find(u=>Xe(u,a))||i.push(a))}return[t,s,i]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
...
> 回调机制基于正则匹配内部词条，在独立子上下文中执行。`,yi=`# $主回调$ — 匹配主词条
...
| 能否省略 | 可以 | 可以 |
| 执行次数 | 每个文件一次 | 入口文件一次
`,Ti=`NR 是 Nebula 词库引擎的领域特定语言（DSL），扩展名为 \`.nr\`，用于定义词条、函数、变量和自动化流程。适用于聊天机器人、互动小说、自动化文本生成等场景。
...
[画布 →](./canvas)
`,Di='# 类型系统\n\nNR 的类型系统是**动态、弱类型**的——变量无需声明类型，运行时自动确定。值在大多数场景下会自动在文本和数字之间转换，`==` 运算符做宽松比较。本章涵盖 NR 中的原始数据类型（没有对象/数组，只有文本、数字和布尔值），以及类型检测、判断和转换操作。\n\nNR 的 `Value` 不是简单的"字符串或数字"二分法——它是一个完整的枚举类型，内部由 Rust 的 `enum` 实现，每个变体携带不同的数据表示。这意味着两个值即使"看起来一样"，也可能属于不同类型，进而影响相等性比较和运算行为。\n\n## 类型一览\n\nNR 变量存储的是**带类型的值**（`Value`），而非纯字符串。类型在赋值时自动推断。\n\n| 类型 | 示例 | 说明 |\n|------|------|------|\n| `整数` | `1`, `-5`, `100` | 64 位有符号整数 |\n| `浮点` | `1.5`, `-0.5`, `3.14` | 64 位浮点数 |\n| `字符串` | `"hello"`, `abc` | 字符串 |\n| `布尔` | `true`, `false` | 布尔值 |\n| `空` | `null` | 空值 |\n| `对象` | — | 对象引用（`$new$` 返回） |\n| `函数` | — | 函数指针（`%func@name%` 返回） |\n\n- `count:5` → Int，`name:Alice` → Str\n- 但 `[...]` 数学表达式运算结果保留数值类型\n- `$new$` 返回值为对象类型\n- `%func@key%` 返回值为函数类型\n\n## 各类型详解\n\n### 整数（Int）\n\n64 位有符号整数（`i64`），范围约为 `-9.2×10¹⁸` 到 `9.2×10¹⁸`。\n\n```\na:42\nb:-100\nc:0\n\n%TYPE@a%   → "整数"\n%TYPE@b%   → "整数"\n%TYPE@c%   → "整数"\n```\n\n整数字面量不能包含小数点、前导零（会被当作十进制解析）或科学计数法。\n\n### 浮点（Float）\n\n64 位浮点数（`f64`），符合 IEEE 754 标准。\n\n```\npi:3.14\nneg:-0.5\nbig:1.5e10\n\n%TYPE@pi%    → "浮点"\n%TYPE@neg%   → "浮点"\n%TYPE@big%   → "浮点"\n```\n\n浮点数和整数在比较（`==`）时**视为不同**：`1 == 1.0` 在严格比较下为假。浮点运算可能产生精度误差，这是 IEEE 754 浮点数的固有特性。\n\n### 字符串（Str）\n\nUTF-8 编码的字符串。不带特殊前缀的纯文本字面量自动判定为字符串。\n\n```\nname:Alice\ngreeting:Hello World\nempty:""              ← 显式空字符串\n\n%TYPE@name%       → "字符串"\n%TYPE@greeting%   → "字符串"\n```\n\n注意：`greeting:Hello World` 中空格不需要转义（赋值操作符 `:` 之后直到行尾均为值部分）。但在 `$...$` 参数传递中空格会分割参数，参见 [词法结构 § 转义规则](./lexical)。\n\n### 布尔（Bool）\n\n只有 `true` 和 `false` 两个字面量。\n\n```\nflag:true\ndone:false\n\n%TYPE@flag%   → "布尔"\n%TYPE@done%   → "布尔"\n```\n\n布尔值可直接用于条件表达式（[判断逻辑](./control-flow)），也可参与逻辑运算（[表达式 § 逻辑运算符](./expressions)）。\n\n### 空值（Null）\n\n表示"无值"或"未设置"。仅有一种字面量：`null`。\n\n```\ndata:null\n\n%TYPE@data%   → "空"\n```\n\n`null` 与空字符串 `""` 不同：`null` 是一个独立的类型标记，而 `""` 是值为空的字符串。在条件判断中，`null` 被视为假值。\n\n### 对象（Object）\n\n由 `$new$` 创建，内部持有一个 JSON 对象引用。对象类型值不可直接输出为文本，需通过 `%TYPE@` 查询或使用 JSON 操作符访问其字段。\n\n```\nobj:$new$ {"key":"val"}\n\n%TYPE@obj%   → "对象"\n```\n\n`$new$` 不是赋值操作符——它是创建新对象的内置函数，参见 [词条系统](./entries)。\n\n### 函数（Func）\n\n由 `%func@name%` 获取，存储的是函数指针/引用，而非函数体文本。\n\n```\nptr:%func@greet%\n\n%TYPE@ptr%   → "函数"\n```\n\n函数类型值主要用途：作为回调传入其他函数，或在需要延迟调用时暂存。\n\n## 类型特性对照\n\n| 类型 | 可修改（`+:` 等） | 宽松相等 `==` | 严格相等 `===` | 数值排序 `>` `<` |\n|------|-------------------|--------------|---------------|------------------|\n| Int | ✅ 算术运算 | 字符串化后比较 | 值和类型均相同 | ✅ 按数值 |\n| Float | ✅ 算术运算 | 字符串化后比较 | 值和类型均相同 | ✅ 按数值 |\n| Str | ✅ 串接 | 内容比较（含类型转换） | 值和类型均相同 | ❌ 无意义 |\n| Bool | ❌ | 字符串化后比较 | 值和类型均相同 | ❌ |\n| Null | ❌ | — | — | ❌ |\n| Object | — | 引用相等 | 引用相等 | ❌ |\n| Func | ❌ | 引用相等 | 引用相等 | ❌ |\n\n## 类型强制转换与兼容性\n\n### 算术上下文中的类型转换\n\n在 `[...]` 数学表达式中，操作数的类型决定了运算结果的类型：\n\n```\n// 整数运算 → 整数\na:[1+2]          → Int(3)\n\n// 浮点数参与 → 浮点\nb:[1+2.0]        → Float(3.0)\nc:[3.14*2]       → Float(6.28)\n\n// 字符串自动转为数值参与运算\nd:["3"+2]        → Int(5)  或报错\n```\n\n- 整数 + 整数 → 整数\n- 任一操作数为浮点 → 结果提升为浮点\n- 字符串操作数：尝试按数值解析，失败则报错\n\n### 比较上下文中的类型转换\n\n`==`（宽松相等）会将两边值转为字符串后比较：\n\n```\n1 == "1"       → true（都转为 "1"）\n1 == 1.0       → true（都转为 "1"，但用 === 则为 false）\ntrue == "true" → true\nnull == ""     → false（"null" ≠ ""）\n```\n\n`===`（严格相等）要求**类型和值都相同**：\n\n```\n1 === 1       → true\n1 === 1.0     → false（Int vs Float）\n"1" === 1     → false（Str vs Int）\ntrue === true → true\n```\n\n**注意事项：**\n\n- 条件判断中（如 `如果:`），**推荐使用严格比较 `===`** 以避免意外的类型转换带来的误判。\n- 数值比较（`>`、`<`、`>=`、`<=`）要求两边均为数值类型（Int 或 Float），字符串会被尝试解析为数值。\n- `0`、`""`、`null`、`false` 在布尔上下文中均为"假"，但它们彼此之间**不相等**（除了 `0 == false` 会因为字符串化为 `"0" == "false"` 而返回假）。\n\n## 类型查询 `%TYPE@var%`\n\n```\ncount:5\nname:Alice\n\n%TYPE@count%   → "整数"\n%TYPE@name%    → "字符串"\n```\n\n未设置变量返回空字符串。\n',ji='# 变量与赋值\n\n变量是 NR 中最基本的存储单元。本章涵盖变量的作用域规则、赋值操作符的语义差异、条件赋值、内置变量以及文本切片等核心机制。理解变量系统是正确组织数据流和控制状态的前提，与[类型系统](./types)和[表达式](./expressions)密切协作。\n\nNR 的赋值不是简单的"文本替换"——它会根据操作符和值的内容自动推断类型（[§ 类型一览](./types)），并在不同作用域间管理变量生命周期。\n\n## 作用域\n\n| 类型 | 作用域 | 说明 |\n|------|--------|------|\n| 局部变量 | 当前上下文 | 子上下文创建时重置 |\n| 全局变量 | 所有子上下文 | 子上下文创建时克隆共享 |\n\n### 作用域选择规则\n\nNR 根据**赋值位置**自动决定变量的作用域：\n\n- **头部区域（第一个空行之前）**中赋值的变量为**全局变量**。这些变量在词条触发、函数调用等子上下文中可被读取和修改。\n- **词条、函数、循环体内部**中首次赋值的变量为**局部变量**。局部变量仅在当前执行上下文中可见，进入子函数或子上下文时会创建独立的副本。\n\n```\n// 头部区域 → 全局变量，整个文件可见\ncounter:0\nbase_url:https://api.example.com\n\n// ← 空行分隔\n\n// 词条内部 → 局部变量\n开始\ntemp:%counter%             ← 可读全局变量\ncounter+:[%counter%+1]   ← 可修改全局变量\nlocal_var:临时值            ← 局部变量，外部不可见\n```\n\n### 作用域注意事项\n\n- 全局变量在**每次词条触发时保持其值**，不会重置。这使得 `counter+:1` 可以在多次触发间累加。\n- 子上下文（如 `$call$` 函数调用）中读取全局变量时，获取的是**当前快照值**；修改全局变量会影响父上下文。\n- 在同一作用域中，对已存在的变量再次使用 `:` 赋值会**覆盖**其值和类型。\n\n## 赋值操作符\n\n| 操作符 | 示例 | 语义 |\n|--------|------|------|\n| `:` | `name:Alice` | **自适应赋值**：值尝试解析为 JSON 字面量（数字/布尔/null/对象/数组），不成则当字符串 |\n| `::` | `greeting::Hello` | **纯文本赋值**：值始终作为字符串，不解析 JSON |\n| `+:` | `score+:5` | 自增 / JSON追加 / 字符串拼接 |\n| `-:` | `count-:1` | 自减 |\n| `*:` | `val*:2` | 乘法 / 字符串重复 |\n| `/:` | `val/:2` | 除法 |\n| `%:` | `val%:3` | 取余 |\n\n> 只有 ASCII 半角冒号 `:`（U+003A）被识别为赋值操作符。中文全角冒号 `：`（U+FF1A）**不是**操作符，在文本中直接原样输出。\n\n### `:`（自适应赋值）vs `::`（纯文本赋值）\n\n这是 NR 中最容易被忽视但最重要的语义差异：\n\n| 特性 | `:`（单冒号） | `::`（双冒号） |\n|------|-------------|---------------|\n| 值解析 | 尝试解析为 JSON 字面量 | 始终作为字符串 |\n| `1` | Int(1) | Str("1") |\n| `1.5` | Float(1.5) | Str("1.5") |\n| `true` | Bool(true) | Str("true") |\n| `null` | Null | Str("null") |\n| `{"a":1}` | JSON 对象 | Str("{\'a\':1}") |\n| `Alice` | Str("Alice") | Str("Alice") |\n\n```\n// : 自适应赋值——数字被识别为数值类型\ncount:100\n%TYPE@count%   → "整数"\n\n// :: 纯文本赋值——永远是字符串\nid::100\n%TYPE@id%      → "字符串"\n\n// 实际影响：数学运算\n[%count%+1]   → 101   （Int 运算）\n// [%id%+1]   → 报错 / 意外（字符串不能加）\n```\n\n### 何时使用 `::`\n\n- 存储**编号、ID、电话号**等不应被当作数字处理的值（如 `id::001` 不会丢掉前导零）\n- 存储可能是数字字面量的**字符串**（如文件名"123.json"）\n- 需要精确控制类型以避免意外数值运算的场景\n\n**注意事项：** 当你对 `::` 赋值的变量使用 `+:`（自增）时，由于值是字符串，`+:` 会执行**字符串拼接**而非数学加法。这可能不是你想要的行为。\n\n## 条件赋值 `?:`\n\n```\nkey:@a?:@b?:fallback\n```\n\n从左到右尝试读取 JSON 路径，第一个非空、非 null、非 false 的值被赋值。\n\n## 内置变量\n\n| 变量 | 说明 |\n|------|------|\n| `%空格%` | 空格 `" "` |\n| `%换行%` | 换行 `"\\n"` |\n| `%时间戳%` | Unix 时间戳（秒） |\n| `%毫秒时间戳%` | Unix 时间戳（毫秒） |\n| `%微秒时间戳%` | Unix 时间戳（微秒） |\n| `%纳秒时间戳%` | Unix 时间戳（纳秒） |\n| `%时间%` | 格式化本地时间 `YYYY-MM-DD HH:MM:SS`（UTC+8） |\n| `%随机数M-N%` | 随机整数 `[M, N]`（含两端） |\n| `%!key%` | 布尔取反：空/0/false/null → `"1"`，否则 → `"0"` |\n| `%?key%` | 可选变量：不存在返回空字符串 |\n| `%++var%` | 自增：先自增再返回递增后的值（变量不存在默认 0） |\n| `%--var%` | 自减：先自减再返回递减后的值（变量不存在默认 0） |\n| `%参数%` | 所有参数列表（JSON 数组） |\n| `%参数0%` | 函数名 / 完整触发名 |\n| `%参数N%` | 第 N 个参数 |\n| `%self%` | 当前对象名 / 函数名 |\n| `%触发%` | 当前触发词 |\n| `%行数%` | 当前行号（1-based） |\n| `%B64@key%` | Base64 解码 |\n| `%URL编码@key%` | URL 编码 |\n| `%len@key%` / `%长度@key%` | 返回变量值的字符长度 |\n| `%@var[切片]%` / `@var[切片]` | 符号截取文本（Python 风格切片，支持 `%` 快捷两种写法） |\n| `%func@key%` | 获取函数指针（类型为"函数"，display 为函数名） |\n| `%包名.变量%` | 跨包变量引用（如 `%mypkg.x%` 读取引入包的头部变量） |\n\n### 内置变量的生命周期\n\n内置变量（`%xxx%`）与用户定义的变量在生命周期上有本质区别：\n\n- **即时求值**：每次读取内置变量（如 `%时间戳%`）时，都会**重新计算**当前值。它不存储"快照"，而是每次调用运行时函数。\n- **不可赋值**：不能对内置变量使用 `:` 赋值——`%时间戳%:123` 是无效的。\n- **临时性**：内置变量的值仅在当前表达式求值瞬间有效。如需多次使用同一值，应将其赋值给用户变量：`ts:%时间戳%`。\n- **参数变量 `%参数N%`** 在函数体内是局部变量，函数返回后失效；在词条触发时反映的是触发参数。\n\n```\n// 推荐做法：缓存内置变量\nstart_time:%毫秒时间戳%\n// ... 多步操作 ...\nelapsed:[%毫秒时间戳%-%start_time%]   ← 两次读取产生不同值，差值有意义\n```\n\n## 符号截取文本 `%@var[切片]%` / `@var[切片]`\n\n内联文本切片语法，对变量值按字符（`.chars()`）进行 Python 风格切片。中文、emoji 等多字节字符均算一个字符。\n\n**两种写法等价**：\n\n- `%@var[切片]%` —— 标准写法，需 `%` 包裹\n- `@var[切片]` —— 快捷写法，无需 `%` 包裹，直接解析\n\n**基本语法**：`@变量名[start:end:step]`\n\n| 写法 | 含义 |\n|------|------|\n| `@a[1:]` | 从第 2 个字符到末尾 |\n| `@a[1:3]` | 第 2 ~ 3 个字符（index 1 和 2，不含 3） |\n| `@a[:3]` | 前 3 个字符 |\n| `@a[-3:]` | 末尾 3 个字符 |\n| `@a[1:6:2]` | index 1~5，步长 2（隔一个取一个） |\n| `@a[::2]` | 从头到尾，步长 2 |\n| `@a[::-1]` | 反转字符串 |\n\n```\nname:你好世界NR语言\n\n%name%             → "你好世界NR语言"\n%len@name%         → "8"\n\n// 标准写法\n%@name[1:]%        → "好世界NR语言"\n%@name[1:3]%       → "好世"\n%@name[:2]%        → "你好"\n%@name[-3:]%       → "R语言"\n%@name[::-1]%      → "言语RN界世好你"\n\n// 快捷写法（无需 % 包裹）\n@name[1:]          → "好世界NR语言"\n@name[1:3]         → "好世"\n@name[:2]          → "你好"\n@name[-3:]         → "R语言"\n@name[::-1]        → "言语RN界世好你"\n```\n\n> 快捷写法 `@var[切片]` 通过方括号内含 `:` 来与 JSON 路径导航（`@json[key]`）区分。不含 `:` 的方括号仍走 JSON 路径逻辑。\n',mf=Object.assign({"../../v0.1.0/canvas.md":$i,"../../v0.1.0/control-flow.md":mi,"../../v0.1.0/entries.md":bi,"../../v0.1.0/expressions.md":_i,"../../v0.1.0/file.md":xi,"../../v0.1.0/flow-callback.md":vi,"../../v0.1.0/flow-main-callback.md":yi,"../../v0.1.0/flow-output.md":wi,"../../v0.1.0/functions.md":ki,"../../v0.1.0/index.md":Ti,"../../v0.1.0/json.md":Si,"../../v0.1.0/lexical.md":Ri,"../../v0.1.0/math.md":Oi,"../../v0.1.0/modules.md":Ei,"../../v0.1.0/network.md":Pi,"../../v0.1.0/object.md":Ai,"../../v0.1.0/oop.md":Ci,"../../v0.1.0/output-print.md":Ni,"../../v0.1.0/server.md":Ii,"../../v0.1.0/string.md":Li,"../../v0.1.0/type.md":Mi,"../../v0.1.0/types.md":Di,"../../v0.1.0/variables.md":ji}),gl=new Set;for(const n of Object.keys(mf)){const e=n.match(/\.\.\/\.\.\/(v[^/]+)\//);e&&gl.add(e[1])}const At=[...gl].sort().reverse();function Ie(n){const e=n.match(/^\/(v[^/]+)/);return e?e[1]:At[0]||"v1.0"}const Ks=[{text:"入门",items:[{text:"概述",link:"/"},{text:"词法结构",link:"/lexical"},{text:"类型系统",link:"/types"},{text:"变量与赋值",link:"/variables"},{text:"表达式与运算符",link:"/expressions"},{text:"判断逻辑",link:"/control-flow"},{text:"词条系统",link:"/entries"},{text:"JSON 数据处理",link:"/json"},{text:"面向对象编程",link:"/oop"},{text:"模块与引入",link:"/modules"},{text:"函数",link:"/functions"},{text:"内置函数",link:"/flow-output",children:[{text:"回调",link:"/flow-callback"},{text:"主回调",link:"/flow-main-callback"},{text:"打印",link:"/output-print"},{text:"服务器",link:"/server"},{text:"对象创建",link:"/object"},{text:"字符串",link:"/string"},{text:"数学",link:"/math"},{text:"网络",link:"/network"},{text:"类型",link:"/type"},{text:"文件",link:"/file"},{text:"画布",link:"/canvas"}]}]}];function $l(n){const e=[];for(const t of n)t.link&&!t.children?e.push(t):t.children&&(t.link&&e.push({text:t.text,link:t.link}),e.push(...$l(t.children)));return e}const Dt=Ks.flatMap(n=>$l(n.items));function bf(){const n=et(),e=mn(()=>Dt.findIndex(i=>{const r=Ie(n.path),o=i.link.split("#")[0];return`/${r}${o}`===n.path})),t=mn(()=>{if(e.value<=0)return null;const i=Ie(n.path),r=Dt[e.value-1];return{text:r.text,link:`/${i}${r.link}`}}),s=mn(()=>{if(e.value>=Dt.length-1)return null;const i=Ie(n.path),r=Dt[e.value+1];return{text:r.text,link:`/${i}${r.link}`}});return{prev:t,next:s}}const je=(n,e)=>{const t=n.__vccOpts||n;for(const[s,i]of e)t[s]=i;return t},_f={class:"sidebar-nav"},xf={class:"sidebar-section-title"},vf=["href"],yf=["href"],wf={key:1,class:"sidebar-section-title"},kf=["href"],Tf={class:"sidebar-sub-title"},Sf={class:"sidebar-sub-group"},Rf=["href"],Of=["href"],Ef={key:2,class:"sidebar-sub-title"},Pf={__name:"Sidebar",setup(n){const e=et(),t=mn(()=>Ie(e.path));function s(r){const o=r.indexOf("#"),l=o>=0?r.substring(0,o):r,a=o>=0?r.substring(o):"";return`#/${t.value}${l}${a}`}function i(r){const o=`/${t.value}`,[l,a]=r.split("#"),u=`${o}${l}`;return a?e.path===u&&e.hash==="#"+a:e.path===u&&!e.hash}return(r,o)=>(F(),z("nav",_f,[(F(!0),z(cn,null,Ee(dn(Ks),(l,a)=>(F(),z("div",{key:l.text,class:Hn(["sidebar-group",{"has-divider":a<dn(Ks).length-1}])},[U("p",xf,xn(l.text),1),(F(!0),z(cn,null,Ee(l.items,u=>(F(),z(cn,{key:u.link||u.text},[u.link&&!u.children?(F(),z("a",{key:0,href:s(u.link),class:Hn(["sidebar-link","sidebar-link-sub",{active:i(u.link)}])},xn(u.text),11,vf)):(F(),z(cn,{key:1},[u.link?(F(),z("a",{key:0,href:s(u.link),class:Hn(["sidebar-section-title","sidebar-section-link",{active:i(u.link)}])},xn(u.text),11,yf)):(F(),z("p",wf,xn(u.text),1)),(F(!0),z(cn,null,Ee(u.children||[],c=>(F(),z(cn,{key:c.link||c.text},[c.link&&!c.children?(F(),z("a",{key:0,href:s(c.link),class:Hn(["sidebar-link","sidebar-link-sub",{active:i(c.link)}])},xn(c.text),11,kf)):c.children?(F(),z(cn,{key:1},[U("p",Tf,xn(c.text),1),U("div",Sf,[(F(!0),z(cn,null,Ee(c.children,f=>(F(),z(cn,{key:f.link||f.text},[f.link&&!f.children?(F(),z("a",{key:0,href:s(f.link),class:Hn(["sidebar-link","sidebar-link-fn",{active:i(f.link)}])},xn(f.text),11,Rf)):f.children&&f.link?(F(),z("a",{key:1,href:s(f.link),class:Hn(["sidebar-link","sidebar-link-fn",{active:i(f.link)}])},xn(f.text),11,Of)):f.children?(F(),z("p",Ef,xn(f.text),1)):Le("",!0)],64))),128))])],64)):Le("",!0)],64))),128))],64))],64))),128))],2))),128))]))}},Af=je(Pf,[["__scopeId","data-v-b84c9d01"]]),Cf={key:0,class:"right-nav"},Nf=["onClick"],If={__name:"RightNav",setup(n){const e=et(),t=$f(),s=pe([]),i=pe("");let r=[],o=!1;function l(){const f=document.querySelector(".markdown-body");if(!f){s.value=[],r=[];return}r=Array.from(f.querySelectorAll("h2[id], h3[id]")),s.value=r.map(p=>({id:p.id,text:p.textContent,tag:p.tagName}))}function a(f){t.replace({hash:"#"+f});const p=document.getElementById(f);p&&p.scrollIntoView({behavior:"smooth",block:"start"})}function u(){if(!r.length)return;let f=r[0].id;for(const p of r)p.getBoundingClientRect().top<=120&&(f=p.id);i.value=f}function c(){o||(requestAnimationFrame(()=>{u(),o=!1}),o=!0)}return Ne(()=>e.path,()=>Et(l),{immediate:!0}),Co(()=>window.addEventListener("scroll",c,{passive:!0})),fi(()=>window.removeEventListener("scroll",c)),(f,p)=>s.value.length?(F(),z("nav",Cf,[(F(!0),z(cn,null,Ee(s.value,g=>(F(),z("a",{key:g.id,href:"javascript:void(0)",class:Hn(["right-nav-link",{active:i.value===g.id},g.tag==="H3"?"sub":""]),onClick:y=>a(g.id)},xn(g.text),11,Nf))),128))])):Le("",!0)}},Lf=je(If,[["__scopeId","data-v-aef8329c"]]),Mf=Object.assign({"../../v0.1.0/canvas.md":$i,"../../v0.1.0/control-flow.md":mi,"../../v0.1.0/entries.md":bi,"../../v0.1.0/expressions.md":_i,"../../v0.1.0/file.md":xi,"../../v0.1.0/flow-callback.md":vi,"../../v0.1.0/flow-main-callback.md":yi,"../../v0.1.0/flow-output.md":wi,"../../v0.1.0/functions.md":ki,"../../v0.1.0/index.md":Ti,"../../v0.1.0/json.md":Si,"../../v0.1.0/lexical.md":Ri,"../../v0.1.0/math.md":Oi,"../../v0.1.0/modules.md":Ei,"../../v0.1.0/network.md":Pi,"../../v0.1.0/object.md":Ai,"../../v0.1.0/oop.md":Ci,"../../v0.1.0/output-print.md":Ni,"../../v0.1.0/server.md":Ii,"../../v0.1.0/string.md":Li,"../../v0.1.0/type.md":Mi,"../../v0.1.0/types.md":Di,"../../v0.1.0/variables.md":ji});function Df(n){const e=`../../${n}/`,t=[];for(const[s,i]of Object.entries(Mf)){if(!s.startsWith(e))continue;const r=s.match(new RegExp(`${n}/(.+)\\.md$`));if(!r)continue;let o=r[1];const l=o==="index"?`/${n}/`:`/${n}/${o}`,a=i.match(/^#\s+(.+)$/m),u=a?a[1]:l,c=[],f=/^#{2,3}\s+(.+)$/gm;let p;for(;(p=f.exec(i))!==null;)c.push(p[1]);t.push({path:l,title:u,headings:c,content:i})}return t}const ml={};for(const n of At)ml[n]=Df(n);function jf(n,e){if(!n.trim())return[];const t=e?Ie(e):At[0],s=ml[t]||[],i=n.toLowerCase().split(/\s+/).filter(Boolean);return s.filter(r=>{const o=(r.title+" "+r.headings.join(" ")+" "+r.content).toLowerCase();return i.every(l=>o.includes(l))}).map(r=>{const o=r.content.toLowerCase().indexOf(i[0]),l=Math.max(0,o-40),a=Math.min(r.content.length,o+120);let u=r.content.slice(l,a).replace(/\n+/g," ");return l>0&&(u="..."+u),a<r.content.length&&(u+="..."),{...r,snippet:u}}).slice(0,10)}const Hf={class:"search-modal"},Bf={class:"search-input-wrap"},Ff={key:0,class:"search-results"},Uf=["onClick","onMouseenter"],zf={class:"result-title"},Vf={class:"result-path"},Gf={class:"result-snippet"},Jf={key:1,class:"search-empty"},Kf={__name:"SearchModal",emits:["close"],setup(n,{emit:e}){const t=e,s=et(),i=pe(""),r=pe([]),o=pe(0),l=pe(null);Et(()=>{var c;return(c=l.value)==null?void 0:c.focus()}),Ne(i,c=>{r.value=jf(c,s.path),o.value=0});function a(c){window.location.hash="#"+c,t("close")}function u(c){c.key==="Escape"?t("close"):c.key==="ArrowDown"?(c.preventDefault(),o.value=Math.min(o.value+1,r.value.length-1)):c.key==="ArrowUp"?(c.preventDefault(),o.value=Math.max(o.value-1,0)):c.key==="Enter"&&r.value[o.value]&&a(r.value[o.value].path)}return(c,f)=>(F(),z("div",{class:"search-overlay",onClick:f[2]||(f[2]=eu(p=>t("close"),["self"]))},[U("div",Hf,[U("div",Bf,[f[3]||(f[3]=U("svg",{class:"search-icon",viewBox:"0 0 24 24",width:"20",height:"20",fill:"none",stroke:"currentColor","stroke-width":"2"},[U("circle",{cx:"11",cy:"11",r:"8"}),U("path",{d:"m21 21-4.35-4.35"})],-1)),ba(U("input",{ref_key:"inputEl",ref:l,"onUpdate:modelValue":f[0]||(f[0]=p=>i.value=p),class:"search-input",placeholder:"搜索文档...",onKeydown:u},null,544),[[Qc,i.value]]),U("button",{class:"search-close",onClick:f[1]||(f[1]=p=>t("close"))},"Esc")]),r.value.length?(F(),z("div",Ff,[(F(!0),z(cn,null,Ee(r.value,(p,g)=>(F(),z("div",{key:p.path,class:Hn(["search-result",{active:g===o.value}]),onClick:y=>a(p.path),onMouseenter:y=>o.value=g},[U("div",zf,xn(p.title),1),U("div",Vf,xn(p.path),1),U("div",Gf,xn(p.snippet),1)],42,Uf))),128))])):i.value?(F(),z("div",Jf," 未找到相关结果 ")):Le("",!0)])]))}},qf=je(Kf,[["__scopeId","data-v-8b5c2c8d"]]),Wf=["value"],Yf=["value"],Zf={__name:"VersionSwitcher",setup(n){const e=et(),t=mn(()=>At.map(r=>({label:r,path:`/${r}/`}))),s=mn(()=>`/${Ie(e.path)}/`);function i(r){window.location.hash="#"+r.target.value}return(r,o)=>(F(),z("select",{class:"version-select",value:s.value,onChange:i},[(F(!0),z(cn,null,Ee(t.value,l=>(F(),z("option",{key:l.path,value:l.path},xn(l.label),9,Yf))),128))],40,Wf))}},Qf=je(Zf,[["__scopeId","data-v-5639bad0"]]),Xf={class:"header"},nd=["title"],ed={key:0,viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},td={key:1,viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},sd={class:"main"},id={class:"sidebar"},rd={class:"content"},od={key:0,class:"right-aside"},ld={__name:"App",setup(n){const{isDark:e,toggle:t}=lu(),s=pe(!1);function i(r){(r.ctrlKey||r.metaKey)&&r.key==="k"&&(r.preventDefault(),s.value=!0)}return(r,o)=>{const l=Da("router-view");return F(),z(cn,null,[U("div",{class:"app",onKeydown:i},[U("header",Xf,[o[6]||(o[6]=U("a",{class:"logo",href:"#/"},"NR 语言参考手册",-1)),gn(Qf),o[7]||(o[7]=U("div",{class:"header-spacer"},null,-1)),U("button",{class:"icon-btn",onClick:o[0]||(o[0]=a=>s.value=!0),title:"搜索 (Ctrl+K)"},[...o[3]||(o[3]=[U("svg",{viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},[U("circle",{cx:"11",cy:"11",r:"8"}),U("path",{d:"m21 21-4.35-4.35"})],-1)])]),U("button",{class:"icon-btn",onClick:o[1]||(o[1]=(...a)=>dn(t)&&dn(t)(...a)),title:dn(e)?"浅色模式":"深色模式"},[dn(e)?(F(),z("svg",ed,[...o[4]||(o[4]=[U("circle",{cx:"12",cy:"12",r:"5"},null,-1),U("path",{d:"M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"},null,-1)])])):(F(),z("svg",td,[...o[5]||(o[5]=[U("path",{d:"M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"},null,-1)])]))],8,nd)]),U("div",sd,[U("aside",id,[gn(Af)]),U("main",rd,[gn(l)]),r.$route.path!=="/"?(F(),z("aside",od,[gn(Lf)])):Le("",!0)])],32),s.value?(F(),Zo(qf,{key:0,onClose:o[2]||(o[2]=a=>s.value=!1)})):Le("",!0)],64)}}},ad=je(ld,[["__scopeId","data-v-ca8421cd"]]),cd={class:"home"},ud={class:"hero"},fd=["href"],dd={__name:"HomePage",setup(n){const e=At[0]||"v0.1.0";return(t,s)=>(F(),z("div",cd,[U("section",ud,[s[0]||(s[0]=U("h1",{class:"hero-name"},"NR 语言",-1)),s[1]||(s[1]=U("p",{class:"hero-text"},"参考手册",-1)),s[2]||(s[2]=U("p",{class:"hero-tagline"},"Nebula 词库引擎的领域特定语言",-1)),U("a",{class:"hero-btn",href:`#/${dn(e)}/`},"开始阅读",8,fd)]),s[3]||(s[3]=$c('<section class="features" data-v-b521dea8><div class="feature" data-v-b521dea8><h3 data-v-b521dea8>简洁语法</h3><p data-v-b521dea8>NR 采用直观的触发词-响应模式，头部空行分隔结构，让词库编写像写笔记一样自然。</p></div><div class="feature" data-v-b521dea8><h3 data-v-b521dea8>动态类型</h3><p data-v-b521dea8>支持整数、浮点、字符串、布尔、对象、函数等类型，运行时自动推断，灵活高效。</p></div><div class="feature" data-v-b521dea8><h3 data-v-b521dea8>模块化</h3><p data-v-b521dea8>支持文件/目录引入、跨包调用、热更新，轻松构建大型自动化文本生成系统。</p></div></section><section class="tools" data-v-b521dea8><h2 data-v-b521dea8>工具</h2><p data-v-b521dea8><a href="./vscode-nr/nr-language-0.1.0.vsix" data-v-b521dea8>下载 VS Code 语法高亮扩展 (.vsix)</a></p><p data-v-b521dea8>安装：VS Code → <code data-v-b521dea8>Ctrl+Shift+P</code> → &quot;Install from VSIX...&quot; → 选择下载的文件</p><p class="vsix-notice" data-v-b521dea8>注意：此插件仅提供最新版本，不保证历史版本兼容。</p></section><section class="info" data-v-b521dea8><h2 data-v-b521dea8>项目信息</h2><ul data-v-b521dea8><li data-v-b521dea8><strong data-v-b521dea8>引擎</strong>：Nebula 词库引擎</li><li data-v-b521dea8><strong data-v-b521dea8>实现语言</strong>：Rust</li><li data-v-b521dea8><strong data-v-b521dea8>许可证</strong>：Copyright (c) 2025 保留所有权利</li></ul></section>',3))]))}},hd=je(dd,[["__scopeId","data-v-b521dea8"]]);function Hi(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let He=Hi();function bl(n){He=n}const _l=/[&<>"']/,pd=new RegExp(_l.source,"g"),xl=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,gd=new RegExp(xl.source,"g"),$d={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},zr=n=>$d[n];function Cn(n,e){if(e){if(_l.test(n))return n.replace(pd,zr)}else if(xl.test(n))return n.replace(gd,zr);return n}const md=/(^|[^\[])\^/g;function tn(n,e){let t=typeof n=="string"?n:n.source;e=e||"";const s={replace:(i,r)=>{let o=typeof r=="string"?r:r.source;return o=o.replace(md,"$1"),t=t.replace(i,o),s},getRegex:()=>new RegExp(t,e)};return s}function Vr(n){try{n=encodeURI(n).replace(/%25/g,"%")}catch{return null}return n}const _t={exec:()=>null};function Gr(n,e){const t=n.replace(/\|/g,(r,o,l)=>{let a=!1,u=o;for(;--u>=0&&l[u]==="\\";)a=!a;return a?"|":" |"}),s=t.split(/ \|/);let i=0;if(s[0].trim()||s.shift(),s.length>0&&!s[s.length-1].trim()&&s.pop(),e)if(s.length>e)s.splice(e);else for(;s.length<e;)s.push("");for(;i<s.length;i++)s[i]=s[i].trim().replace(/\\\|/g,"|");return s}function lt(n,e,t){const s=n.length;if(s===0)return"";let i=0;for(;i<s&&n.charAt(s-i-1)===e;)i++;return n.slice(0,s-i)}function bd(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let s=0;s<n.length;s++)if(n[s]==="\\")s++;else if(n[s]===e[0])t++;else if(n[s]===e[1]&&(t--,t<0))return s;return-1}function Jr(n,e,t,s){const i=e.href,r=e.title?Cn(e.title):null,o=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){s.state.inLink=!0;const l={type:"link",raw:t,href:i,title:r,text:o,tokens:s.inlineTokens(o)};return s.state.inLink=!1,l}return{type:"image",raw:t,href:i,title:r,text:Cn(o)}}function _d(n,e){const t=n.match(/^(\s+)(?:```)/);if(t===null)return e;const s=t[1];return e.split(`
...
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const s=t[0],i=_d(s,t[3]||"");return{type:"code",raw:s,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:i}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let s=t[2].trim();if(/#$/.test(s)){const i=lt(s,"#");(this.options.pedantic||!i||/ $/.test(i))&&(s=i.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:s,tokens:this.lexer.inline(s)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:lt(t[0],`
...
`+i.raw,r.text+=`
`+i.text,this.inlineQueue.pop(),this.inlineQueue[this.inlineQueue.length-1].src=r.text):t.push(i);continue}if(e){const l="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(l);break}else throw new Error(l)}}return this.state.top=!0,t}inline(e,t=[]){return this.inlineQueue.push({src:e,tokens:t}),t}inlineTokens(e,t=[]){let s,i,r,o=e,l,a,u;if(this.tokens.links){const c=Object.keys(this.tokens.links);if(c.length>0)for(;(l=this.tokenizer.rules.inline.reflinkSearch.exec(o))!=null;)c.includes(l[0].slice(l[0].lastIndexOf("[")+1,-1))&&(o=o.slice(0,l.index)+"["+"a".repeat(l[0].length-2)+"]"+o.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(l=this.tokenizer.rules.inline.blockSkip.exec(o))!=null;)o=o.slice(0,l.index)+"["+"a".repeat(l[0].length-2)+"]"+o.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);for(;(l=this.tokenizer.rules.inline.anyPunctuation.exec(o))!=null;)o=o.slice(0,l.index)+"++"+o.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);for(;e;)if(a||(u=""),a=!1,!(this.options.extensions&&this.options.extensions.inline&&this.options.extensions.inline.some(c=>(s=c.call({lexer:this},e,t))?(e=e.substring(s.raw.length),t.push(s),!0):!1))){if(s=this.tokenizer.escape(e)){e=e.substring(s.raw.length),t.push(s);continue}if(s=this.tokenizer.tag(e)){e=e.substring(s.raw.length),i=t[t.length-1],i&&s.type==="text"&&i.type==="text"?(i.raw+=s.raw,i.text+=s.text):t.push(s);continue}if(s=this.tokenizer.link(e)){e=e.substring(s.raw.length),t.push(s);continue}if(s=this.tokenizer.reflink(e,this.tokens.links)){e=e.substring(s.raw.length),i=t[t.length-1],i&&s.type==="text"&&i.type==="text"?(i.raw+=s.raw,i.text+=s.text):t.push(s);continue}if(s=this.tokenizer.emStrong(e,o,u)){e=e.substring(s.raw.length),t.push(s);continue}if(s=this.tokenizer.codespan(e)){e=e.substring(s.raw.length),t.push(s);continue}if(s=this.tokenizer.br(e)){e=e.substring(s.raw.length),t.push(s);continue}if(s=this.tokenizer.del(e)){e=e.substring(s.raw.length),t.push(s);continue}if(s=this.tokenizer.autolink(e)){e=e.substring(s.raw.length),t.push(s);continue}if(!this.state.inLink&&(s=this.tokenizer.url(e))){e=e.substring(s.raw.length),t.push(s);continue}if(r=e,this.options.extensions&&this.options.extensions.startInline){let c=1/0;const f=e.slice(1);let p;this.options.extensions.startInline.forEach(g=>{p=g.call({lexer:this},f),typeof p=="number"&&p>=0&&(c=Math.min(c,p))}),c<1/0&&c>=0&&(r=e.substring(0,c+1))}if(s=this.tokenizer.inlineText(r)){e=e.substring(s.raw.length),s.raw.slice(-1)!=="_"&&(u=s.raw.slice(-1)),a=!0,i=t[t.length-1],i&&i.type==="text"?(i.raw+=s.raw,i.text+=s.text):t.push(s);continue}if(e){const c="Infinite loop on byte: "+e.charCodeAt(0);if(this.options.silent){console.error(c);break}else throw new Error(c)}}return t}}class es{constructor(e){rn(this,"options");rn(this,"parser");this.options=e||He}space(e){return""}code({text:e,lang:t,escaped:s}){var o;const i=(o=(t||"").match(/^\S*/))==null?void 0:o[0],r=e.replace(/\n$/,"")+`
