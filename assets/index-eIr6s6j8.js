var Tl=Object.defineProperty;var Sl=(n,e,t)=>e in n?Tl(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var rn=(n,e,t)=>Sl(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();/**
* @vue/shared v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Ks(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const on={},Je=[],se=()=>{},kr=()=>!1,Xt=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),ns=n=>n.startsWith("onUpdate:"),vn=Object.assign,qs=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},Rl=Object.prototype.hasOwnProperty,W=(n,e)=>Rl.call(n,e),H=Array.isArray,Ke=n=>Tt(n)==="[object Map]",Tr=n=>Tt(n)==="[object Set]",ki=n=>Tt(n)==="[object Date]",B=n=>typeof n=="function",fn=n=>typeof n=="string",ie=n=>typeof n=="symbol",X=n=>n!==null&&typeof n=="object",Sr=n=>(X(n)||B(n))&&B(n.then)&&B(n.catch),Rr=Object.prototype.toString,Tt=n=>Rr.call(n),Ol=n=>Tt(n).slice(8,-1),Or=n=>Tt(n)==="[object Object]",Ws=n=>fn(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,ct=Ks(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),es=n=>{const e=Object.create(null);return t=>e[t]||(e[t]=n(t))},El=/-\w/g,On=es(n=>n.replace(El,e=>e.slice(1).toUpperCase())),Pl=/\B([A-Z])/g,Me=es(n=>n.replace(Pl,"-$1").toLowerCase()),ts=es(n=>n.charAt(0).toUpperCase()+n.slice(1)),gs=es(n=>n?`on${ts(n)}`:""),te=(n,e)=>!Object.is(n,e),Mt=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},Er=(n,e,t,s=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:s,value:t})},Ys=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let Ti;const ss=()=>Ti||(Ti=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Zs(n){if(H(n)){const e={};for(let t=0;t<n.length;t++){const s=n[t],i=fn(s)?Il(s):Zs(s);if(i)for(const r in i)e[r]=i[r]}return e}else if(fn(n)||X(n))return n}const Al=/;(?![^(]*\))/g,Cl=/:([^]+)/,Nl=/\/\*[^]*?\*\//g;function Il(n){const e={};return n.replace(Nl,"").split(Al).forEach(t=>{if(t){const s=t.split(Cl);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function Hn(n){let e="";if(fn(n))e=n;else if(H(n))for(let t=0;t<n.length;t++){const s=Hn(n[t]);s&&(e+=s+" ")}else if(X(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const Ll="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Ml=Ks(Ll);function Pr(n){return!!n||n===""}function Dl(n,e){if(n.length!==e.length)return!1;let t=!0;for(let s=0;t&&s<n.length;s++)t=Qs(n[s],e[s]);return t}function Qs(n,e){if(n===e)return!0;let t=ki(n),s=ki(e);if(t||s)return t&&s?n.getTime()===e.getTime():!1;if(t=ie(n),s=ie(e),t||s)return n===e;if(t=H(n),s=H(e),t||s)return t&&s?Dl(n,e):!1;if(t=X(n),s=X(e),t||s){if(!t||!s)return!1;const i=Object.keys(n).length,r=Object.keys(e).length;if(i!==r)return!1;for(const o in n){const l=n.hasOwnProperty(o),a=e.hasOwnProperty(o);if(l&&!a||!l&&a||!Qs(n[o],e[o]))return!1}}return String(n)===String(e)}const Ar=n=>!!(n&&n.__v_isRef===!0),bn=n=>fn(n)?n:n==null?"":H(n)||X(n)&&(n.toString===Rr||!B(n.toString))?Ar(n)?bn(n.value):JSON.stringify(n,Cr,2):String(n),Cr=(n,e)=>Ar(e)?Cr(n,e.value):Ke(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[s,i],r)=>(t[$s(s,r)+" =>"]=i,t),{})}:Tr(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>$s(t))}:ie(e)?$s(e):X(e)&&!H(e)&&!Or(e)?String(e):e,$s=(n,e="")=>{var t;return ie(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let _n;class jl{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!e&&_n&&(_n.active?(this.parent=_n,this.index=(_n.scopes||(_n.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=_n;try{return _n=this,e()}finally{_n=t}}}on(){++this._on===1&&(this.prevScope=_n,_n=this)}off(){if(this._on>0&&--this._on===0){if(_n===this)_n=this.prevScope;else{let e=_n;for(;e;){if(e.prevScope===this){e.prevScope=this.prevScope;break}e=e.prevScope}}this.prevScope=void 0}}stop(e){if(this._active){this._active=!1;let t,s;for(t=0,s=this.effects.length;t<s;t++)this.effects[t].stop();for(this.effects.length=0,t=0,s=this.cleanups.length;t<s;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function Hl(){return _n}let ln;const ms=new WeakSet;class Nr{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,_n&&(_n.active?_n.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,ms.has(this)&&(ms.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Lr(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Si(this),Mr(this);const e=ln,t=Bn;ln=this,Bn=!0;try{return this.fn()}finally{Dr(this),ln=e,Bn=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)ei(e);this.deps=this.depsTail=void 0,Si(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?ms.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Ps(this)&&this.run()}get dirty(){return Ps(this)}}let Ir=0,ut,ft;function Lr(n,e=!1){if(n.flags|=8,e){n.next=ft,ft=n;return}n.next=ut,ut=n}function Xs(){Ir++}function ni(){if(--Ir>0)return;if(ft){let e=ft;for(ft=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;ut;){let e=ut;for(ut=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(s){n||(n=s)}e=t}}if(n)throw n}function Mr(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Dr(n){let e,t=n.depsTail,s=t;for(;s;){const i=s.prevDep;s.version===-1?(s===t&&(t=i),ei(s),Bl(s)):e=s,s.dep.activeLink=s.prevActiveLink,s.prevActiveLink=void 0,s=i}n.deps=e,n.depsTail=t}function Ps(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(jr(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function jr(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===bt)||(n.globalVersion=bt,!n.isSSR&&n.flags&128&&(!n.deps&&!n._dirty||!Ps(n))))return;n.flags|=2;const e=n.dep,t=ln,s=Bn;ln=n,Bn=!0;try{Mr(n);const i=n.fn(n._value);(e.version===0||te(i,n._value))&&(n.flags|=128,n._value=i,e.version++)}catch(i){throw e.version++,i}finally{ln=t,Bn=s,Dr(n),n.flags&=-3}}function ei(n,e=!1){const{dep:t,prevSub:s,nextSub:i}=n;if(s&&(s.nextSub=i,n.prevSub=void 0),i&&(i.prevSub=s,n.nextSub=void 0),t.subs===n&&(t.subs=s,!s&&t.computed)){t.computed.flags&=-5;for(let r=t.computed.deps;r;r=r.nextDep)ei(r,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function Bl(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let Bn=!0;const Hr=[];function re(){Hr.push(Bn),Bn=!1}function oe(){const n=Hr.pop();Bn=n===void 0?!0:n}function Si(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=ln;ln=void 0;try{e()}finally{ln=t}}}let bt=0;class Fl{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class ti{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!ln||!Bn||ln===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==ln)t=this.activeLink=new Fl(ln,this),ln.deps?(t.prevDep=ln.depsTail,ln.depsTail.nextDep=t,ln.depsTail=t):ln.deps=ln.depsTail=t,Br(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const s=t.nextDep;s.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=s),t.prevDep=ln.depsTail,t.nextDep=void 0,ln.depsTail.nextDep=t,ln.depsTail=t,ln.deps===t&&(ln.deps=s)}return t}trigger(e){this.version++,bt++,this.notify(e)}notify(e){Xs();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{ni()}}}function Br(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let s=e.deps;s;s=s.nextDep)Br(s)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const As=new WeakMap,Ae=Symbol(""),Cs=Symbol(""),vt=Symbol("");function xn(n,e,t){if(Bn&&ln){let s=As.get(n);s||As.set(n,s=new Map);let i=s.get(t);i||(s.set(t,i=new ti),i.map=s,i.key=t),i.track()}}function de(n,e,t,s,i,r){const o=As.get(n);if(!o){bt++;return}const l=a=>{a&&a.trigger()};if(Xs(),e==="clear")o.forEach(l);else{const a=H(n),u=a&&Ws(t);if(a&&t==="length"){const c=Number(s);o.forEach((f,p)=>{(p==="length"||p===vt||!ie(p)&&p>=c)&&l(f)})}else switch((t!==void 0||o.has(void 0))&&l(o.get(t)),u&&l(o.get(vt)),e){case"add":a?u&&l(o.get("length")):(l(o.get(Ae)),Ke(n)&&l(o.get(Cs)));break;case"delete":a||(l(o.get(Ae)),Ke(n)&&l(o.get(Cs)));break;case"set":Ke(n)&&l(o.get(Ae));break}}ni()}function Ue(n){const e=q(n);return e===n?e:(xn(e,"iterate",vt),jn(n)?e:e.map(Un))}function is(n){return xn(n=q(n),"iterate",vt),n}function ne(n,e){return ge(n)?Ye(Ce(n)?Un(e):e):Un(e)}const Ul={__proto__:null,[Symbol.iterator](){return _s(this,Symbol.iterator,n=>ne(this,n))},concat(...n){return Ue(this).concat(...n.map(e=>H(e)?Ue(e):e))},entries(){return _s(this,"entries",n=>(n[1]=ne(this,n[1]),n))},every(n,e){return ae(this,"every",n,e,void 0,arguments)},filter(n,e){return ae(this,"filter",n,e,t=>t.map(s=>ne(this,s)),arguments)},find(n,e){return ae(this,"find",n,e,t=>ne(this,t),arguments)},findIndex(n,e){return ae(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return ae(this,"findLast",n,e,t=>ne(this,t),arguments)},findLastIndex(n,e){return ae(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return ae(this,"forEach",n,e,void 0,arguments)},includes(...n){return bs(this,"includes",n)},indexOf(...n){return bs(this,"indexOf",n)},join(n){return Ue(this).join(n)},lastIndexOf(...n){return bs(this,"lastIndexOf",n)},map(n,e){return ae(this,"map",n,e,void 0,arguments)},pop(){return tt(this,"pop")},push(...n){return tt(this,"push",n)},reduce(n,...e){return Ri(this,"reduce",n,e)},reduceRight(n,...e){return Ri(this,"reduceRight",n,e)},shift(){return tt(this,"shift")},some(n,e){return ae(this,"some",n,e,void 0,arguments)},splice(...n){return tt(this,"splice",n)},toReversed(){return Ue(this).toReversed()},toSorted(n){return Ue(this).toSorted(n)},toSpliced(...n){return Ue(this).toSpliced(...n)},unshift(...n){return tt(this,"unshift",n)},values(){return _s(this,"values",n=>ne(this,n))}};function _s(n,e,t){const s=is(n),i=s[e]();return s!==n&&!jn(n)&&(i._next=i.next,i.next=()=>{const r=i._next();return r.done||(r.value=t(r.value)),r}),i}const zl=Array.prototype;function ae(n,e,t,s,i,r){const o=is(n),l=o!==n&&!jn(n),a=o[e];if(a!==zl[e]){const f=a.apply(n,r);return l?Un(f):f}let u=t;o!==n&&(l?u=function(f,p){return t.call(this,ne(n,f),p,n)}:t.length>2&&(u=function(f,p){return t.call(this,f,p,n)}));const c=a.call(o,u,s);return l&&i?i(c):c}function Ri(n,e,t,s){const i=is(n),r=i!==n&&!jn(n);let o=t,l=!1;i!==n&&(r?(l=s.length===0,o=function(u,c,f){return l&&(l=!1,u=ne(n,u)),t.call(this,u,ne(n,c),f,n)}):t.length>3&&(o=function(u,c,f){return t.call(this,u,c,f,n)}));const a=i[e](o,...s);return l?ne(n,a):a}function bs(n,e,t){const s=q(n);xn(s,"iterate",vt);const i=s[e](...t);return(i===-1||i===!1)&&ri(t[0])?(t[0]=q(t[0]),s[e](...t)):i}function tt(n,e,t=[]){re(),Xs();const s=q(n)[e].apply(n,t);return ni(),oe(),s}const Vl=Ks("__proto__,__v_isRef,__isVue"),Fr=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(ie));function Gl(n){ie(n)||(n=String(n));const e=q(this);return xn(e,"has",n),e.hasOwnProperty(n)}class Ur{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,s){if(t==="__v_skip")return e.__v_skip;const i=this._isReadonly,r=this._isShallow;if(t==="__v_isReactive")return!i;if(t==="__v_isReadonly")return i;if(t==="__v_isShallow")return r;if(t==="__v_raw")return s===(i?r?ea:Jr:r?Gr:Vr).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(s)?e:void 0;const o=H(e);if(!i){let a;if(o&&(a=Ul[t]))return a;if(t==="hasOwnProperty")return Gl}const l=Reflect.get(e,t,wn(e)?e:s);if((ie(t)?Fr.has(t):Vl(t))||(i||xn(e,"get",t),r))return l;if(wn(l)){const a=o&&Ws(t)?l:l.value;return i&&X(a)?Is(a):a}return X(l)?i?Is(l):rs(l):l}}class zr extends Ur{constructor(e=!1){super(!1,e)}set(e,t,s,i){let r=e[t];const o=H(e)&&Ws(t);if(!this._isShallow){const u=ge(r);if(!jn(s)&&!ge(s)&&(r=q(r),s=q(s)),!o&&wn(r)&&!wn(s))return u||(r.value=s),!0}const l=o?Number(t)<e.length:W(e,t),a=Reflect.set(e,t,s,wn(e)?e:i);return e===q(i)&&a&&(l?te(s,r)&&de(e,"set",t,s):de(e,"add",t,s)),a}deleteProperty(e,t){const s=W(e,t);e[t];const i=Reflect.deleteProperty(e,t);return i&&s&&de(e,"delete",t,void 0),i}has(e,t){const s=Reflect.has(e,t);return(!ie(t)||!Fr.has(t))&&xn(e,"has",t),s}ownKeys(e){return xn(e,"iterate",H(e)?"length":Ae),Reflect.ownKeys(e)}}class Jl extends Ur{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const Kl=new zr,ql=new Jl,Wl=new zr(!0);const Ns=n=>n,At=n=>Reflect.getPrototypeOf(n);function Yl(n,e,t){return function(...s){const i=this.__v_raw,r=q(i),o=Ke(r),l=n==="entries"||n===Symbol.iterator&&o,a=n==="keys"&&o,u=i[n](...s),c=t?Ns:e?Ye:Un;return!e&&xn(r,"iterate",a?Cs:Ae),vn(Object.create(u),{next(){const{value:f,done:p}=u.next();return p?{value:f,done:p}:{value:l?[c(f[0]),c(f[1])]:c(f),done:p}}})}}function Ct(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function Zl(n,e){const t={get(i){const r=this.__v_raw,o=q(r),l=q(i);n||(te(i,l)&&xn(o,"get",i),xn(o,"get",l));const{has:a}=At(o),u=e?Ns:n?Ye:Un;if(a.call(o,i))return u(r.get(i));if(a.call(o,l))return u(r.get(l));r!==o&&r.get(i)},get size(){const i=this.__v_raw;return!n&&xn(q(i),"iterate",Ae),i.size},has(i){const r=this.__v_raw,o=q(r),l=q(i);return n||(te(i,l)&&xn(o,"has",i),xn(o,"has",l)),i===l?r.has(i):r.has(i)||r.has(l)},forEach(i,r){const o=this,l=o.__v_raw,a=q(l),u=e?Ns:n?Ye:Un;return!n&&xn(a,"iterate",Ae),l.forEach((c,f)=>i.call(r,u(c),u(f),o))}};return vn(t,n?{add:Ct("add"),set:Ct("set"),delete:Ct("delete"),clear:Ct("clear")}:{add(i){const r=q(this),o=At(r),l=q(i),a=!e&&!jn(i)&&!ge(i)?l:i;return o.has.call(r,a)||te(i,a)&&o.has.call(r,i)||te(l,a)&&o.has.call(r,l)||(r.add(a),de(r,"add",a,a)),this},set(i,r){!e&&!jn(r)&&!ge(r)&&(r=q(r));const o=q(this),{has:l,get:a}=At(o);let u=l.call(o,i);u||(i=q(i),u=l.call(o,i));const c=a.call(o,i);return o.set(i,r),u?te(r,c)&&de(o,"set",i,r):de(o,"add",i,r),this},delete(i){const r=q(this),{has:o,get:l}=At(r);let a=o.call(r,i);a||(i=q(i),a=o.call(r,i)),l&&l.call(r,i);const u=r.delete(i);return a&&de(r,"delete",i,void 0),u},clear(){const i=q(this),r=i.size!==0,o=i.clear();return r&&de(i,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(i=>{t[i]=Yl(i,n,e)}),t}function si(n,e){const t=Zl(n,e);return(s,i,r)=>i==="__v_isReactive"?!n:i==="__v_isReadonly"?n:i==="__v_raw"?s:Reflect.get(W(t,i)&&i in s?t:s,i,r)}const Ql={get:si(!1,!1)},Xl={get:si(!1,!0)},na={get:si(!0,!1)};const Vr=new WeakMap,Gr=new WeakMap,Jr=new WeakMap,ea=new WeakMap;function ta(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function rs(n){return ge(n)?n:ii(n,!1,Kl,Ql,Vr)}function Kr(n){return ii(n,!1,Wl,Xl,Gr)}function Is(n){return ii(n,!0,ql,na,Jr)}function ii(n,e,t,s,i){if(!X(n)||n.__v_raw&&!(e&&n.__v_isReactive)||n.__v_skip||!Object.isExtensible(n))return n;const r=i.get(n);if(r)return r;const o=ta(Ol(n));if(o===0)return n;const l=new Proxy(n,o===2?s:t);return i.set(n,l),l}function Ce(n){return ge(n)?Ce(n.__v_raw):!!(n&&n.__v_isReactive)}function ge(n){return!!(n&&n.__v_isReadonly)}function jn(n){return!!(n&&n.__v_isShallow)}function ri(n){return n?!!n.__v_raw:!1}function q(n){const e=n&&n.__v_raw;return e?q(e):n}function sa(n){return!W(n,"__v_skip")&&Object.isExtensible(n)&&Er(n,"__v_skip",!0),n}const Un=n=>X(n)?rs(n):n,Ye=n=>X(n)?Is(n):n;function wn(n){return n?n.__v_isRef===!0:!1}function pe(n){return qr(n,!1)}function ia(n){return qr(n,!0)}function qr(n,e){return wn(n)?n:new ra(n,e)}class ra{constructor(e,t){this.dep=new ti,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:q(e),this._value=t?e:Un(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,s=this.__v_isShallow||jn(e)||ge(e);e=s?e:q(e),te(e,t)&&(this._rawValue=e,this._value=s?e:Un(e),this.dep.trigger())}}function hn(n){return wn(n)?n.value:n}const oa={get:(n,e,t)=>e==="__v_raw"?n:hn(Reflect.get(n,e,t)),set:(n,e,t,s)=>{const i=n[e];return wn(i)&&!wn(t)?(i.value=t,!0):Reflect.set(n,e,t,s)}};function Wr(n){return Ce(n)?n:new Proxy(n,oa)}class la{constructor(e,t,s){this.fn=e,this.setter=t,this._value=void 0,this.dep=new ti(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=bt-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=s}notify(){if(this.flags|=16,!(this.flags&8)&&ln!==this)return Lr(this,!0),!0}get value(){const e=this.dep.track();return jr(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function aa(n,e,t=!1){let s,i;return B(n)?s=n:(s=n.get,i=n.set),new la(s,i,t)}const Nt={},Ft=new WeakMap;let Oe;function ca(n,e=!1,t=Oe){if(t){let s=Ft.get(t);s||Ft.set(t,s=[]),s.push(n)}}function ua(n,e,t=on){const{immediate:s,deep:i,once:r,scheduler:o,augmentJob:l,call:a}=t,u=A=>i?A:jn(A)||i===!1||i===0?he(A,1):he(A);let c,f,p,g,y=!1,w=!1;if(wn(n)?(f=()=>n.value,y=jn(n)):Ce(n)?(f=()=>u(n),y=!0):H(n)?(w=!0,y=n.some(A=>Ce(A)||jn(A)),f=()=>n.map(A=>{if(wn(A))return A.value;if(Ce(A))return u(A);if(B(A))return a?a(A,2):A()})):B(n)?e?f=a?()=>a(n,2):n:f=()=>{if(p){re();try{p()}finally{oe()}}const A=Oe;Oe=c;try{return a?a(n,3,[g]):n(g)}finally{Oe=A}}:f=se,e&&i){const A=f,Y=i===!0?1/0:i;f=()=>he(A(),Y)}const N=Hl(),M=()=>{c.stop(),N&&N.active&&qs(N.effects,c)};if(r&&e){const A=e;e=(...Y)=>{const an=A(...Y);return M(),an}}let E=w?new Array(n.length).fill(Nt):Nt;const C=A=>{if(!(!(c.flags&1)||!c.dirty&&!A))if(e){const Y=c.run();if(A||i||y||(w?Y.some((an,Z)=>te(an,E[Z])):te(Y,E))){p&&p();const an=Oe;Oe=c;try{const Z=[Y,E===Nt?void 0:w&&E[0]===Nt?[]:E,g];E=Y,a?a(e,3,Z):e(...Z)}finally{Oe=an}}}else c.run()};return l&&l(C),c=new Nr(f),c.scheduler=o?()=>o(C,!1):C,g=A=>ca(A,!1,c),p=c.onStop=()=>{const A=Ft.get(c);if(A){if(a)a(A,4);else for(const Y of A)Y();Ft.delete(c)}},e?s?C(!0):E=c.run():o?o(C.bind(null,!0),!0):c.run(),M.pause=c.pause.bind(c),M.resume=c.resume.bind(c),M.stop=M,M}function he(n,e=1/0,t){if(e<=0||!X(n)||n.__v_skip||(t=t||new Map,(t.get(n)||0)>=e))return n;if(t.set(n,e),e--,wn(n))he(n.value,e,t);else if(H(n))for(let s=0;s<n.length;s++)he(n[s],e,t);else if(Tr(n)||Ke(n))n.forEach(s=>{he(s,e,t)});else if(Or(n)){for(const s in n)he(n[s],e,t);for(const s of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,s)&&he(n[s],e,t)}return n}/**
* @vue/runtime-core v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function St(n,e,t,s){try{return s?n(...s):n()}catch(i){os(i,e,t)}}function zn(n,e,t,s){if(B(n)){const i=St(n,e,t,s);return i&&Sr(i)&&i.catch(r=>{os(r,e,t)}),i}if(H(n)){const i=[];for(let r=0;r<n.length;r++)i.push(zn(n[r],e,t,s));return i}}function os(n,e,t,s=!0){const i=e?e.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:o}=e&&e.appContext.config||on;if(e){let l=e.parent;const a=e.proxy,u=`https://vuejs.org/error-reference/#runtime-${t}`;for(;l;){const c=l.ec;if(c){for(let f=0;f<c.length;f++)if(c[f](n,a,u)===!1)return}l=l.parent}if(r){re(),St(r,null,10,[n,a,u]),oe();return}}fa(n,t,i,s,o)}function fa(n,e,t,s=!0,i=!1){if(i)throw n;console.error(n)}const Sn=[];let Xn=-1;const qe=[];let xe=null,ze=0;const Yr=Promise.resolve();let Ut=null;function Rt(n){const e=Ut||Yr;return n?e.then(this?n.bind(this):n):e}function da(n){let e=Xn+1,t=Sn.length;for(;e<t;){const s=e+t>>>1,i=Sn[s],r=xt(i);r<n||r===n&&i.flags&2?e=s+1:t=s}return e}function oi(n){if(!(n.flags&1)){const e=xt(n),t=Sn[Sn.length-1];!t||!(n.flags&2)&&e>=xt(t)?Sn.push(n):Sn.splice(da(e),0,n),n.flags|=1,Zr()}}function Zr(){Ut||(Ut=Yr.then(Xr))}function ha(n){H(n)?qe.push(...n):xe&&n.id===-1?xe.splice(ze+1,0,n):n.flags&1||(qe.push(n),n.flags|=1),Zr()}function Oi(n,e,t=Xn+1){for(;t<Sn.length;t++){const s=Sn[t];if(s&&s.flags&2){if(n&&s.id!==n.uid)continue;Sn.splice(t,1),t--,s.flags&4&&(s.flags&=-2),s(),s.flags&4||(s.flags&=-2)}}}function Qr(n){if(qe.length){const e=[...new Set(qe)].sort((t,s)=>xt(t)-xt(s));if(qe.length=0,xe){xe.push(...e);return}for(xe=e,ze=0;ze<xe.length;ze++){const t=xe[ze];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}xe=null,ze=0}}const xt=n=>n.id==null?n.flags&2?-1:1/0:n.id;function Xr(n){try{for(Xn=0;Xn<Sn.length;Xn++){const e=Sn[Xn];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),St(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Xn<Sn.length;Xn++){const e=Sn[Xn];e&&(e.flags&=-2)}Xn=-1,Sn.length=0,Qr(),Ut=null,(Sn.length||qe.length)&&Xr()}}let Nn=null,no=null;function zt(n){const e=Nn;return Nn=n,no=n&&n.type.__scopeId||null,e}function pa(n,e=Nn,t){if(!e||n._n)return n;const s=(...i)=>{s._d&&Jt(-1);const r=zt(e);let o;try{o=n(...i)}finally{zt(r),s._d&&Jt(1)}return o};return s._n=!0,s._c=!0,s._d=!0,s}function ga(n,e){if(Nn===null)return n;const t=us(Nn),s=n.dirs||(n.dirs=[]);for(let i=0;i<e.length;i++){let[r,o,l,a=on]=e[i];r&&(B(r)&&(r={mounted:r,updated:r}),r.deep&&he(o),s.push({dir:r,instance:t,value:o,oldValue:void 0,arg:l,modifiers:a}))}return n}function Se(n,e,t,s){const i=n.dirs,r=e&&e.dirs;for(let o=0;o<i.length;o++){const l=i[o];r&&(l.oldValue=r[o].value);let a=l.dir[s];a&&(re(),zn(a,t,8,[n.el,l,n,e]),oe())}}function Dt(n,e){if(yn){let t=yn.provides;const s=yn.parent&&yn.parent.provides;s===t&&(t=yn.provides=Object.create(s)),t[n]=e}}function Fn(n,e,t=!1){const s=_c();if(s||We){let i=We?We._context.provides:s?s.parent==null||s.ce?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:void 0;if(i&&n in i)return i[n];if(arguments.length>1)return t&&B(e)?e.call(s&&s.proxy):e}}const $a=Symbol.for("v-scx"),ma=()=>Fn($a);function _a(n,e){return li(n,null,e)}function Ne(n,e,t){return li(n,e,t)}function li(n,e,t=on){const{immediate:s,deep:i,flush:r,once:o}=t,l=vn({},t),a=e&&s||!e&&r!=="post";let u;if(wt){if(r==="sync"){const g=ma();u=g.__watcherHandles||(g.__watcherHandles=[])}else if(!a){const g=()=>{};return g.stop=se,g.resume=se,g.pause=se,g}}const c=yn;l.call=(g,y,w)=>zn(g,c,y,w);let f=!1;r==="post"?l.scheduler=g=>{Pn(g,c&&c.suspense)}:r!=="sync"&&(f=!0,l.scheduler=(g,y)=>{y?g():oi(g)}),l.augmentJob=g=>{e&&(g.flags|=4),f&&(g.flags|=2,c&&(g.id=c.uid,g.i=c))};const p=ua(n,e,l);return wt&&(u?u.push(p):a&&p()),p}function ba(n,e,t){const s=this.proxy,i=fn(n)?n.includes(".")?eo(s,n):()=>s[n]:n.bind(s,s);let r;B(e)?r=e:(r=e.handler,t=e);const o=Ot(this),l=li(i,r.bind(s),t);return o(),l}function eo(n,e){const t=e.split(".");return()=>{let s=n;for(let i=0;i<t.length&&s;i++)s=s[t[i]];return s}}const va=Symbol("_vte"),xa=n=>n.__isTeleport,vs=Symbol("_leaveCb");function ai(n,e){n.shapeFlag&6&&n.component?(n.transition=e,ai(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}function to(n,e){return B(n)?vn({name:n.name},e,{setup:n}):n}function so(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}function Ei(n,e){let t;return!!((t=Object.getOwnPropertyDescriptor(n,e))&&!t.configurable)}const Vt=new WeakMap;function dt(n,e,t,s,i=!1){if(H(n)){n.forEach((w,N)=>dt(w,e&&(H(e)?e[N]:e),t,s,i));return}if(ht(s)&&!i){s.shapeFlag&512&&s.type.__asyncResolved&&s.component.subTree.component&&dt(n,e,t,s.component.subTree);return}const r=s.shapeFlag&4?us(s.component):s.el,o=i?null:r,{i:l,r:a}=n,u=e&&e.r,c=l.refs===on?l.refs={}:l.refs,f=l.setupState,p=q(f),g=f===on?kr:w=>Ei(c,w)?!1:W(p,w),y=(w,N)=>!(N&&Ei(c,N));if(u!=null&&u!==a){if(Pi(e),fn(u))c[u]=null,g(u)&&(f[u]=null);else if(wn(u)){const w=e;y(u,w.k)&&(u.value=null),w.k&&(c[w.k]=null)}}if(B(a)){re();try{St(a,l,12,[o,c])}finally{oe()}}else{const w=fn(a),N=wn(a);if(w||N){const M=()=>{if(n.f){const E=w?g(a)?f[a]:c[a]:y()||!n.k?a.value:c[n.k];if(i)H(E)&&qs(E,r);else if(H(E))E.includes(r)||E.push(r);else if(w)c[a]=[r],g(a)&&(f[a]=c[a]);else{const C=[r];y(a,n.k)&&(a.value=C),n.k&&(c[n.k]=C)}}else w?(c[a]=o,g(a)&&(f[a]=o)):N&&(y(a,n.k)&&(a.value=o),n.k&&(c[n.k]=o))};if(o){const E=()=>{M(),Vt.delete(n)};E.id=-1,Vt.set(n,E),Pn(E,t)}else Pi(n),M()}}}function Pi(n){const e=Vt.get(n);e&&(e.flags|=8,Vt.delete(n))}ss().requestIdleCallback;ss().cancelIdleCallback;const ht=n=>!!n.type.__asyncLoader,io=n=>n.type.__isKeepAlive;function ya(n,e){ro(n,"a",e)}function wa(n,e){ro(n,"da",e)}function ro(n,e,t=yn){const s=n.__wdc||(n.__wdc=()=>{let i=t;for(;i;){if(i.isDeactivated)return;i=i.parent}return n()});if(ls(e,s,t),t){let i=t.parent;for(;i&&i.parent;)io(i.parent.vnode)&&ka(s,e,t,i),i=i.parent}}function ka(n,e,t,s){const i=ls(e,n,s,!0);ci(()=>{qs(s[e],i)},t)}function ls(n,e,t=yn,s=!1){if(t){const i=t[n]||(t[n]=[]),r=e.__weh||(e.__weh=(...o)=>{re();const l=Ot(t),a=zn(e,t,n,o);return l(),oe(),a});return s?i.unshift(r):i.push(r),r}}const $e=n=>(e,t=yn)=>{(!wt||n==="sp")&&ls(n,(...s)=>e(...s),t)},Ta=$e("bm"),oo=$e("m"),Sa=$e("bu"),Ra=$e("u"),Oa=$e("bum"),ci=$e("um"),Ea=$e("sp"),Pa=$e("rtg"),Aa=$e("rtc");function Ca(n,e=yn){ls("ec",n,e)}const Na="components";function Ia(n,e){return Ma(Na,n,!0,e)||n}const La=Symbol.for("v-ndc");function Ma(n,e,t=!0,s=!1){const i=Nn||yn;if(i){const r=i.type;{const l=wc(r,!1);if(l&&(l===e||l===On(e)||l===ts(On(e))))return r}const o=Ai(i[n]||r[n],e)||Ai(i.appContext[n],e);return!o&&s?r:o}}function Ai(n,e){return n&&(n[e]||n[On(e)]||n[ts(On(e))])}function Ee(n,e,t,s){let i;const r=t,o=H(n);if(o||fn(n)){const l=o&&Ce(n);let a=!1,u=!1;l&&(a=!jn(n),u=ge(n),n=is(n)),i=new Array(n.length);for(let c=0,f=n.length;c<f;c++)i[c]=e(a?u?Ye(Un(n[c])):Un(n[c]):n[c],c,void 0,r)}else if(typeof n=="number"){i=new Array(n);for(let l=0;l<n;l++)i[l]=e(l+1,l,void 0,r)}else if(X(n))if(n[Symbol.iterator])i=Array.from(n,(l,a)=>e(l,a,void 0,r));else{const l=Object.keys(n);i=new Array(l.length);for(let a=0,u=l.length;a<u;a++){const c=l[a];i[a]=e(n[c],c,a,r)}}else i=[];return i}const Ls=n=>n?Oo(n)?us(n):Ls(n.parent):null,pt=vn(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>Ls(n.parent),$root:n=>Ls(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>ao(n),$forceUpdate:n=>n.f||(n.f=()=>{oi(n.update)}),$nextTick:n=>n.n||(n.n=Rt.bind(n.proxy)),$watch:n=>ba.bind(n)}),xs=(n,e)=>n!==on&&!n.__isScriptSetup&&W(n,e),Da={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:s,data:i,props:r,accessCache:o,type:l,appContext:a}=n;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return s[e];case 2:return i[e];case 4:return t[e];case 3:return r[e]}else{if(xs(s,e))return o[e]=1,s[e];if(i!==on&&W(i,e))return o[e]=2,i[e];if(W(r,e))return o[e]=3,r[e];if(t!==on&&W(t,e))return o[e]=4,t[e];Ms&&(o[e]=0)}}const u=pt[e];let c,f;if(u)return e==="$attrs"&&xn(n.attrs,"get",""),u(n);if((c=l.__cssModules)&&(c=c[e]))return c;if(t!==on&&W(t,e))return o[e]=4,t[e];if(f=a.config.globalProperties,W(f,e))return f[e]},set({_:n},e,t){const{data:s,setupState:i,ctx:r}=n;return xs(i,e)?(i[e]=t,!0):s!==on&&W(s,e)?(s[e]=t,!0):W(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(r[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:s,appContext:i,props:r,type:o}},l){let a;return!!(t[l]||n!==on&&l[0]!=="$"&&W(n,l)||xs(e,l)||W(r,l)||W(s,l)||W(pt,l)||W(i.config.globalProperties,l)||(a=o.__cssModules)&&a[l])},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:W(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function Ci(n){return H(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let Ms=!0;function ja(n){const e=ao(n),t=n.proxy,s=n.ctx;Ms=!1,e.beforeCreate&&Ni(e.beforeCreate,n,"bc");const{data:i,computed:r,methods:o,watch:l,provide:a,inject:u,created:c,beforeMount:f,mounted:p,beforeUpdate:g,updated:y,activated:w,deactivated:N,beforeDestroy:M,beforeUnmount:E,destroyed:C,unmounted:A,render:Y,renderTracked:an,renderTriggered:Z,errorCaptured:Gn,serverPrefetch:me,expose:Jn,inheritAttrs:_e,components:ke,directives:Kn,filters:nt}=e;if(u&&Ha(u,s,null),o)for(const nn in o){const J=o[nn];B(J)&&(s[nn]=J.bind(t))}if(i){const nn=i.call(t,t);X(nn)&&(n.data=rs(nn))}if(Ms=!0,r)for(const nn in r){const J=r[nn],le=B(J)?J.bind(t,t):B(J.get)?J.get.bind(t,t):se,be=!B(J)&&B(J.set)?J.set.bind(t):se,qn=Rn({get:le,set:be});Object.defineProperty(s,nn,{enumerable:!0,configurable:!0,get:()=>qn.value,set:En=>qn.value=En})}if(l)for(const nn in l)lo(l[nn],s,t,nn);if(a){const nn=B(a)?a.call(t):a;Reflect.ownKeys(nn).forEach(J=>{Dt(J,nn[J])})}c&&Ni(c,n,"c");function $n(nn,J){H(J)?J.forEach(le=>nn(le.bind(t))):J&&nn(J.bind(t))}if($n(Ta,f),$n(oo,p),$n(Sa,g),$n(Ra,y),$n(ya,w),$n(wa,N),$n(Ca,Gn),$n(Aa,an),$n(Pa,Z),$n(Oa,E),$n(ci,A),$n(Ea,me),H(Jn))if(Jn.length){const nn=n.exposed||(n.exposed={});Jn.forEach(J=>{Object.defineProperty(nn,J,{get:()=>t[J],set:le=>t[J]=le,enumerable:!0})})}else n.exposed||(n.exposed={});Y&&n.render===se&&(n.render=Y),_e!=null&&(n.inheritAttrs=_e),ke&&(n.components=ke),Kn&&(n.directives=Kn),me&&so(n)}function Ha(n,e,t=se){H(n)&&(n=Ds(n));for(const s in n){const i=n[s];let r;X(i)?"default"in i?r=Fn(i.from||s,i.default,!0):r=Fn(i.from||s):r=Fn(i),wn(r)?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):e[s]=r}}function Ni(n,e,t){zn(H(n)?n.map(s=>s.bind(e.proxy)):n.bind(e.proxy),e,t)}function lo(n,e,t,s){let i=s.includes(".")?eo(t,s):()=>t[s];if(fn(n)){const r=e[n];B(r)&&Ne(i,r)}else if(B(n))Ne(i,n.bind(t));else if(X(n))if(H(n))n.forEach(r=>lo(r,e,t,s));else{const r=B(n.handler)?n.handler.bind(t):e[n.handler];B(r)&&Ne(i,r,n)}}function ao(n){const e=n.type,{mixins:t,extends:s}=e,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=n.appContext,l=r.get(e);let a;return l?a=l:!i.length&&!t&&!s?a=e:(a={},i.length&&i.forEach(u=>Gt(a,u,o,!0)),Gt(a,e,o)),X(e)&&r.set(e,a),a}function Gt(n,e,t,s=!1){const{mixins:i,extends:r}=e;r&&Gt(n,r,t,!0),i&&i.forEach(o=>Gt(n,o,t,!0));for(const o in e)if(!(s&&o==="expose")){const l=Ba[o]||t&&t[o];n[o]=l?l(n[o],e[o]):e[o]}return n}const Ba={data:Ii,props:Li,emits:Li,methods:lt,computed:lt,beforeCreate:kn,created:kn,beforeMount:kn,mounted:kn,beforeUpdate:kn,updated:kn,beforeDestroy:kn,beforeUnmount:kn,destroyed:kn,unmounted:kn,activated:kn,deactivated:kn,errorCaptured:kn,serverPrefetch:kn,components:lt,directives:lt,watch:Ua,provide:Ii,inject:Fa};function Ii(n,e){return e?n?function(){return vn(B(n)?n.call(this,this):n,B(e)?e.call(this,this):e)}:e:n}function Fa(n,e){return lt(Ds(n),Ds(e))}function Ds(n){if(H(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function kn(n,e){return n?[...new Set([].concat(n,e))]:e}function lt(n,e){return n?vn(Object.create(null),n,e):e}function Li(n,e){return n?H(n)&&H(e)?[...new Set([...n,...e])]:vn(Object.create(null),Ci(n),Ci(e??{})):e}function Ua(n,e){if(!n)return e;if(!e)return n;const t=vn(Object.create(null),n);for(const s in e)t[s]=kn(n[s],e[s]);return t}function co(){return{app:null,config:{isNativeTag:kr,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let za=0;function Va(n,e){return function(s,i=null){B(s)||(s=vn({},s)),i!=null&&!X(i)&&(i=null);const r=co(),o=new WeakSet,l=[];let a=!1;const u=r.app={_uid:za++,_component:s,_props:i,_container:null,_context:r,_instance:null,version:Tc,get config(){return r.config},set config(c){},use(c,...f){return o.has(c)||(c&&B(c.install)?(o.add(c),c.install(u,...f)):B(c)&&(o.add(c),c(u,...f))),u},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),u},component(c,f){return f?(r.components[c]=f,u):r.components[c]},directive(c,f){return f?(r.directives[c]=f,u):r.directives[c]},mount(c,f,p){if(!a){const g=u._ceVNode||gn(s,i);return g.appContext=r,p===!0?p="svg":p===!1&&(p=void 0),n(g,c,p),a=!0,u._container=c,c.__vue_app__=u,us(g.component)}},onUnmount(c){l.push(c)},unmount(){a&&(zn(l,u._instance,16),n(null,u._container),delete u._container.__vue_app__)},provide(c,f){return r.provides[c]=f,u},runWithContext(c){const f=We;We=u;try{return c()}finally{We=f}}};return u}}let We=null;const Ga=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${On(e)}Modifiers`]||n[`${Me(e)}Modifiers`];function Ja(n,e,...t){if(n.isUnmounted)return;const s=n.vnode.props||on;let i=t;const r=e.startsWith("update:"),o=r&&Ga(s,e.slice(7));o&&(o.trim&&(i=t.map(c=>fn(c)?c.trim():c)),o.number&&(i=t.map(Ys)));let l,a=s[l=gs(e)]||s[l=gs(On(e))];!a&&r&&(a=s[l=gs(Me(e))]),a&&zn(a,n,6,i);const u=s[l+"Once"];if(u){if(!n.emitted)n.emitted={};else if(n.emitted[l])return;n.emitted[l]=!0,zn(u,n,6,i)}}const Ka=new WeakMap;function uo(n,e,t=!1){const s=t?Ka:e.emitsCache,i=s.get(n);if(i!==void 0)return i;const r=n.emits;let o={},l=!1;if(!B(n)){const a=u=>{const c=uo(u,e,!0);c&&(l=!0,vn(o,c))};!t&&e.mixins.length&&e.mixins.forEach(a),n.extends&&a(n.extends),n.mixins&&n.mixins.forEach(a)}return!r&&!l?(X(n)&&s.set(n,null),null):(H(r)?r.forEach(a=>o[a]=null):vn(o,r),X(n)&&s.set(n,o),o)}function as(n,e){return!n||!Xt(e)?!1:(e=e.slice(2),e=e==="Once"?e:e.replace(/Once$/,""),W(n,e[0].toLowerCase()+e.slice(1))||W(n,Me(e))||W(n,e))}function Mi(n){const{type:e,vnode:t,proxy:s,withProxy:i,propsOptions:[r],slots:o,attrs:l,emit:a,render:u,renderCache:c,props:f,data:p,setupState:g,ctx:y,inheritAttrs:w}=n,N=zt(n);let M,E;try{if(t.shapeFlag&4){const A=i||s,Y=A;M=ee(u.call(Y,A,c,f,g,p,y)),E=l}else{const A=e;M=ee(A.length>1?A(f,{attrs:l,slots:o,emit:a}):A(f,null)),E=e.props?l:qa(l)}}catch(A){gt.length=0,os(A,n,1),M=gn(we)}let C=M;if(E&&w!==!1){const A=Object.keys(E),{shapeFlag:Y}=C;A.length&&Y&7&&(r&&A.some(ns)&&(E=Wa(E,r)),C=Ze(C,E,!1,!0))}return t.dirs&&(C=Ze(C,null,!1,!0),C.dirs=C.dirs?C.dirs.concat(t.dirs):t.dirs),t.transition&&ai(C,t.transition),M=C,zt(N),M}const qa=n=>{let e;for(const t in n)(t==="class"||t==="style"||Xt(t))&&((e||(e={}))[t]=n[t]);return e},Wa=(n,e)=>{const t={};for(const s in n)(!ns(s)||!(s.slice(9)in e))&&(t[s]=n[s]);return t};function Ya(n,e,t){const{props:s,children:i,component:r}=n,{props:o,children:l,patchFlag:a}=e,u=r.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&a>=0){if(a&1024)return!0;if(a&16)return s?Di(s,o,u):!!o;if(a&8){const c=e.dynamicProps;for(let f=0;f<c.length;f++){const p=c[f];if(fo(o,s,p)&&!as(u,p))return!0}}}else return(i||l)&&(!l||!l.$stable)?!0:s===o?!1:s?o?Di(s,o,u):!0:!!o;return!1}function Di(n,e,t){const s=Object.keys(e);if(s.length!==Object.keys(n).length)return!0;for(let i=0;i<s.length;i++){const r=s[i];if(fo(e,n,r)&&!as(t,r))return!0}return!1}function fo(n,e,t){const s=n[t],i=e[t];return t==="style"&&X(s)&&X(i)?!Qs(s,i):s!==i}function Za({vnode:n,parent:e,suspense:t},s){for(;e;){const i=e.subTree;if(i.suspense&&i.suspense.activeBranch===n&&(i.suspense.vnode.el=i.el=s,n=i),i===n)(n=e.vnode).el=s,e=e.parent;else break}t&&t.activeBranch===n&&(t.vnode.el=s)}const ho={},po=()=>Object.create(ho),go=n=>Object.getPrototypeOf(n)===ho;function Qa(n,e,t,s=!1){const i={},r=po();n.propsDefaults=Object.create(null),$o(n,e,i,r);for(const o in n.propsOptions[0])o in i||(i[o]=void 0);t?n.props=s?i:Kr(i):n.type.props?n.props=i:n.props=r,n.attrs=r}function Xa(n,e,t,s){const{props:i,attrs:r,vnode:{patchFlag:o}}=n,l=q(i),[a]=n.propsOptions;let u=!1;if((s||o>0)&&!(o&16)){if(o&8){const c=n.vnode.dynamicProps;for(let f=0;f<c.length;f++){let p=c[f];if(as(n.emitsOptions,p))continue;const g=e[p];if(a)if(W(r,p))g!==r[p]&&(r[p]=g,u=!0);else{const y=On(p);i[y]=js(a,l,y,g,n,!1)}else g!==r[p]&&(r[p]=g,u=!0)}}}else{$o(n,e,i,r)&&(u=!0);let c;for(const f in l)(!e||!W(e,f)&&((c=Me(f))===f||!W(e,c)))&&(a?t&&(t[f]!==void 0||t[c]!==void 0)&&(i[f]=js(a,l,f,void 0,n,!0)):delete i[f]);if(r!==l)for(const f in r)(!e||!W(e,f))&&(delete r[f],u=!0)}u&&de(n.attrs,"set","")}function $o(n,e,t,s){const[i,r]=n.propsOptions;let o=!1,l;if(e)for(let a in e){if(ct(a))continue;const u=e[a];let c;i&&W(i,c=On(a))?!r||!r.includes(c)?t[c]=u:(l||(l={}))[c]=u:as(n.emitsOptions,a)||(!(a in s)||u!==s[a])&&(s[a]=u,o=!0)}if(r){const a=q(t),u=l||on;for(let c=0;c<r.length;c++){const f=r[c];t[f]=js(i,a,f,u[f],n,!W(u,f))}}return o}function js(n,e,t,s,i,r){const o=n[t];if(o!=null){const l=W(o,"default");if(l&&s===void 0){const a=o.default;if(o.type!==Function&&!o.skipFactory&&B(a)){const{propsDefaults:u}=i;if(t in u)s=u[t];else{const c=Ot(i);s=u[t]=a.call(null,e),c()}}else s=a;i.ce&&i.ce._setProp(t,s)}o[0]&&(r&&!l?s=!1:o[1]&&(s===""||s===Me(t))&&(s=!0))}return s}const nc=new WeakMap;function mo(n,e,t=!1){const s=t?nc:e.propsCache,i=s.get(n);if(i)return i;const r=n.props,o={},l=[];let a=!1;if(!B(n)){const c=f=>{a=!0;const[p,g]=mo(f,e,!0);vn(o,p),g&&l.push(...g)};!t&&e.mixins.length&&e.mixins.forEach(c),n.extends&&c(n.extends),n.mixins&&n.mixins.forEach(c)}if(!r&&!a)return X(n)&&s.set(n,Je),Je;if(H(r))for(let c=0;c<r.length;c++){const f=On(r[c]);ji(f)&&(o[f]=on)}else if(r)for(const c in r){const f=On(c);if(ji(f)){const p=r[c],g=o[f]=H(p)||B(p)?{type:p}:vn({},p),y=g.type;let w=!1,N=!0;if(H(y))for(let M=0;M<y.length;++M){const E=y[M],C=B(E)&&E.name;if(C==="Boolean"){w=!0;break}else C==="String"&&(N=!1)}else w=B(y)&&y.name==="Boolean";g[0]=w,g[1]=N,(w||W(g,"default"))&&l.push(f)}}const u=[o,l];return X(n)&&s.set(n,u),u}function ji(n){return n[0]!=="$"&&!ct(n)}const ui=n=>n==="_"||n==="_ctx"||n==="$stable",fi=n=>H(n)?n.map(ee):[ee(n)],ec=(n,e,t)=>{if(e._n)return e;const s=pa((...i)=>fi(e(...i)),t);return s._c=!1,s},_o=(n,e,t)=>{const s=n._ctx;for(const i in n){if(ui(i))continue;const r=n[i];if(B(r))e[i]=ec(i,r,s);else if(r!=null){const o=fi(r);e[i]=()=>o}}},bo=(n,e)=>{const t=fi(e);n.slots.default=()=>t},vo=(n,e,t)=>{for(const s in e)(t||!ui(s))&&(n[s]=e[s])},tc=(n,e,t)=>{const s=n.slots=po();if(n.vnode.shapeFlag&32){const i=e._;i?(vo(s,e,t),t&&Er(s,"_",i,!0)):_o(e,s)}else e&&bo(n,e)},sc=(n,e,t)=>{const{vnode:s,slots:i}=n;let r=!0,o=on;if(s.shapeFlag&32){const l=e._;l?t&&l===1?r=!1:vo(i,e,t):(r=!e.$stable,_o(e,i)),o=e}else e&&(bo(n,e),o={default:1});if(r)for(const l in i)!ui(l)&&o[l]==null&&delete i[l]},Pn=ac;function ic(n){return rc(n)}function rc(n,e){const t=ss();t.__VUE__=!0;const{insert:s,remove:i,patchProp:r,createElement:o,createText:l,createComment:a,setText:u,setElementText:c,parentNode:f,nextSibling:p,setScopeId:g=se,insertStaticContent:y}=n,w=(d,h,$,_=null,v=null,m=null,S=void 0,T=null,k=!!h.dynamicChildren)=>{if(d===h)return;d&&!st(d,h)&&(_=b(d),En(d,v,m,!0),d=null),h.patchFlag===-2&&(k=!1,h.dynamicChildren=null);const{type:x,ref:D,shapeFlag:O}=h;switch(x){case cs:N(d,h,$,_);break;case we:M(d,h,$,_);break;case jt:d==null&&E(h,$,_,S);break;case cn:ke(d,h,$,_,v,m,S,T,k);break;default:O&1?Y(d,h,$,_,v,m,S,T,k):O&6?Kn(d,h,$,_,v,m,S,T,k):(O&64||O&128)&&x.process(d,h,$,_,v,m,S,T,k,I)}D!=null&&v?dt(D,d&&d.ref,m,h||d,!h):D==null&&d&&d.ref!=null&&dt(d.ref,null,m,d,!0)},N=(d,h,$,_)=>{if(d==null)s(h.el=l(h.children),$,_);else{const v=h.el=d.el;h.children!==d.children&&u(v,h.children)}},M=(d,h,$,_)=>{d==null?s(h.el=a(h.children||""),$,_):h.el=d.el},E=(d,h,$,_)=>{[d.el,d.anchor]=y(d.children,h,$,_,d.el,d.anchor)},C=({el:d,anchor:h},$,_)=>{let v;for(;d&&d!==h;)v=p(d),s(d,$,_),d=v;s(h,$,_)},A=({el:d,anchor:h})=>{let $;for(;d&&d!==h;)$=p(d),i(d),d=$;i(h)},Y=(d,h,$,_,v,m,S,T,k)=>{if(h.type==="svg"?S="svg":h.type==="math"&&(S="mathml"),d==null)an(h,$,_,v,m,S,T,k);else{const x=d.el&&d.el._isVueCE?d.el:null;try{x&&x._beginPatch(),me(d,h,v,m,S,T,k)}finally{x&&x._endPatch()}}},an=(d,h,$,_,v,m,S,T)=>{let k,x;const{props:D,shapeFlag:O,transition:L,dirs:j}=d;if(k=d.el=o(d.type,m,D&&D.is,D),O&8?c(k,d.children):O&16&&Gn(d.children,k,null,_,v,ys(d,m),S,T),j&&Se(d,null,_,"created"),Z(k,d,d.scopeId,S,_),D){for(const sn in D)sn!=="value"&&!ct(sn)&&r(k,sn,null,D[sn],m,_);"value"in D&&r(k,"value",null,D.value,m),(x=D.onVnodeBeforeMount)&&Qn(x,_,d)}j&&Se(d,null,_,"beforeMount");const G=oc(v,L);G&&L.beforeEnter(k),s(k,h,$),((x=D&&D.onVnodeMounted)||G||j)&&Pn(()=>{try{x&&Qn(x,_,d),G&&L.enter(k),j&&Se(d,null,_,"mounted")}finally{}},v)},Z=(d,h,$,_,v)=>{if($&&g(d,$),_)for(let m=0;m<_.length;m++)g(d,_[m]);if(v){let m=v.subTree;if(h===m||ko(m.type)&&(m.ssContent===h||m.ssFallback===h)){const S=v.vnode;Z(d,S,S.scopeId,S.slotScopeIds,v.parent)}}},Gn=(d,h,$,_,v,m,S,T,k=0)=>{for(let x=k;x<d.length;x++){const D=d[x]=T?fe(d[x]):ee(d[x]);w(null,D,h,$,_,v,m,S,T)}},me=(d,h,$,_,v,m,S)=>{const T=h.el=d.el;let{patchFlag:k,dynamicChildren:x,dirs:D}=h;k|=d.patchFlag&16;const O=d.props||on,L=h.props||on;let j;if($&&Re($,!1),(j=L.onVnodeBeforeUpdate)&&Qn(j,$,h,d),D&&Se(h,d,$,"beforeUpdate"),$&&Re($,!0),x&&(!d.dynamicChildren||d.dynamicChildren.length!==x.length)&&(k=0,S=!1,x=null),(O.innerHTML&&L.innerHTML==null||O.textContent&&L.textContent==null)&&c(T,""),x?Jn(d.dynamicChildren,x,T,$,_,ys(h,v),m):S||J(d,h,T,null,$,_,ys(h,v),m,!1),k>0){if(k&16)_e(T,O,L,$,v);else if(k&2&&O.class!==L.class&&r(T,"class",null,L.class,v),k&4&&r(T,"style",O.style,L.style,v),k&8){const G=h.dynamicProps;for(let sn=0;sn<G.length;sn++){const en=G[sn],dn=O[en],mn=L[en];(mn!==dn||en==="value")&&r(T,en,dn,mn,v,$)}}k&1&&d.children!==h.children&&c(T,h.children)}else!S&&x==null&&_e(T,O,L,$,v);((j=L.onVnodeUpdated)||D)&&Pn(()=>{j&&Qn(j,$,h,d),D&&Se(h,d,$,"updated")},_)},Jn=(d,h,$,_,v,m,S)=>{for(let T=0;T<h.length;T++){const k=d[T],x=h[T],D=k.el&&(k.type===cn||!st(k,x)||k.shapeFlag&198)?f(k.el):$;w(k,x,D,null,_,v,m,S,!0)}},_e=(d,h,$,_,v)=>{if(h!==$){if(h!==on)for(const m in h)!ct(m)&&!(m in $)&&r(d,m,h[m],null,v,_);for(const m in $){if(ct(m))continue;const S=$[m],T=h[m];S!==T&&m!=="value"&&r(d,m,T,S,v,_)}"value"in $&&r(d,"value",h.value,$.value,v)}},ke=(d,h,$,_,v,m,S,T,k)=>{const x=h.el=d?d.el:l(""),D=h.anchor=d?d.anchor:l("");let{patchFlag:O,dynamicChildren:L,slotScopeIds:j}=h;j&&(T=T?T.concat(j):j),d==null?(s(x,$,_),s(D,$,_),Gn(h.children||[],$,D,v,m,S,T,k)):O>0&&O&64&&L&&d.dynamicChildren&&d.dynamicChildren.length===L.length?(Jn(d.dynamicChildren,L,$,v,m,S,T),(h.key!=null||v&&h===v.subTree)&&xo(d,h,!0)):J(d,h,$,D,v,m,S,T,k)},Kn=(d,h,$,_,v,m,S,T,k)=>{h.slotScopeIds=T,d==null?h.shapeFlag&512?v.ctx.activate(h,$,_,S,k):nt(h,$,_,v,m,S,k):He(d,h,k)},nt=(d,h,$,_,v,m,S)=>{const T=d.component=mc(d,_,v);if(io(d)&&(T.ctx.renderer=I),bc(T,!1,S),T.asyncDep){if(v&&v.registerDep(T,$n,S),!d.el){const k=T.subTree=gn(we);M(null,k,h,$),d.placeholder=k.el}}else $n(T,d,h,$,v,m,S)},He=(d,h,$)=>{const _=h.component=d.component;if(Ya(d,h,$))if(_.asyncDep&&!_.asyncResolved){nn(_,h,$);return}else _.next=h,_.update();else h.el=d.el,_.vnode=h},$n=(d,h,$,_,v,m,S)=>{const T=()=>{if(d.isMounted){let{next:O,bu:L,u:j,parent:G,vnode:sn}=d;{const Yn=yo(d);if(Yn){O&&(O.el=sn.el,nn(d,O,S)),Yn.asyncDep.then(()=>{Pn(()=>{d.isUnmounted||x()},v)});return}}let en=O,dn;Re(d,!1),O?(O.el=sn.el,nn(d,O,S)):O=sn,L&&Mt(L),(dn=O.props&&O.props.onVnodeBeforeUpdate)&&Qn(dn,G,O,sn),Re(d,!0);const mn=Mi(d),Wn=d.subTree;d.subTree=mn,w(Wn,mn,f(Wn.el),b(Wn),d,v,m),O.el=mn.el,en===null&&Za(d,mn.el),j&&Pn(j,v),(dn=O.props&&O.props.onVnodeUpdated)&&Pn(()=>Qn(dn,G,O,sn),v)}else{let O;const{el:L,props:j}=h,{bm:G,m:sn,parent:en,root:dn,type:mn}=d,Wn=ht(h);Re(d,!1),G&&Mt(G),!Wn&&(O=j&&j.onVnodeBeforeMount)&&Qn(O,en,h),Re(d,!0);{dn.ce&&dn.ce._hasShadowRoot()&&dn.ce._injectChildStyle(mn,d.parent?d.parent.type:void 0);const Yn=d.subTree=Mi(d);w(null,Yn,$,_,d,v,m),h.el=Yn.el}if(sn&&Pn(sn,v),!Wn&&(O=j&&j.onVnodeMounted)){const Yn=h;Pn(()=>Qn(O,en,Yn),v)}(h.shapeFlag&256||en&&ht(en.vnode)&&en.vnode.shapeFlag&256)&&d.a&&Pn(d.a,v),d.isMounted=!0,h=$=_=null}};d.scope.on();const k=d.effect=new Nr(T);d.scope.off();const x=d.update=k.run.bind(k),D=d.job=k.runIfDirty.bind(k);D.i=d,D.id=d.uid,k.scheduler=()=>oi(D),Re(d,!0),x()},nn=(d,h,$)=>{h.component=d;const _=d.vnode.props;d.vnode=h,d.next=null,Xa(d,h.props,_,$),sc(d,h.children,$),re(),Oi(d),oe()},J=(d,h,$,_,v,m,S,T,k=!1)=>{const x=d&&d.children,D=d?d.shapeFlag:0,O=h.children,{patchFlag:L,shapeFlag:j}=h;if(L>0){if(L&128){be(x,O,$,_,v,m,S,T,k);return}else if(L&256){le(x,O,$,_,v,m,S,T,k);return}}j&8?(D&16&&Ln(x,v,m),O!==x&&c($,O)):D&16?j&16?be(x,O,$,_,v,m,S,T,k):Ln(x,v,m,!0):(D&8&&c($,""),j&16&&Gn(O,$,_,v,m,S,T,k))},le=(d,h,$,_,v,m,S,T,k)=>{d=d||Je,h=h||Je;const x=d.length,D=h.length,O=Math.min(x,D);let L;for(L=0;L<O;L++){const j=h[L]=k?fe(h[L]):ee(h[L]);w(d[L],j,$,null,v,m,S,T,k)}x>D?Ln(d,v,m,!0,!1,O):Gn(h,$,_,v,m,S,T,k,O)},be=(d,h,$,_,v,m,S,T,k)=>{let x=0;const D=h.length;let O=d.length-1,L=D-1;for(;x<=O&&x<=L;){const j=d[x],G=h[x]=k?fe(h[x]):ee(h[x]);if(st(j,G))w(j,G,$,null,v,m,S,T,k);else break;x++}for(;x<=O&&x<=L;){const j=d[O],G=h[L]=k?fe(h[L]):ee(h[L]);if(st(j,G))w(j,G,$,null,v,m,S,T,k);else break;O--,L--}if(x>O){if(x<=L){const j=L+1,G=j<D?h[j].el:_;for(;x<=L;)w(null,h[x]=k?fe(h[x]):ee(h[x]),$,G,v,m,S,T,k),x++}}else if(x>L)for(;x<=O;)En(d[x],v,m,!0),x++;else{const j=x,G=x,sn=new Map;for(x=G;x<=L;x++){const An=h[x]=k?fe(h[x]):ee(h[x]);An.key!=null&&sn.set(An.key,x)}let en,dn=0;const mn=L-G+1;let Wn=!1,Yn=0;const et=new Array(mn);for(x=0;x<mn;x++)et[x]=0;for(x=j;x<=O;x++){const An=d[x];if(dn>=mn){En(An,v,m,!0);continue}let Zn;if(An.key!=null)Zn=sn.get(An.key);else for(en=G;en<=L;en++)if(et[en-G]===0&&st(An,h[en])){Zn=en;break}Zn===void 0?En(An,v,m,!0):(et[Zn-G]=x+1,Zn>=Yn?Yn=Zn:Wn=!0,w(An,h[Zn],$,null,v,m,S,T,k),dn++)}const xi=Wn?lc(et):Je;for(en=xi.length-1,x=mn-1;x>=0;x--){const An=G+x,Zn=h[An],yi=h[An+1],wi=An+1<D?yi.el||wo(yi):_;et[x]===0?w(null,Zn,$,wi,v,m,S,T,k):Wn&&(en<0||x!==xi[en]?qn(Zn,$,wi,2):en--)}}},qn=(d,h,$,_,v=null)=>{const{el:m,type:S,transition:T,children:k,shapeFlag:x}=d;if(x&6){qn(d.component.subTree,h,$,_);return}if(x&128){d.suspense.move(h,$,_);return}if(x&64){S.move(d,h,$,I);return}if(S===cn){s(m,h,$);for(let O=0;O<k.length;O++)qn(k[O],h,$,_);s(d.anchor,h,$);return}if(S===jt){C(d,h,$);return}if(_!==2&&x&1&&T)if(_===0)T.persisted&&!m[vs]?s(m,h,$):(T.beforeEnter(m),s(m,h,$),Pn(()=>T.enter(m),v));else{const{leave:O,delayLeave:L,afterLeave:j}=T,G=()=>{d.ctx.isUnmounted?i(m):s(m,h,$)},sn=()=>{const en=m._isLeaving||!!m[vs];m._isLeaving&&m[vs](!0),T.persisted&&!en?G():O(m,()=>{G(),j&&j()})};L?L(m,G,sn):sn()}else s(m,h,$)},En=(d,h,$,_=!1,v=!1)=>{const{type:m,props:S,ref:T,children:k,dynamicChildren:x,shapeFlag:D,patchFlag:O,dirs:L,cacheIndex:j,memo:G}=d;if(O===-2&&(v=!1),T!=null&&(re(),dt(T,null,$,d,!0),oe()),j!=null&&(h.renderCache[j]=void 0),D&256){h.ctx.deactivate(d);return}const sn=D&1&&L,en=!ht(d);let dn;if(en&&(dn=S&&S.onVnodeBeforeUnmount)&&Qn(dn,h,d),D&6)Te(d.component,$,_);else{if(D&128){d.suspense.unmount($,_);return}sn&&Se(d,null,h,"beforeUnmount"),D&64?d.type.remove(d,h,$,I,_):x&&!x.hasOnce&&(m!==cn||O>0&&O&64)?Ln(x,h,$,!1,!0):(m===cn&&O&384||!v&&D&16)&&Ln(k,h,$),_&&Be(d)}const mn=G!=null&&j==null;(en&&(dn=S&&S.onVnodeUnmounted)||sn||mn)&&Pn(()=>{dn&&Qn(dn,h,d),sn&&Se(d,null,h,"unmounted"),mn&&(d.el=null)},$)},Be=d=>{const{type:h,el:$,anchor:_,transition:v}=d;if(h===cn){Fe($,_);return}if(h===jt){A(d);return}const m=()=>{i($),v&&!v.persisted&&v.afterLeave&&v.afterLeave()};if(d.shapeFlag&1&&v&&!v.persisted){const{leave:S,delayLeave:T}=v,k=()=>S($,m);T?T(d.el,m,k):k()}else m()},Fe=(d,h)=>{let $;for(;d!==h;)$=p(d),i(d),d=$;i(h)},Te=(d,h,$)=>{const{bum:_,scope:v,job:m,subTree:S,um:T,m:k,a:x}=d;Hi(k),Hi(x),_&&Mt(_),v.stop(),m&&(m.flags|=8,En(S,d,h,$)),T&&Pn(T,h),Pn(()=>{d.isUnmounted=!0},h)},Ln=(d,h,$,_=!1,v=!1,m=0)=>{for(let S=m;S<d.length;S++)En(d[S],h,$,_,v)},b=d=>{if(d.shapeFlag&6)return b(d.component.subTree);if(d.shapeFlag&128)return d.suspense.next();const h=p(d.anchor||d.el),$=h&&h[va];return $?p($):h};let P=!1;const R=(d,h,$)=>{let _;d==null?h._vnode&&(En(h._vnode,null,null,!0),_=h._vnode.component):w(h._vnode||null,d,h,null,null,null,$),h._vnode=d,P||(P=!0,Oi(_),Qr(),P=!1)},I={p:w,um:En,m:qn,r:Be,mt:nt,mc:Gn,pc:J,pbc:Jn,n:b,o:n};return{render:R,hydrate:void 0,createApp:Va(R)}}function ys({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function Re({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function oc(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function xo(n,e,t=!1){const s=n.children,i=e.children;if(H(s)&&H(i))for(let r=0;r<s.length;r++){const o=s[r];let l=i[r];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=i[r]=fe(i[r]),l.el=o.el),!t&&l.patchFlag!==-2&&xo(o,l)),l.type===cs&&(l.patchFlag===-1&&(l=i[r]=fe(l)),l.el=o.el),l.type===we&&!l.el&&(l.el=o.el)}}function lc(n){const e=n.slice(),t=[0];let s,i,r,o,l;const a=n.length;for(s=0;s<a;s++){const u=n[s];if(u!==0){if(i=t[t.length-1],n[i]<u){e[s]=i,t.push(s);continue}for(r=0,o=t.length-1;r<o;)l=r+o>>1,n[t[l]]<u?r=l+1:o=l;u<n[t[r]]&&(r>0&&(e[s]=t[r-1]),t[r]=s)}}for(r=t.length,o=t[r-1];r-- >0;)t[r]=o,o=e[o];return t}function yo(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:yo(e)}function Hi(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}function wo(n){if(n.placeholder)return n.placeholder;const e=n.component;return e?wo(e.subTree):null}const ko=n=>n.__isSuspense;function ac(n,e){e&&e.pendingBranch?H(n)?e.effects.push(...n):e.effects.push(n):ha(n)}const cn=Symbol.for("v-fgt"),cs=Symbol.for("v-txt"),we=Symbol.for("v-cmt"),jt=Symbol.for("v-stc"),gt=[];let In=null;function F(n=!1){gt.push(In=n?null:[])}function cc(){gt.pop(),In=gt[gt.length-1]||null}let yt=1;function Jt(n,e=!1){yt+=n,n<0&&In&&e&&(In.hasOnce=!0)}function To(n){return n.dynamicChildren=yt>0?In||Je:null,cc(),yt>0&&In&&In.push(n),n}function U(n,e,t,s,i,r){return To(z(n,e,t,s,i,r,!0))}function So(n,e,t,s,i){return To(gn(n,e,t,s,i,!0))}function Kt(n){return n?n.__v_isVNode===!0:!1}function st(n,e){return n.type===e.type&&n.key===e.key}const Ro=({key:n})=>n??null,Ht=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?fn(n)||wn(n)||B(n)?{i:Nn,r:n,k:e,f:!!t}:n:null);function z(n,e=null,t=null,s=0,i=null,r=n===cn?0:1,o=!1,l=!1){const a={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&Ro(e),ref:e&&Ht(e),scopeId:no,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:s,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:Nn};return l?(qt(a,t),r&128&&n.normalize(a)):t&&(a.shapeFlag|=fn(t)?8:16),yt>0&&!o&&In&&(a.patchFlag>0||r&6)&&a.patchFlag!==32&&In.push(a),a}const gn=uc;function uc(n,e=null,t=null,s=0,i=null,r=!1){if((!n||n===La)&&(n=we),Kt(n)){const l=Ze(n,e,!0);return t&&qt(l,t),yt>0&&!r&&In&&(l.shapeFlag&6?In[In.indexOf(n)]=l:In.push(l)),l.patchFlag=-2,l}if(kc(n)&&(n=n.__vccOpts),e){e=fc(e);let{class:l,style:a}=e;l&&!fn(l)&&(e.class=Hn(l)),X(a)&&(ri(a)&&!H(a)&&(a=vn({},a)),e.style=Zs(a))}const o=fn(n)?1:ko(n)?128:xa(n)?64:X(n)?4:B(n)?2:0;return z(n,e,t,s,i,o,r,!0)}function fc(n){return n?ri(n)||go(n)?vn({},n):n:null}function Ze(n,e,t=!1,s=!1){const{props:i,ref:r,patchFlag:o,children:l,transition:a}=n,u=e?pc(i||{},e):i,c={__v_isVNode:!0,__v_skip:!0,type:n.type,props:u,key:u&&Ro(u),ref:e&&e.ref?t&&r?H(r)?r.concat(Ht(e)):[r,Ht(e)]:Ht(e):r,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:l,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==cn?o===-1?16:o|16:o,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:a,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&Ze(n.ssContent),ssFallback:n.ssFallback&&Ze(n.ssFallback),placeholder:n.placeholder,el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return a&&s&&ai(c,a.clone(c)),c}function dc(n=" ",e=0){return gn(cs,null,n,e)}function hc(n,e){const t=gn(jt,null,n);return t.staticCount=e,t}function Ie(n="",e=!1){return e?(F(),So(we,null,n)):gn(we,null,n)}function ee(n){return n==null||typeof n=="boolean"?gn(we):H(n)?gn(cn,null,n.slice()):Kt(n)?fe(n):gn(cs,null,String(n))}function fe(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:Ze(n)}function qt(n,e){let t=0;const{shapeFlag:s}=n;if(e==null)e=null;else if(H(e))t=16;else if(typeof e=="object")if(s&65){const i=e.default;i&&(i._c&&(i._d=!1),qt(n,i()),i._c&&(i._d=!0));return}else{t=32;const i=e._;!i&&!go(e)?e._ctx=Nn:i===3&&Nn&&(Nn.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else if(B(e)){if(s&65){qt(n,{default:e});return}e={default:e,_ctx:Nn},t=32}else e=String(e),s&64?(t=16,e=[dc(e)]):t=8;n.children=e,n.shapeFlag|=t}function pc(...n){const e={};for(let t=0;t<n.length;t++){const s=n[t];for(const i in s)if(i==="class")e.class!==s.class&&(e.class=Hn([e.class,s.class]));else if(i==="style")e.style=Zs([e.style,s.style]);else if(Xt(i)){const r=e[i],o=s[i];o&&r!==o&&!(H(r)&&r.includes(o))?e[i]=r?[].concat(r,o):o:o==null&&r==null&&!ns(i)&&(e[i]=o)}else i!==""&&(e[i]=s[i])}return e}function Qn(n,e,t,s=null){zn(n,e,7,[t,s])}const gc=co();let $c=0;function mc(n,e,t){const s=n.type,i=(e?e.appContext:n.appContext)||gc,r={uid:$c++,vnode:n,type:s,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new jl(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:mo(s,i),emitsOptions:uo(s,i),emit:null,emitted:null,propsDefaults:on,inheritAttrs:s.inheritAttrs,ctx:on,data:on,props:on,attrs:on,slots:on,refs:on,setupState:on,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=Ja.bind(null,r),n.ce&&n.ce(r),r}let yn=null;const _c=()=>yn||Nn;let Wt,Hs;{const n=ss(),e=(t,s)=>{let i;return(i=n[t])||(i=n[t]=[]),i.push(s),r=>{i.length>1?i.forEach(o=>o(r)):i[0](r)}};Wt=e("__VUE_INSTANCE_SETTERS__",t=>yn=t),Hs=e("__VUE_SSR_SETTERS__",t=>wt=t)}const Ot=n=>{const e=yn;return Wt(n),n.scope.on(),()=>{n.scope.off(),Wt(e)}},Bi=()=>{yn&&yn.scope.off(),Wt(null)};function Oo(n){return n.vnode.shapeFlag&4}let wt=!1;function bc(n,e=!1,t=!1){e&&Hs(e);const{props:s,children:i}=n.vnode,r=Oo(n);Qa(n,s,r,e),tc(n,i,t||e);const o=r?vc(n,e):void 0;return e&&Hs(!1),o}function vc(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,Da);const{setup:s}=t;if(s){re();const i=n.setupContext=s.length>1?yc(n):null,r=Ot(n),o=St(s,n,0,[n.props,i]),l=Sr(o);if(oe(),r(),(l||n.sp)&&!ht(n)&&so(n),l){if(o.then(Bi,Bi),e)return o.then(a=>{Fi(n,a)}).catch(a=>{os(a,n,0)});n.asyncDep=o}else Fi(n,o)}else Eo(n)}function Fi(n,e,t){B(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:X(e)&&(n.setupState=Wr(e)),Eo(n)}function Eo(n,e,t){const s=n.type;n.render||(n.render=s.render||se);{const i=Ot(n);re();try{ja(n)}finally{oe(),i()}}}const xc={get(n,e){return xn(n,"get",""),n[e]}};function yc(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,xc),slots:n.slots,emit:n.emit,expose:e}}function us(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(Wr(sa(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in pt)return pt[t](n)},has(e,t){return t in e||t in pt}})):n.proxy}function wc(n,e=!0){return B(n)?n.displayName||n.name:n.name||e&&n.__name}function kc(n){return B(n)&&"__vccOpts"in n}const Rn=(n,e)=>aa(n,e,wt);function Po(n,e,t){try{Jt(-1);const s=arguments.length;return s===2?X(e)&&!H(e)?Kt(e)?gn(n,null,[e]):gn(n,e):gn(n,null,e):(s>3?t=Array.prototype.slice.call(arguments,2):s===3&&Kt(t)&&(t=[t]),gn(n,e,t))}finally{Jt(1)}}const Tc="3.5.39";/**
* @vue/runtime-dom v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Bs;const Ui=typeof window<"u"&&window.trustedTypes;if(Ui)try{Bs=Ui.createPolicy("vue",{createHTML:n=>n})}catch{}const Ao=Bs?n=>Bs.createHTML(n):n=>n,Sc="http://www.w3.org/2000/svg",Rc="http://www.w3.org/1998/Math/MathML",ue=typeof document<"u"?document:null,zi=ue&&ue.createElement("template"),Oc={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,s)=>{const i=e==="svg"?ue.createElementNS(Sc,n):e==="mathml"?ue.createElementNS(Rc,n):t?ue.createElement(n,{is:t}):ue.createElement(n);return n==="select"&&s&&s.multiple!=null&&i.setAttribute("multiple",s.multiple),i},createText:n=>ue.createTextNode(n),createComment:n=>ue.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>ue.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,s,i,r){const o=t?t.previousSibling:e.lastChild;if(i&&(i===r||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),t),!(i===r||!(i=i.nextSibling)););else{zi.innerHTML=Ao(s==="svg"?`<svg>${n}</svg>`:s==="mathml"?`<math>${n}</math>`:n);const l=zi.content;if(s==="svg"||s==="mathml"){const a=l.firstChild;for(;a.firstChild;)l.appendChild(a.firstChild);l.removeChild(a)}e.insertBefore(l,t)}return[o?o.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},Ec=Symbol("_vtc");function Pc(n,e,t){const s=n[Ec];s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const Vi=Symbol("_vod"),Ac=Symbol("_vsh"),Cc=Symbol(""),Nc=/(?:^|;)\s*display\s*:/;function Ic(n,e,t){const s=n.style,i=fn(t);let r=!1;if(t&&!i){if(e)if(fn(e))for(const o of e.split(";")){const l=o.slice(0,o.indexOf(":")).trim();t[l]==null&&at(s,l,"")}else for(const o in e)t[o]==null&&at(s,o,"");for(const o in t){o==="display"&&(r=!0);const l=t[o];l!=null?Mc(n,o,!fn(e)&&e?e[o]:void 0,l)||at(s,o,l):at(s,o,"")}}else if(i){if(e!==t){const o=s[Cc];o&&(t+=";"+o),s.cssText=t,r=Nc.test(t)}}else e&&n.removeAttribute("style");Vi in n&&(n[Vi]=r?s.display:"",n[Ac]&&(s.display="none"))}const Gi=/\s*!important$/;function at(n,e,t){if(H(t))t.forEach(s=>at(n,e,s));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const s=Lc(n,e);Gi.test(t)?n.setProperty(Me(s),t.replace(Gi,""),"important"):n[s]=t}}const Ji=["Webkit","Moz","ms"],ws={};function Lc(n,e){const t=ws[e];if(t)return t;let s=On(e);if(s!=="filter"&&s in n)return ws[e]=s;s=ts(s);for(let i=0;i<Ji.length;i++){const r=Ji[i]+s;if(r in n)return ws[e]=r}return e}function Mc(n,e,t,s){return n.tagName==="TEXTAREA"&&(e==="width"||e==="height")&&fn(s)&&t===s}const Ki="http://www.w3.org/1999/xlink";function qi(n,e,t,s,i,r=Ml(e)){s&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(Ki,e.slice(6,e.length)):n.setAttributeNS(Ki,e,t):t==null||r&&!Pr(t)?n.removeAttribute(e):n.setAttribute(e,r?"":ie(t)?String(t):t)}function Wi(n,e,t,s,i){if(e==="innerHTML"||e==="textContent"){t!=null&&(n[e]=e==="innerHTML"?Ao(t):t);return}const r=n.tagName;if(e==="value"&&r!=="PROGRESS"&&!r.includes("-")){const l=r==="OPTION"?n.getAttribute("value")||"":n.value,a=t==null?n.type==="checkbox"?"on":"":String(t);(l!==a||!("_value"in n))&&(n.value=a),t==null&&n.removeAttribute(e),n._value=t;return}let o=!1;if(t===""||t==null){const l=typeof n[e];l==="boolean"?t=Pr(t):t==null&&l==="string"?(t="",o=!0):l==="number"&&(t=0,o=!0)}try{n[e]=t}catch{}o&&n.removeAttribute(i||e)}function Ve(n,e,t,s){n.addEventListener(e,t,s)}function Dc(n,e,t,s){n.removeEventListener(e,t,s)}const Yi=Symbol("_vei");function jc(n,e,t,s,i=null){const r=n[Yi]||(n[Yi]={}),o=r[e];if(s&&o)o.value=s;else{const[l,a]=Fc(e);if(s){const u=r[e]=Vc(s,i);Ve(n,l,u,a)}else o&&(Dc(n,l,o,a),r[e]=void 0)}}const Hc=/(Once|Passive|Capture)$/,Bc=/^on:?(?:Once|Passive|Capture)$/;function Fc(n){let e,t;for(;(t=n.match(Hc))&&!Bc.test(n);)e||(e={}),n=n.slice(0,n.length-t[1].length),e[t[1].toLowerCase()]=!0;return[n[2]===":"?n.slice(3):Me(n.slice(2)),e]}let ks=0;const Uc=Promise.resolve(),zc=()=>ks||(Uc.then(()=>ks=0),ks=Date.now());function Vc(n,e){const t=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=t.attached)return;const i=t.value;if(H(i)){const r=s.stopImmediatePropagation;s.stopImmediatePropagation=()=>{r.call(s),s._stopped=!0};const o=i.slice(),l=[s];for(let a=0;a<o.length&&!s._stopped;a++){const u=o[a];u&&zn(u,e,5,l)}}else zn(i,e,5,[s])};return t.value=n,t.attached=zc(),t}const Zi=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,Gc=(n,e,t,s,i,r)=>{const o=i==="svg";e==="class"?Pc(n,s,o):e==="style"?Ic(n,t,s):Xt(e)?ns(e)||jc(n,e,t,s,r):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Jc(n,e,s,o))?(Wi(n,e,s),!n.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&qi(n,e,s,o,r,e!=="value")):n._isVueCE&&(Kc(n,e)||n._def.__asyncLoader&&(/[A-Z]/.test(e)||!fn(s)))?Wi(n,On(e),s,r,e):(e==="true-value"?n._trueValue=s:e==="false-value"&&(n._falseValue=s),qi(n,e,s,o))};function Jc(n,e,t,s){if(s)return!!(e==="innerHTML"||e==="textContent"||e in n&&Zi(e)&&B(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="sandbox"&&n.tagName==="IFRAME"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const i=n.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return Zi(e)&&fn(t)?!1:e in n}function Kc(n,e){const t=n._def.props;if(!t)return!1;const s=On(e);return Array.isArray(t)?t.some(i=>On(i)===s):Object.keys(t).some(i=>On(i)===s)}const Qi=n=>{const e=n.props["onUpdate:modelValue"]||!1;return H(e)?t=>Mt(e,t):e};function qc(n){n.target.composing=!0}function Xi(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const Ts=Symbol("_assign");function nr(n,e,t){return e&&(n=n.trim()),t&&(n=Ys(n)),n}const Wc={created(n,{modifiers:{lazy:e,trim:t,number:s}},i){n[Ts]=Qi(i);const r=s||i.props&&i.props.type==="number";Ve(n,e?"change":"input",o=>{o.target.composing||n[Ts](nr(n.value,t,r))}),(t||r)&&Ve(n,"change",()=>{n.value=nr(n.value,t,r)}),e||(Ve(n,"compositionstart",qc),Ve(n,"compositionend",Xi),Ve(n,"change",Xi))},mounted(n,{value:e}){n.value=e??""},beforeUpdate(n,{value:e,oldValue:t,modifiers:{lazy:s,trim:i,number:r}},o){if(n[Ts]=Qi(o),n.composing)return;const l=(r||n.type==="number")&&!/^0\d/.test(n.value)?Ys(n.value):n.value,a=e??"";if(l===a)return;const u=n.getRootNode();(u instanceof Document||u instanceof ShadowRoot)&&u.activeElement===n&&n.type!=="range"&&(s&&e===t||i&&n.value.trim()===a)||(n.value=a)}},Yc=["ctrl","shift","alt","meta"],Zc={stop:n=>n.stopPropagation(),prevent:n=>n.preventDefault(),self:n=>n.target!==n.currentTarget,ctrl:n=>!n.ctrlKey,shift:n=>!n.shiftKey,alt:n=>!n.altKey,meta:n=>!n.metaKey,left:n=>"button"in n&&n.button!==0,middle:n=>"button"in n&&n.button!==1,right:n=>"button"in n&&n.button!==2,exact:(n,e)=>Yc.some(t=>n[`${t}Key`]&&!e.includes(t))},Qc=(n,e)=>{if(!n)return n;const t=n._withMods||(n._withMods={}),s=e.join(".");return t[s]||(t[s]=(i,...r)=>{for(let o=0;o<e.length;o++){const l=Zc[e[o]];if(l&&l(i,e))return}return n(i,...r)})},Xc=vn({patchProp:Gc},Oc);let er;function nu(){return er||(er=ic(Xc))}const eu=(...n)=>{const e=nu().createApp(...n),{mount:t}=e;return e.mount=s=>{const i=su(s);if(!i)return;const r=e._component;!B(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const o=t(i,!1,tu(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function tu(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function su(n){return fn(n)?document.querySelector(n):n}const Bt=pe(localStorage.getItem("theme")!=="light");_a(()=>{const n=Bt.value?"dark":"light";document.documentElement.setAttribute("data-theme",n),localStorage.setItem("theme",n)});function iu(){function n(){Bt.value=!Bt.value}return{isDark:Bt,toggle:n}}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */const Ge=typeof document<"u";function Co(n){return typeof n=="object"||"displayName"in n||"props"in n||"__vccOpts"in n}function ru(n){return n.__esModule||n[Symbol.toStringTag]==="Module"||n.default&&Co(n.default)}const K=Object.assign;function Ss(n,e){const t={};for(const s in e){const i=e[s];t[s]=Vn(i)?i.map(n):n(i)}return t}const $t=()=>{},Vn=Array.isArray;function tr(n,e){const t={};for(const s in n)t[s]=s in e?e[s]:n[s];return t}const No=/#/g,ou=/&/g,lu=/\//g,au=/=/g,cu=/\?/g,Io=/\+/g,uu=/%5B/g,fu=/%5D/g,Lo=/%5E/g,du=/%60/g,Mo=/%7B/g,hu=/%7C/g,Do=/%7D/g,pu=/%20/g;function di(n){return n==null?"":encodeURI(""+n).replace(hu,"|").replace(uu,"[").replace(fu,"]")}function gu(n){return di(n).replace(Mo,"{").replace(Do,"}").replace(Lo,"^")}function Fs(n){return di(n).replace(Io,"%2B").replace(pu,"+").replace(No,"%23").replace(ou,"%26").replace(du,"`").replace(Mo,"{").replace(Do,"}").replace(Lo,"^")}function $u(n){return Fs(n).replace(au,"%3D")}function mu(n){return di(n).replace(No,"%23").replace(cu,"%3F")}function _u(n){return mu(n).replace(lu,"%2F")}function kt(n){if(n==null)return null;try{return decodeURIComponent(""+n)}catch{}return""+n}const bu=/\/$/,vu=n=>n.replace(bu,"");function Rs(n,e,t="/"){let s,i={},r="",o="";const l=e.indexOf("#");let a=e.indexOf("?");return a=l>=0&&a>l?-1:a,a>=0&&(s=e.slice(0,a),r=e.slice(a,l>0?l:e.length),i=n(r.slice(1))),l>=0&&(s=s||e.slice(0,l),o=e.slice(l,e.length)),s=ku(s??e,t),{fullPath:s+r+o,path:s,query:i,hash:kt(o)}}function xu(n,e){const t=e.query?n(e.query):"";return e.path+(t&&"?")+t+(e.hash||"")}function sr(n,e){return!e||!n.toLowerCase().startsWith(e.toLowerCase())?n:n.slice(e.length)||"/"}function yu(n,e,t){const s=e.matched.length-1,i=t.matched.length-1;return s>-1&&s===i&&Qe(e.matched[s],t.matched[i])&&jo(e.params,t.params)&&n(e.query)===n(t.query)&&e.hash===t.hash}function Qe(n,e){return(n.aliasOf||n)===(e.aliasOf||e)}function jo(n,e){if(Object.keys(n).length!==Object.keys(e).length)return!1;for(var t in n)if(!wu(n[t],e[t]))return!1;return!0}function wu(n,e){return Vn(n)?ir(n,e):Vn(e)?ir(e,n):(n==null?void 0:n.valueOf())===(e==null?void 0:e.valueOf())}function ir(n,e){return Vn(e)?n.length===e.length&&n.every((t,s)=>t===e[s]):n.length===1&&n[0]===e}function ku(n,e){if(n.startsWith("/"))return n;if(!n)return e;const t=e.split("/"),s=n.split("/"),i=s[s.length-1];(i===".."||i===".")&&s.push("");let r=t.length-1,o,l;for(o=0;o<s.length;o++)if(l=s[o],l!==".")if(l==="..")r>1&&r--;else break;return t.slice(0,r).join("/")+"/"+s.slice(o).join("/")}const ve={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Us=function(n){return n.pop="pop",n.push="push",n}({}),Os=function(n){return n.back="back",n.forward="forward",n.unknown="",n}({});function Tu(n){if(!n)if(Ge){const e=document.querySelector("base");n=e&&e.getAttribute("href")||"/",n=n.replace(/^\w+:\/\/[^\/]+/,"")}else n="/";return n[0]!=="/"&&n[0]!=="#"&&(n="/"+n),vu(n)}const Su=/^[^#]+#/;function Ru(n,e){return n.replace(Su,"#")+e}function Ou(n,e){const t=document.documentElement.getBoundingClientRect(),s=n.getBoundingClientRect();return{behavior:e.behavior,left:s.left-t.left-(e.left||0),top:s.top-t.top-(e.top||0)}}const fs=()=>({left:window.scrollX,top:window.scrollY});function Eu(n){let e;if("el"in n){const t=n.el,s=typeof t=="string"&&t.startsWith("#"),i=typeof t=="string"?s?document.getElementById(t.slice(1)):document.querySelector(t):t;if(!i)return;e=Ou(i,n)}else e=n;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.scrollX,e.top!=null?e.top:window.scrollY)}function rr(n,e){return(history.state?history.state.position-e:-1)+n}const zs=new Map;function Pu(n,e){zs.set(n,e)}function Au(n){const e=zs.get(n);return zs.delete(n),e}function Cu(n){return typeof n=="string"||n&&typeof n=="object"}function Ho(n){return typeof n=="string"||typeof n=="symbol"}let un=function(n){return n[n.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",n[n.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",n[n.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",n[n.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",n[n.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",n}({});const Bo=Symbol("");un.MATCHER_NOT_FOUND+"",un.NAVIGATION_GUARD_REDIRECT+"",un.NAVIGATION_ABORTED+"",un.NAVIGATION_CANCELLED+"",un.NAVIGATION_DUPLICATED+"";function Xe(n,e){return K(new Error,{type:n,[Bo]:!0},e)}function ce(n,e){return n instanceof Error&&Bo in n&&(e==null||!!(n.type&e))}const Nu=["params","query","hash"];function Iu(n){if(typeof n=="string")return n;if(n.path!=null)return n.path;const e={};for(const t of Nu)t in n&&(e[t]=n[t]);return JSON.stringify(e,null,2)}function Lu(n){const e={};if(n===""||n==="?")return e;const t=(n[0]==="?"?n.slice(1):n).split("&");for(let s=0;s<t.length;++s){const i=t[s].replace(Io," "),r=i.indexOf("="),o=kt(r<0?i:i.slice(0,r)),l=r<0?null:kt(i.slice(r+1));if(o in e){let a=e[o];Vn(a)||(a=e[o]=[a]),a.push(l)}else e[o]=l}return e}function or(n){let e="";for(let t in n){const s=n[t];if(t=$u(t),s==null){s!==void 0&&(e+=(e.length?"&":"")+t);continue}(Vn(s)?s.map(i=>i&&Fs(i)):[s&&Fs(s)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+t,i!=null&&(e+="="+i))})}return e}function Mu(n){const e={};for(const t in n){const s=n[t];s!==void 0&&(e[t]=Vn(s)?s.map(i=>i==null?null:""+i):s==null?s:""+s)}return e}const Du=Symbol(""),lr=Symbol(""),ds=Symbol(""),hi=Symbol(""),Vs=Symbol("");function it(){let n=[];function e(s){return n.push(s),()=>{const i=n.indexOf(s);i>-1&&n.splice(i,1)}}function t(){n=[]}return{add:e,list:()=>n.slice(),reset:t}}function ye(n,e,t,s,i,r=o=>o()){const o=s&&(s.enterCallbacks[i]=s.enterCallbacks[i]||[]);return()=>new Promise((l,a)=>{const u=p=>{p===!1?a(Xe(un.NAVIGATION_ABORTED,{from:t,to:e})):p instanceof Error?a(p):Cu(p)?a(Xe(un.NAVIGATION_GUARD_REDIRECT,{from:e,to:p})):(o&&s.enterCallbacks[i]===o&&typeof p=="function"&&o.push(p),l())},c=r(()=>n.call(s&&s.instances[i],e,t,u));let f=Promise.resolve(c);n.length<3&&(f=f.then(u)),f.catch(p=>a(p))})}function Es(n,e,t,s,i=r=>r()){const r=[];for(const o of n)for(const l in o.components){let a=o.components[l];if(!(e!=="beforeRouteEnter"&&!o.instances[l]))if(Co(a)){const u=(a.__vccOpts||a)[e];u&&r.push(ye(u,t,s,o,l,i))}else{let u=a();r.push(()=>u.then(c=>{if(!c)throw new Error(`Couldn't resolve component "${l}" at "${o.path}"`);const f=ru(c)?c.default:c;o.mods[l]=c,o.components[l]=f;const p=(f.__vccOpts||f)[e];return p&&ye(p,t,s,o,l,i)()}))}}return r}function ju(n,e){const t=[],s=[],i=[],r=Math.max(e.matched.length,n.matched.length);for(let o=0;o<r;o++){const l=e.matched[o];l&&(n.matched.find(u=>Qe(u,l))?s.push(l):t.push(l));const a=n.matched[o];a&&(e.matched.find(u=>Qe(u,a))||i.push(a))}return[t,s,i]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let Hu=()=>location.protocol+"//"+location.host;function Fo(n,e){const{pathname:t,search:s,hash:i}=e,r=n.indexOf("#");if(r>-1){let o=i.includes(n.slice(r))?n.slice(r).length:1,l=i.slice(o);return l[0]!=="/"&&(l="/"+l),sr(l,"")}return sr(t,n)+s+i}function Bu(n,e,t,s){let i=[],r=[],o=null;const l=({state:p})=>{const g=Fo(n,location),y=t.value,w=e.value;let N=0;if(p){if(t.value=g,e.value=p,o&&o===y){o=null;return}N=w?p.position-w.position:0}else s(g);i.forEach(M=>{M(t.value,y,{delta:N,type:Us.pop,direction:N?N>0?Os.forward:Os.back:Os.unknown})})};function a(){o=t.value}function u(p){i.push(p);const g=()=>{const y=i.indexOf(p);y>-1&&i.splice(y,1)};return r.push(g),g}function c(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(K({},p.state,{scroll:fs()}),"")}}function f(){for(const p of r)p();r=[],window.removeEventListener("popstate",l),window.removeEventListener("pagehide",c),document.removeEventListener("visibilitychange",c)}return window.addEventListener("popstate",l),window.addEventListener("pagehide",c),document.addEventListener("visibilitychange",c),{pauseListeners:a,listen:u,destroy:f}}function ar(n,e,t,s=!1,i=!1){return{back:n,current:e,forward:t,replaced:s,position:window.history.length,scroll:i?fs():null}}function Fu(n){const{history:e,location:t}=window,s={value:Fo(n,t)},i={value:e.state};i.value||r(s.value,{back:null,current:s.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function r(a,u,c){const f=n.indexOf("#"),p=f>-1?(t.host&&document.querySelector("base")?n:n.slice(f))+a:Hu()+n+a;try{e[c?"replaceState":"pushState"](u,"",p),i.value=u}catch(g){console.error(g),t[c?"replace":"assign"](p)}}function o(a,u){r(a,K({},e.state,ar(i.value.back,a,i.value.forward,!0),u,{position:i.value.position}),!0),s.value=a}function l(a,u){const c=K({},i.value,e.state,{forward:a,scroll:fs()});r(c.current,c,!0),r(a,K({},ar(s.value,a,null),{position:c.position+1},u),!1),s.value=a}return{location:s,state:i,push:l,replace:o}}function Uu(n){n=Tu(n);const e=Fu(n),t=Bu(n,e.state,e.location,e.replace);function s(r,o=!0){o||t.pauseListeners(),history.go(r)}const i=K({location:"",base:n,go:s,createHref:Ru.bind(null,n)},e,t);return Object.defineProperty(i,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(i,"state",{enumerable:!0,get:()=>e.state.value}),i}function zu(n){return n=location.host?n||location.pathname+location.search:"",n.includes("#")||(n+="#"),Uu(n)}let Pe=function(n){return n[n.Static=0]="Static",n[n.Param=1]="Param",n[n.Group=2]="Group",n}({});var pn=function(n){return n[n.Static=0]="Static",n[n.Param=1]="Param",n[n.ParamRegExp=2]="ParamRegExp",n[n.ParamRegExpEnd=3]="ParamRegExpEnd",n[n.EscapeNext=4]="EscapeNext",n}(pn||{});const Vu={type:Pe.Static,value:""},Gu=/[a-zA-Z0-9_]/;function Ju(n){if(!n)return[[]];if(n==="/")return[[Vu]];if(!n.startsWith("/"))throw new Error(`Invalid path "${n}"`);function e(g){throw new Error(`ERR (${t})/"${u}": ${g}`)}let t=pn.Static,s=t;const i=[];let r;function o(){r&&i.push(r),r=[]}let l=0,a,u="",c="";function f(){u&&(t===pn.Static?r.push({type:Pe.Static,value:u}):t===pn.Param||t===pn.ParamRegExp||t===pn.ParamRegExpEnd?(r.length>1&&(a==="*"||a==="+")&&e(`A repeatable param (${u}) must be alone in its segment. eg: '/:ids+.`),r.push({type:Pe.Param,value:u,regexp:c,repeatable:a==="*"||a==="+",optional:a==="*"||a==="?"})):e("Invalid state to consume buffer"),u="")}function p(){u+=a}for(;l<n.length;){if(a=n[l++],a==="\\"&&t!==pn.ParamRegExp){s=t,t=pn.EscapeNext;continue}switch(t){case pn.Static:a==="/"?(u&&f(),o()):a===":"?(f(),t=pn.Param):p();break;case pn.EscapeNext:p(),t=s;break;case pn.Param:a==="("?t=pn.ParamRegExp:Gu.test(a)?p():(f(),t=pn.Static,a!=="*"&&a!=="?"&&a!=="+"&&l--);break;case pn.ParamRegExp:a===")"?c[c.length-1]=="\\"?c=c.slice(0,-1)+a:t=pn.ParamRegExpEnd:c+=a;break;case pn.ParamRegExpEnd:f(),t=pn.Static,a!=="*"&&a!=="?"&&a!=="+"&&l--,c="";break;default:e("Unknown state");break}}return t===pn.ParamRegExp&&e(`Unfinished custom RegExp for param "${u}"`),f(),o(),i}const cr="[^/]+?",Ku={sensitive:!1,strict:!1,start:!0,end:!0};var Tn=function(n){return n[n._multiplier=10]="_multiplier",n[n.Root=90]="Root",n[n.Segment=40]="Segment",n[n.SubSegment=30]="SubSegment",n[n.Static=40]="Static",n[n.Dynamic=20]="Dynamic",n[n.BonusCustomRegExp=10]="BonusCustomRegExp",n[n.BonusWildcard=-50]="BonusWildcard",n[n.BonusRepeatable=-20]="BonusRepeatable",n[n.BonusOptional=-8]="BonusOptional",n[n.BonusStrict=.7000000000000001]="BonusStrict",n[n.BonusCaseSensitive=.25]="BonusCaseSensitive",n}(Tn||{});const qu=/[.+*?^${}()[\]/\\]/g;function Wu(n,e){const t=K({},Ku,e),s=[];let i=t.start?"^":"";const r=[];for(const u of n){const c=u.length?[]:[Tn.Root];t.strict&&!u.length&&(i+="/");for(let f=0;f<u.length;f++){const p=u[f];let g=Tn.Segment+(t.sensitive?Tn.BonusCaseSensitive:0);if(p.type===Pe.Static)f||(i+="/"),i+=p.value.replace(qu,"\\$&"),g+=Tn.Static;else if(p.type===Pe.Param){const{value:y,repeatable:w,optional:N,regexp:M}=p;r.push({name:y,repeatable:w,optional:N});const E=M||cr;if(E!==cr){g+=Tn.BonusCustomRegExp;try{`${E}`}catch(A){throw new Error(`Invalid custom RegExp for param "${y}" (${E}): `+A.message)}}let C=w?`((?:${E})(?:/(?:${E}))*)`:`(${E})`;f||(C=N&&u.length<2?`(?:/${C})`:"/"+C),N&&(C+="?"),i+=C,g+=Tn.Dynamic,N&&(g+=Tn.BonusOptional),w&&(g+=Tn.BonusRepeatable),E===".*"&&(g+=Tn.BonusWildcard)}c.push(g)}s.push(c)}if(t.strict&&t.end){const u=s.length-1;s[u][s[u].length-1]+=Tn.BonusStrict}t.strict||(i+="/?"),t.end?i+="$":t.strict&&!i.endsWith("/")&&(i+="(?:/|$)");const o=new RegExp(i,t.sensitive?"":"i");function l(u){const c=u.match(o),f={};if(!c)return null;for(let p=1;p<c.length;p++){const g=c[p]||"",y=r[p-1];f[y.name]=g&&y.repeatable?g.split("/"):g}return f}function a(u){let c="",f=!1;for(const p of n){(!f||!c.endsWith("/"))&&(c+="/"),f=!1;for(const g of p)if(g.type===Pe.Static)c+=g.value;else if(g.type===Pe.Param){const{value:y,repeatable:w,optional:N}=g,M=y in u?u[y]:"";if(Vn(M)&&!w)throw new Error(`Provided param "${y}" is an array but it is not repeatable (* or + modifiers)`);const E=Vn(M)?M.join("/"):M;if(!E)if(N)p.length<2&&(c.endsWith("/")?c=c.slice(0,-1):f=!0);else throw new Error(`Missing required param "${y}"`);c+=E}}return c||"/"}return{re:o,score:s,keys:r,parse:l,stringify:a}}function Yu(n,e){let t=0;for(;t<n.length&&t<e.length;){const s=e[t]-n[t];if(s)return s;t++}return n.length<e.length?n.length===1&&n[0]===Tn.Static+Tn.Segment?-1:1:n.length>e.length?e.length===1&&e[0]===Tn.Static+Tn.Segment?1:-1:0}function Uo(n,e){let t=0;const s=n.score,i=e.score;for(;t<s.length&&t<i.length;){const r=Yu(s[t],i[t]);if(r)return r;t++}if(Math.abs(i.length-s.length)===1){if(ur(s))return 1;if(ur(i))return-1}return i.length-s.length}function ur(n){const e=n[n.length-1];return n.length>0&&e[e.length-1]<0}const Zu={strict:!1,end:!0,sensitive:!1};function Qu(n,e,t){const s=Wu(Ju(n.path),t),i=K(s,{record:n,parent:e,children:[],alias:[]});return e&&!i.record.aliasOf==!e.record.aliasOf&&e.children.push(i),i}function Xu(n,e){const t=[],s=new Map;e=tr(Zu,e);function i(f){return s.get(f)}function r(f,p,g){const y=!g,w=dr(f);w.aliasOf=g&&g.record;const N=tr(e,f),M=[w];if("alias"in f){const A=typeof f.alias=="string"?[f.alias]:f.alias;for(const Y of A)M.push(dr(K({},w,{components:g?g.record.components:w.components,path:Y,aliasOf:g?g.record:w})))}let E,C;for(const A of M){const{path:Y}=A;if(p&&Y[0]!=="/"){const an=p.record.path,Z=an[an.length-1]==="/"?"":"/";A.path=p.record.path+(Y&&Z+Y)}if(E=Qu(A,p,N),g?g.alias.push(E):(C=C||E,C!==E&&C.alias.push(E),y&&f.name&&!hr(E)&&o(f.name)),zo(E)&&a(E),w.children){const an=w.children;for(let Z=0;Z<an.length;Z++)r(an[Z],E,g&&g.children[Z])}g=g||E}return C?()=>{o(C)}:$t}function o(f){if(Ho(f)){const p=s.get(f);p&&(s.delete(f),t.splice(t.indexOf(p),1),p.children.forEach(o),p.alias.forEach(o))}else{const p=t.indexOf(f);p>-1&&(t.splice(p,1),f.record.name&&s.delete(f.record.name),f.children.forEach(o),f.alias.forEach(o))}}function l(){return t}function a(f){const p=tf(f,t);t.splice(p,0,f),f.record.name&&!hr(f)&&s.set(f.record.name,f)}function u(f,p){let g,y={},w,N;if("name"in f&&f.name){if(g=s.get(f.name),!g)throw Xe(un.MATCHER_NOT_FOUND,{location:f});N=g.record.name,y=K(fr(p.params,g.keys.filter(C=>!C.optional).concat(g.parent?g.parent.keys.filter(C=>C.optional):[]).map(C=>C.name)),f.params&&fr(f.params,g.keys.map(C=>C.name))),w=g.stringify(y)}else if(f.path!=null)w=f.path,g=t.find(C=>C.re.test(w)),g&&(y=g.parse(w),N=g.record.name);else{if(g=p.name?s.get(p.name):t.find(C=>C.re.test(p.path)),!g)throw Xe(un.MATCHER_NOT_FOUND,{location:f,currentLocation:p});N=g.record.name,y=K({},p.params,f.params),w=g.stringify(y)}const M=[];let E=g;for(;E;)M.unshift(E.record),E=E.parent;return{name:N,path:w,params:y,matched:M,meta:ef(M)}}n.forEach(f=>r(f));function c(){t.length=0,s.clear()}return{addRoute:r,resolve:u,removeRoute:o,clearRoutes:c,getRoutes:l,getRecordMatcher:i}}function fr(n,e){const t={};for(const s of e)s in n&&(t[s]=n[s]);return t}function dr(n){const e={path:n.path,redirect:n.redirect,name:n.name,meta:n.meta||{},aliasOf:n.aliasOf,beforeEnter:n.beforeEnter,props:nf(n),children:n.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in n?n.components||null:n.component&&{default:n.component}};return Object.defineProperty(e,"mods",{value:{}}),e}function nf(n){const e={},t=n.props||!1;if("component"in n)e.default=t;else for(const s in n.components)e[s]=typeof t=="object"?t[s]:t;return e}function hr(n){for(;n;){if(n.record.aliasOf)return!0;n=n.parent}return!1}function ef(n){return n.reduce((e,t)=>K(e,t.meta),{})}function tf(n,e){let t=0,s=e.length;for(;t!==s;){const r=t+s>>1;Uo(n,e[r])<0?s=r:t=r+1}const i=sf(n);return i&&(s=e.lastIndexOf(i,s-1)),s}function sf(n){let e=n;for(;e=e.parent;)if(zo(e)&&Uo(n,e)===0)return e}function zo({record:n}){return!!(n.name||n.components&&Object.keys(n.components).length||n.redirect)}function pr(n){const e=Fn(ds),t=Fn(hi),s=Rn(()=>{const a=hn(n.to);return e.resolve(a)}),i=Rn(()=>{const{matched:a}=s.value,{length:u}=a,c=a[u-1],f=t.matched;if(!c||!f.length)return-1;const p=f.findIndex(Qe.bind(null,c));if(p>-1)return p;const g=gr(a[u-2]);return u>1&&gr(c)===g&&f[f.length-1].path!==g?f.findIndex(Qe.bind(null,a[u-2])):p}),r=Rn(()=>i.value>-1&&cf(t.params,s.value.params)),o=Rn(()=>i.value>-1&&i.value===t.matched.length-1&&jo(t.params,s.value.params));function l(a={}){if(af(a)){const u=e[hn(n.replace)?"replace":"push"](hn(n.to)).catch($t);return n.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>u),u}return Promise.resolve()}return{route:s,href:Rn(()=>s.value.href),isActive:r,isExactActive:o,navigate:l}}function rf(n){return n.length===1?n[0]:n}const of=to({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:pr,setup(n,{slots:e}){const t=rs(pr(n)),{options:s}=Fn(ds),i=Rn(()=>({[$r(n.activeClass,s.linkActiveClass,"router-link-active")]:t.isActive,[$r(n.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:t.isExactActive}));return()=>{const r=e.default&&rf(e.default(t));return n.custom?r:Po("a",{"aria-current":t.isExactActive?n.ariaCurrentValue:null,href:t.href,onClick:t.navigate,class:i.value},r)}}}),lf=of;function af(n){if(!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)&&!n.defaultPrevented&&!(n.button!==void 0&&n.button!==0)){if(n.currentTarget&&n.currentTarget.getAttribute){const e=n.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return n.preventDefault&&n.preventDefault(),!0}}function cf(n,e){for(const t in e){const s=e[t],i=n[t];if(typeof s=="string"){if(s!==i)return!1}else if(!Vn(i)||i.length!==s.length||s.some((r,o)=>r.valueOf()!==i[o].valueOf()))return!1}return!0}function gr(n){return n?n.aliasOf?n.aliasOf.path:n.path:""}const $r=(n,e,t)=>n??e??t,uf=to({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(n,{attrs:e,slots:t}){const s=Fn(Vs),i=Rn(()=>n.route||s.value),r=Fn(lr,0),o=Rn(()=>{let u=hn(r);const{matched:c}=i.value;let f;for(;(f=c[u])&&!f.components;)u++;return u}),l=Rn(()=>i.value.matched[o.value]);Dt(lr,Rn(()=>o.value+1)),Dt(Du,l),Dt(Vs,i);const a=pe();return Ne(()=>[a.value,l.value,n.name],([u,c,f],[p,g,y])=>{c&&(c.instances[f]=u,g&&g!==c&&u&&u===p&&(c.leaveGuards.size||(c.leaveGuards=g.leaveGuards),c.updateGuards.size||(c.updateGuards=g.updateGuards))),u&&c&&(!g||!Qe(c,g)||!p)&&(c.enterCallbacks[f]||[]).forEach(w=>w(u))},{flush:"post"}),()=>{const u=i.value,c=n.name,f=l.value,p=f&&f.components[c];if(!p)return mr(t.default,{Component:p,route:u});const g=f.props[c],y=g?g===!0?u.params:typeof g=="function"?g(u):g:null,N=Po(p,K({},y,e,{onVnodeUnmounted:M=>{M.component.isUnmounted&&(f.instances[c]=null)},ref:a}));return mr(t.default,{Component:N,route:u})||N}}});function mr(n,e){if(!n)return null;const t=n(e);return t.length===1?t[0]:t}const ff=uf;function df(n){const e=Xu(n.routes,n),t=n.parseQuery||Lu,s=n.stringifyQuery||or,i=n.history,r=it(),o=it(),l=it(),a=ia(ve);let u=ve;Ge&&n.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const c=Ss.bind(null,b=>""+b),f=Ss.bind(null,_u),p=Ss.bind(null,kt);function g(b,P){let R,I;return Ho(b)?(R=e.getRecordMatcher(b),I=P):I=b,e.addRoute(I,R)}function y(b){const P=e.getRecordMatcher(b);P&&e.removeRoute(P)}function w(){return e.getRoutes().map(b=>b.record)}function N(b){return!!e.getRecordMatcher(b)}function M(b,P){if(P=K({},P||a.value),typeof b=="string"){const $=Rs(t,b,P.path),_=e.resolve({path:$.path},P),v=i.createHref($.fullPath);return K($,_,{params:p(_.params),hash:kt($.hash),redirectedFrom:void 0,href:v})}let R;if(b.path!=null)R=K({},b,{path:Rs(t,b.path,P.path).path});else{const $=K({},b.params);for(const _ in $)$[_]==null&&delete $[_];R=K({},b,{params:f($)}),P.params=f(P.params)}const I=e.resolve(R,P),V=b.hash||"";I.params=c(p(I.params));const d=xu(s,K({},b,{hash:gu(V),path:I.path})),h=i.createHref(d);return K({fullPath:d,hash:V,query:s===or?Mu(b.query):b.query||{}},I,{redirectedFrom:void 0,href:h})}function E(b){return typeof b=="string"?Rs(t,b,a.value.path):K({},b)}function C(b,P){if(u!==b)return Xe(un.NAVIGATION_CANCELLED,{from:P,to:b})}function A(b){return Z(b)}function Y(b){return A(K(E(b),{replace:!0}))}function an(b,P){const R=b.matched[b.matched.length-1];if(R&&R.redirect){const{redirect:I}=R;let V=typeof I=="function"?I(b,P):I;return typeof V=="string"&&(V=V.includes("?")||V.includes("#")?V=E(V):{path:V},V.params={}),K({query:b.query,hash:b.hash,params:V.path!=null?{}:b.params},V)}}function Z(b,P){const R=u=M(b),I=a.value,V=b.state,d=b.force,h=b.replace===!0,$=an(R,I);if($)return Z(K(E($),{state:typeof $=="object"?K({},V,$.state):V,force:d,replace:h}),P||R);const _=R;_.redirectedFrom=P;let v;return!d&&yu(s,I,R)&&(v=Xe(un.NAVIGATION_DUPLICATED,{to:_,from:I}),qn(I,I,!0,!1)),(v?Promise.resolve(v):Jn(_,I)).catch(m=>ce(m)?ce(m,un.NAVIGATION_GUARD_REDIRECT)?m:be(m):J(m,_,I)).then(m=>{if(m){if(ce(m,un.NAVIGATION_GUARD_REDIRECT))return Z(K({replace:h},E(m.to),{state:typeof m.to=="object"?K({},V,m.to.state):V,force:d}),P||_)}else m=ke(_,I,!0,h,V);return _e(_,I,m),m})}function Gn(b,P){const R=C(b,P);return R?Promise.reject(R):Promise.resolve()}function me(b){const P=Fe.values().next().value;return P&&typeof P.runWithContext=="function"?P.runWithContext(b):b()}function Jn(b,P){let R;const[I,V,d]=ju(b,P);R=Es(I.reverse(),"beforeRouteLeave",b,P);for(const $ of I)$.leaveGuards.forEach(_=>{R.push(ye(_,b,P))});const h=Gn.bind(null,b,P);return R.push(h),Ln(R).then(()=>{R=[];for(const $ of r.list())R.push(ye($,b,P));return R.push(h),Ln(R)}).then(()=>{R=Es(V,"beforeRouteUpdate",b,P);for(const $ of V)$.updateGuards.forEach(_=>{R.push(ye(_,b,P))});return R.push(h),Ln(R)}).then(()=>{R=[];for(const $ of d)if($.beforeEnter)if(Vn($.beforeEnter))for(const _ of $.beforeEnter)R.push(ye(_,b,P));else R.push(ye($.beforeEnter,b,P));return R.push(h),Ln(R)}).then(()=>(b.matched.forEach($=>$.enterCallbacks={}),R=Es(d,"beforeRouteEnter",b,P,me),R.push(h),Ln(R))).then(()=>{R=[];for(const $ of o.list())R.push(ye($,b,P));return R.push(h),Ln(R)}).catch($=>ce($,un.NAVIGATION_CANCELLED)?$:Promise.reject($))}function _e(b,P,R){l.list().forEach(I=>me(()=>I(b,P,R)))}function ke(b,P,R,I,V){const d=C(b,P);if(d)return d;const h=P===ve,$=Ge?history.state:{};R&&(I||h?i.replace(b.fullPath,K({scroll:h&&$&&$.scroll},V)):i.push(b.fullPath,V)),a.value=b,qn(b,P,R,h),be()}let Kn;function nt(){Kn||(Kn=i.listen((b,P,R)=>{if(!Te.listening)return;const I=M(b),V=an(I,Te.currentRoute.value);if(V){Z(K(V,{replace:!0,force:!0}),I).catch($t);return}u=I;const d=a.value;Ge&&Pu(rr(d.fullPath,R.delta),fs()),Jn(I,d).catch(h=>ce(h,un.NAVIGATION_ABORTED|un.NAVIGATION_CANCELLED)?h:ce(h,un.NAVIGATION_GUARD_REDIRECT)?(Z(K(E(h.to),{force:!0}),I).then($=>{ce($,un.NAVIGATION_ABORTED|un.NAVIGATION_DUPLICATED)&&!R.delta&&R.type===Us.pop&&i.go(-1,!1)}).catch($t),Promise.reject()):(R.delta&&i.go(-R.delta,!1),J(h,I,d))).then(h=>{h=h||ke(I,d,!1),h&&(R.delta&&!ce(h,un.NAVIGATION_CANCELLED)?i.go(-R.delta,!1):R.type===Us.pop&&ce(h,un.NAVIGATION_ABORTED|un.NAVIGATION_DUPLICATED)&&i.go(-1,!1)),_e(I,d,h)}).catch($t)}))}let He=it(),$n=it(),nn;function J(b,P,R){be(b);const I=$n.list();return I.length?I.forEach(V=>V(b,P,R)):console.error(b),Promise.reject(b)}function le(){return nn&&a.value!==ve?Promise.resolve():new Promise((b,P)=>{He.add([b,P])})}function be(b){return nn||(nn=!b,nt(),He.list().forEach(([P,R])=>b?R(b):P()),He.reset()),b}function qn(b,P,R,I){const{scrollBehavior:V}=n;if(!Ge||!V)return Promise.resolve();const d=!R&&Au(rr(b.fullPath,0))||(I||!R)&&history.state&&history.state.scroll||null;return Rt().then(()=>V(b,P,d)).then(h=>h&&Eu(h)).catch(h=>J(h,b,P))}const En=b=>i.go(b);let Be;const Fe=new Set,Te={currentRoute:a,listening:!0,addRoute:g,removeRoute:y,clearRoutes:e.clearRoutes,hasRoute:N,getRoutes:w,resolve:M,options:n,push:A,replace:Y,go:En,back:()=>En(-1),forward:()=>En(1),beforeEach:r.add,beforeResolve:o.add,afterEach:l.add,onError:$n.add,isReady:le,install(b){b.component("RouterLink",lf),b.component("RouterView",ff),b.config.globalProperties.$router=Te,Object.defineProperty(b.config.globalProperties,"$route",{enumerable:!0,get:()=>hn(a)}),Ge&&!Be&&a.value===ve&&(Be=!0,A(i.location).catch(I=>{}));const P={};for(const I in ve)Object.defineProperty(P,I,{get:()=>a.value[I],enumerable:!0});b.provide(ds,Te),b.provide(hi,Kr(P)),b.provide(Vs,a);const R=b.unmount;Fe.add(b),b.unmount=function(){Fe.delete(b),Fe.size<1&&(u=ve,Kn&&Kn(),Kn=null,a.value=ve,Be=!1,nn=!1),R()}}};function Ln(b){return b.reduce((P,R)=>P.then(()=>me(R)),Promise.resolve())}return Te}function hf(){return Fn(ds)}function hs(n){return Fn(hi)}const Gs=[{text:"入门",items:[{text:"概述",link:"/v1.0/"},{text:"词法结构",link:"/v1.0/lexical"},{text:"类型系统",link:"/v1.0/types"},{text:"变量与赋值",link:"/v1.0/variables"},{text:"表达式与运算符",link:"/v1.0/expressions"},{text:"判断逻辑",link:"/v1.0/control-flow"},{text:"词条系统",link:"/v1.0/entries"},{text:"JSON 数据处理",link:"/v1.0/json"},{text:"面向对象编程",link:"/v1.0/oop"},{text:"模块与引入",link:"/v1.0/modules"},{text:"函数",link:"/v1.0/functions"},{text:"内置函数",link:"/v1.0/flow-output",children:[{text:"回调",link:"/v1.0/flow-callback"},{text:"主回调",link:"/v1.0/flow-main-callback"},{text:"打印",link:"/v1.0/output-print"},{text:"服务器",link:"/v1.0/server"},{text:"对象创建",link:"/v1.0/object"},{text:"字符串",link:"/v1.0/string"},{text:"数学",link:"/v1.0/math"},{text:"网络",link:"/v1.0/network"},{text:"类型",link:"/v1.0/type"},{text:"文件",link:"/v1.0/file"},{text:"画布",link:"/v1.0/canvas"}]}]}];function Vo(n){const e=[];for(const t of n)t.link&&!t.children?e.push(t):t.children&&(t.link&&e.push({text:t.text,link:t.link}),e.push(...Vo(t.children)));return e}const It=Gs.flatMap(n=>Vo(n.items));function pf(){const n=hs(),e=Rn(()=>It.findIndex(i=>i.link.split("#")[0]===n.path)),t=Rn(()=>e.value>0?It[e.value-1]:null),s=Rn(()=>e.value<It.length-1?It[e.value+1]:null);return{prev:t,next:s}}const De=(n,e)=>{const t=n.__vccOpts||n;for(const[s,i]of e)t[s]=i;return t},gf={class:"sidebar-nav"},$f={class:"sidebar-section-title"},mf=["href"],_f=["href"],bf={key:1,class:"sidebar-section-title"},vf=["href"],xf={class:"sidebar-sub-title"},yf={class:"sidebar-sub-group"},wf=["href"],kf=["href"],Tf={key:2,class:"sidebar-sub-title"},Sf={__name:"Sidebar",setup(n){const e=hs();function t(i){const r=i.indexOf("#"),o=r>=0?i.substring(0,r):i,l=r>=0?i.substring(r):"";return"#"+o+l}function s(i){const[r,o]=i.split("#");return o?e.path===r&&e.hash==="#"+o:e.path===r&&!e.hash}return(i,r)=>(F(),U("nav",gf,[(F(!0),U(cn,null,Ee(hn(Gs),(o,l)=>(F(),U("div",{key:o.text,class:Hn(["sidebar-group",{"has-divider":l<hn(Gs).length-1}])},[z("p",$f,bn(o.text),1),(F(!0),U(cn,null,Ee(o.items,a=>(F(),U(cn,{key:a.link||a.text},[a.link&&!a.children?(F(),U("a",{key:0,href:t(a.link),class:Hn(["sidebar-link","sidebar-link-sub",{active:s(a.link)}])},bn(a.text),11,mf)):(F(),U(cn,{key:1},[a.link?(F(),U("a",{key:0,href:t(a.link),class:Hn(["sidebar-section-title","sidebar-section-link",{active:s(a.link)}])},bn(a.text),11,_f)):(F(),U("p",bf,bn(a.text),1)),(F(!0),U(cn,null,Ee(a.children||[],u=>(F(),U(cn,{key:u.link||u.text},[u.link&&!u.children?(F(),U("a",{key:0,href:t(u.link),class:Hn(["sidebar-link","sidebar-link-sub",{active:s(u.link)}])},bn(u.text),11,vf)):u.children?(F(),U(cn,{key:1},[z("p",xf,bn(u.text),1),z("div",yf,[(F(!0),U(cn,null,Ee(u.children,c=>(F(),U(cn,{key:c.link||c.text},[c.link&&!c.children?(F(),U("a",{key:0,href:t(c.link),class:Hn(["sidebar-link","sidebar-link-fn",{active:s(c.link)}])},bn(c.text),11,wf)):c.children&&c.link?(F(),U("a",{key:1,href:t(c.link),class:Hn(["sidebar-link","sidebar-link-fn",{active:s(c.link)}])},bn(c.text),11,kf)):c.children?(F(),U("p",Tf,bn(c.text),1)):Ie("",!0)],64))),128))])],64)):Ie("",!0)],64))),128))],64))],64))),128))],2))),128))]))}},Rf=De(Sf,[["__scopeId","data-v-3b852181"]]),Of={key:0,class:"right-nav"},Ef=["onClick"],Pf={__name:"RightNav",setup(n){const e=hs(),t=hf(),s=pe([]),i=pe("");let r=[],o=!1;function l(){const f=document.querySelector(".markdown-body");if(!f){s.value=[],r=[];return}r=Array.from(f.querySelectorAll("h2[id], h3[id]")),s.value=r.map(p=>({id:p.id,text:p.textContent,tag:p.tagName}))}function a(f){t.replace({hash:"#"+f});const p=document.getElementById(f);p&&p.scrollIntoView({behavior:"smooth",block:"start"})}function u(){if(!r.length)return;let f=r[0].id;for(const p of r)p.getBoundingClientRect().top<=120&&(f=p.id);i.value=f}function c(){o||(requestAnimationFrame(()=>{u(),o=!1}),o=!0)}return Ne(()=>e.path,()=>Rt(l),{immediate:!0}),oo(()=>window.addEventListener("scroll",c,{passive:!0})),ci(()=>window.removeEventListener("scroll",c)),(f,p)=>s.value.length?(F(),U("nav",Of,[(F(!0),U(cn,null,Ee(s.value,g=>(F(),U("a",{key:g.id,href:"javascript:void(0)",class:Hn(["right-nav-link",{active:i.value===g.id},g.tag==="H3"?"sub":""]),onClick:y=>a(g.id)},bn(g.text),11,Ef))),128))])):Ie("",!0)}},Af=De(Pf,[["__scopeId","data-v-aef8329c"]]),Go=`# 画布
...
[画布 →](./canvas)
`,dl='# 类型系统\n\nNR 的类型系统是**动态、弱类型**的——变量无需声明类型，运行时自动确定。值在大多数场景下会自动在文本和数字之间转换，`==` 运算符做宽松比较。本章涵盖 NR 中的原始数据类型（没有对象/数组，只有文本、数字和布尔值），以及类型检测、判断和转换操作。\n\nNR 的 `Value` 不是简单的"字符串或数字"二分法——它是一个完整的枚举类型，内部由 Rust 的 `enum` 实现，每个变体携带不同的数据表示。这意味着两个值即使"看起来一样"，也可能属于不同类型，进而影响相等性比较和运算行为。\n\n## 类型一览\n\nNR 变量存储的是**带类型的值**（`Value`），而非纯字符串。类型在赋值时自动推断。\n\n| 类型 | 示例 | 说明 |\n|------|------|------|\n| `整数` | `1`, `-5`, `100` | 64 位有符号整数 |\n| `浮点` | `1.5`, `-0.5`, `3.14` | 64 位浮点数 |\n| `字符串` | `"hello"`, `abc` | 字符串 |\n| `布尔` | `true`, `false` | 布尔值 |\n| `空` | `null` | 空值 |\n| `对象` | — | 对象引用（`$new$` 返回） |\n| `函数` | — | 函数指针（`%func@name%` 返回） |\n\n- `count:5` → Int，`name:Alice` → Str\n- 但 `[...]` 数学表达式运算结果保留数值类型\n- `$new$` 返回值为对象类型\n- `%func@key%` 返回值为函数类型\n\n## 各类型详解\n\n### 整数（Int）\n\n64 位有符号整数（`i64`），范围约为 `-9.2×10¹⁸` 到 `9.2×10¹⁸`。\n\n```\na:42\nb:-100\nc:0\n\n%TYPE@a%   → "整数"\n%TYPE@b%   → "整数"\n%TYPE@c%   → "整数"\n```\n\n整数字面量不能包含小数点、前导零（会被当作十进制解析）或科学计数法。\n\n### 浮点（Float）\n\n64 位浮点数（`f64`），符合 IEEE 754 标准。\n\n```\npi:3.14\nneg:-0.5\nbig:1.5e10\n\n%TYPE@pi%    → "浮点"\n%TYPE@neg%   → "浮点"\n%TYPE@big%   → "浮点"\n```\n\n浮点数和整数在比较（`==`）时**视为不同**：`1 == 1.0` 在严格比较下为假。浮点运算可能产生精度误差，这是 IEEE 754 浮点数的固有特性。\n\n### 字符串（Str）\n\nUTF-8 编码的字符串。不带特殊前缀的纯文本字面量自动判定为字符串。\n\n```\nname:Alice\ngreeting:Hello World\nempty:""              ← 显式空字符串\n\n%TYPE@name%       → "字符串"\n%TYPE@greeting%   → "字符串"\n```\n\n注意：`greeting:Hello World` 中空格不需要转义（赋值操作符 `:` 之后直到行尾均为值部分）。但在 `$...$` 参数传递中空格会分割参数，参见 [词法结构 § 转义规则](./lexical)。\n\n### 布尔（Bool）\n\n只有 `true` 和 `false` 两个字面量。\n\n```\nflag:true\ndone:false\n\n%TYPE@flag%   → "布尔"\n%TYPE@done%   → "布尔"\n```\n\n布尔值可直接用于条件表达式（[判断逻辑](./control-flow)），也可参与逻辑运算（[表达式 § 逻辑运算符](./expressions)）。\n\n### 空值（Null）\n\n表示"无值"或"未设置"。仅有一种字面量：`null`。\n\n```\ndata:null\n\n%TYPE@data%   → "空"\n```\n\n`null` 与空字符串 `""` 不同：`null` 是一个独立的类型标记，而 `""` 是值为空的字符串。在条件判断中，`null` 被视为假值。\n\n### 对象（Object）\n\n由 `$new$` 创建，内部持有一个 JSON 对象引用。对象类型值不可直接输出为文本，需通过 `%TYPE@` 查询或使用 JSON 操作符访问其字段。\n\n```\nobj:$new$ {"key":"val"}\n\n%TYPE@obj%   → "对象"\n```\n\n`$new$` 不是赋值操作符——它是创建新对象的内置函数，参见 [词条系统](./entries)。\n\n### 函数（Func）\n\n由 `%func@name%` 获取，存储的是函数指针/引用，而非函数体文本。\n\n```\nptr:%func@greet%\n\n%TYPE@ptr%   → "函数"\n```\n\n函数类型值主要用途：作为回调传入其他函数，或在需要延迟调用时暂存。\n\n## 类型特性对照\n\n| 类型 | 可修改（`+:` 等） | 宽松相等 `==` | 严格相等 `===` | 数值排序 `>` `<` |\n|------|-------------------|--------------|---------------|------------------|\n| Int | ✅ 算术运算 | 字符串化后比较 | 值和类型均相同 | ✅ 按数值 |\n| Float | ✅ 算术运算 | 字符串化后比较 | 值和类型均相同 | ✅ 按数值 |\n| Str | ✅ 串接 | 内容比较（含类型转换） | 值和类型均相同 | ❌ 无意义 |\n| Bool | ❌ | 字符串化后比较 | 值和类型均相同 | ❌ |\n| Null | ❌ | — | — | ❌ |\n| Object | — | 引用相等 | 引用相等 | ❌ |\n| Func | ❌ | 引用相等 | 引用相等 | ❌ |\n\n## 类型强制转换与兼容性\n\n### 算术上下文中的类型转换\n\n在 `[...]` 数学表达式中，操作数的类型决定了运算结果的类型：\n\n```\n// 整数运算 → 整数\na:[1+2]          → Int(3)\n\n// 浮点数参与 → 浮点\nb:[1+2.0]        → Float(3.0)\nc:[3.14*2]       → Float(6.28)\n\n// 字符串自动转为数值参与运算\nd:["3"+2]        → Int(5)  或报错\n```\n\n- 整数 + 整数 → 整数\n- 任一操作数为浮点 → 结果提升为浮点\n- 字符串操作数：尝试按数值解析，失败则报错\n\n### 比较上下文中的类型转换\n\n`==`（宽松相等）会将两边值转为字符串后比较：\n\n```\n1 == "1"       → true（都转为 "1"）\n1 == 1.0       → true（都转为 "1"，但用 === 则为 false）\ntrue == "true" → true\nnull == ""     → false（"null" ≠ ""）\n```\n\n`===`（严格相等）要求**类型和值都相同**：\n\n```\n1 === 1       → true\n1 === 1.0     → false（Int vs Float）\n"1" === 1     → false（Str vs Int）\ntrue === true → true\n```\n\n**注意事项：**\n\n- 条件判断中（如 `如果:`），**推荐使用严格比较 `===`** 以避免意外的类型转换带来的误判。\n- 数值比较（`>`、`<`、`>=`、`<=`）要求两边均为数值类型（Int 或 Float），字符串会被尝试解析为数值。\n- `0`、`""`、`null`、`false` 在布尔上下文中均为"假"，但它们彼此之间**不相等**（除了 `0 == false` 会因为字符串化为 `"0" == "false"` 而返回假）。\n\n## 类型查询 `%TYPE@var%`\n\n```\ncount:5\nname:Alice\n\n%TYPE@count%   → "整数"\n%TYPE@name%    → "字符串"\n```\n\n未设置变量返回空字符串。\n',hl='# 变量与赋值\n\n变量是 NR 中最基本的存储单元。本章涵盖变量的作用域规则、赋值操作符的语义差异、条件赋值、内置变量以及文本切片等核心机制。理解变量系统是正确组织数据流和控制状态的前提，与[类型系统](./types)和[表达式](./expressions)密切协作。\n\nNR 的赋值不是简单的"文本替换"——它会根据操作符和值的内容自动推断类型（[§ 类型一览](./types)），并在不同作用域间管理变量生命周期。\n\n## 作用域\n\n| 类型 | 作用域 | 说明 |\n|------|--------|------|\n| 局部变量 | 当前上下文 | 子上下文创建时重置 |\n| 全局变量 | 所有子上下文 | 子上下文创建时克隆共享 |\n\n### 作用域选择规则\n\nNR 根据**赋值位置**自动决定变量的作用域：\n\n- **头部区域（第一个空行之前）**中赋值的变量为**全局变量**。这些变量在词条触发、函数调用等子上下文中可被读取和修改。\n- **词条、函数、循环体内部**中首次赋值的变量为**局部变量**。局部变量仅在当前执行上下文中可见，进入子函数或子上下文时会创建独立的副本。\n\n```\n// 头部区域 → 全局变量，整个文件可见\ncounter:0\nbase_url:https://api.example.com\n\n// ← 空行分隔\n\n// 词条内部 → 局部变量\n开始\ntemp:%counter%             ← 可读全局变量\ncounter+:[%counter%+1]   ← 可修改全局变量\nlocal_var:临时值            ← 局部变量，外部不可见\n```\n\n### 作用域注意事项\n\n- 全局变量在**每次词条触发时保持其值**，不会重置。这使得 `counter+:1` 可以在多次触发间累加。\n- 子上下文（如 `$call$` 函数调用）中读取全局变量时，获取的是**当前快照值**；修改全局变量会影响父上下文。\n- 在同一作用域中，对已存在的变量再次使用 `:` 赋值会**覆盖**其值和类型。\n\n## 赋值操作符\n\n| 操作符 | 示例 | 语义 |\n|--------|------|------|\n| `:` | `name:Alice` | **自适应赋值**：值尝试解析为 JSON 字面量（数字/布尔/null/对象/数组），不成则当字符串 |\n| `::` | `greeting::Hello` | **纯文本赋值**：值始终作为字符串，不解析 JSON |\n| `+:` | `score+:5` | 自增 / JSON追加 / 字符串拼接 |\n| `-:` | `count-:1` | 自减 |\n| `*:` | `val*:2` | 乘法 / 字符串重复 |\n| `/:` | `val/:2` | 除法 |\n| `%:` | `val%:3` | 取余 |\n\n> 只有 ASCII 半角冒号 `:`（U+003A）被识别为赋值操作符。中文全角冒号 `：`（U+FF1A）**不是**操作符，在文本中直接原样输出。\n\n### `:`（自适应赋值）vs `::`（纯文本赋值）\n\n这是 NR 中最容易被忽视但最重要的语义差异：\n\n| 特性 | `:`（单冒号） | `::`（双冒号） |\n|------|-------------|---------------|\n| 值解析 | 尝试解析为 JSON 字面量 | 始终作为字符串 |\n| `1` | Int(1) | Str("1") |\n| `1.5` | Float(1.5) | Str("1.5") |\n| `true` | Bool(true) | Str("true") |\n| `null` | Null | Str("null") |\n| `{"a":1}` | JSON 对象 | Str("{\'a\':1}") |\n| `Alice` | Str("Alice") | Str("Alice") |\n\n```\n// : 自适应赋值——数字被识别为数值类型\ncount:100\n%TYPE@count%   → "整数"\n\n// :: 纯文本赋值——永远是字符串\nid::100\n%TYPE@id%      → "字符串"\n\n// 实际影响：数学运算\n[%count%+1]   → 101   （Int 运算）\n// [%id%+1]   → 报错 / 意外（字符串不能加）\n```\n\n### 何时使用 `::`\n\n- 存储**编号、ID、电话号**等不应被当作数字处理的值（如 `id::001` 不会丢掉前导零）\n- 存储可能是数字字面量的**字符串**（如文件名"123.json"）\n- 需要精确控制类型以避免意外数值运算的场景\n\n**注意事项：** 当你对 `::` 赋值的变量使用 `+:`（自增）时，由于值是字符串，`+:` 会执行**字符串拼接**而非数学加法。这可能不是你想要的行为。\n\n## 条件赋值 `?:`\n\n```\nkey:@a?:@b?:fallback\n```\n\n从左到右尝试读取 JSON 路径，第一个非空、非 null、非 false 的值被赋值。\n\n## 内置变量\n\n| 变量 | 说明 |\n|------|------|\n| `%空格%` | 空格 `" "` |\n| `%换行%` | 换行 `"\\n"` |\n| `%时间戳%` | Unix 时间戳（秒） |\n| `%毫秒时间戳%` | Unix 时间戳（毫秒） |\n| `%微秒时间戳%` | Unix 时间戳（微秒） |\n| `%纳秒时间戳%` | Unix 时间戳（纳秒） |\n| `%时间%` | 格式化本地时间 `YYYY-MM-DD HH:MM:SS`（UTC+8） |\n| `%随机数M-N%` | 随机整数 `[M, N]`（含两端） |\n| `%!key%` | 布尔取反：空/0/false/null → `"1"`，否则 → `"0"` |\n| `%?key%` | 可选变量：不存在返回空字符串 |\n| `%++var%` | 自增：先自增再返回递增后的值（变量不存在默认 0） |\n| `%--var%` | 自减：先自减再返回递减后的值（变量不存在默认 0） |\n| `%参数%` | 所有参数列表（JSON 数组） |\n| `%参数0%` | 函数名 / 完整触发名 |\n| `%参数N%` | 第 N 个参数 |\n| `%self%` | 当前对象名 / 函数名 |\n| `%触发%` | 当前触发词 |\n| `%行数%` | 当前行号（1-based） |\n| `%B64@key%` | Base64 解码 |\n| `%URL编码@key%` | URL 编码 |\n| `%len@key%` / `%长度@key%` | 返回变量值的字符长度 |\n| `%@var[切片]%` / `@var[切片]` | 符号截取文本（Python 风格切片，支持 `%` 快捷两种写法） |\n| `%func@key%` | 获取函数指针（类型为"函数"，display 为函数名） |\n| `%包名.变量%` | 跨包变量引用（如 `%mypkg.x%` 读取引入包的头部变量） |\n\n### 内置变量的生命周期\n\n内置变量（`%xxx%`）与用户定义的变量在生命周期上有本质区别：\n\n- **即时求值**：每次读取内置变量（如 `%时间戳%`）时，都会**重新计算**当前值。它不存储"快照"，而是每次调用运行时函数。\n- **不可赋值**：不能对内置变量使用 `:` 赋值——`%时间戳%:123` 是无效的。\n- **临时性**：内置变量的值仅在当前表达式求值瞬间有效。如需多次使用同一值，应将其赋值给用户变量：`ts:%时间戳%`。\n- **参数变量 `%参数N%`** 在函数体内是局部变量，函数返回后失效；在词条触发时反映的是触发参数。\n\n```\n// 推荐做法：缓存内置变量\nstart_time:%毫秒时间戳%\n// ... 多步操作 ...\nelapsed:[%毫秒时间戳%-%start_time%]   ← 两次读取产生不同值，差值有意义\n```\n\n## 符号截取文本 `%@var[切片]%` / `@var[切片]`\n\n内联文本切片语法，对变量值按字符（`.chars()`）进行 Python 风格切片。中文、emoji 等多字节字符均算一个字符。\n\n**两种写法等价**：\n\n- `%@var[切片]%` —— 标准写法，需 `%` 包裹\n- `@var[切片]` —— 快捷写法，无需 `%` 包裹，直接解析\n\n**基本语法**：`@变量名[start:end:step]`\n\n| 写法 | 含义 |\n|------|------|\n| `@a[1:]` | 从第 2 个字符到末尾 |\n| `@a[1:3]` | 第 2 ~ 3 个字符（index 1 和 2，不含 3） |\n| `@a[:3]` | 前 3 个字符 |\n| `@a[-3:]` | 末尾 3 个字符 |\n| `@a[1:6:2]` | index 1~5，步长 2（隔一个取一个） |\n| `@a[::2]` | 从头到尾，步长 2 |\n| `@a[::-1]` | 反转字符串 |\n\n```\nname:你好世界NR语言\n\n%name%             → "你好世界NR语言"\n%len@name%         → "8"\n\n// 标准写法\n%@name[1:]%        → "好世界NR语言"\n%@name[1:3]%       → "好世"\n%@name[:2]%        → "你好"\n%@name[-3:]%       → "R语言"\n%@name[::-1]%      → "言语RN界世好你"\n\n// 快捷写法（无需 % 包裹）\n@name[1:]          → "好世界NR语言"\n@name[1:3]         → "好世"\n@name[:2]          → "你好"\n@name[-3:]         → "R语言"\n@name[::-1]        → "言语RN界世好你"\n```\n\n> 快捷写法 `@var[切片]` 通过方括号内含 `:` 来与 JSON 路径导航（`@json[key]`）区分。不含 `:` 的方括号仍走 JSON 路径逻辑。\n',Cf=Object.assign({"../../v1.0/canvas.md":Go,"../../v1.0/control-flow.md":Jo,"../../v1.0/entries.md":Ko,"../../v1.0/expressions.md":qo,"../../v1.0/file.md":Wo,"../../v1.0/flow-callback.md":Yo,"../../v1.0/flow-main-callback.md":Zo,"../../v1.0/flow-output.md":Qo,"../../v1.0/functions.md":Xo,"../../v1.0/index.md":nl,"../../v1.0/json.md":el,"../../v1.0/lexical.md":tl,"../../v1.0/math.md":sl,"../../v1.0/modules.md":il,"../../v1.0/network.md":rl,"../../v1.0/object.md":ol,"../../v1.0/oop.md":ll,"../../v1.0/output-print.md":al,"../../v1.0/server.md":cl,"../../v1.0/string.md":ul,"../../v1.0/type.md":fl,"../../v1.0/types.md":dl,"../../v1.0/variables.md":hl}),pl=[];for(const[n,e]of Object.entries(Cf)){const t=n.match(/v1\.0\/(.+)\.md$/);if(!t)continue;let s=t[1];const i=s==="index"?"/v1.0/":`/v1.0/${s}`,r=e.match(/^#\s+(.+)$/m),o=r?r[1]:i,l=[],a=/^#{2,3}\s+(.+)$/gm;let u;for(;(u=a.exec(e))!==null;)l.push(u[1]);pl.push({path:i,title:o,headings:l,content:e})}function Nf(n){if(!n.trim())return[];const e=n.toLowerCase().split(/\s+/).filter(Boolean);return pl.filter(t=>{const s=(t.title+" "+t.headings.join(" ")+" "+t.content).toLowerCase();return e.every(i=>s.includes(i))}).map(t=>{const s=t.content.toLowerCase().indexOf(e[0]),i=Math.max(0,s-40),r=Math.min(t.content.length,s+120);let o=t.content.slice(i,r).replace(/\n+/g," ");return i>0&&(o="..."+o),r<t.content.length&&(o+="..."),{...t,snippet:o}}).slice(0,10)}const If={class:"search-modal"},Lf={class:"search-input-wrap"},Mf={key:0,class:"search-results"},Df=["onClick","onMouseenter"],jf={class:"result-title"},Hf={class:"result-path"},Bf={class:"result-snippet"},Ff={key:1,class:"search-empty"},Uf={__name:"SearchModal",emits:["close"],setup(n,{emit:e}){const t=e,s=pe(""),i=pe([]),r=pe(0),o=pe(null);Rt(()=>{var u;return(u=o.value)==null?void 0:u.focus()}),Ne(s,u=>{i.value=Nf(u),r.value=0});function l(u){window.location.hash="#"+u,t("close")}function a(u){u.key==="Escape"?t("close"):u.key==="ArrowDown"?(u.preventDefault(),r.value=Math.min(r.value+1,i.value.length-1)):u.key==="ArrowUp"?(u.preventDefault(),r.value=Math.max(r.value-1,0)):u.key==="Enter"&&i.value[r.value]&&l(i.value[r.value].path)}return(u,c)=>(F(),U("div",{class:"search-overlay",onClick:c[2]||(c[2]=Qc(f=>t("close"),["self"]))},[z("div",If,[z("div",Lf,[c[3]||(c[3]=z("svg",{class:"search-icon",viewBox:"0 0 24 24",width:"20",height:"20",fill:"none",stroke:"currentColor","stroke-width":"2"},[z("circle",{cx:"11",cy:"11",r:"8"}),z("path",{d:"m21 21-4.35-4.35"})],-1)),ga(z("input",{ref_key:"inputEl",ref:o,"onUpdate:modelValue":c[0]||(c[0]=f=>s.value=f),class:"search-input",placeholder:"搜索文档...",onKeydown:a},null,544),[[Wc,s.value]]),z("button",{class:"search-close",onClick:c[1]||(c[1]=f=>t("close"))},"Esc")]),i.value.length?(F(),U("div",Mf,[(F(!0),U(cn,null,Ee(i.value,(f,p)=>(F(),U("div",{key:f.path,class:Hn(["search-result",{active:p===r.value}]),onClick:g=>l(f.path),onMouseenter:g=>r.value=p},[z("div",jf,bn(f.title),1),z("div",Hf,bn(f.path),1),z("div",Bf,bn(f.snippet),1)],42,Df))),128))])):s.value?(F(),U("div",Ff," 未找到相关结果 ")):Ie("",!0)])]))}},zf=De(Uf,[["__scopeId","data-v-66966829"]]),Vf=["value"],Gf="/v1.0/",Jf={__name:"VersionSwitcher",setup(n){const e=[{label:"v1.0",path:"/v1.0/"}];function t(s){window.location.hash="#"+s.target.value}return(s,i)=>(F(),U("select",{class:"version-select",value:Gf,onChange:t},[(F(),U(cn,null,Ee(e,r=>z("option",{key:r.path,value:r.path},bn(r.label),9,Vf)),64))],32))}},Kf=De(Jf,[["__scopeId","data-v-8cf198cc"]]),qf={class:"header"},Wf=["title"],Yf={key:0,viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},Zf={key:1,viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},Qf={class:"main"},Xf={class:"sidebar"},nd={class:"content"},ed={key:0,class:"right-aside"},td={__name:"App",setup(n){const{isDark:e,toggle:t}=iu(),s=pe(!1);function i(r){(r.ctrlKey||r.metaKey)&&r.key==="k"&&(r.preventDefault(),s.value=!0)}return(r,o)=>{const l=Ia("router-view");return F(),U(cn,null,[z("div",{class:"app",onKeydown:i},[z("header",qf,[o[6]||(o[6]=z("a",{class:"logo",href:"#/"},"NR 语言参考手册",-1)),gn(Kf),o[7]||(o[7]=z("div",{class:"header-spacer"},null,-1)),z("button",{class:"icon-btn",onClick:o[0]||(o[0]=a=>s.value=!0),title:"搜索 (Ctrl+K)"},[...o[3]||(o[3]=[z("svg",{viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},[z("circle",{cx:"11",cy:"11",r:"8"}),z("path",{d:"m21 21-4.35-4.35"})],-1)])]),z("button",{class:"icon-btn",onClick:o[1]||(o[1]=(...a)=>hn(t)&&hn(t)(...a)),title:hn(e)?"浅色模式":"深色模式"},[hn(e)?(F(),U("svg",Yf,[...o[4]||(o[4]=[z("circle",{cx:"12",cy:"12",r:"5"},null,-1),z("path",{d:"M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"},null,-1)])])):(F(),U("svg",Zf,[...o[5]||(o[5]=[z("path",{d:"M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"},null,-1)])]))],8,Wf)]),z("div",Qf,[z("aside",Xf,[gn(Rf)]),z("main",nd,[gn(l)]),r.$route.path!=="/"?(F(),U("aside",ed,[gn(Af)])):Ie("",!0)])],32),s.value?(F(),So(zf,{key:0,onClose:o[2]||(o[2]=a=>s.value=!1)})):Ie("",!0)],64)}}},sd=De(td,[["__scopeId","data-v-a715b592"]]),id={},rd={class:"home"};function od(n,e){return F(),U("div",rd,[...e[0]||(e[0]=[hc('<section class="hero" data-v-f50f9c69><h1 class="hero-name" data-v-f50f9c69>NR 语言</h1><p class="hero-text" data-v-f50f9c69>参考手册</p><p class="hero-tagline" data-v-f50f9c69>Nebula 词库引擎的领域特定语言</p><a class="hero-btn" href="#/v1.0/" data-v-f50f9c69>开始阅读</a></section><section class="features" data-v-f50f9c69><div class="feature" data-v-f50f9c69><h3 data-v-f50f9c69>简洁语法</h3><p data-v-f50f9c69>NR 采用直观的触发词-响应模式，头部空行分隔结构，让词库编写像写笔记一样自然。</p></div><div class="feature" data-v-f50f9c69><h3 data-v-f50f9c69>动态类型</h3><p data-v-f50f9c69>支持整数、浮点、字符串、布尔、对象、函数等类型，运行时自动推断，灵活高效。</p></div><div class="feature" data-v-f50f9c69><h3 data-v-f50f9c69>模块化</h3><p data-v-f50f9c69>支持文件/目录引入、跨包调用、热更新，轻松构建大型自动化文本生成系统。</p></div></section><section class="tools" data-v-f50f9c69><h2 data-v-f50f9c69>工具</h2><p data-v-f50f9c69><a href="./vscode-nr/nr-language-0.1.0.vsix" data-v-f50f9c69>下载 VS Code 语法高亮扩展 (.vsix)</a></p><p data-v-f50f9c69>安装：VS Code → <code data-v-f50f9c69>Ctrl+Shift+P</code> → &quot;Install from VSIX...&quot; → 选择下载的文件</p><p class="vsix-notice" data-v-f50f9c69>注意：此插件仅提供最新版本，不保证历史版本兼容。</p></section><section class="info" data-v-f50f9c69><h2 data-v-f50f9c69>项目信息</h2><ul data-v-f50f9c69><li data-v-f50f9c69><strong data-v-f50f9c69>引擎</strong>：Nebula 词库引擎</li><li data-v-f50f9c69><strong data-v-f50f9c69>实现语言</strong>：Rust</li><li data-v-f50f9c69><strong data-v-f50f9c69>许可证</strong>：Copyright (c) 2025 保留所有权利</li></ul></section>',4)])])}const ld=De(id,[["render",od],["__scopeId","data-v-f50f9c69"]]);function pi(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let je=pi();function gl(n){je=n}const $l=/[&<>"']/,ad=new RegExp($l.source,"g"),ml=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,cd=new RegExp(ml.source,"g"),ud={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},_r=n=>ud[n];function Cn(n,e){if(e){if($l.test(n))return n.replace(ad,_r)}else if(ml.test(n))return n.replace(cd,_r);return n}const fd=/(^|[^\[])\^/g;function tn(n,e){let t=typeof n=="string"?n:n.source;e=e||"";const s={replace:(i,r)=>{let o=typeof r=="string"?r:r.source;return o=o.replace(fd,"$1"),t=t.replace(i,o),s},getRegex:()=>new RegExp(t,e)};return s}function br(n){try{n=encodeURI(n).replace(/%25/g,"%")}catch{return null}return n}const mt={exec:()=>null};function vr(n,e){const t=n.replace(/\|/g,(r,o,l)=>{let a=!1,u=o;for(;--u>=0&&l[u]==="\\";)a=!a;return a?"|":" |"}),s=t.split(/ \|/);let i=0;if(s[0].trim()||s.shift(),s.length>0&&!s[s.length-1].trim()&&s.pop(),e)if(s.length>e)s.splice(e);else for(;s.length<e;)s.push("");for(;i<s.length;i++)s[i]=s[i].trim().replace(/\\\|/g,"|");return s}function rt(n,e,t){const s=n.length;if(s===0)return"";let i=0;for(;i<s&&n.charAt(s-i-1)===e;)i++;return n.slice(0,s-i)}function dd(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let s=0;s<n.length;s++)if(n[s]==="\\")s++;else if(n[s]===e[0])t++;else if(n[s]===e[1]&&(t--,t<0))return s;return-1}function xr(n,e,t,s){const i=e.href,r=e.title?Cn(e.title):null,o=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){s.state.inLink=!0;const l={type:"link",raw:t,href:i,title:r,text:o,tokens:s.inlineTokens(o)};return s.state.inLink=!1,l}return{type:"image",raw:t,href:i,title:r,text:Cn(o)}}function hd(n,e){const t=n.match(/^(\s+)(?:```)/);if(t===null)return e;const s=t[1];return e.split(`
...
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const s=t[0],i=hd(s,t[3]||"");return{type:"code",raw:s,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:i}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let s=t[2].trim();if(/#$/.test(s)){const i=rt(s,"#");(this.options.pedantic||!i||/ $/.test(i))&&(s=i.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:s,tokens:this.lexer.inline(s)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:rt(t[0],`
