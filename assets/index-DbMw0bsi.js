...
`,1)[0];let Z;if(p=an,this.options.pedantic?(p=p.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  "),Z=p):Z=p.replace(/\t/g,"    "),N.test(p)||P.test(p)||Y.test(p)||L.test(p)||O.test(p))break;if(Z.search(/[^ ]/)>=y||!p.trim())c+=`
`+Z.slice(y);else{if(g||f.replace(/\t/g,"    ").search(/[^ ]/)>=4||N.test(f)||P.test(f)||O.test(f))break;c+=`
`+p}!g&&!p.trim()&&(g=!0),u+=an+`
...
Please report this to https://github.com/markedjs/marked.`,e){const r="<p>An error occurred:</p><pre>"+Nn(s.message+"",!0)+"</pre>";return t?Promise.resolve(r):r}if(t)return Promise.reject(s);throw s}}}const Me=new Fd;function Q(n,e){return Me.parse(n,e)}Q.options=Q.setOptions=function(n){return Me.setOptions(n),Q.defaults=Me.defaults,$l(Q.defaults),Q};Q.getDefaults=pr;Q.defaults=He;Q.use=function(...n){return Me.use(...n),Q.defaults=Me.defaults,$l(Q.defaults),Q};Q.walkTokens=function(n,e){return Me.walkTokens(n,e)};Q.parseInline=Me.parseInline;Q.Parser=Dn;Q.parser=Dn.parse;Q.Renderer=Zt;Q.TextRenderer=br;Q.Lexer=Ln;Q.lexer=Ln.lex;Q.Tokenizer=Wt;Q.Hooks=_t;Q.parse=Q;Q.options;Q.setOptions;Q.use;Q.walkTokens;Q.parseInline;Dn.parse;Ln.lex;const Ud={key:0,class:"doc-footer"},Vd={class:"doc-footer-inner"},zd=["href"],Gd={class:"footer-text"},Kd={key:1,class:"footer-link prev placeholder"},qd=["href"],Jd={class:"footer-text"},Wd={key:3,class:"footer-link next placeholder"},Yd={__name:"DocFooter",setup(n){const{prev:e,next:t}=gf();return(s,r)=>hn(e)||hn(t)?(F(),U("nav",Ud,[V("div",Vd,[hn(e)?(F(),U("a",{key:0,href:"#"+hn(e).link,class:"footer-link prev"},[r[0]||(r[0]=V("span",{class:"footer-label"},"上一章",-1)),V("span",Gd,vn(hn(e).text),1)],8,zd)):(F(),U("div",Kd)),hn(t)?(F(),U("a",{key:2,href:"#"+hn(t).link,class:"footer-link next"},[r[1]||(r[1]=V("span",{class:"footer-label"},"下一章",-1)),V("span",Jd,vn(hn(t).text),1)],8,qd)):(F(),U("div",Wd))])])):Ie("",!0)}},Zd=De(Yd,[["__scopeId","data-v-c9726e4b"]]),Qd=["innerHTML"],wi={__name:"MarkdownPage",setup(n){const e=hs(),t=Object.assign({"../../v1.0/canvas.md":Go,"../../v1.0/control-flow.md":Ko,"../../v1.0/entries.md":qo,"../../v1.0/expressions.md":Jo,"../../v1.0/file.md":Wo,"../../v1.0/flow-callback.md":Yo,"../../v1.0/flow-main-callback.md":Zo,"../../v1.0/flow-output.md":Qo,"../../v1.0/functions.md":Xo,"../../v1.0/index.md":nl,"../../v1.0/json.md":el,"../../v1.0/lexical.md":tl,"../../v1.0/math.md":sl,"../../v1.0/modules.md":rl,"../../v1.0/network.md":il,"../../v1.0/object.md":ol,"../../v1.0/oop.md":ll,"../../v1.0/output-print-return.md":al,"../../v1.0/output-print.md":cl,"../../v1.0/server.md":ul,"../../v1.0/string.md":fl,"../../v1.0/type.md":dl,"../../v1.0/types.md":hl,"../../v1.0/variables.md":pl});function s(l){return l.replace(/<[^>]*>/g,"").toLowerCase().replace(/[^\w\u4e00-\u9fff]+/g,"-").replace(/^-|-$/g,"")}function r(l){return l.replace(/<(h[23])>(.*?)<\/\1>/gi,(a,u,c)=>`<${u} id="${s(c)}">${c}</${u}>`)}function i(l){return l.replace(/\]\(\.\/([^)]*?)\)/g,(a,u)=>/\.(vsix|png|jpg|gif|svg|pdf)$/i.test(u)||u.startsWith("http")?a:`](#/v1.0/${u})`)}const o=Tn(()=>{let l;e.path==="/v1.0/"?l="../../v1.0/index.md":l=`../../v1.0/${e.params.page}.md`;const a=t[l];return a?r(Q.parse(i(a),{gfm:!0,breaks:!1})):"<p>页面未找到</p>"});return Ce([()=>e.hash,o],([l])=>{os(()=>{if(l){const a=document.getElementById(l.slice(1));a&&a.scrollIntoView({behavior:"smooth",block:"start"})}})}),(l,a)=>(F(),U(cn,null,[V("article",{class:"markdown-body",innerHTML:o.value},null,8,Qd),gn(Zd)],64))}},Xd=hf({history:zu(),routes:[{path:"/",component:ad},{path:"/v1.0",redirect:"/v1.0/"},{path:"/v1.0/",component:wi},{path:"/v1.0/:page",component:wi}],scrollBehavior(n){return n.hash?{el:n.hash,behavior:"smooth",top:80}:{top:0}}});tu(rd).use(Xd).mount("#app");
