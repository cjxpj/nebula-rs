...
* @license MIT
**/function Vs(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const sn={},je=[],ne=()=>{},wi=()=>!1,Zt=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),Qt=n=>n.startsWith("onUpdate:"),_n=Object.assign,zs=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},xl=Object.prototype.hasOwnProperty,K=(n,e)=>xl.call(n,e),F=Array.isArray,Ue=n=>wt(n)==="[object Map]",ki=n=>wt(n)==="[object Set]",wr=n=>wt(n)==="[object Date]",B=n=>typeof n=="function",un=n=>typeof n=="string",te=n=>typeof n=="symbol",Z=n=>n!==null&&typeof n=="object",Si=n=>(Z(n)||B(n))&&B(n.then)&&B(n.catch),Ri=Object.prototype.toString,wt=n=>Ri.call(n),vl=n=>wt(n).slice(8,-1),Ti=n=>wt(n)==="[object Object]",Gs=n=>un(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,ot=Vs(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Xt=n=>{const e=Object.create(null);return t=>e[t]||(e[t]=n(t))},yl=/-\w/g,Rn=Xt(n=>n.replace(yl,e=>e.slice(1).toUpperCase())),wl=/\B([A-Z])/g,Pe=Xt(n=>n.replace(wl,"-$1").toLowerCase()),ns=Xt(n=>n.charAt(0).toUpperCase()+n.slice(1)),fs=Xt(n=>n?`on${ns(n)}`:""),Xn=(n,e)=>!Object.is(n,e),Ct=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},Ei=(n,e,t,s=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:s,value:t})},qs=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let kr;const es=()=>kr||(kr=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Ks(n){if(F(n)){const e={};for(let t=0;t<n.length;t++){const s=n[t],r=un(s)?Tl(s):Ks(s);if(r)for(const i in r)e[i]=r[i]}return e}else if(un(n)||Z(n))return n}const kl=/;(?![^(]*\))/g,Sl=/:([^]+)/,Rl=/\/\*[^]*?\*\//g;function Tl(n){const e={};return n.replace(Rl,"").split(kl).forEach(t=>{if(t){const s=t.split(Sl);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function Ge(n){let e="";if(un(n))e=n;else if(F(n))for(let t=0;t<n.length;t++){const s=Ge(n[t]);s&&(e+=s+" ")}else if(Z(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const El="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Al=Vs(El);function Ai(n){return!!n||n===""}function Ol(n,e){if(n.length!==e.length)return!1;let t=!0;for(let s=0;t&&s<n.length;s++)t=Js(n[s],e[s]);return t}function Js(n,e){if(n===e)return!0;let t=wr(n),s=wr(e);if(t||s)return t&&s?n.getTime()===e.getTime():!1;if(t=te(n),s=te(e),t||s)return n===e;if(t=F(n),s=F(e),t||s)return t&&s?Ol(n,e):!1;if(t=Z(n),s=Z(e),t||s){if(!t||!s)return!1;const r=Object.keys(n).length,i=Object.keys(e).length;if(r!==i)return!1;for(const o in n){const l=n.hasOwnProperty(o),a=e.hasOwnProperty(o);if(l&&!a||!l&&a||!Js(n[o],e[o]))return!1}}return String(n)===String(e)}const Oi=n=>!!(n&&n.__v_isRef===!0),de=n=>un(n)?n:n==null?"":F(n)||Z(n)&&(n.toString===Ri||!B(n.toString))?Oi(n)?de(n.value):JSON.stringify(n,Ni,2):String(n),Ni=(n,e)=>Oi(e)?Ni(n,e.value):Ue(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[s,r],i)=>(t[ds(s,i)+" =>"]=r,t),{})}:ki(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>ds(t))}:te(e)?ds(e):Z(e)&&!F(e)&&!Ti(e)?String(e):e,ds=(n,e="")=>{var t;return te(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let mn;class Nl{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!e&&mn&&(mn.active?(this.parent=mn,this.index=(mn.scopes||(mn.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=mn;try{return mn=this,e()}finally{mn=t}}}on(){++this._on===1&&(this.prevScope=mn,mn=this)}off(){if(this._on>0&&--this._on===0){if(mn===this)mn=this.prevScope;else{let e=mn;for(;e;){if(e.prevScope===this){e.prevScope=this.prevScope;break}e=e.prevScope}}this.prevScope=void 0}}stop(e){if(this._active){this._active=!1;let t,s;for(t=0,s=this.effects.length;t<s;t++)this.effects[t].stop();for(this.effects.length=0,t=0,s=this.cleanups.length;t<s;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0}}}function Pl(){return mn}let rn;const hs=new WeakSet;class Pi{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,mn&&(mn.active?mn.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,hs.has(this)&&(hs.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Ii(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Sr(this),Mi(this);const e=rn,t=Hn;rn=this,Hn=!0;try{return this.fn()}finally{Li(this),rn=e,Hn=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)Zs(e);this.deps=this.depsTail=void 0,Sr(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?hs.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Rs(this)&&this.run()}get dirty(){return Rs(this)}}let Ci=0,lt,at;function Ii(n,e=!1){if(n.flags|=8,e){n.next=at,at=n;return}n.next=lt,lt=n}function Ws(){Ci++}function Ys(){if(--Ci>0)return;if(at){let e=at;for(at=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;lt;){let e=lt;for(lt=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(s){n||(n=s)}e=t}}if(n)throw n}function Mi(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function Li(n){let e,t=n.depsTail,s=t;for(;s;){const r=s.prevDep;s.version===-1?(s===t&&(t=r),Zs(s),Cl(s)):e=s,s.dep.activeLink=s.prevActiveLink,s.prevActiveLink=void 0,s=r}n.deps=e,n.depsTail=t}function Rs(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(Di(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function Di(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===mt)||(n.globalVersion=mt,!n.isSSR&&n.flags&128&&(!n.deps&&!n._dirty||!Rs(n))))return;n.flags|=2;const e=n.dep,t=rn,s=Hn;rn=n,Hn=!0;try{Mi(n);const r=n.fn(n._value);(e.version===0||Xn(r,n._value))&&(n.flags|=128,n._value=r,e.version++)}catch(r){throw e.version++,r}finally{rn=t,Hn=s,Li(n),n.flags&=-3}}function Zs(n,e=!1){const{dep:t,prevSub:s,nextSub:r}=n;if(s&&(s.nextSub=r,n.prevSub=void 0),r&&(r.prevSub=s,n.nextSub=void 0),t.subs===n&&(t.subs=s,!s&&t.computed)){t.computed.flags&=-5;for(let i=t.computed.deps;i;i=i.nextDep)Zs(i,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function Cl(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let Hn=!0;const Hi=[];function se(){Hi.push(Hn),Hn=!1}function re(){const n=Hi.pop();Hn=n===void 0?!0:n}function Sr(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=rn;rn=void 0;try{e()}finally{rn=t}}}let mt=0;class Il{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Qs{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!rn||!Hn||rn===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==rn)t=this.activeLink=new Il(rn,this),rn.deps?(t.prevDep=rn.depsTail,rn.depsTail.nextDep=t,rn.depsTail=t):rn.deps=rn.depsTail=t,Fi(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const s=t.nextDep;s.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=s),t.prevDep=rn.depsTail,t.nextDep=void 0,rn.depsTail.nextDep=t,rn.depsTail=t,rn.deps===t&&(rn.deps=s)}return t}trigger(e){this.version++,mt++,this.notify(e)}notify(e){Ws();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{Ys()}}}function Fi(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let s=e.deps;s;s=s.nextDep)Fi(s)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const Ts=new WeakMap,Ae=Symbol(""),Es=Symbol(""),_t=Symbol("");function bn(n,e,t){if(Hn&&rn){let s=Ts.get(n);s||Ts.set(n,s=new Map);let r=s.get(t);r||(s.set(t,r=new Qs),r.map=s,r.key=t),r.track()}}function ue(n,e,t,s,r,i){const o=Ts.get(n);if(!o){mt++;return}const l=a=>{a&&a.trigger()};if(Ws(),e==="clear")o.forEach(l);else{const a=F(n),u=a&&Gs(t);if(a&&t==="length"){const c=Number(s);o.forEach((d,p)=>{(p==="length"||p===_t||!te(p)&&p>=c)&&l(d)})}else switch((t!==void 0||o.has(void 0))&&l(o.get(t)),u&&l(o.get(_t)),e){case"add":a?u&&l(o.get("length")):(l(o.get(Ae)),Ue(n)&&l(o.get(Es)));break;case"delete":a||(l(o.get(Ae)),Ue(n)&&l(o.get(Es)));break;case"set":Ue(n)&&l(o.get(Ae));break}}Ys()}function De(n){const e=q(n);return e===n?e:(bn(e,"iterate",_t),Dn(n)?e:e.map(Fn))}function ts(n){return bn(n=q(n),"iterate",_t),n}function Zn(n,e){return he(n)?qe(Oe(n)?Fn(e):e):Fn(e)}const Ml={__proto__:null,[Symbol.iterator](){return ps(this,Symbol.iterator,n=>Zn(this,n))},concat(...n){return De(this).concat(...n.map(e=>F(e)?De(e):e))},entries(){return ps(this,"entries",n=>(n[1]=Zn(this,n[1]),n))},every(n,e){return oe(this,"every",n,e,void 0,arguments)},filter(n,e){return oe(this,"filter",n,e,t=>t.map(s=>Zn(this,s)),arguments)},find(n,e){return oe(this,"find",n,e,t=>Zn(this,t),arguments)},findIndex(n,e){return oe(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return oe(this,"findLast",n,e,t=>Zn(this,t),arguments)},findLastIndex(n,e){return oe(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return oe(this,"forEach",n,e,void 0,arguments)},includes(...n){return gs(this,"includes",n)},indexOf(...n){return gs(this,"indexOf",n)},join(n){return De(this).join(n)},lastIndexOf(...n){return gs(this,"lastIndexOf",n)},map(n,e){return oe(this,"map",n,e,void 0,arguments)},pop(){return Xe(this,"pop")},push(...n){return Xe(this,"push",n)},reduce(n,...e){return Rr(this,"reduce",n,e)},reduceRight(n,...e){return Rr(this,"reduceRight",n,e)},shift(){return Xe(this,"shift")},some(n,e){return oe(this,"some",n,e,void 0,arguments)},splice(...n){return Xe(this,"splice",n)},toReversed(){return De(this).toReversed()},toSorted(n){return De(this).toSorted(n)},toSpliced(...n){return De(this).toSpliced(...n)},unshift(...n){return Xe(this,"unshift",n)},values(){return ps(this,"values",n=>Zn(this,n))}};function ps(n,e,t){const s=ts(n),r=s[e]();return s!==n&&!Dn(n)&&(r._next=r.next,r.next=()=>{const i=r._next();return i.done||(i.value=t(i.value)),i}),r}const Ll=Array.prototype;function oe(n,e,t,s,r,i){const o=ts(n),l=o!==n&&!Dn(n),a=o[e];if(a!==Ll[e]){const d=a.apply(n,i);return l?Fn(d):d}let u=t;o!==n&&(l?u=function(d,p){return t.call(this,Zn(n,d),p,n)}:t.length>2&&(u=function(d,p){return t.call(this,d,p,n)}));const c=a.call(o,u,s);return l&&r?r(c):c}function Rr(n,e,t,s){const r=ts(n),i=r!==n&&!Dn(n);let o=t,l=!1;r!==n&&(i?(l=s.length===0,o=function(u,c,d){return l&&(l=!1,u=Zn(n,u)),t.call(this,u,Zn(n,c),d,n)}):t.length>3&&(o=function(u,c,d){return t.call(this,u,c,d,n)}));const a=r[e](o,...s);return l?Zn(n,a):a}function gs(n,e,t){const s=q(n);bn(s,"iterate",_t);const r=s[e](...t);return(r===-1||r===!1)&&er(t[0])?(t[0]=q(t[0]),s[e](...t)):r}function Xe(n,e,t=[]){se(),Ws();const s=q(n)[e].apply(n,t);return Ys(),re(),s}const Dl=Vs("__proto__,__v_isRef,__isVue"),Bi=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(te));function Hl(n){te(n)||(n=String(n));const e=q(this);return bn(e,"has",n),e.hasOwnProperty(n)}class ji{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,s){if(t==="__v_skip")return e.__v_skip;const r=this._isReadonly,i=this._isShallow;if(t==="__v_isReactive")return!r;if(t==="__v_isReadonly")return r;if(t==="__v_isShallow")return i;if(t==="__v_raw")return s===(r?i?Jl:Gi:i?zi:Vi).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(s)?e:void 0;const o=F(e);if(!r){let a;if(o&&(a=Ml[t]))return a;if(t==="hasOwnProperty")return Hl}const l=Reflect.get(e,t,vn(e)?e:s);if((te(t)?Bi.has(t):Dl(t))||(r||bn(e,"get",t),i))return l;if(vn(l)){const a=o&&Gs(t)?l:l.value;return r&&Z(a)?Os(a):a}return Z(l)?r?Os(l):ss(l):l}}class Ui extends ji{constructor(e=!1){super(!1,e)}set(e,t,s,r){let i=e[t];const o=F(e)&&Gs(t);if(!this._isShallow){const u=he(i);if(!Dn(s)&&!he(s)&&(i=q(i),s=q(s)),!o&&vn(i)&&!vn(s))return u||(i.value=s),!0}const l=o?Number(t)<e.length:K(e,t),a=Reflect.set(e,t,s,vn(e)?e:r);return e===q(r)&&a&&(l?Xn(s,i)&&ue(e,"set",t,s):ue(e,"add",t,s)),a}deleteProperty(e,t){const s=K(e,t);e[t];const r=Reflect.deleteProperty(e,t);return r&&s&&ue(e,"delete",t,void 0),r}has(e,t){const s=Reflect.has(e,t);return(!te(t)||!Bi.has(t))&&bn(e,"has",t),s}ownKeys(e){return bn(e,"iterate",F(e)?"length":Ae),Reflect.ownKeys(e)}}class Fl extends ji{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const Bl=new Ui,jl=new Fl,Ul=new Ui(!0);const As=n=>n,Et=n=>Reflect.getPrototypeOf(n);function Vl(n,e,t){return function(...s){const r=this.__v_raw,i=q(r),o=Ue(i),l=n==="entries"||n===Symbol.iterator&&o,a=n==="keys"&&o,u=r[n](...s),c=t?As:e?qe:Fn;return!e&&bn(i,"iterate",a?Es:Ae),_n(Object.create(u),{next(){const{value:d,done:p}=u.next();return p?{value:d,done:p}:{value:l?[c(d[0]),c(d[1])]:c(d),done:p}}})}}function At(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function zl(n,e){const t={get(r){const i=this.__v_raw,o=q(i),l=q(r);n||(Xn(r,l)&&bn(o,"get",r),bn(o,"get",l));const{has:a}=Et(o),u=e?As:n?qe:Fn;if(a.call(o,r))return u(i.get(r));if(a.call(o,l))return u(i.get(l));i!==o&&i.get(r)},get size(){const r=this.__v_raw;return!n&&bn(q(r),"iterate",Ae),r.size},has(r){const i=this.__v_raw,o=q(i),l=q(r);return n||(Xn(r,l)&&bn(o,"has",r),bn(o,"has",l)),r===l?i.has(r):i.has(r)||i.has(l)},forEach(r,i){const o=this,l=o.__v_raw,a=q(l),u=e?As:n?qe:Fn;return!n&&bn(a,"iterate",Ae),l.forEach((c,d)=>r.call(i,u(c),u(d),o))}};return _n(t,n?{add:At("add"),set:At("set"),delete:At("delete"),clear:At("clear")}:{add(r){const i=q(this),o=Et(i),l=q(r),a=!e&&!Dn(r)&&!he(r)?l:r;return o.has.call(i,a)||Xn(r,a)&&o.has.call(i,r)||Xn(l,a)&&o.has.call(i,l)||(i.add(a),ue(i,"add",a,a)),this},set(r,i){!e&&!Dn(i)&&!he(i)&&(i=q(i));const o=q(this),{has:l,get:a}=Et(o);let u=l.call(o,r);u||(r=q(r),u=l.call(o,r));const c=a.call(o,r);return o.set(r,i),u?Xn(i,c)&&ue(o,"set",r,i):ue(o,"add",r,i),this},delete(r){const i=q(this),{has:o,get:l}=Et(i);let a=o.call(i,r);a||(r=q(r),a=o.call(i,r)),l&&l.call(i,r);const u=i.delete(r);return a&&ue(i,"delete",r,void 0),u},clear(){const r=q(this),i=r.size!==0,o=r.clear();return i&&ue(r,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=Vl(r,n,e)}),t}function Xs(n,e){const t=zl(n,e);return(s,r,i)=>r==="__v_isReactive"?!n:r==="__v_isReadonly"?n:r==="__v_raw"?s:Reflect.get(K(t,r)&&r in s?t:s,r,i)}const Gl={get:Xs(!1,!1)},ql={get:Xs(!1,!0)},Kl={get:Xs(!0,!1)};const Vi=new WeakMap,zi=new WeakMap,Gi=new WeakMap,Jl=new WeakMap;function Wl(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function ss(n){return he(n)?n:nr(n,!1,Bl,Gl,Vi)}function qi(n){return nr(n,!1,Ul,ql,zi)}function Os(n){return nr(n,!0,jl,Kl,Gi)}function nr(n,e,t,s,r){if(!Z(n)||n.__v_raw&&!(e&&n.__v_isReactive)||n.__v_skip||!Object.isExtensible(n))return n;const i=r.get(n);if(i)return i;const o=Wl(vl(n));if(o===0)return n;const l=new Proxy(n,o===2?s:t);return r.set(n,l),l}function Oe(n){return he(n)?Oe(n.__v_raw):!!(n&&n.__v_isReactive)}function he(n){return!!(n&&n.__v_isReadonly)}function Dn(n){return!!(n&&n.__v_isShallow)}function er(n){return n?!!n.__v_raw:!1}function q(n){const e=n&&n.__v_raw;return e?q(e):n}function Yl(n){return!K(n,"__v_skip")&&Object.isExtensible(n)&&Ei(n,"__v_skip",!0),n}const Fn=n=>Z(n)?ss(n):n,qe=n=>Z(n)?Os(n):n;function vn(n){return n?n.__v_isRef===!0:!1}function Te(n){return Ki(n,!1)}function Zl(n){return Ki(n,!0)}function Ki(n,e){return vn(n)?n:new Ql(n,e)}class Ql{constructor(e,t){this.dep=new Qs,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:q(e),this._value=t?e:Fn(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,s=this.__v_isShallow||Dn(e)||he(e);e=s?e:q(e),Xn(e,t)&&(this._rawValue=e,this._value=s?e:Fn(e),this.dep.trigger())}}function dn(n){return vn(n)?n.value:n}const Xl={get:(n,e,t)=>e==="__v_raw"?n:dn(Reflect.get(n,e,t)),set:(n,e,t,s)=>{const r=n[e];return vn(r)&&!vn(t)?(r.value=t,!0):Reflect.set(n,e,t,s)}};function Ji(n){return Oe(n)?n:new Proxy(n,Xl)}class na{constructor(e,t,s){this.fn=e,this.setter=t,this._value=void 0,this.dep=new Qs(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=mt-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=s}notify(){if(this.flags|=16,!(this.flags&8)&&rn!==this)return Ii(this,!0),!0}get value(){const e=this.dep.track();return Di(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function ea(n,e,t=!1){let s,r;return B(n)?s=n:(s=n.get,r=n.set),new na(s,r,t)}const Ot={},Ht=new WeakMap;let Re;function ta(n,e=!1,t=Re){if(t){let s=Ht.get(t);s||Ht.set(t,s=[]),s.push(n)}}function sa(n,e,t=sn){const{immediate:s,deep:r,once:i,scheduler:o,augmentJob:l,call:a}=t,u=N=>r?N:Dn(N)||r===!1||r===0?fe(N,1):fe(N);let c,d,p,$,y=!1,w=!1;if(vn(n)?(d=()=>n.value,y=Dn(n)):Oe(n)?(d=()=>u(n),y=!0):F(n)?(w=!0,y=n.some(N=>Oe(N)||Dn(N)),d=()=>n.map(N=>{if(vn(N))return N.value;if(Oe(N))return u(N);if(B(N))return a?a(N,2):N()})):B(n)?e?d=a?()=>a(n,2):n:d=()=>{if(p){se();try{p()}finally{re()}}const N=Re;Re=c;try{return a?a(n,3,[$]):n($)}finally{Re=N}}:d=ne,e&&r){const N=d,J=r===!0?1/0:r;d=()=>fe(N(),J)}const C=Pl(),L=()=>{c.stop(),C&&C.active&&zs(C.effects,c)};if(i&&e){const N=e;e=(...J)=>{const ln=N(...J);return L(),ln}}let A=w?new Array(n.length).fill(Ot):Ot;const P=N=>{if(!(!(c.flags&1)||!c.dirty&&!N))if(e){const J=c.run();if(N||r||y||(w?J.some((ln,W)=>Xn(ln,A[W])):Xn(J,A))){p&&p();const ln=Re;Re=c;try{const W=[J,A===Ot?void 0:w&&A[0]===Ot?[]:A,$];A=J,a?a(e,3,W):e(...W)}finally{Re=ln}}}else c.run()};return l&&l(P),c=new Pi(d),c.scheduler=o?()=>o(P,!1):P,$=N=>ta(N,!1,c),p=c.onStop=()=>{const N=Ht.get(c);if(N){if(a)a(N,4);else for(const J of N)J();Ht.delete(c)}},e?s?P(!0):A=c.run():o?o(P.bind(null,!0),!0):c.run(),L.pause=c.pause.bind(c),L.resume=c.resume.bind(c),L.stop=L,L}function fe(n,e=1/0,t){if(e<=0||!Z(n)||n.__v_skip||(t=t||new Map,(t.get(n)||0)>=e))return n;if(t.set(n,e),e--,vn(n))fe(n.value,e,t);else if(F(n))for(let s=0;s<n.length;s++)fe(n[s],e,t);else if(ki(n)||Ue(n))n.forEach(s=>{fe(s,e,t)});else if(Ti(n)){for(const s in n)fe(n[s],e,t);for(const s of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,s)&&fe(n[s],e,t)}return n}/**
* @vue/runtime-core v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function kt(n,e,t,s){try{return s?n(...s):n()}catch(r){rs(r,e,t)}}function Bn(n,e,t,s){if(B(n)){const r=kt(n,e,t,s);return r&&Si(r)&&r.catch(i=>{rs(i,e,t)}),r}if(F(n)){const r=[];for(let i=0;i<n.length;i++)r.push(Bn(n[i],e,t,s));return r}}function rs(n,e,t,s=!0){const r=e?e.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:o}=e&&e.appContext.config||sn;if(e){let l=e.parent;const a=e.proxy,u=`https://vuejs.org/error-reference/#runtime-${t}`;for(;l;){const c=l.ec;if(c){for(let d=0;d<c.length;d++)if(c[d](n,a,u)===!1)return}l=l.parent}if(i){se(),kt(i,null,10,[n,a,u]),re();return}}ra(n,t,r,s,o)}function ra(n,e,t,s=!0,r=!1){if(r)throw n;console.error(n)}const kn=[];let Yn=-1;const Ve=[];let be=null,He=0;const Wi=Promise.resolve();let Ft=null;function tr(n){const e=Ft||Wi;return n?e.then(this?n.bind(this):n):e}function ia(n){let e=Yn+1,t=kn.length;for(;e<t;){const s=e+t>>>1,r=kn[s],i=bt(r);i<n||i===n&&r.flags&2?e=s+1:t=s}return e}function sr(n){if(!(n.flags&1)){const e=bt(n),t=kn[kn.length-1];!t||!(n.flags&2)&&e>=bt(t)?kn.push(n):kn.splice(ia(e),0,n),n.flags|=1,Yi()}}function Yi(){Ft||(Ft=Wi.then(Qi))}function oa(n){F(n)?Ve.push(...n):be&&n.id===-1?be.splice(He+1,0,n):n.flags&1||(Ve.push(n),n.flags|=1),Yi()}function Tr(n,e,t=Yn+1){for(;t<kn.length;t++){const s=kn[t];if(s&&s.flags&2){if(n&&s.id!==n.uid)continue;kn.splice(t,1),t--,s.flags&4&&(s.flags&=-2),s(),s.flags&4||(s.flags&=-2)}}}function Zi(n){if(Ve.length){const e=[...new Set(Ve)].sort((t,s)=>bt(t)-bt(s));if(Ve.length=0,be){be.push(...e);return}for(be=e,He=0;He<be.length;He++){const t=be[He];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}be=null,He=0}}const bt=n=>n.id==null?n.flags&2?-1:1/0:n.id;function Qi(n){try{for(Yn=0;Yn<kn.length;Yn++){const e=kn[Yn];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),kt(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;Yn<kn.length;Yn++){const e=kn[Yn];e&&(e.flags&=-2)}Yn=-1,kn.length=0,Zi(),Ft=null,(kn.length||Ve.length)&&Qi()}}let Nn=null,Xi=null;function Bt(n){const e=Nn;return Nn=n,Xi=n&&n.type.__scopeId||null,e}function la(n,e=Nn,t){if(!e||n._n)return n;const s=(...r)=>{s._d&&zt(-1);const i=Bt(e);let o;try{o=n(...r)}finally{Bt(i),s._d&&zt(1)}return o};return s._n=!0,s._c=!0,s._d=!0,s}function aa(n,e){if(Nn===null)return n;const t=as(Nn),s=n.dirs||(n.dirs=[]);for(let r=0;r<e.length;r++){let[i,o,l,a=sn]=e[r];i&&(B(i)&&(i={mounted:i,updated:i}),i.deep&&fe(o),s.push({dir:i,instance:t,value:o,oldValue:void 0,arg:l,modifiers:a}))}return n}function ke(n,e,t,s){const r=n.dirs,i=e&&e.dirs;for(let o=0;o<r.length;o++){const l=r[o];i&&(l.oldValue=i[o].value);let a=l.dir[s];a&&(se(),Bn(a,t,8,[n.el,l,n,e]),re())}}function It(n,e){if(xn){let t=xn.provides;const s=xn.parent&&xn.parent.provides;s===t&&(t=xn.provides=Object.create(s)),t[n]=e}}function ee(n,e,t=!1){const s=dc();if(s||ze){let r=ze?ze._context.provides:s?s.parent==null||s.ce?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:void 0;if(r&&n in r)return r[n];if(arguments.length>1)return t&&B(e)?e.call(s&&s.proxy):e}}const ca=Symbol.for("v-scx"),ua=()=>ee(ca);function fa(n,e){return rr(n,null,e)}function ct(n,e,t){return rr(n,e,t)}function rr(n,e,t=sn){const{immediate:s,deep:r,flush:i,once:o}=t,l=_n({},t),a=e&&s||!e&&i!=="post";let u;if(vt){if(i==="sync"){const $=ua();u=$.__watcherHandles||($.__watcherHandles=[])}else if(!a){const $=()=>{};return $.stop=ne,$.resume=ne,$.pause=ne,$}}const c=xn;l.call=($,y,w)=>Bn($,c,y,w);let d=!1;i==="post"?l.scheduler=$=>{En($,c&&c.suspense)}:i!=="sync"&&(d=!0,l.scheduler=($,y)=>{y?$():sr($)}),l.augmentJob=$=>{e&&($.flags|=4),d&&($.flags|=2,c&&($.id=c.uid,$.i=c))};const p=sa(n,e,l);return vt&&(u?u.push(p):a&&p()),p}function da(n,e,t){const s=this.proxy,r=un(n)?n.includes(".")?no(s,n):()=>s[n]:n.bind(s,s);let i;B(e)?i=e:(i=e.handler,t=e);const o=St(this),l=rr(r,i.bind(s),t);return o(),l}function no(n,e){const t=e.split(".");return()=>{let s=n;for(let r=0;r<t.length&&s;r++)s=s[t[r]];return s}}const ha=Symbol("_vte"),pa=n=>n.__isTeleport,$s=Symbol("_leaveCb");function ir(n,e){n.shapeFlag&6&&n.component?(n.transition=e,ir(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}function eo(n,e){return B(n)?_n({name:n.name},e,{setup:n}):n}function to(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}function Er(n,e){let t;return!!((t=Object.getOwnPropertyDescriptor(n,e))&&!t.configurable)}const jt=new WeakMap;function ut(n,e,t,s,r=!1){if(F(n)){n.forEach((w,C)=>ut(w,e&&(F(e)?e[C]:e),t,s,r));return}if(ft(s)&&!r){s.shapeFlag&512&&s.type.__asyncResolved&&s.component.subTree.component&&ut(n,e,t,s.component.subTree);return}const i=s.shapeFlag&4?as(s.component):s.el,o=r?null:i,{i:l,r:a}=n,u=e&&e.r,c=l.refs===sn?l.refs={}:l.refs,d=l.setupState,p=q(d),$=d===sn?wi:w=>Er(c,w)?!1:K(p,w),y=(w,C)=>!(C&&Er(c,C));if(u!=null&&u!==a){if(Ar(e),un(u))c[u]=null,$(u)&&(d[u]=null);else if(vn(u)){const w=e;y(u,w.k)&&(u.value=null),w.k&&(c[w.k]=null)}}if(B(a)){se();try{kt(a,l,12,[o,c])}finally{re()}}else{const w=un(a),C=vn(a);if(w||C){const L=()=>{if(n.f){const A=w?$(a)?d[a]:c[a]:y()||!n.k?a.value:c[n.k];if(r)F(A)&&zs(A,i);else if(F(A))A.includes(i)||A.push(i);else if(w)c[a]=[i],$(a)&&(d[a]=c[a]);else{const P=[i];y(a,n.k)&&(a.value=P),n.k&&(c[n.k]=P)}}else w?(c[a]=o,$(a)&&(d[a]=o)):C&&(y(a,n.k)&&(a.value=o),n.k&&(c[n.k]=o))};if(o){const A=()=>{L(),jt.delete(n)};A.id=-1,jt.set(n,A),En(A,t)}else Ar(n),L()}}}function Ar(n){const e=jt.get(n);e&&(e.flags|=8,jt.delete(n))}es().requestIdleCallback;es().cancelIdleCallback;const ft=n=>!!n.type.__asyncLoader,so=n=>n.type.__isKeepAlive;function ga(n,e){ro(n,"a",e)}function $a(n,e){ro(n,"da",e)}function ro(n,e,t=xn){const s=n.__wdc||(n.__wdc=()=>{let r=t;for(;r;){if(r.isDeactivated)return;r=r.parent}return n()});if(is(e,s,t),t){let r=t.parent;for(;r&&r.parent;)so(r.parent.vnode)&&ma(s,e,t,r),r=r.parent}}function ma(n,e,t,s){const r=is(e,n,s,!0);io(()=>{zs(s[e],r)},t)}function is(n,e,t=xn,s=!1){if(t){const r=t[n]||(t[n]=[]),i=e.__weh||(e.__weh=(...o)=>{se();const l=St(t),a=Bn(e,t,n,o);return l(),re(),a});return s?r.unshift(i):r.push(i),i}}const pe=n=>(e,t=xn)=>{(!vt||n==="sp")&&is(n,(...s)=>e(...s),t)},_a=pe("bm"),ba=pe("m"),xa=pe("bu"),va=pe("u"),ya=pe("bum"),io=pe("um"),wa=pe("sp"),ka=pe("rtg"),Sa=pe("rtc");function Ra(n,e=xn){is("ec",n,e)}const Ta="components";function Ea(n,e){return Oa(Ta,n,!0,e)||n}const Aa=Symbol.for("v-ndc");function Oa(n,e,t=!0,s=!1){const r=Nn||xn;if(r){const i=r.type;{const l=mc(i,!1);if(l&&(l===e||l===Rn(e)||l===ns(Rn(e))))return i}const o=Or(r[n]||i[n],e)||Or(r.appContext[n],e);return!o&&s?i:o}}function Or(n,e){return n&&(n[e]||n[Rn(e)]||n[ns(Rn(e))])}function Ut(n,e,t,s){let r;const i=t,o=F(n);if(o||un(n)){const l=o&&Oe(n);let a=!1,u=!1;l&&(a=!Dn(n),u=he(n),n=ts(n)),r=new Array(n.length);for(let c=0,d=n.length;c<d;c++)r[c]=e(a?u?qe(Fn(n[c])):Fn(n[c]):n[c],c,void 0,i)}else if(typeof n=="number"){r=new Array(n);for(let l=0;l<n;l++)r[l]=e(l+1,l,void 0,i)}else if(Z(n))if(n[Symbol.iterator])r=Array.from(n,(l,a)=>e(l,a,void 0,i));else{const l=Object.keys(n);r=new Array(l.length);for(let a=0,u=l.length;a<u;a++){const c=l[a];r[a]=e(n[c],c,a,i)}}else r=[];return r}const Ns=n=>n?To(n)?as(n):Ns(n.parent):null,dt=_n(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>Ns(n.parent),$root:n=>Ns(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>lo(n),$forceUpdate:n=>n.f||(n.f=()=>{sr(n.update)}),$nextTick:n=>n.n||(n.n=tr.bind(n.proxy)),$watch:n=>da.bind(n)}),ms=(n,e)=>n!==sn&&!n.__isScriptSetup&&K(n,e),Na={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:s,data:r,props:i,accessCache:o,type:l,appContext:a}=n;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return s[e];case 2:return r[e];case 4:return t[e];case 3:return i[e]}else{if(ms(s,e))return o[e]=1,s[e];if(r!==sn&&K(r,e))return o[e]=2,r[e];if(K(i,e))return o[e]=3,i[e];if(t!==sn&&K(t,e))return o[e]=4,t[e];Ps&&(o[e]=0)}}const u=dt[e];let c,d;if(u)return e==="$attrs"&&bn(n.attrs,"get",""),u(n);if((c=l.__cssModules)&&(c=c[e]))return c;if(t!==sn&&K(t,e))return o[e]=4,t[e];if(d=a.config.globalProperties,K(d,e))return d[e]},set({_:n},e,t){const{data:s,setupState:r,ctx:i}=n;return ms(r,e)?(r[e]=t,!0):s!==sn&&K(s,e)?(s[e]=t,!0):K(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(i[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:s,appContext:r,props:i,type:o}},l){let a;return!!(t[l]||n!==sn&&l[0]!=="$"&&K(n,l)||ms(e,l)||K(i,l)||K(s,l)||K(dt,l)||K(r.config.globalProperties,l)||(a=o.__cssModules)&&a[l])},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:K(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function Nr(n){return F(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let Ps=!0;function Pa(n){const e=lo(n),t=n.proxy,s=n.ctx;Ps=!1,e.beforeCreate&&Pr(e.beforeCreate,n,"bc");const{data:r,computed:i,methods:o,watch:l,provide:a,inject:u,created:c,beforeMount:d,mounted:p,beforeUpdate:$,updated:y,activated:w,deactivated:C,beforeDestroy:L,beforeUnmount:A,destroyed:P,unmounted:N,render:J,renderTracked:ln,renderTriggered:W,errorCaptured:Un,serverPrefetch:ge,expose:Vn,inheritAttrs:$e,components:ye,directives:zn,filters:Ze}=e;if(u&&Ca(u,s,null),o)for(const Q in o){const z=o[Q];B(z)&&(s[Q]=z.bind(t))}if(r){const Q=r.call(t,t);Z(Q)&&(n.data=ss(Q))}if(Ps=!0,i)for(const Q in i){const z=i[Q],ie=B(z)?z.bind(t,t):B(z.get)?z.get.bind(t,t):ne,me=!B(z)&&B(z.set)?z.set.bind(t):ne,Gn=In({get:ie,set:me});Object.defineProperty(s,Q,{enumerable:!0,configurable:!0,get:()=>Gn.value,set:Tn=>Gn.value=Tn})}if(l)for(const Q in l)oo(l[Q],s,t,Q);if(a){const Q=B(a)?a.call(t):a;Reflect.ownKeys(Q).forEach(z=>{It(z,Q[z])})}c&&Pr(c,n,"c");function pn(Q,z){F(z)?z.forEach(ie=>Q(ie.bind(t))):z&&Q(z.bind(t))}if(pn(_a,d),pn(ba,p),pn(xa,$),pn(va,y),pn(ga,w),pn($a,C),pn(Ra,Un),pn(Sa,ln),pn(ka,W),pn(ya,A),pn(io,N),pn(wa,ge),F(Vn))if(Vn.length){const Q=n.exposed||(n.exposed={});Vn.forEach(z=>{Object.defineProperty(Q,z,{get:()=>t[z],set:ie=>t[z]=ie,enumerable:!0})})}else n.exposed||(n.exposed={});J&&n.render===ne&&(n.render=J),$e!=null&&(n.inheritAttrs=$e),ye&&(n.components=ye),zn&&(n.directives=zn),ge&&to(n)}function Ca(n,e,t=ne){F(n)&&(n=Cs(n));for(const s in n){const r=n[s];let i;Z(r)?"default"in r?i=ee(r.from||s,r.default,!0):i=ee(r.from||s):i=ee(r),vn(i)?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>i.value,set:o=>i.value=o}):e[s]=i}}function Pr(n,e,t){Bn(F(n)?n.map(s=>s.bind(e.proxy)):n.bind(e.proxy),e,t)}function oo(n,e,t,s){let r=s.includes(".")?no(t,s):()=>t[s];if(un(n)){const i=e[n];B(i)&&ct(r,i)}else if(B(n))ct(r,n.bind(t));else if(Z(n))if(F(n))n.forEach(i=>oo(i,e,t,s));else{const i=B(n.handler)?n.handler.bind(t):e[n.handler];B(i)&&ct(r,i,n)}}function lo(n){const e=n.type,{mixins:t,extends:s}=e,{mixins:r,optionsCache:i,config:{optionMergeStrategies:o}}=n.appContext,l=i.get(e);let a;return l?a=l:!r.length&&!t&&!s?a=e:(a={},r.length&&r.forEach(u=>Vt(a,u,o,!0)),Vt(a,e,o)),Z(e)&&i.set(e,a),a}function Vt(n,e,t,s=!1){const{mixins:r,extends:i}=e;i&&Vt(n,i,t,!0),r&&r.forEach(o=>Vt(n,o,t,!0));for(const o in e)if(!(s&&o==="expose")){const l=Ia[o]||t&&t[o];n[o]=l?l(n[o],e[o]):e[o]}return n}const Ia={data:Cr,props:Ir,emits:Ir,methods:rt,computed:rt,beforeCreate:yn,created:yn,beforeMount:yn,mounted:yn,beforeUpdate:yn,updated:yn,beforeDestroy:yn,beforeUnmount:yn,destroyed:yn,unmounted:yn,activated:yn,deactivated:yn,errorCaptured:yn,serverPrefetch:yn,components:rt,directives:rt,watch:La,provide:Cr,inject:Ma};function Cr(n,e){return e?n?function(){return _n(B(n)?n.call(this,this):n,B(e)?e.call(this,this):e)}:e:n}function Ma(n,e){return rt(Cs(n),Cs(e))}function Cs(n){if(F(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function yn(n,e){return n?[...new Set([].concat(n,e))]:e}function rt(n,e){return n?_n(Object.create(null),n,e):e}function Ir(n,e){return n?F(n)&&F(e)?[...new Set([...n,...e])]:_n(Object.create(null),Nr(n),Nr(e??{})):e}function La(n,e){if(!n)return e;if(!e)return n;const t=_n(Object.create(null),n);for(const s in e)t[s]=yn(n[s],e[s]);return t}function ao(){return{app:null,config:{isNativeTag:wi,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Da=0;function Ha(n,e){return function(s,r=null){B(s)||(s=_n({},s)),r!=null&&!Z(r)&&(r=null);const i=ao(),o=new WeakSet,l=[];let a=!1;const u=i.app={_uid:Da++,_component:s,_props:r,_container:null,_context:i,_instance:null,version:bc,get config(){return i.config},set config(c){},use(c,...d){return o.has(c)||(c&&B(c.install)?(o.add(c),c.install(u,...d)):B(c)&&(o.add(c),c(u,...d))),u},mixin(c){return i.mixins.includes(c)||i.mixins.push(c),u},component(c,d){return d?(i.components[c]=d,u):i.components[c]},directive(c,d){return d?(i.directives[c]=d,u):i.directives[c]},mount(c,d,p){if(!a){const $=u._ceVNode||gn(s,r);return $.appContext=i,p===!0?p="svg":p===!1&&(p=void 0),n($,c,p),a=!0,u._container=c,c.__vue_app__=u,as($.component)}},onUnmount(c){l.push(c)},unmount(){a&&(Bn(l,u._instance,16),n(null,u._container),delete u._container.__vue_app__)},provide(c,d){return i.provides[c]=d,u},runWithContext(c){const d=ze;ze=u;try{return c()}finally{ze=d}}};return u}}let ze=null;const Fa=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${Rn(e)}Modifiers`]||n[`${Pe(e)}Modifiers`];function Ba(n,e,...t){if(n.isUnmounted)return;const s=n.vnode.props||sn;let r=t;const i=e.startsWith("update:"),o=i&&Fa(s,e.slice(7));o&&(o.trim&&(r=t.map(c=>un(c)?c.trim():c)),o.number&&(r=t.map(qs)));let l,a=s[l=fs(e)]||s[l=fs(Rn(e))];!a&&i&&(a=s[l=fs(Pe(e))]),a&&Bn(a,n,6,r);const u=s[l+"Once"];if(u){if(!n.emitted)n.emitted={};else if(n.emitted[l])return;n.emitted[l]=!0,Bn(u,n,6,r)}}const ja=new WeakMap;function co(n,e,t=!1){const s=t?ja:e.emitsCache,r=s.get(n);if(r!==void 0)return r;const i=n.emits;let o={},l=!1;if(!B(n)){const a=u=>{const c=co(u,e,!0);c&&(l=!0,_n(o,c))};!t&&e.mixins.length&&e.mixins.forEach(a),n.extends&&a(n.extends),n.mixins&&n.mixins.forEach(a)}return!i&&!l?(Z(n)&&s.set(n,null),null):(F(i)?i.forEach(a=>o[a]=null):_n(o,i),Z(n)&&s.set(n,o),o)}function os(n,e){return!n||!Zt(e)?!1:(e=e.slice(2),e=e==="Once"?e:e.replace(/Once$/,""),K(n,e[0].toLowerCase()+e.slice(1))||K(n,Pe(e))||K(n,e))}function Mr(n){const{type:e,vnode:t,proxy:s,withProxy:r,propsOptions:[i],slots:o,attrs:l,emit:a,render:u,renderCache:c,props:d,data:p,setupState:$,ctx:y,inheritAttrs:w}=n,C=Bt(n);let L,A;try{if(t.shapeFlag&4){const N=r||s,J=N;L=Qn(u.call(J,N,c,d,$,p,y)),A=l}else{const N=e;L=Qn(N.length>1?N(d,{attrs:l,slots:o,emit:a}):N(d,null)),A=e.props?l:Ua(l)}}catch(N){ht.length=0,rs(N,n,1),L=gn(ve)}let P=L;if(A&&w!==!1){const N=Object.keys(A),{shapeFlag:J}=P;N.length&&J&7&&(i&&N.some(Qt)&&(A=Va(A,i)),P=Ke(P,A,!1,!0))}return t.dirs&&(P=Ke(P,null,!1,!0),P.dirs=P.dirs?P.dirs.concat(t.dirs):t.dirs),t.transition&&ir(P,t.transition),L=P,Bt(C),L}const Ua=n=>{let e;for(const t in n)(t==="class"||t==="style"||Zt(t))&&((e||(e={}))[t]=n[t]);return e},Va=(n,e)=>{const t={};for(const s in n)(!Qt(s)||!(s.slice(9)in e))&&(t[s]=n[s]);return t};function za(n,e,t){const{props:s,children:r,component:i}=n,{props:o,children:l,patchFlag:a}=e,u=i.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&a>=0){if(a&1024)return!0;if(a&16)return s?Lr(s,o,u):!!o;if(a&8){const c=e.dynamicProps;for(let d=0;d<c.length;d++){const p=c[d];if(uo(o,s,p)&&!os(u,p))return!0}}}else return(r||l)&&(!l||!l.$stable)?!0:s===o?!1:s?o?Lr(s,o,u):!0:!!o;return!1}function Lr(n,e,t){const s=Object.keys(e);if(s.length!==Object.keys(n).length)return!0;for(let r=0;r<s.length;r++){const i=s[r];if(uo(e,n,i)&&!os(t,i))return!0}return!1}function uo(n,e,t){const s=n[t],r=e[t];return t==="style"&&Z(s)&&Z(r)?!Js(s,r):s!==r}function Ga({vnode:n,parent:e,suspense:t},s){for(;e;){const r=e.subTree;if(r.suspense&&r.suspense.activeBranch===n&&(r.suspense.vnode.el=r.el=s,n=r),r===n)(n=e.vnode).el=s,e=e.parent;else break}t&&t.activeBranch===n&&(t.vnode.el=s)}const fo={},ho=()=>Object.create(fo),po=n=>Object.getPrototypeOf(n)===fo;function qa(n,e,t,s=!1){const r={},i=ho();n.propsDefaults=Object.create(null),go(n,e,r,i);for(const o in n.propsOptions[0])o in r||(r[o]=void 0);t?n.props=s?r:qi(r):n.type.props?n.props=r:n.props=i,n.attrs=i}function Ka(n,e,t,s){const{props:r,attrs:i,vnode:{patchFlag:o}}=n,l=q(r),[a]=n.propsOptions;let u=!1;if((s||o>0)&&!(o&16)){if(o&8){const c=n.vnode.dynamicProps;for(let d=0;d<c.length;d++){let p=c[d];if(os(n.emitsOptions,p))continue;const $=e[p];if(a)if(K(i,p))$!==i[p]&&(i[p]=$,u=!0);else{const y=Rn(p);r[y]=Is(a,l,y,$,n,!1)}else $!==i[p]&&(i[p]=$,u=!0)}}}else{go(n,e,r,i)&&(u=!0);let c;for(const d in l)(!e||!K(e,d)&&((c=Pe(d))===d||!K(e,c)))&&(a?t&&(t[d]!==void 0||t[c]!==void 0)&&(r[d]=Is(a,l,d,void 0,n,!0)):delete r[d]);if(i!==l)for(const d in i)(!e||!K(e,d))&&(delete i[d],u=!0)}u&&ue(n.attrs,"set","")}function go(n,e,t,s){const[r,i]=n.propsOptions;let o=!1,l;if(e)for(let a in e){if(ot(a))continue;const u=e[a];let c;r&&K(r,c=Rn(a))?!i||!i.includes(c)?t[c]=u:(l||(l={}))[c]=u:os(n.emitsOptions,a)||(!(a in s)||u!==s[a])&&(s[a]=u,o=!0)}if(i){const a=q(t),u=l||sn;for(let c=0;c<i.length;c++){const d=i[c];t[d]=Is(r,a,d,u[d],n,!K(u,d))}}return o}function Is(n,e,t,s,r,i){const o=n[t];if(o!=null){const l=K(o,"default");if(l&&s===void 0){const a=o.default;if(o.type!==Function&&!o.skipFactory&&B(a)){const{propsDefaults:u}=r;if(t in u)s=u[t];else{const c=St(r);s=u[t]=a.call(null,e),c()}}else s=a;r.ce&&r.ce._setProp(t,s)}o[0]&&(i&&!l?s=!1:o[1]&&(s===""||s===Pe(t))&&(s=!0))}return s}const Ja=new WeakMap;function $o(n,e,t=!1){const s=t?Ja:e.propsCache,r=s.get(n);if(r)return r;const i=n.props,o={},l=[];let a=!1;if(!B(n)){const c=d=>{a=!0;const[p,$]=$o(d,e,!0);_n(o,p),$&&l.push(...$)};!t&&e.mixins.length&&e.mixins.forEach(c),n.extends&&c(n.extends),n.mixins&&n.mixins.forEach(c)}if(!i&&!a)return Z(n)&&s.set(n,je),je;if(F(i))for(let c=0;c<i.length;c++){const d=Rn(i[c]);Dr(d)&&(o[d]=sn)}else if(i)for(const c in i){const d=Rn(c);if(Dr(d)){const p=i[c],$=o[d]=F(p)||B(p)?{type:p}:_n({},p),y=$.type;let w=!1,C=!0;if(F(y))for(let L=0;L<y.length;++L){const A=y[L],P=B(A)&&A.name;if(P==="Boolean"){w=!0;break}else P==="String"&&(C=!1)}else w=B(y)&&y.name==="Boolean";$[0]=w,$[1]=C,(w||K($,"default"))&&l.push(d)}}const u=[o,l];return Z(n)&&s.set(n,u),u}function Dr(n){return n[0]!=="$"&&!ot(n)}const or=n=>n==="_"||n==="_ctx"||n==="$stable",lr=n=>F(n)?n.map(Qn):[Qn(n)],Wa=(n,e,t)=>{if(e._n)return e;const s=la((...r)=>lr(e(...r)),t);return s._c=!1,s},mo=(n,e,t)=>{const s=n._ctx;for(const r in n){if(or(r))continue;const i=n[r];if(B(i))e[r]=Wa(r,i,s);else if(i!=null){const o=lr(i);e[r]=()=>o}}},_o=(n,e)=>{const t=lr(e);n.slots.default=()=>t},bo=(n,e,t)=>{for(const s in e)(t||!or(s))&&(n[s]=e[s])},Ya=(n,e,t)=>{const s=n.slots=ho();if(n.vnode.shapeFlag&32){const r=e._;r?(bo(s,e,t),t&&Ei(s,"_",r,!0)):mo(e,s)}else e&&_o(n,e)},Za=(n,e,t)=>{const{vnode:s,slots:r}=n;let i=!0,o=sn;if(s.shapeFlag&32){const l=e._;l?t&&l===1?i=!1:bo(r,e,t):(i=!e.$stable,mo(e,r)),o=e}else e&&(_o(n,e),o={default:1});if(i)for(const l in r)!or(l)&&o[l]==null&&delete r[l]},En=tc;function Qa(n){return Xa(n)}function Xa(n,e){const t=es();t.__VUE__=!0;const{insert:s,remove:r,patchProp:i,createElement:o,createText:l,createComment:a,setText:u,setElementText:c,parentNode:d,nextSibling:p,setScopeId:$=ne,insertStaticContent:y}=n,w=(f,h,g,_=null,x=null,m=null,R=void 0,S=null,k=!!h.dynamicChildren)=>{if(f===h)return;f&&!nt(f,h)&&(_=b(f),Tn(f,x,m,!0),f=null),h.patchFlag===-2&&(k=!1,h.dynamicChildren=null);const{type:v,ref:D,shapeFlag:E}=h;switch(v){case ls:C(f,h,g,_);break;case ve:L(f,h,g,_);break;case Mt:f==null&&A(h,g,_,R);break;case Sn:ye(f,h,g,_,x,m,R,S,k);break;default:E&1?J(f,h,g,_,x,m,R,S,k):E&6?zn(f,h,g,_,x,m,R,S,k):(E&64||E&128)&&v.process(f,h,g,_,x,m,R,S,k,I)}D!=null&&x?ut(D,f&&f.ref,m,h||f,!h):D==null&&f&&f.ref!=null&&ut(f.ref,null,m,f,!0)},C=(f,h,g,_)=>{if(f==null)s(h.el=l(h.children),g,_);else{const x=h.el=f.el;h.children!==f.children&&u(x,h.children)}},L=(f,h,g,_)=>{f==null?s(h.el=a(h.children||""),g,_):h.el=f.el},A=(f,h,g,_)=>{[f.el,f.anchor]=y(f.children,h,g,_,f.el,f.anchor)},P=({el:f,anchor:h},g,_)=>{let x;for(;f&&f!==h;)x=p(f),s(f,g,_),f=x;s(h,g,_)},N=({el:f,anchor:h})=>{let g;for(;f&&f!==h;)g=p(f),r(f),f=g;r(h)},J=(f,h,g,_,x,m,R,S,k)=>{if(h.type==="svg"?R="svg":h.type==="math"&&(R="mathml"),f==null)ln(h,g,_,x,m,R,S,k);else{const v=f.el&&f.el._isVueCE?f.el:null;try{v&&v._beginPatch(),ge(f,h,x,m,R,S,k)}finally{v&&v._endPatch()}}},ln=(f,h,g,_,x,m,R,S)=>{let k,v;const{props:D,shapeFlag:E,transition:M,dirs:H}=f;if(k=f.el=o(f.type,m,D&&D.is,D),E&8?c(k,f.children):E&16&&Un(f.children,k,null,_,x,_s(f,m),R,S),H&&ke(f,null,_,"created"),W(k,f,f.scopeId,R,_),D){for(const en in D)en!=="value"&&!ot(en)&&i(k,en,null,D[en],m,_);"value"in D&&i(k,"value",null,D.value,m),(v=D.onVnodeBeforeMount)&&Wn(v,_,f)}H&&ke(f,null,_,"beforeMount");const V=nc(x,M);V&&M.beforeEnter(k),s(k,h,g),((v=D&&D.onVnodeMounted)||V||H)&&En(()=>{try{v&&Wn(v,_,f),V&&M.enter(k),H&&ke(f,null,_,"mounted")}finally{}},x)},W=(f,h,g,_,x)=>{if(g&&$(f,g),_)for(let m=0;m<_.length;m++)$(f,_[m]);if(x){let m=x.subTree;if(h===m||wo(m.type)&&(m.ssContent===h||m.ssFallback===h)){const R=x.vnode;W(f,R,R.scopeId,R.slotScopeIds,x.parent)}}},Un=(f,h,g,_,x,m,R,S,k=0)=>{for(let v=k;v<f.length;v++){const D=f[v]=S?ce(f[v]):Qn(f[v]);w(null,D,h,g,_,x,m,R,S)}},ge=(f,h,g,_,x,m,R)=>{const S=h.el=f.el;let{patchFlag:k,dynamicChildren:v,dirs:D}=h;k|=f.patchFlag&16;const E=f.props||sn,M=h.props||sn;let H;if(g&&Se(g,!1),(H=M.onVnodeBeforeUpdate)&&Wn(H,g,h,f),D&&ke(h,f,g,"beforeUpdate"),g&&Se(g,!0),v&&(!f.dynamicChildren||f.dynamicChildren.length!==v.length)&&(k=0,R=!1,v=null),(E.innerHTML&&M.innerHTML==null||E.textContent&&M.textContent==null)&&c(S,""),v?Vn(f.dynamicChildren,v,S,g,_,_s(h,x),m):R||z(f,h,S,null,g,_,_s(h,x),m,!1),k>0){if(k&16)$e(S,E,M,g,x);else if(k&2&&E.class!==M.class&&i(S,"class",null,M.class,x),k&4&&i(S,"style",E.style,M.style,x),k&8){const V=h.dynamicProps;for(let en=0;en<V.length;en++){const X=V[en],fn=E[X],$n=M[X];($n!==fn||X==="value")&&i(S,X,fn,$n,x,g)}}k&1&&f.children!==h.children&&c(S,h.children)}else!R&&v==null&&$e(S,E,M,g,x);((H=M.onVnodeUpdated)||D)&&En(()=>{H&&Wn(H,g,h,f),D&&ke(h,f,g,"updated")},_)},Vn=(f,h,g,_,x,m,R)=>{for(let S=0;S<h.length;S++){const k=f[S],v=h[S],D=k.el&&(k.type===Sn||!nt(k,v)||k.shapeFlag&198)?d(k.el):g;w(k,v,D,null,_,x,m,R,!0)}},$e=(f,h,g,_,x)=>{if(h!==g){if(h!==sn)for(const m in h)!ot(m)&&!(m in g)&&i(f,m,h[m],null,x,_);for(const m in g){if(ot(m))continue;const R=g[m],S=h[m];R!==S&&m!=="value"&&i(f,m,S,R,x,_)}"value"in g&&i(f,"value",h.value,g.value,x)}},ye=(f,h,g,_,x,m,R,S,k)=>{const v=h.el=f?f.el:l(""),D=h.anchor=f?f.anchor:l("");let{patchFlag:E,dynamicChildren:M,slotScopeIds:H}=h;H&&(S=S?S.concat(H):H),f==null?(s(v,g,_),s(D,g,_),Un(h.children||[],g,D,x,m,R,S,k)):E>0&&E&64&&M&&f.dynamicChildren&&f.dynamicChildren.length===M.length?(Vn(f.dynamicChildren,M,g,x,m,R,S),(h.key!=null||x&&h===x.subTree)&&xo(f,h,!0)):z(f,h,g,D,x,m,R,S,k)},zn=(f,h,g,_,x,m,R,S,k)=>{h.slotScopeIds=S,f==null?h.shapeFlag&512?x.ctx.activate(h,g,_,R,k):Ze(h,g,_,x,m,R,k):Ie(f,h,k)},Ze=(f,h,g,_,x,m,R)=>{const S=f.component=fc(f,_,x);if(so(f)&&(S.ctx.renderer=I),hc(S,!1,R),S.asyncDep){if(x&&x.registerDep(S,pn,R),!f.el){const k=S.subTree=gn(ve);L(null,k,h,g),f.placeholder=k.el}}else pn(S,f,h,g,x,m,R)},Ie=(f,h,g)=>{const _=h.component=f.component;if(za(f,h,g))if(_.asyncDep&&!_.asyncResolved){Q(_,h,g);return}else _.next=h,_.update();else h.el=f.el,_.vnode=h},pn=(f,h,g,_,x,m,R)=>{const S=()=>{if(f.isMounted){let{next:E,bu:M,u:H,parent:V,vnode:en}=f;{const Kn=vo(f);if(Kn){E&&(E.el=en.el,Q(f,E,R)),Kn.asyncDep.then(()=>{En(()=>{f.isUnmounted||v()},x)});return}}let X=E,fn;Se(f,!1),E?(E.el=en.el,Q(f,E,R)):E=en,M&&Ct(M),(fn=E.props&&E.props.onVnodeBeforeUpdate)&&Wn(fn,V,E,en),Se(f,!0);const $n=Mr(f),qn=f.subTree;f.subTree=$n,w(qn,$n,d(qn.el),b(qn),f,x,m),E.el=$n.el,X===null&&Ga(f,$n.el),H&&En(H,x),(fn=E.props&&E.props.onVnodeUpdated)&&En(()=>Wn(fn,V,E,en),x)}else{let E;const{el:M,props:H}=h,{bm:V,m:en,parent:X,root:fn,type:$n}=f,qn=ft(h);Se(f,!1),V&&Ct(V),!qn&&(E=H&&H.onVnodeBeforeMount)&&Wn(E,X,h),Se(f,!0);{fn.ce&&fn.ce._hasShadowRoot()&&fn.ce._injectChildStyle($n,f.parent?f.parent.type:void 0);const Kn=f.subTree=Mr(f);w(null,Kn,g,_,f,x,m),h.el=Kn.el}if(en&&En(en,x),!qn&&(E=H&&H.onVnodeMounted)){const Kn=h;En(()=>Wn(E,X,Kn),x)}(h.shapeFlag&256||X&&ft(X.vnode)&&X.vnode.shapeFlag&256)&&f.a&&En(f.a,x),f.isMounted=!0,h=g=_=null}};f.scope.on();const k=f.effect=new Pi(S);f.scope.off();const v=f.update=k.run.bind(k),D=f.job=k.runIfDirty.bind(k);D.i=f,D.id=f.uid,k.scheduler=()=>sr(D),Se(f,!0),v()},Q=(f,h,g)=>{h.component=f;const _=f.vnode.props;f.vnode=h,f.next=null,Ka(f,h.props,_,g),Za(f,h.children,g),se(),Tr(f),re()},z=(f,h,g,_,x,m,R,S,k=!1)=>{const v=f&&f.children,D=f?f.shapeFlag:0,E=h.children,{patchFlag:M,shapeFlag:H}=h;if(M>0){if(M&128){me(v,E,g,_,x,m,R,S,k);return}else if(M&256){ie(v,E,g,_,x,m,R,S,k);return}}H&8?(D&16&&Cn(v,x,m),E!==v&&c(g,E)):D&16?H&16?me(v,E,g,_,x,m,R,S,k):Cn(v,x,m,!0):(D&8&&c(g,""),H&16&&Un(E,g,_,x,m,R,S,k))},ie=(f,h,g,_,x,m,R,S,k)=>{f=f||je,h=h||je;const v=f.length,D=h.length,E=Math.min(v,D);let M;for(M=0;M<E;M++){const H=h[M]=k?ce(h[M]):Qn(h[M]);w(f[M],H,g,null,x,m,R,S,k)}v>D?Cn(f,x,m,!0,!1,E):Un(h,g,_,x,m,R,S,k,E)},me=(f,h,g,_,x,m,R,S,k)=>{let v=0;const D=h.length;let E=f.length-1,M=D-1;for(;v<=E&&v<=M;){const H=f[v],V=h[v]=k?ce(h[v]):Qn(h[v]);if(nt(H,V))w(H,V,g,null,x,m,R,S,k);else break;v++}for(;v<=E&&v<=M;){const H=f[E],V=h[M]=k?ce(h[M]):Qn(h[M]);if(nt(H,V))w(H,V,g,null,x,m,R,S,k);else break;E--,M--}if(v>E){if(v<=M){const H=M+1,V=H<D?h[H].el:_;for(;v<=M;)w(null,h[v]=k?ce(h[v]):Qn(h[v]),g,V,x,m,R,S,k),v++}}else if(v>M)for(;v<=E;)Tn(f[v],x,m,!0),v++;else{const H=v,V=v,en=new Map;for(v=V;v<=M;v++){const An=h[v]=k?ce(h[v]):Qn(h[v]);An.key!=null&&en.set(An.key,v)}let X,fn=0;const $n=M-V+1;let qn=!1,Kn=0;const Qe=new Array($n);for(v=0;v<$n;v++)Qe[v]=0;for(v=H;v<=E;v++){const An=f[v];if(fn>=$n){Tn(An,x,m,!0);continue}let Jn;if(An.key!=null)Jn=en.get(An.key);else for(X=V;X<=M;X++)if(Qe[X-V]===0&&nt(An,h[X])){Jn=X;break}Jn===void 0?Tn(An,x,m,!0):(Qe[Jn-V]=v+1,Jn>=Kn?Kn=Jn:qn=!0,w(An,h[Jn],g,null,x,m,R,S,k),fn++)}const xr=qn?ec(Qe):je;for(X=xr.length-1,v=$n-1;v>=0;v--){const An=V+v,Jn=h[An],vr=h[An+1],yr=An+1<D?vr.el||yo(vr):_;Qe[v]===0?w(null,Jn,g,yr,x,m,R,S,k):qn&&(X<0||v!==xr[X]?Gn(Jn,g,yr,2):X--)}}},Gn=(f,h,g,_,x=null)=>{const{el:m,type:R,transition:S,children:k,shapeFlag:v}=f;if(v&6){Gn(f.component.subTree,h,g,_);return}if(v&128){f.suspense.move(h,g,_);return}if(v&64){R.move(f,h,g,I);return}if(R===Sn){s(m,h,g);for(let E=0;E<k.length;E++)Gn(k[E],h,g,_);s(f.anchor,h,g);return}if(R===Mt){P(f,h,g);return}if(_!==2&&v&1&&S)if(_===0)S.persisted&&!m[$s]?s(m,h,g):(S.beforeEnter(m),s(m,h,g),En(()=>S.enter(m),x));else{const{leave:E,delayLeave:M,afterLeave:H}=S,V=()=>{f.ctx.isUnmounted?r(m):s(m,h,g)},en=()=>{const X=m._isLeaving||!!m[$s];m._isLeaving&&m[$s](!0),S.persisted&&!X?V():E(m,()=>{V(),H&&H()})};M?M(m,V,en):en()}else s(m,h,g)},Tn=(f,h,g,_=!1,x=!1)=>{const{type:m,props:R,ref:S,children:k,dynamicChildren:v,shapeFlag:D,patchFlag:E,dirs:M,cacheIndex:H,memo:V}=f;if(E===-2&&(x=!1),S!=null&&(se(),ut(S,null,g,f,!0),re()),H!=null&&(h.renderCache[H]=void 0),D&256){h.ctx.deactivate(f);return}const en=D&1&&M,X=!ft(f);let fn;if(X&&(fn=R&&R.onVnodeBeforeUnmount)&&Wn(fn,h,f),D&6)we(f.component,g,_);else{if(D&128){f.suspense.unmount(g,_);return}en&&ke(f,null,h,"beforeUnmount"),D&64?f.type.remove(f,h,g,I,_):v&&!v.hasOnce&&(m!==Sn||E>0&&E&64)?Cn(v,h,g,!1,!0):(m===Sn&&E&384||!x&&D&16)&&Cn(k,h,g),_&&Me(f)}const $n=V!=null&&H==null;(X&&(fn=R&&R.onVnodeUnmounted)||en||$n)&&En(()=>{fn&&Wn(fn,h,f),en&&ke(f,null,h,"unmounted"),$n&&(f.el=null)},g)},Me=f=>{const{type:h,el:g,anchor:_,transition:x}=f;if(h===Sn){Le(g,_);return}if(h===Mt){N(f);return}const m=()=>{r(g),x&&!x.persisted&&x.afterLeave&&x.afterLeave()};if(f.shapeFlag&1&&x&&!x.persisted){const{leave:R,delayLeave:S}=x,k=()=>R(g,m);S?S(f.el,m,k):k()}else m()},Le=(f,h)=>{let g;for(;f!==h;)g=p(f),r(f),f=g;r(h)},we=(f,h,g)=>{const{bum:_,scope:x,job:m,subTree:R,um:S,m:k,a:v}=f;Hr(k),Hr(v),_&&Ct(_),x.stop(),m&&(m.flags|=8,Tn(R,f,h,g)),S&&En(S,h),En(()=>{f.isUnmounted=!0},h)},Cn=(f,h,g,_=!1,x=!1,m=0)=>{for(let R=m;R<f.length;R++)Tn(f[R],h,g,_,x)},b=f=>{if(f.shapeFlag&6)return b(f.component.subTree);if(f.shapeFlag&128)return f.suspense.next();const h=p(f.anchor||f.el),g=h&&h[ha];return g?p(g):h};let O=!1;const T=(f,h,g)=>{let _;f==null?h._vnode&&(Tn(h._vnode,null,null,!0),_=h._vnode.component):w(h._vnode||null,f,h,null,null,null,g),h._vnode=f,O||(O=!0,Tr(_),Zi(),O=!1)},I={p:w,um:Tn,m:Gn,r:Me,mt:Ze,mc:Un,pc:z,pbc:Vn,n:b,o:n};return{render:T,hydrate:void 0,createApp:Ha(T)}}function _s({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function Se({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function nc(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function xo(n,e,t=!1){const s=n.children,r=e.children;if(F(s)&&F(r))for(let i=0;i<s.length;i++){const o=s[i];let l=r[i];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=r[i]=ce(r[i]),l.el=o.el),!t&&l.patchFlag!==-2&&xo(o,l)),l.type===ls&&(l.patchFlag===-1&&(l=r[i]=ce(l)),l.el=o.el),l.type===ve&&!l.el&&(l.el=o.el)}}function ec(n){const e=n.slice(),t=[0];let s,r,i,o,l;const a=n.length;for(s=0;s<a;s++){const u=n[s];if(u!==0){if(r=t[t.length-1],n[r]<u){e[s]=r,t.push(s);continue}for(i=0,o=t.length-1;i<o;)l=i+o>>1,n[t[l]]<u?i=l+1:o=l;u<n[t[i]]&&(i>0&&(e[s]=t[i-1]),t[i]=s)}}for(i=t.length,o=t[i-1];i-- >0;)t[i]=o,o=e[o];return t}function vo(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:vo(e)}function Hr(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}function yo(n){if(n.placeholder)return n.placeholder;const e=n.component;return e?yo(e.subTree):null}const wo=n=>n.__isSuspense;function tc(n,e){e&&e.pendingBranch?F(n)?e.effects.push(...n):e.effects.push(n):oa(n)}const Sn=Symbol.for("v-fgt"),ls=Symbol.for("v-txt"),ve=Symbol.for("v-cmt"),Mt=Symbol.for("v-stc"),ht=[];let Pn=null;function on(n=!1){ht.push(Pn=n?null:[])}function sc(){ht.pop(),Pn=ht[ht.length-1]||null}let xt=1;function zt(n,e=!1){xt+=n,n<0&&Pn&&e&&(Pn.hasOnce=!0)}function ko(n){return n.dynamicChildren=xt>0?Pn||je:null,sc(),xt>0&&Pn&&Pn.push(n),n}function cn(n,e,t,s,r,i){return ko(j(n,e,t,s,r,i,!0))}function So(n,e,t,s,r){return ko(gn(n,e,t,s,r,!0))}function Gt(n){return n?n.__v_isVNode===!0:!1}function nt(n,e){return n.type===e.type&&n.key===e.key}const Ro=({key:n})=>n??null,Lt=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?un(n)||vn(n)||B(n)?{i:Nn,r:n,k:e,f:!!t}:n:null);function j(n,e=null,t=null,s=0,r=null,i=n===Sn?0:1,o=!1,l=!1){const a={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&Ro(e),ref:e&&Lt(e),scopeId:Xi,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:s,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:Nn};return l?(qt(a,t),i&128&&n.normalize(a)):t&&(a.shapeFlag|=un(t)?8:16),xt>0&&!o&&Pn&&(a.patchFlag>0||i&6)&&a.patchFlag!==32&&Pn.push(a),a}const gn=rc;function rc(n,e=null,t=null,s=0,r=null,i=!1){if((!n||n===Aa)&&(n=ve),Gt(n)){const l=Ke(n,e,!0);return t&&qt(l,t),xt>0&&!i&&Pn&&(l.shapeFlag&6?Pn[Pn.indexOf(n)]=l:Pn.push(l)),l.patchFlag=-2,l}if(_c(n)&&(n=n.__vccOpts),e){e=ic(e);let{class:l,style:a}=e;l&&!un(l)&&(e.class=Ge(l)),Z(a)&&(er(a)&&!F(a)&&(a=_n({},a)),e.style=Ks(a))}const o=un(n)?1:wo(n)?128:pa(n)?64:Z(n)?4:B(n)?2:0;return j(n,e,t,s,r,o,i,!0)}function ic(n){return n?er(n)||po(n)?_n({},n):n:null}function Ke(n,e,t=!1,s=!1){const{props:r,ref:i,patchFlag:o,children:l,transition:a}=n,u=e?ac(r||{},e):r,c={__v_isVNode:!0,__v_skip:!0,type:n.type,props:u,key:u&&Ro(u),ref:e&&e.ref?t&&i?F(i)?i.concat(Lt(e)):[i,Lt(e)]:Lt(e):i,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:l,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==Sn?o===-1?16:o|16:o,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:a,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&Ke(n.ssContent),ssFallback:n.ssFallback&&Ke(n.ssFallback),placeholder:n.placeholder,el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return a&&s&&ir(c,a.clone(c)),c}function oc(n=" ",e=0){return gn(ls,null,n,e)}function lc(n,e){const t=gn(Mt,null,n);return t.staticCount=e,t}function ar(n="",e=!1){return e?(on(),So(ve,null,n)):gn(ve,null,n)}function Qn(n){return n==null||typeof n=="boolean"?gn(ve):F(n)?gn(Sn,null,n.slice()):Gt(n)?ce(n):gn(ls,null,String(n))}function ce(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:Ke(n)}function qt(n,e){let t=0;const{shapeFlag:s}=n;if(e==null)e=null;else if(F(e))t=16;else if(typeof e=="object")if(s&65){const r=e.default;r&&(r._c&&(r._d=!1),qt(n,r()),r._c&&(r._d=!0));return}else{t=32;const r=e._;!r&&!po(e)?e._ctx=Nn:r===3&&Nn&&(Nn.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else if(B(e)){if(s&65){qt(n,{default:e});return}e={default:e,_ctx:Nn},t=32}else e=String(e),s&64?(t=16,e=[oc(e)]):t=8;n.children=e,n.shapeFlag|=t}function ac(...n){const e={};for(let t=0;t<n.length;t++){const s=n[t];for(const r in s)if(r==="class")e.class!==s.class&&(e.class=Ge([e.class,s.class]));else if(r==="style")e.style=Ks([e.style,s.style]);else if(Zt(r)){const i=e[r],o=s[r];o&&i!==o&&!(F(i)&&i.includes(o))?e[r]=i?[].concat(i,o):o:o==null&&i==null&&!Qt(r)&&(e[r]=o)}else r!==""&&(e[r]=s[r])}return e}function Wn(n,e,t,s=null){Bn(n,e,7,[t,s])}const cc=ao();let uc=0;function fc(n,e,t){const s=n.type,r=(e?e.appContext:n.appContext)||cc,i={uid:uc++,vnode:n,type:s,parent:e,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Nl(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(r.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:$o(s,r),emitsOptions:co(s,r),emit:null,emitted:null,propsDefaults:sn,inheritAttrs:s.inheritAttrs,ctx:sn,data:sn,props:sn,attrs:sn,slots:sn,refs:sn,setupState:sn,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=Ba.bind(null,i),n.ce&&n.ce(i),i}let xn=null;const dc=()=>xn||Nn;let Kt,Ms;{const n=es(),e=(t,s)=>{let r;return(r=n[t])||(r=n[t]=[]),r.push(s),i=>{r.length>1?r.forEach(o=>o(i)):r[0](i)}};Kt=e("__VUE_INSTANCE_SETTERS__",t=>xn=t),Ms=e("__VUE_SSR_SETTERS__",t=>vt=t)}const St=n=>{const e=xn;return Kt(n),n.scope.on(),()=>{n.scope.off(),Kt(e)}},Fr=()=>{xn&&xn.scope.off(),Kt(null)};function To(n){return n.vnode.shapeFlag&4}let vt=!1;function hc(n,e=!1,t=!1){e&&Ms(e);const{props:s,children:r}=n.vnode,i=To(n);qa(n,s,i,e),Ya(n,r,t||e);const o=i?pc(n,e):void 0;return e&&Ms(!1),o}function pc(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,Na);const{setup:s}=t;if(s){se();const r=n.setupContext=s.length>1?$c(n):null,i=St(n),o=kt(s,n,0,[n.props,r]),l=Si(o);if(re(),i(),(l||n.sp)&&!ft(n)&&to(n),l){if(o.then(Fr,Fr),e)return o.then(a=>{Br(n,a)}).catch(a=>{rs(a,n,0)});n.asyncDep=o}else Br(n,o)}else Eo(n)}function Br(n,e,t){B(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:Z(e)&&(n.setupState=Ji(e)),Eo(n)}function Eo(n,e,t){const s=n.type;n.render||(n.render=s.render||ne);{const r=St(n);se();try{Pa(n)}finally{re(),r()}}}const gc={get(n,e){return bn(n,"get",""),n[e]}};function $c(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,gc),slots:n.slots,emit:n.emit,expose:e}}function as(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(Ji(Yl(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in dt)return dt[t](n)},has(e,t){return t in e||t in dt}})):n.proxy}function mc(n,e=!0){return B(n)?n.displayName||n.name:n.name||e&&n.__name}function _c(n){return B(n)&&"__vccOpts"in n}const In=(n,e)=>ea(n,e,vt);function Ao(n,e,t){try{zt(-1);const s=arguments.length;return s===2?Z(e)&&!F(e)?Gt(e)?gn(n,null,[e]):gn(n,e):gn(n,null,e):(s>3?t=Array.prototype.slice.call(arguments,2):s===3&&Gt(t)&&(t=[t]),gn(n,e,t))}finally{zt(1)}}const bc="3.5.39";/**
* @vue/runtime-dom v3.5.39
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ls;const jr=typeof window<"u"&&window.trustedTypes;if(jr)try{Ls=jr.createPolicy("vue",{createHTML:n=>n})}catch{}const Oo=Ls?n=>Ls.createHTML(n):n=>n,xc="http://www.w3.org/2000/svg",vc="http://www.w3.org/1998/Math/MathML",ae=typeof document<"u"?document:null,Ur=ae&&ae.createElement("template"),yc={insert:(n,e,t)=>{e.insertBefore(n,t||null)},remove:n=>{const e=n.parentNode;e&&e.removeChild(n)},createElement:(n,e,t,s)=>{const r=e==="svg"?ae.createElementNS(xc,n):e==="mathml"?ae.createElementNS(vc,n):t?ae.createElement(n,{is:t}):ae.createElement(n);return n==="select"&&s&&s.multiple!=null&&r.setAttribute("multiple",s.multiple),r},createText:n=>ae.createTextNode(n),createComment:n=>ae.createComment(n),setText:(n,e)=>{n.nodeValue=e},setElementText:(n,e)=>{n.textContent=e},parentNode:n=>n.parentNode,nextSibling:n=>n.nextSibling,querySelector:n=>ae.querySelector(n),setScopeId(n,e){n.setAttribute(e,"")},insertStaticContent(n,e,t,s,r,i){const o=t?t.previousSibling:e.lastChild;if(r&&(r===i||r.nextSibling))for(;e.insertBefore(r.cloneNode(!0),t),!(r===i||!(r=r.nextSibling)););else{Ur.innerHTML=Oo(s==="svg"?`<svg>${n}</svg>`:s==="mathml"?`<math>${n}</math>`:n);const l=Ur.content;if(s==="svg"||s==="mathml"){const a=l.firstChild;for(;a.firstChild;)l.appendChild(a.firstChild);l.removeChild(a)}e.insertBefore(l,t)}return[o?o.nextSibling:e.firstChild,t?t.previousSibling:e.lastChild]}},wc=Symbol("_vtc");function kc(n,e,t){const s=n[wc];s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?n.removeAttribute("class"):t?n.setAttribute("class",e):n.className=e}const Vr=Symbol("_vod"),Sc=Symbol("_vsh"),Rc=Symbol(""),Tc=/(?:^|;)\s*display\s*:/;function Ec(n,e,t){const s=n.style,r=un(t);let i=!1;if(t&&!r){if(e)if(un(e))for(const o of e.split(";")){const l=o.slice(0,o.indexOf(":")).trim();t[l]==null&&it(s,l,"")}else for(const o in e)t[o]==null&&it(s,o,"");for(const o in t){o==="display"&&(i=!0);const l=t[o];l!=null?Oc(n,o,!un(e)&&e?e[o]:void 0,l)||it(s,o,l):it(s,o,"")}}else if(r){if(e!==t){const o=s[Rc];o&&(t+=";"+o),s.cssText=t,i=Tc.test(t)}}else e&&n.removeAttribute("style");Vr in n&&(n[Vr]=i?s.display:"",n[Sc]&&(s.display="none"))}const zr=/\s*!important$/;function it(n,e,t){if(F(t))t.forEach(s=>it(n,e,s));else if(t==null&&(t=""),e.startsWith("--"))n.setProperty(e,t);else{const s=Ac(n,e);zr.test(t)?n.setProperty(Pe(s),t.replace(zr,""),"important"):n[s]=t}}const Gr=["Webkit","Moz","ms"],bs={};function Ac(n,e){const t=bs[e];if(t)return t;let s=Rn(e);if(s!=="filter"&&s in n)return bs[e]=s;s=ns(s);for(let r=0;r<Gr.length;r++){const i=Gr[r]+s;if(i in n)return bs[e]=i}return e}function Oc(n,e,t,s){return n.tagName==="TEXTAREA"&&(e==="width"||e==="height")&&un(s)&&t===s}const qr="http://www.w3.org/1999/xlink";function Kr(n,e,t,s,r,i=Al(e)){s&&e.startsWith("xlink:")?t==null?n.removeAttributeNS(qr,e.slice(6,e.length)):n.setAttributeNS(qr,e,t):t==null||i&&!Ai(t)?n.removeAttribute(e):n.setAttribute(e,i?"":te(t)?String(t):t)}function Jr(n,e,t,s,r){if(e==="innerHTML"||e==="textContent"){t!=null&&(n[e]=e==="innerHTML"?Oo(t):t);return}const i=n.tagName;if(e==="value"&&i!=="PROGRESS"&&!i.includes("-")){const l=i==="OPTION"?n.getAttribute("value")||"":n.value,a=t==null?n.type==="checkbox"?"on":"":String(t);(l!==a||!("_value"in n))&&(n.value=a),t==null&&n.removeAttribute(e),n._value=t;return}let o=!1;if(t===""||t==null){const l=typeof n[e];l==="boolean"?t=Ai(t):t==null&&l==="string"?(t="",o=!0):l==="number"&&(t=0,o=!0)}try{n[e]=t}catch{}o&&n.removeAttribute(r||e)}function Fe(n,e,t,s){n.addEventListener(e,t,s)}function Nc(n,e,t,s){n.removeEventListener(e,t,s)}const Wr=Symbol("_vei");function Pc(n,e,t,s,r=null){const i=n[Wr]||(n[Wr]={}),o=i[e];if(s&&o)o.value=s;else{const[l,a]=Mc(e);if(s){const u=i[e]=Hc(s,r);Fe(n,l,u,a)}else o&&(Nc(n,l,o,a),i[e]=void 0)}}const Cc=/(Once|Passive|Capture)$/,Ic=/^on:?(?:Once|Passive|Capture)$/;function Mc(n){let e,t;for(;(t=n.match(Cc))&&!Ic.test(n);)e||(e={}),n=n.slice(0,n.length-t[1].length),e[t[1].toLowerCase()]=!0;return[n[2]===":"?n.slice(3):Pe(n.slice(2)),e]}let xs=0;const Lc=Promise.resolve(),Dc=()=>xs||(Lc.then(()=>xs=0),xs=Date.now());function Hc(n,e){const t=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=t.attached)return;const r=t.value;if(F(r)){const i=s.stopImmediatePropagation;s.stopImmediatePropagation=()=>{i.call(s),s._stopped=!0};const o=r.slice(),l=[s];for(let a=0;a<o.length&&!s._stopped;a++){const u=o[a];u&&Bn(u,e,5,l)}}else Bn(r,e,5,[s])};return t.value=n,t.attached=Dc(),t}const Yr=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&n.charCodeAt(2)>96&&n.charCodeAt(2)<123,Fc=(n,e,t,s,r,i)=>{const o=r==="svg";e==="class"?kc(n,s,o):e==="style"?Ec(n,t,s):Zt(e)?Qt(e)||Pc(n,e,t,s,i):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Bc(n,e,s,o))?(Jr(n,e,s),!n.tagName.includes("-")&&(e==="value"||e==="checked"||e==="selected")&&Kr(n,e,s,o,i,e!=="value")):n._isVueCE&&(jc(n,e)||n._def.__asyncLoader&&(/[A-Z]/.test(e)||!un(s)))?Jr(n,Rn(e),s,i,e):(e==="true-value"?n._trueValue=s:e==="false-value"&&(n._falseValue=s),Kr(n,e,s,o))};function Bc(n,e,t,s){if(s)return!!(e==="innerHTML"||e==="textContent"||e in n&&Yr(e)&&B(t));if(e==="spellcheck"||e==="draggable"||e==="translate"||e==="autocorrect"||e==="sandbox"&&n.tagName==="IFRAME"||e==="form"||e==="list"&&n.tagName==="INPUT"||e==="type"&&n.tagName==="TEXTAREA")return!1;if(e==="width"||e==="height"){const r=n.tagName;if(r==="IMG"||r==="VIDEO"||r==="CANVAS"||r==="SOURCE")return!1}return Yr(e)&&un(t)?!1:e in n}function jc(n,e){const t=n._def.props;if(!t)return!1;const s=Rn(e);return Array.isArray(t)?t.some(r=>Rn(r)===s):Object.keys(t).some(r=>Rn(r)===s)}const Zr=n=>{const e=n.props["onUpdate:modelValue"]||!1;return F(e)?t=>Ct(e,t):e};function Uc(n){n.target.composing=!0}function Qr(n){const e=n.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const vs=Symbol("_assign");function Xr(n,e,t){return e&&(n=n.trim()),t&&(n=qs(n)),n}const Vc={created(n,{modifiers:{lazy:e,trim:t,number:s}},r){n[vs]=Zr(r);const i=s||r.props&&r.props.type==="number";Fe(n,e?"change":"input",o=>{o.target.composing||n[vs](Xr(n.value,t,i))}),(t||i)&&Fe(n,"change",()=>{n.value=Xr(n.value,t,i)}),e||(Fe(n,"compositionstart",Uc),Fe(n,"compositionend",Qr),Fe(n,"change",Qr))},mounted(n,{value:e}){n.value=e??""},beforeUpdate(n,{value:e,oldValue:t,modifiers:{lazy:s,trim:r,number:i}},o){if(n[vs]=Zr(o),n.composing)return;const l=(i||n.type==="number")&&!/^0\d/.test(n.value)?qs(n.value):n.value,a=e??"";if(l===a)return;const u=n.getRootNode();(u instanceof Document||u instanceof ShadowRoot)&&u.activeElement===n&&n.type!=="range"&&(s&&e===t||r&&n.value.trim()===a)||(n.value=a)}},zc=["ctrl","shift","alt","meta"],Gc={stop:n=>n.stopPropagation(),prevent:n=>n.preventDefault(),self:n=>n.target!==n.currentTarget,ctrl:n=>!n.ctrlKey,shift:n=>!n.shiftKey,alt:n=>!n.altKey,meta:n=>!n.metaKey,left:n=>"button"in n&&n.button!==0,middle:n=>"button"in n&&n.button!==1,right:n=>"button"in n&&n.button!==2,exact:(n,e)=>zc.some(t=>n[`${t}Key`]&&!e.includes(t))},qc=(n,e)=>{if(!n)return n;const t=n._withMods||(n._withMods={}),s=e.join(".");return t[s]||(t[s]=(r,...i)=>{for(let o=0;o<e.length;o++){const l=Gc[e[o]];if(l&&l(r,e))return}return n(r,...i)})},Kc=_n({patchProp:Fc},yc);let ni;function Jc(){return ni||(ni=Qa(Kc))}const Wc=(...n)=>{const e=Jc().createApp(...n),{mount:t}=e;return e.mount=s=>{const r=Zc(s);if(!r)return;const i=e._component;!B(i)&&!i.render&&!i.template&&(i.template=r.innerHTML),r.nodeType===1&&(r.textContent="");const o=t(r,!1,Yc(r));return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),o},e};function Yc(n){if(n instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&n instanceof MathMLElement)return"mathml"}function Zc(n){return un(n)?document.querySelector(n):n}const Dt=Te(localStorage.getItem("theme")!=="light");fa(()=>{const n=Dt.value?"dark":"light";document.documentElement.setAttribute("data-theme",n),localStorage.setItem("theme",n)});function Qc(){function n(){Dt.value=!Dt.value}return{isDark:Dt,toggle:n}}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */const Be=typeof document<"u";function No(n){return typeof n=="object"||"displayName"in n||"props"in n||"__vccOpts"in n}function Xc(n){return n.__esModule||n[Symbol.toStringTag]==="Module"||n.default&&No(n.default)}const G=Object.assign;function ys(n,e){const t={};for(const s in e){const r=e[s];t[s]=jn(r)?r.map(n):n(r)}return t}const pt=()=>{},jn=Array.isArray;function ei(n,e){const t={};for(const s in n)t[s]=s in e?e[s]:n[s];return t}const Po=/#/g,nu=/&/g,eu=/\//g,tu=/=/g,su=/\?/g,Co=/\+/g,ru=/%5B/g,iu=/%5D/g,Io=/%5E/g,ou=/%60/g,Mo=/%7B/g,lu=/%7C/g,Lo=/%7D/g,au=/%20/g;function cr(n){return n==null?"":encodeURI(""+n).replace(lu,"|").replace(ru,"[").replace(iu,"]")}function cu(n){return cr(n).replace(Mo,"{").replace(Lo,"}").replace(Io,"^")}function Ds(n){return cr(n).replace(Co,"%2B").replace(au,"+").replace(Po,"%23").replace(nu,"%26").replace(ou,"`").replace(Mo,"{").replace(Lo,"}").replace(Io,"^")}function uu(n){return Ds(n).replace(tu,"%3D")}function fu(n){return cr(n).replace(Po,"%23").replace(su,"%3F")}function du(n){return fu(n).replace(eu,"%2F")}function yt(n){if(n==null)return null;try{return decodeURIComponent(""+n)}catch{}return""+n}const hu=/\/$/,pu=n=>n.replace(hu,"");function ws(n,e,t="/"){let s,r={},i="",o="";const l=e.indexOf("#");let a=e.indexOf("?");return a=l>=0&&a>l?-1:a,a>=0&&(s=e.slice(0,a),i=e.slice(a,l>0?l:e.length),r=n(i.slice(1))),l>=0&&(s=s||e.slice(0,l),o=e.slice(l,e.length)),s=_u(s??e,t),{fullPath:s+i+o,path:s,query:r,hash:yt(o)}}function gu(n,e){const t=e.query?n(e.query):"";return e.path+(t&&"?")+t+(e.hash||"")}function ti(n,e){return!e||!n.toLowerCase().startsWith(e.toLowerCase())?n:n.slice(e.length)||"/"}function $u(n,e,t){const s=e.matched.length-1,r=t.matched.length-1;return s>-1&&s===r&&Je(e.matched[s],t.matched[r])&&Do(e.params,t.params)&&n(e.query)===n(t.query)&&e.hash===t.hash}function Je(n,e){return(n.aliasOf||n)===(e.aliasOf||e)}function Do(n,e){if(Object.keys(n).length!==Object.keys(e).length)return!1;for(var t in n)if(!mu(n[t],e[t]))return!1;return!0}function mu(n,e){return jn(n)?si(n,e):jn(e)?si(e,n):(n==null?void 0:n.valueOf())===(e==null?void 0:e.valueOf())}function si(n,e){return jn(e)?n.length===e.length&&n.every((t,s)=>t===e[s]):n.length===1&&n[0]===e}function _u(n,e){if(n.startsWith("/"))return n;if(!n)return e;const t=e.split("/"),s=n.split("/"),r=s[s.length-1];(r===".."||r===".")&&s.push("");let i=t.length-1,o,l;for(o=0;o<s.length;o++)if(l=s[o],l!==".")if(l==="..")i>1&&i--;else break;return t.slice(0,i).join("/")+"/"+s.slice(o).join("/")}const _e={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Hs=function(n){return n.pop="pop",n.push="push",n}({}),ks=function(n){return n.back="back",n.forward="forward",n.unknown="",n}({});function bu(n){if(!n)if(Be){const e=document.querySelector("base");n=e&&e.getAttribute("href")||"/",n=n.replace(/^\w+:\/\/[^\/]+/,"")}else n="/";return n[0]!=="/"&&n[0]!=="#"&&(n="/"+n),pu(n)}const xu=/^[^#]+#/;function vu(n,e){return n.replace(xu,"#")+e}function yu(n,e){const t=document.documentElement.getBoundingClientRect(),s=n.getBoundingClientRect();return{behavior:e.behavior,left:s.left-t.left-(e.left||0),top:s.top-t.top-(e.top||0)}}const cs=()=>({left:window.scrollX,top:window.scrollY});function wu(n){let e;if("el"in n){const t=n.el,s=typeof t=="string"&&t.startsWith("#"),r=typeof t=="string"?s?document.getElementById(t.slice(1)):document.querySelector(t):t;if(!r)return;e=yu(r,n)}else e=n;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.scrollX,e.top!=null?e.top:window.scrollY)}function ri(n,e){return(history.state?history.state.position-e:-1)+n}const Fs=new Map;function ku(n,e){Fs.set(n,e)}function Su(n){const e=Fs.get(n);return Fs.delete(n),e}function Ru(n){return typeof n=="string"||n&&typeof n=="object"}function Ho(n){return typeof n=="string"||typeof n=="symbol"}let an=function(n){return n[n.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",n[n.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",n[n.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",n[n.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",n[n.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",n}({});const Fo=Symbol("");an.MATCHER_NOT_FOUND+"",an.NAVIGATION_GUARD_REDIRECT+"",an.NAVIGATION_ABORTED+"",an.NAVIGATION_CANCELLED+"",an.NAVIGATION_DUPLICATED+"";function We(n,e){return G(new Error,{type:n,[Fo]:!0},e)}function le(n,e){return n instanceof Error&&Fo in n&&(e==null||!!(n.type&e))}const Tu=["params","query","hash"];function Eu(n){if(typeof n=="string")return n;if(n.path!=null)return n.path;const e={};for(const t of Tu)t in n&&(e[t]=n[t]);return JSON.stringify(e,null,2)}function Au(n){const e={};if(n===""||n==="?")return e;const t=(n[0]==="?"?n.slice(1):n).split("&");for(let s=0;s<t.length;++s){const r=t[s].replace(Co," "),i=r.indexOf("="),o=yt(i<0?r:r.slice(0,i)),l=i<0?null:yt(r.slice(i+1));if(o in e){let a=e[o];jn(a)||(a=e[o]=[a]),a.push(l)}else e[o]=l}return e}function ii(n){let e="";for(let t in n){const s=n[t];if(t=uu(t),s==null){s!==void 0&&(e+=(e.length?"&":"")+t);continue}(jn(s)?s.map(r=>r&&Ds(r)):[s&&Ds(s)]).forEach(r=>{r!==void 0&&(e+=(e.length?"&":"")+t,r!=null&&(e+="="+r))})}return e}function Ou(n){const e={};for(const t in n){const s=n[t];s!==void 0&&(e[t]=jn(s)?s.map(r=>r==null?null:""+r):s==null?s:""+s)}return e}const Nu=Symbol(""),oi=Symbol(""),ur=Symbol(""),fr=Symbol(""),Bs=Symbol("");function et(){let n=[];function e(s){return n.push(s),()=>{const r=n.indexOf(s);r>-1&&n.splice(r,1)}}function t(){n=[]}return{add:e,list:()=>n.slice(),reset:t}}function xe(n,e,t,s,r,i=o=>o()){const o=s&&(s.enterCallbacks[r]=s.enterCallbacks[r]||[]);return()=>new Promise((l,a)=>{const u=p=>{p===!1?a(We(an.NAVIGATION_ABORTED,{from:t,to:e})):p instanceof Error?a(p):Ru(p)?a(We(an.NAVIGATION_GUARD_REDIRECT,{from:e,to:p})):(o&&s.enterCallbacks[r]===o&&typeof p=="function"&&o.push(p),l())},c=i(()=>n.call(s&&s.instances[r],e,t,u));let d=Promise.resolve(c);n.length<3&&(d=d.then(u)),d.catch(p=>a(p))})}function Ss(n,e,t,s,r=i=>i()){const i=[];for(const o of n)for(const l in o.components){let a=o.components[l];if(!(e!=="beforeRouteEnter"&&!o.instances[l]))if(No(a)){const u=(a.__vccOpts||a)[e];u&&i.push(xe(u,t,s,o,l,r))}else{let u=a();i.push(()=>u.then(c=>{if(!c)throw new Error(`Couldn't resolve component "${l}" at "${o.path}"`);const d=Xc(c)?c.default:c;o.mods[l]=c,o.components[l]=d;const p=(d.__vccOpts||d)[e];return p&&xe(p,t,s,o,l,r)()}))}}return i}function Pu(n,e){const t=[],s=[],r=[],i=Math.max(e.matched.length,n.matched.length);for(let o=0;o<i;o++){const l=e.matched[o];l&&(n.matched.find(u=>Je(u,l))?s.push(l):t.push(l));const a=n.matched[o];a&&(e.matched.find(u=>Je(u,a))||r.push(a))}return[t,s,r]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let Cu=()=>location.protocol+"//"+location.host;function Bo(n,e){const{pathname:t,search:s,hash:r}=e,i=n.indexOf("#");if(i>-1){let o=r.includes(n.slice(i))?n.slice(i).length:1,l=r.slice(o);return l[0]!=="/"&&(l="/"+l),ti(l,"")}return ti(t,n)+s+r}function Iu(n,e,t,s){let r=[],i=[],o=null;const l=({state:p})=>{const $=Bo(n,location),y=t.value,w=e.value;let C=0;if(p){if(t.value=$,e.value=p,o&&o===y){o=null;return}C=w?p.position-w.position:0}else s($);r.forEach(L=>{L(t.value,y,{delta:C,type:Hs.pop,direction:C?C>0?ks.forward:ks.back:ks.unknown})})};function a(){o=t.value}function u(p){r.push(p);const $=()=>{const y=r.indexOf(p);y>-1&&r.splice(y,1)};return i.push($),$}function c(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(G({},p.state,{scroll:cs()}),"")}}function d(){for(const p of i)p();i=[],window.removeEventListener("popstate",l),window.removeEventListener("pagehide",c),document.removeEventListener("visibilitychange",c)}return window.addEventListener("popstate",l),window.addEventListener("pagehide",c),document.addEventListener("visibilitychange",c),{pauseListeners:a,listen:u,destroy:d}}function li(n,e,t,s=!1,r=!1){return{back:n,current:e,forward:t,replaced:s,position:window.history.length,scroll:r?cs():null}}function Mu(n){const{history:e,location:t}=window,s={value:Bo(n,t)},r={value:e.state};r.value||i(s.value,{back:null,current:s.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(a,u,c){const d=n.indexOf("#"),p=d>-1?(t.host&&document.querySelector("base")?n:n.slice(d))+a:Cu()+n+a;try{e[c?"replaceState":"pushState"](u,"",p),r.value=u}catch($){console.error($),t[c?"replace":"assign"](p)}}function o(a,u){i(a,G({},e.state,li(r.value.back,a,r.value.forward,!0),u,{position:r.value.position}),!0),s.value=a}function l(a,u){const c=G({},r.value,e.state,{forward:a,scroll:cs()});i(c.current,c,!0),i(a,G({},li(s.value,a,null),{position:c.position+1},u),!1),s.value=a}return{location:s,state:r,push:l,replace:o}}function Lu(n){n=bu(n);const e=Mu(n),t=Iu(n,e.state,e.location,e.replace);function s(i,o=!0){o||t.pauseListeners(),history.go(i)}const r=G({location:"",base:n,go:s,createHref:vu.bind(null,n)},e,t);return Object.defineProperty(r,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(r,"state",{enumerable:!0,get:()=>e.state.value}),r}function Du(n){return n=location.host?n||location.pathname+location.search:"",n.includes("#")||(n+="#"),Lu(n)}let Ee=function(n){return n[n.Static=0]="Static",n[n.Param=1]="Param",n[n.Group=2]="Group",n}({});var hn=function(n){return n[n.Static=0]="Static",n[n.Param=1]="Param",n[n.ParamRegExp=2]="ParamRegExp",n[n.ParamRegExpEnd=3]="ParamRegExpEnd",n[n.EscapeNext=4]="EscapeNext",n}(hn||{});const Hu={type:Ee.Static,value:""},Fu=/[a-zA-Z0-9_]/;function Bu(n){if(!n)return[[]];if(n==="/")return[[Hu]];if(!n.startsWith("/"))throw new Error(`Invalid path "${n}"`);function e($){throw new Error(`ERR (${t})/"${u}": ${$}`)}let t=hn.Static,s=t;const r=[];let i;function o(){i&&r.push(i),i=[]}let l=0,a,u="",c="";function d(){u&&(t===hn.Static?i.push({type:Ee.Static,value:u}):t===hn.Param||t===hn.ParamRegExp||t===hn.ParamRegExpEnd?(i.length>1&&(a==="*"||a==="+")&&e(`A repeatable param (${u}) must be alone in its segment. eg: '/:ids+.`),i.push({type:Ee.Param,value:u,regexp:c,repeatable:a==="*"||a==="+",optional:a==="*"||a==="?"})):e("Invalid state to consume buffer"),u="")}function p(){u+=a}for(;l<n.length;){if(a=n[l++],a==="\\"&&t!==hn.ParamRegExp){s=t,t=hn.EscapeNext;continue}switch(t){case hn.Static:a==="/"?(u&&d(),o()):a===":"?(d(),t=hn.Param):p();break;case hn.EscapeNext:p(),t=s;break;case hn.Param:a==="("?t=hn.ParamRegExp:Fu.test(a)?p():(d(),t=hn.Static,a!=="*"&&a!=="?"&&a!=="+"&&l--);break;case hn.ParamRegExp:a===")"?c[c.length-1]=="\\"?c=c.slice(0,-1)+a:t=hn.ParamRegExpEnd:c+=a;break;case hn.ParamRegExpEnd:d(),t=hn.Static,a!=="*"&&a!=="?"&&a!=="+"&&l--,c="";break;default:e("Unknown state");break}}return t===hn.ParamRegExp&&e(`Unfinished custom RegExp for param "${u}"`),d(),o(),r}const ai="[^/]+?",ju={sensitive:!1,strict:!1,start:!0,end:!0};var wn=function(n){return n[n._multiplier=10]="_multiplier",n[n.Root=90]="Root",n[n.Segment=40]="Segment",n[n.SubSegment=30]="SubSegment",n[n.Static=40]="Static",n[n.Dynamic=20]="Dynamic",n[n.BonusCustomRegExp=10]="BonusCustomRegExp",n[n.BonusWildcard=-50]="BonusWildcard",n[n.BonusRepeatable=-20]="BonusRepeatable",n[n.BonusOptional=-8]="BonusOptional",n[n.BonusStrict=.7000000000000001]="BonusStrict",n[n.BonusCaseSensitive=.25]="BonusCaseSensitive",n}(wn||{});const Uu=/[.+*?^${}()[\]/\\]/g;function Vu(n,e){const t=G({},ju,e),s=[];let r=t.start?"^":"";const i=[];for(const u of n){const c=u.length?[]:[wn.Root];t.strict&&!u.length&&(r+="/");for(let d=0;d<u.length;d++){const p=u[d];let $=wn.Segment+(t.sensitive?wn.BonusCaseSensitive:0);if(p.type===Ee.Static)d||(r+="/"),r+=p.value.replace(Uu,"\\$&"),$+=wn.Static;else if(p.type===Ee.Param){const{value:y,repeatable:w,optional:C,regexp:L}=p;i.push({name:y,repeatable:w,optional:C});const A=L||ai;if(A!==ai){$+=wn.BonusCustomRegExp;try{`${A}`}catch(N){throw new Error(`Invalid custom RegExp for param "${y}" (${A}): `+N.message)}}let P=w?`((?:${A})(?:/(?:${A}))*)`:`(${A})`;d||(P=C&&u.length<2?`(?:/${P})`:"/"+P),C&&(P+="?"),r+=P,$+=wn.Dynamic,C&&($+=wn.BonusOptional),w&&($+=wn.BonusRepeatable),A===".*"&&($+=wn.BonusWildcard)}c.push($)}s.push(c)}if(t.strict&&t.end){const u=s.length-1;s[u][s[u].length-1]+=wn.BonusStrict}t.strict||(r+="/?"),t.end?r+="$":t.strict&&!r.endsWith("/")&&(r+="(?:/|$)");const o=new RegExp(r,t.sensitive?"":"i");function l(u){const c=u.match(o),d={};if(!c)return null;for(let p=1;p<c.length;p++){const $=c[p]||"",y=i[p-1];d[y.name]=$&&y.repeatable?$.split("/"):$}return d}function a(u){let c="",d=!1;for(const p of n){(!d||!c.endsWith("/"))&&(c+="/"),d=!1;for(const $ of p)if($.type===Ee.Static)c+=$.value;else if($.type===Ee.Param){const{value:y,repeatable:w,optional:C}=$,L=y in u?u[y]:"";if(jn(L)&&!w)throw new Error(`Provided param "${y}" is an array but it is not repeatable (* or + modifiers)`);const A=jn(L)?L.join("/"):L;if(!A)if(C)p.length<2&&(c.endsWith("/")?c=c.slice(0,-1):d=!0);else throw new Error(`Missing required param "${y}"`);c+=A}}return c||"/"}return{re:o,score:s,keys:i,parse:l,stringify:a}}function zu(n,e){let t=0;for(;t<n.length&&t<e.length;){const s=e[t]-n[t];if(s)return s;t++}return n.length<e.length?n.length===1&&n[0]===wn.Static+wn.Segment?-1:1:n.length>e.length?e.length===1&&e[0]===wn.Static+wn.Segment?1:-1:0}function jo(n,e){let t=0;const s=n.score,r=e.score;for(;t<s.length&&t<r.length;){const i=zu(s[t],r[t]);if(i)return i;t++}if(Math.abs(r.length-s.length)===1){if(ci(s))return 1;if(ci(r))return-1}return r.length-s.length}function ci(n){const e=n[n.length-1];return n.length>0&&e[e.length-1]<0}const Gu={strict:!1,end:!0,sensitive:!1};function qu(n,e,t){const s=Vu(Bu(n.path),t),r=G(s,{record:n,parent:e,children:[],alias:[]});return e&&!r.record.aliasOf==!e.record.aliasOf&&e.children.push(r),r}function Ku(n,e){const t=[],s=new Map;e=ei(Gu,e);function r(d){return s.get(d)}function i(d,p,$){const y=!$,w=fi(d);w.aliasOf=$&&$.record;const C=ei(e,d),L=[w];if("alias"in d){const N=typeof d.alias=="string"?[d.alias]:d.alias;for(const J of N)L.push(fi(G({},w,{components:$?$.record.components:w.components,path:J,aliasOf:$?$.record:w})))}let A,P;for(const N of L){const{path:J}=N;if(p&&J[0]!=="/"){const ln=p.record.path,W=ln[ln.length-1]==="/"?"":"/";N.path=p.record.path+(J&&W+J)}if(A=qu(N,p,C),$?$.alias.push(A):(P=P||A,P!==A&&P.alias.push(A),y&&d.name&&!di(A)&&o(d.name)),Uo(A)&&a(A),w.children){const ln=w.children;for(let W=0;W<ln.length;W++)i(ln[W],A,$&&$.children[W])}$=$||A}return P?()=>{o(P)}:pt}function o(d){if(Ho(d)){const p=s.get(d);p&&(s.delete(d),t.splice(t.indexOf(p),1),p.children.forEach(o),p.alias.forEach(o))}else{const p=t.indexOf(d);p>-1&&(t.splice(p,1),d.record.name&&s.delete(d.record.name),d.children.forEach(o),d.alias.forEach(o))}}function l(){return t}function a(d){const p=Yu(d,t);t.splice(p,0,d),d.record.name&&!di(d)&&s.set(d.record.name,d)}function u(d,p){let $,y={},w,C;if("name"in d&&d.name){if($=s.get(d.name),!$)throw We(an.MATCHER_NOT_FOUND,{location:d});C=$.record.name,y=G(ui(p.params,$.keys.filter(P=>!P.optional).concat($.parent?$.parent.keys.filter(P=>P.optional):[]).map(P=>P.name)),d.params&&ui(d.params,$.keys.map(P=>P.name))),w=$.stringify(y)}else if(d.path!=null)w=d.path,$=t.find(P=>P.re.test(w)),$&&(y=$.parse(w),C=$.record.name);else{if($=p.name?s.get(p.name):t.find(P=>P.re.test(p.path)),!$)throw We(an.MATCHER_NOT_FOUND,{location:d,currentLocation:p});C=$.record.name,y=G({},p.params,d.params),w=$.stringify(y)}const L=[];let A=$;for(;A;)L.unshift(A.record),A=A.parent;return{name:C,path:w,params:y,matched:L,meta:Wu(L)}}n.forEach(d=>i(d));function c(){t.length=0,s.clear()}return{addRoute:i,resolve:u,removeRoute:o,clearRoutes:c,getRoutes:l,getRecordMatcher:r}}function ui(n,e){const t={};for(const s of e)s in n&&(t[s]=n[s]);return t}function fi(n){const e={path:n.path,redirect:n.redirect,name:n.name,meta:n.meta||{},aliasOf:n.aliasOf,beforeEnter:n.beforeEnter,props:Ju(n),children:n.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in n?n.components||null:n.component&&{default:n.component}};return Object.defineProperty(e,"mods",{value:{}}),e}function Ju(n){const e={},t=n.props||!1;if("component"in n)e.default=t;else for(const s in n.components)e[s]=typeof t=="object"?t[s]:t;return e}function di(n){for(;n;){if(n.record.aliasOf)return!0;n=n.parent}return!1}function Wu(n){return n.reduce((e,t)=>G(e,t.meta),{})}function Yu(n,e){let t=0,s=e.length;for(;t!==s;){const i=t+s>>1;jo(n,e[i])<0?s=i:t=i+1}const r=Zu(n);return r&&(s=e.lastIndexOf(r,s-1)),s}function Zu(n){let e=n;for(;e=e.parent;)if(Uo(e)&&jo(n,e)===0)return e}function Uo({record:n}){return!!(n.name||n.components&&Object.keys(n.components).length||n.redirect)}function hi(n){const e=ee(ur),t=ee(fr),s=In(()=>{const a=dn(n.to);return e.resolve(a)}),r=In(()=>{const{matched:a}=s.value,{length:u}=a,c=a[u-1],d=t.matched;if(!c||!d.length)return-1;const p=d.findIndex(Je.bind(null,c));if(p>-1)return p;const $=pi(a[u-2]);return u>1&&pi(c)===$&&d[d.length-1].path!==$?d.findIndex(Je.bind(null,a[u-2])):p}),i=In(()=>r.value>-1&&tf(t.params,s.value.params)),o=In(()=>r.value>-1&&r.value===t.matched.length-1&&Do(t.params,s.value.params));function l(a={}){if(ef(a)){const u=e[dn(n.replace)?"replace":"push"](dn(n.to)).catch(pt);return n.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>u),u}return Promise.resolve()}return{route:s,href:In(()=>s.value.href),isActive:i,isExactActive:o,navigate:l}}function Qu(n){return n.length===1?n[0]:n}const Xu=eo({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:hi,setup(n,{slots:e}){const t=ss(hi(n)),{options:s}=ee(ur),r=In(()=>({[gi(n.activeClass,s.linkActiveClass,"router-link-active")]:t.isActive,[gi(n.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:t.isExactActive}));return()=>{const i=e.default&&Qu(e.default(t));return n.custom?i:Ao("a",{"aria-current":t.isExactActive?n.ariaCurrentValue:null,href:t.href,onClick:t.navigate,class:r.value},i)}}}),nf=Xu;function ef(n){if(!(n.metaKey||n.altKey||n.ctrlKey||n.shiftKey)&&!n.defaultPrevented&&!(n.button!==void 0&&n.button!==0)){if(n.currentTarget&&n.currentTarget.getAttribute){const e=n.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return n.preventDefault&&n.preventDefault(),!0}}function tf(n,e){for(const t in e){const s=e[t],r=n[t];if(typeof s=="string"){if(s!==r)return!1}else if(!jn(r)||r.length!==s.length||s.some((i,o)=>i.valueOf()!==r[o].valueOf()))return!1}return!0}function pi(n){return n?n.aliasOf?n.aliasOf.path:n.path:""}const gi=(n,e,t)=>n??e??t,sf=eo({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(n,{attrs:e,slots:t}){const s=ee(Bs),r=In(()=>n.route||s.value),i=ee(oi,0),o=In(()=>{let u=dn(i);const{matched:c}=r.value;let d;for(;(d=c[u])&&!d.components;)u++;return u}),l=In(()=>r.value.matched[o.value]);It(oi,In(()=>o.value+1)),It(Nu,l),It(Bs,r);const a=Te();return ct(()=>[a.value,l.value,n.name],([u,c,d],[p,$,y])=>{c&&(c.instances[d]=u,$&&$!==c&&u&&u===p&&(c.leaveGuards.size||(c.leaveGuards=$.leaveGuards),c.updateGuards.size||(c.updateGuards=$.updateGuards))),u&&c&&(!$||!Je(c,$)||!p)&&(c.enterCallbacks[d]||[]).forEach(w=>w(u))},{flush:"post"}),()=>{const u=r.value,c=n.name,d=l.value,p=d&&d.components[c];if(!p)return $i(t.default,{Component:p,route:u});const $=d.props[c],y=$?$===!0?u.params:typeof $=="function"?$(u):$:null,C=Ao(p,G({},y,e,{onVnodeUnmounted:L=>{L.component.isUnmounted&&(d.instances[c]=null)},ref:a}));return $i(t.default,{Component:C,route:u})||C}}});function $i(n,e){if(!n)return null;const t=n(e);return t.length===1?t[0]:t}const rf=sf;function of(n){const e=Ku(n.routes,n),t=n.parseQuery||Au,s=n.stringifyQuery||ii,r=n.history,i=et(),o=et(),l=et(),a=Zl(_e);let u=_e;Be&&n.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const c=ys.bind(null,b=>""+b),d=ys.bind(null,du),p=ys.bind(null,yt);function $(b,O){let T,I;return Ho(b)?(T=e.getRecordMatcher(b),I=O):I=b,e.addRoute(I,T)}function y(b){const O=e.getRecordMatcher(b);O&&e.removeRoute(O)}function w(){return e.getRoutes().map(b=>b.record)}function C(b){return!!e.getRecordMatcher(b)}function L(b,O){if(O=G({},O||a.value),typeof b=="string"){const g=ws(t,b,O.path),_=e.resolve({path:g.path},O),x=r.createHref(g.fullPath);return G(g,_,{params:p(_.params),hash:yt(g.hash),redirectedFrom:void 0,href:x})}let T;if(b.path!=null)T=G({},b,{path:ws(t,b.path,O.path).path});else{const g=G({},b.params);for(const _ in g)g[_]==null&&delete g[_];T=G({},b,{params:d(g)}),O.params=d(O.params)}const I=e.resolve(T,O),U=b.hash||"";I.params=c(p(I.params));const f=gu(s,G({},b,{hash:cu(U),path:I.path})),h=r.createHref(f);return G({fullPath:f,hash:U,query:s===ii?Ou(b.query):b.query||{}},I,{redirectedFrom:void 0,href:h})}function A(b){return typeof b=="string"?ws(t,b,a.value.path):G({},b)}function P(b,O){if(u!==b)return We(an.NAVIGATION_CANCELLED,{from:O,to:b})}function N(b){return W(b)}function J(b){return N(G(A(b),{replace:!0}))}function ln(b,O){const T=b.matched[b.matched.length-1];if(T&&T.redirect){const{redirect:I}=T;let U=typeof I=="function"?I(b,O):I;return typeof U=="string"&&(U=U.includes("?")||U.includes("#")?U=A(U):{path:U},U.params={}),G({query:b.query,hash:b.hash,params:U.path!=null?{}:b.params},U)}}function W(b,O){const T=u=L(b),I=a.value,U=b.state,f=b.force,h=b.replace===!0,g=ln(T,I);if(g)return W(G(A(g),{state:typeof g=="object"?G({},U,g.state):U,force:f,replace:h}),O||T);const _=T;_.redirectedFrom=O;let x;return!f&&$u(s,I,T)&&(x=We(an.NAVIGATION_DUPLICATED,{to:_,from:I}),Gn(I,I,!0,!1)),(x?Promise.resolve(x):Vn(_,I)).catch(m=>le(m)?le(m,an.NAVIGATION_GUARD_REDIRECT)?m:me(m):z(m,_,I)).then(m=>{if(m){if(le(m,an.NAVIGATION_GUARD_REDIRECT))return W(G({replace:h},A(m.to),{state:typeof m.to=="object"?G({},U,m.to.state):U,force:f}),O||_)}else m=ye(_,I,!0,h,U);return $e(_,I,m),m})}function Un(b,O){const T=P(b,O);return T?Promise.reject(T):Promise.resolve()}function ge(b){const O=Le.values().next().value;return O&&typeof O.runWithContext=="function"?O.runWithContext(b):b()}function Vn(b,O){let T;const[I,U,f]=Pu(b,O);T=Ss(I.reverse(),"beforeRouteLeave",b,O);for(const g of I)g.leaveGuards.forEach(_=>{T.push(xe(_,b,O))});const h=Un.bind(null,b,O);return T.push(h),Cn(T).then(()=>{T=[];for(const g of i.list())T.push(xe(g,b,O));return T.push(h),Cn(T)}).then(()=>{T=Ss(U,"beforeRouteUpdate",b,O);for(const g of U)g.updateGuards.forEach(_=>{T.push(xe(_,b,O))});return T.push(h),Cn(T)}).then(()=>{T=[];for(const g of f)if(g.beforeEnter)if(jn(g.beforeEnter))for(const _ of g.beforeEnter)T.push(xe(_,b,O));else T.push(xe(g.beforeEnter,b,O));return T.push(h),Cn(T)}).then(()=>(b.matched.forEach(g=>g.enterCallbacks={}),T=Ss(f,"beforeRouteEnter",b,O,ge),T.push(h),Cn(T))).then(()=>{T=[];for(const g of o.list())T.push(xe(g,b,O));return T.push(h),Cn(T)}).catch(g=>le(g,an.NAVIGATION_CANCELLED)?g:Promise.reject(g))}function $e(b,O,T){l.list().forEach(I=>ge(()=>I(b,O,T)))}function ye(b,O,T,I,U){const f=P(b,O);if(f)return f;const h=O===_e,g=Be?history.state:{};T&&(I||h?r.replace(b.fullPath,G({scroll:h&&g&&g.scroll},U)):r.push(b.fullPath,U)),a.value=b,Gn(b,O,T,h),me()}let zn;function Ze(){zn||(zn=r.listen((b,O,T)=>{if(!we.listening)return;const I=L(b),U=ln(I,we.currentRoute.value);if(U){W(G(U,{replace:!0,force:!0}),I).catch(pt);return}u=I;const f=a.value;Be&&ku(ri(f.fullPath,T.delta),cs()),Vn(I,f).catch(h=>le(h,an.NAVIGATION_ABORTED|an.NAVIGATION_CANCELLED)?h:le(h,an.NAVIGATION_GUARD_REDIRECT)?(W(G(A(h.to),{force:!0}),I).then(g=>{le(g,an.NAVIGATION_ABORTED|an.NAVIGATION_DUPLICATED)&&!T.delta&&T.type===Hs.pop&&r.go(-1,!1)}).catch(pt),Promise.reject()):(T.delta&&r.go(-T.delta,!1),z(h,I,f))).then(h=>{h=h||ye(I,f,!1),h&&(T.delta&&!le(h,an.NAVIGATION_CANCELLED)?r.go(-T.delta,!1):T.type===Hs.pop&&le(h,an.NAVIGATION_ABORTED|an.NAVIGATION_DUPLICATED)&&r.go(-1,!1)),$e(I,f,h)}).catch(pt)}))}let Ie=et(),pn=et(),Q;function z(b,O,T){me(b);const I=pn.list();return I.length?I.forEach(U=>U(b,O,T)):console.error(b),Promise.reject(b)}function ie(){return Q&&a.value!==_e?Promise.resolve():new Promise((b,O)=>{Ie.add([b,O])})}function me(b){return Q||(Q=!b,Ze(),Ie.list().forEach(([O,T])=>b?T(b):O()),Ie.reset()),b}function Gn(b,O,T,I){const{scrollBehavior:U}=n;if(!Be||!U)return Promise.resolve();const f=!T&&Su(ri(b.fullPath,0))||(I||!T)&&history.state&&history.state.scroll||null;return tr().then(()=>U(b,O,f)).then(h=>h&&wu(h)).catch(h=>z(h,b,O))}const Tn=b=>r.go(b);let Me;const Le=new Set,we={currentRoute:a,listening:!0,addRoute:$,removeRoute:y,clearRoutes:e.clearRoutes,hasRoute:C,getRoutes:w,resolve:L,options:n,push:N,replace:J,go:Tn,back:()=>Tn(-1),forward:()=>Tn(1),beforeEach:i.add,beforeResolve:o.add,afterEach:l.add,onError:pn.add,isReady:ie,install(b){b.component("RouterLink",nf),b.component("RouterView",rf),b.config.globalProperties.$router=we,Object.defineProperty(b.config.globalProperties,"$route",{enumerable:!0,get:()=>dn(a)}),Be&&!Me&&a.value===_e&&(Me=!0,N(r.location).catch(I=>{}));const O={};for(const I in _e)Object.defineProperty(O,I,{get:()=>a.value[I],enumerable:!0});b.provide(ur,we),b.provide(fr,qi(O)),b.provide(Bs,a);const T=b.unmount;Le.add(b),b.unmount=function(){Le.delete(b),Le.size<1&&(u=_e,zn&&zn(),zn=null,a.value=_e,Me=!1,Q=!1),T()}}};function Cn(b){return b.reduce((O,T)=>O.then(()=>ge(T)),Promise.resolve())}return we}function dr(n){return ee(fr)}const js=[{text:"NR 语言参考手册",items:[{text:"概述",link:"/v1.0/"},{text:"1. 词法结构",link:"/v1.0/lexical"},{text:"2. 类型系统",link:"/v1.0/types"},{text:"3. 变量与赋值",link:"/v1.0/variables"},{text:"4. 表达式与运算符",link:"/v1.0/expressions"},{text:"5. 控制流",link:"/v1.0/control-flow"},{text:"6. 词条系统",link:"/v1.0/entries"},{text:"7. 函数",link:"/v1.0/functions"},{text:"8. JSON 数据处理",link:"/v1.0/json"},{text:"9. 面向对象编程",link:"/v1.0/oop"},{text:"10. 模块与引入",link:"/v1.0/modules"},{text:"11. 内置函数参考",link:"/v1.0/flow-output"}]},{text:"内置函数分类",items:[{text:"字符串操作",link:"/v1.0/string"},{text:"数学操作",link:"/v1.0/math"},{text:"网络操作",link:"/v1.0/network"},{text:"类型操作",link:"/v1.0/type"},{text:"画布操作",link:"/v1.0/canvas"},{text:"文件操作",link:"/v1.0/file"}]}],Nt=js.flatMap(n=>n.items);function lf(){const n=dr(),e=Nt.findIndex(r=>r.link===n.path),t=e>0?Nt[e-1]:null,s=e<Nt.length-1?Nt[e+1]:null;return{prev:t,next:s}}const Ye=(n,e)=>{const t=n.__vccOpts||n;for(const[s,r]of e)t[s]=r;return t},af={class:"sidebar-nav"},cf={class:"sidebar-group-title"},uf=["href"],ff={__name:"Sidebar",setup(n){const e=dr();function t(s){return e.path===s}return(s,r)=>(on(),cn("nav",af,[(on(!0),cn(Sn,null,Ut(dn(js),(i,o)=>(on(),cn("div",{key:i.text,class:Ge(["sidebar-group",{"has-divider":o<dn(js).length-1}])},[j("p",cf,de(i.text),1),(on(!0),cn(Sn,null,Ut(i.items,l=>(on(),cn("a",{key:l.link,href:"#"+l.link,class:Ge(["sidebar-link",{active:t(l.link)}])},de(l.text),11,uf))),128))],2))),128))]))}},df=Ye(ff,[["__scopeId","data-v-ec3f3c15"]]),Vo=`# 11.10 @画布
...
[@画布 →](./canvas)
`,il='# 2. 类型系统\n\nNR 的类型系统是**动态、弱类型**的——变量无需声明类型，运行时自动确定。值在大多数场景下会自动在文本和数字之间转换，`==` 运算符做宽松比较。本章涵盖 NR 中的原始数据类型（没有对象/数组，只有文本、数字和布尔值），以及类型检测、判断和转换操作。\n\nNR 的 `Value` 不是简单的"字符串或数字"二分法——它是一个完整的枚举类型，内部由 Rust 的 `enum` 实现，每个变体携带不同的数据表示。这意味着两个值即使"看起来一样"，也可能属于不同类型，进而影响相等性比较和运算行为。\n\n## 2.1 类型一览\n\nNR 变量存储的是**带类型的值**（`Value`），而非纯字符串。类型在赋值时自动推断。\n\n| 类型 | 示例 | 说明 |\n|------|------|------|\n| `整数` | `1`, `-5`, `100` | 64 位有符号整数 |\n| `浮点` | `1.5`, `-0.5`, `3.14` | 64 位浮点数 |\n| `字符串` | `"hello"`, `abc` | 字符串 |\n| `布尔` | `true`, `false` | 布尔值 |\n| `空` | `null` | 空值 |\n| `对象` | — | 对象引用（`$new$` 返回） |\n| `函数` | — | 函数指针（`%func@name%` 返回） |\n\n- `count:5` → Int，`name:Alice` → Str\n- 但 `[...]` 数学表达式运算结果保留数值类型\n- `$new$` 返回值为对象类型\n- `%func@key%` 返回值为函数类型\n\n## 2.2 各类型详解\n\n### 整数（Int）\n\n64 位有符号整数（`i64`），范围约为 `-9.2×10¹⁸` 到 `9.2×10¹⁸`。\n\n```\na:42\nb:-100\nc:0\n\n%TYPE@a%   → "整数"\n%TYPE@b%   → "整数"\n%TYPE@c%   → "整数"\n```\n\n整数字面量不能包含小数点、前导零（会被当作十进制解析）或科学计数法。\n\n### 浮点（Float）\n\n64 位浮点数（`f64`），符合 IEEE 754 标准。\n\n```\npi:3.14\nneg:-0.5\nbig:1.5e10\n\n%TYPE@pi%    → "浮点"\n%TYPE@neg%   → "浮点"\n%TYPE@big%   → "浮点"\n```\n\n浮点数和整数在比较（`==`）时**视为不同**：`1 == 1.0` 在严格比较下为假。浮点运算可能产生精度误差，这是 IEEE 754 浮点数的固有特性。\n\n### 字符串（Str）\n\nUTF-8 编码的字符串。不带特殊前缀的纯文本字面量自动判定为字符串。\n\n```\nname:Alice\ngreeting:Hello World\nempty:""              ← 显式空字符串\n\n%TYPE@name%       → "字符串"\n%TYPE@greeting%   → "字符串"\n```\n\n注意：`greeting:Hello World` 中空格不需要转义（赋值操作符 `:` 之后直到行尾均为值部分）。但在 `$...$` 参数传递中空格会分割参数，参见 [词法结构 § 转义规则](./lexical)。\n\n### 布尔（Bool）\n\n只有 `true` 和 `false` 两个字面量。\n\n```\nflag:true\ndone:false\n\n%TYPE@flag%   → "布尔"\n%TYPE@done%   → "布尔"\n```\n\n布尔值可直接用于条件表达式（[控制流](./control-flow)），也可参与逻辑运算（[表达式 § 逻辑运算符](./expressions)）。\n\n### 空值（Null）\n\n表示"无值"或"未设置"。仅有一种字面量：`null`。\n\n```\ndata:null\n\n%TYPE@data%   → "空"\n```\n\n`null` 与空字符串 `""` 不同：`null` 是一个独立的类型标记，而 `""` 是值为空的字符串。在条件判断中，`null` 被视为假值。\n\n### 对象（Object）\n\n由 `$new$` 创建，内部持有一个 JSON 对象引用。对象类型值不可直接输出为文本，需通过 `%TYPE@` 查询或使用 JSON 操作符访问其字段。\n\n```\nobj:$new$ {"key":"val"}\n\n%TYPE@obj%   → "对象"\n```\n\n`$new$` 不是赋值操作符——它是创建新对象的内置函数，参见 [词条系统](./entries)。\n\n### 函数（Func）\n\n由 `%func@name%` 获取，存储的是函数指针/引用，而非函数体文本。\n\n```\nptr:%func@greet%\n\n%TYPE@ptr%   → "函数"\n```\n\n函数类型值主要用途：作为回调传入其他函数，或在需要延迟调用时暂存。\n\n## 2.3 类型特性对照\n\n| 类型 | 可修改（`+:` 等） | 宽松相等 `==` | 严格相等 `===` | 数值排序 `>` `<` |\n|------|-------------------|--------------|---------------|------------------|\n| Int | ✅ 算术运算 | 字符串化后比较 | 值和类型均相同 | ✅ 按数值 |\n| Float | ✅ 算术运算 | 字符串化后比较 | 值和类型均相同 | ✅ 按数值 |\n| Str | ✅ 串接 | 内容比较（含类型转换） | 值和类型均相同 | ❌ 无意义 |\n| Bool | ❌ | 字符串化后比较 | 值和类型均相同 | ❌ |\n| Null | ❌ | — | — | ❌ |\n| Object | — | 引用相等 | 引用相等 | ❌ |\n| Func | ❌ | 引用相等 | 引用相等 | ❌ |\n\n## 2.4 类型强制转换与兼容性\n\n### 算术上下文中的类型转换\n\n在 `[...]` 数学表达式中，操作数的类型决定了运算结果的类型：\n\n```\n// 整数运算 → 整数\na:[1+2]          → Int(3)\n\n// 浮点数参与 → 浮点\nb:[1+2.0]        → Float(3.0)\nc:[3.14*2]       → Float(6.28)\n\n// 字符串自动转为数值参与运算\nd:["3"+2]        → Int(5)  或报错\n```\n\n- 整数 + 整数 → 整数\n- 任一操作数为浮点 → 结果提升为浮点\n- 字符串操作数：尝试按数值解析，失败则报错\n\n### 比较上下文中的类型转换\n\n`==`（宽松相等）会将两边值转为字符串后比较：\n\n```\n1 == "1"       → true（都转为 "1"）\n1 == 1.0       → true（都转为 "1"，但用 === 则为 false）\ntrue == "true" → true\nnull == ""     → false（"null" ≠ ""）\n```\n\n`===`（严格相等）要求**类型和值都相同**：\n\n```\n1 === 1       → true\n1 === 1.0     → false（Int vs Float）\n"1" === 1     → false（Str vs Int）\ntrue === true → true\n```\n\n**注意事项：**\n\n- 条件判断中（如 `如果:`），**推荐使用严格比较 `===`** 以避免意外的类型转换带来的误判。\n- 数值比较（`>`、`<`、`>=`、`<=`）要求两边均为数值类型（Int 或 Float），字符串会被尝试解析为数值。\n- `0`、`""`、`null`、`false` 在布尔上下文中均为"假"，但它们彼此之间**不相等**（除了 `0 == false` 会因为字符串化为 `"0" == "false"` 而返回假）。\n\n## 类型查询 `%TYPE@var%`\n\n```\ncount:5\nname:Alice\n\n%TYPE@count%   → "整数"\n%TYPE@name%    → "字符串"\n```\n\n未设置变量返回空字符串。\n',ol='# 3. 变量与赋值\n\n变量是 NR 中最基本的存储单元。本章涵盖变量的作用域规则、赋值操作符的语义差异、条件赋值、内置变量以及文本切片等核心机制。理解变量系统是正确组织数据流和控制状态的前提，与[类型系统](./types)和[表达式](./expressions)密切协作。\n\nNR 的赋值不是简单的"文本替换"——它会根据操作符和值的内容自动推断类型（[§ 类型一览](./types)），并在不同作用域间管理变量生命周期。\n\n## 3.1 作用域\n\n| 类型 | 作用域 | 说明 |\n|------|--------|------|\n| 局部变量 | 当前上下文 | 子上下文创建时重置 |\n| 全局变量 | 所有子上下文 | 子上下文创建时克隆共享 |\n\n### 作用域选择规则\n\nNR 根据**赋值位置**自动决定变量的作用域：\n\n- **头部区域（第一个空行之前）**中赋值的变量为**全局变量**。这些变量在词条触发、函数调用等子上下文中可被读取和修改。\n- **词条、函数、循环体内部**中首次赋值的变量为**局部变量**。局部变量仅在当前执行上下文中可见，进入子函数或子上下文时会创建独立的副本。\n\n```\n// 头部区域 → 全局变量，整个文件可见\ncounter:0\nbase_url:https://api.example.com\n\n// ← 空行分隔\n\n// 词条内部 → 局部变量\n开始\ntemp:%counter%             ← 可读全局变量\ncounter+:[%counter%+1]   ← 可修改全局变量\nlocal_var:临时值            ← 局部变量，外部不可见\n```\n\n### 作用域注意事项\n\n- 全局变量在**每次词条触发时保持其值**，不会重置。这使得 `counter+:1` 可以在多次触发间累加。\n- 子上下文（如 `$call$` 函数调用）中读取全局变量时，获取的是**当前快照值**；修改全局变量会影响父上下文。\n- 在同一作用域中，对已存在的变量再次使用 `:` 赋值会**覆盖**其值和类型。\n\n## 3.2 赋值操作符\n\n| 操作符 | 示例 | 语义 |\n|--------|------|------|\n| `:` | `name:Alice` | **自适应赋值**：值尝试解析为 JSON 字面量（数字/布尔/null/对象/数组），不成则当字符串 |\n| `::` | `greeting::Hello` | **纯文本赋值**：值始终作为字符串，不解析 JSON |\n| `+:` | `score+:5` | 自增 / JSON追加 / 字符串拼接 |\n| `-:` | `count-:1` | 自减 |\n| `*:` | `val*:2` | 乘法 / 字符串重复 |\n| `/:` | `val/:2` | 除法 |\n| `%:` | `val%:3` | 取余 |\n\n> 只有 ASCII 半角冒号 `:`（U+003A）被识别为赋值操作符。中文全角冒号 `：`（U+FF1A）**不是**操作符，在文本中直接原样输出。\n\n### `:`（自适应赋值）vs `::`（纯文本赋值）\n\n这是 NR 中最容易被忽视但最重要的语义差异：\n\n| 特性 | `:`（单冒号） | `::`（双冒号） |\n|------|-------------|---------------|\n| 值解析 | 尝试解析为 JSON 字面量 | 始终作为字符串 |\n| `1` | Int(1) | Str("1") |\n| `1.5` | Float(1.5) | Str("1.5") |\n| `true` | Bool(true) | Str("true") |\n| `null` | Null | Str("null") |\n| `{"a":1}` | JSON 对象 | Str("{\'a\':1}") |\n| `Alice` | Str("Alice") | Str("Alice") |\n\n```\n// : 自适应赋值——数字被识别为数值类型\ncount:100\n%TYPE@count%   → "整数"\n\n// :: 纯文本赋值——永远是字符串\nid::100\n%TYPE@id%      → "字符串"\n\n// 实际影响：数学运算\n[%count%+1]   → 101   （Int 运算）\n// [%id%+1]   → 报错 / 意外（字符串不能加）\n```\n\n### 何时使用 `::`\n\n- 存储**编号、ID、电话号**等不应被当作数字处理的值（如 `id::001` 不会丢掉前导零）\n- 存储可能是数字字面量的**字符串**（如文件名"123.json"）\n- 需要精确控制类型以避免意外数值运算的场景\n\n**注意事项：** 当你对 `::` 赋值的变量使用 `+:`（自增）时，由于值是字符串，`+:` 会执行**字符串拼接**而非数学加法。这可能不是你想要的行为。\n\n## 3.3 条件赋值 `?:`\n\n```\nkey:@a?:@b?:fallback\n```\n\n从左到右尝试读取 JSON 路径，第一个非空、非 null、非 false 的值被赋值。\n\n## 3.4 内置变量\n\n| 变量 | 说明 |\n|------|------|\n| `%空格%` | 空格 `" "` |\n| `%换行%` | 换行 `"\\n"` |\n| `%时间戳%` | Unix 时间戳（秒） |\n| `%毫秒时间戳%` | Unix 时间戳（毫秒） |\n| `%微秒时间戳%` | Unix 时间戳（微秒） |\n| `%纳秒时间戳%` | Unix 时间戳（纳秒） |\n| `%时间%` | 格式化本地时间 `YYYY-MM-DD HH:MM:SS`（UTC+8） |\n| `%随机数M-N%` | 随机整数 `[M, N]`（含两端） |\n| `%!key%` | 布尔取反：空/0/false/null → `"1"`，否则 → `"0"` |\n| `%?key%` | 可选变量：不存在返回空字符串 |\n| `%++var%` | 自增：先自增再返回递增后的值（变量不存在默认 0） |\n| `%--var%` | 自减：先自减再返回递减后的值（变量不存在默认 0） |\n| `%参数%` | 所有参数列表（JSON 数组） |\n| `%参数0%` | 函数名 / 完整触发名 |\n| `%参数N%` | 第 N 个参数 |\n| `%_%` | 当前对象名 / 函数名 |\n| `%触发%` | 当前触发词 |\n| `%行数%` | 当前行号（1-based） |\n| `%B64@key%` | Base64 解码 |\n| `%URL编码@key%` | URL 编码 |\n| `%len@key%` / `%长度@key%` | 返回变量值的字符长度 |\n| `%@var[切片]%` / `@var[切片]` | 符号截取文本（Python 风格切片，支持 `%` 快捷两种写法） |\n| `%func@key%` | 获取函数指针（类型为"函数"，display 为函数名） |\n| `%包名.变量%` | 跨包变量引用（如 `%mypkg.x%` 读取引入包的头部变量） |\n\n### 内置变量的生命周期\n\n内置变量（`%xxx%`）与用户定义的变量在生命周期上有本质区别：\n\n- **即时求值**：每次读取内置变量（如 `%时间戳%`）时，都会**重新计算**当前值。它不存储"快照"，而是每次调用运行时函数。\n- **不可赋值**：不能对内置变量使用 `:` 赋值——`%时间戳%:123` 是无效的。\n- **临时性**：内置变量的值仅在当前表达式求值瞬间有效。如需多次使用同一值，应将其赋值给用户变量：`ts:%时间戳%`。\n- **参数变量 `%参数N%`** 在函数体内是局部变量，函数返回后失效；在词条触发时反映的是触发参数。\n\n```\n// 推荐做法：缓存内置变量\nstart_time:%毫秒时间戳%\n// ... 多步操作 ...\nelapsed:[%毫秒时间戳%-%start_time%]   ← 两次读取产生不同值，差值有意义\n```\n\n## 3.5 符号截取文本 `%@var[切片]%` / `@var[切片]`\n\n内联文本切片语法，对变量值按字符（`.chars()`）进行 Python 风格切片。中文、emoji 等多字节字符均算一个字符。\n\n**两种写法等价**：\n\n- `%@var[切片]%` —— 标准写法，需 `%` 包裹\n- `@var[切片]` —— 快捷写法，无需 `%` 包裹，直接解析\n\n**基本语法**：`@变量名[start:end:step]`\n\n| 写法 | 含义 |\n|------|------|\n| `@a[1:]` | 从第 2 个字符到末尾 |\n| `@a[1:3]` | 第 2 ~ 3 个字符（index 1 和 2，不含 3） |\n| `@a[:3]` | 前 3 个字符 |\n| `@a[-3:]` | 末尾 3 个字符 |\n| `@a[1:6:2]` | index 1~5，步长 2（隔一个取一个） |\n| `@a[::2]` | 从头到尾，步长 2 |\n| `@a[::-1]` | 反转字符串 |\n\n```\nname:你好世界NR语言\n\n%name%             → "你好世界NR语言"\n%len@name%         → "8"\n\n// 标准写法\n%@name[1:]%        → "好世界NR语言"\n%@name[1:3]%       → "好世"\n%@name[:2]%        → "你好"\n%@name[-3:]%       → "R语言"\n%@name[::-1]%      → "言语RN界世好你"\n\n// 快捷写法（无需 % 包裹）\n@name[1:]          → "好世界NR语言"\n@name[1:3]         → "好世"\n@name[:2]          → "你好"\n@name[-3:]         → "R语言"\n@name[::-1]        → "言语RN界世好你"\n```\n\n> 快捷写法 `@var[切片]` 通过方括号内含 `:` 来与 JSON 路径导航（`@json[key]`）区分。不含 `:` 的方括号仍走 JSON 路径逻辑。\n',hf=Object.assign({"../../v1.0/canvas.md":Vo,"../../v1.0/control-flow.md":zo,"../../v1.0/entries.md":Go,"../../v1.0/expressions.md":qo,"../../v1.0/file.md":Ko,"../../v1.0/flow-output.md":Jo,"../../v1.0/functions.md":Wo,"../../v1.0/index.md":Yo,"../../v1.0/json.md":Zo,"../../v1.0/lexical.md":Qo,"../../v1.0/math.md":Xo,"../../v1.0/modules.md":nl,"../../v1.0/network.md":el,"../../v1.0/oop.md":tl,"../../v1.0/string.md":sl,"../../v1.0/type.md":rl,"../../v1.0/types.md":il,"../../v1.0/variables.md":ol}),ll=[];for(const[n,e]of Object.entries(hf)){const t=n.match(/v1\.0\/(.+)\.md$/);if(!t)continue;let s=t[1];const r=s==="index"?"/v1.0/":`/v1.0/${s}`,i=e.match(/^#\s+(.+)$/m),o=i?i[1]:r,l=[],a=/^#{2,3}\s+(.+)$/gm;let u;for(;(u=a.exec(e))!==null;)l.push(u[1]);ll.push({path:r,title:o,headings:l,content:e})}function pf(n){if(!n.trim())return[];const e=n.toLowerCase().split(/\s+/).filter(Boolean);return ll.filter(t=>{const s=(t.title+" "+t.headings.join(" ")+" "+t.content).toLowerCase();return e.every(r=>s.includes(r))}).map(t=>{const s=t.content.toLowerCase().indexOf(e[0]),r=Math.max(0,s-40),i=Math.min(t.content.length,s+120);let o=t.content.slice(r,i).replace(/\n+/g," ");return r>0&&(o="..."+o),i<t.content.length&&(o+="..."),{...t,snippet:o}}).slice(0,10)}const gf={class:"search-modal"},$f={class:"search-input-wrap"},mf={key:0,class:"search-results"},_f=["onClick","onMouseenter"],bf={class:"result-title"},xf={class:"result-path"},vf={class:"result-snippet"},yf={key:1,class:"search-empty"},wf={__name:"SearchModal",emits:["close"],setup(n,{emit:e}){const t=e,s=Te(""),r=Te([]),i=Te(0),o=Te(null);tr(()=>{var u;return(u=o.value)==null?void 0:u.focus()}),ct(s,u=>{r.value=pf(u),i.value=0});function l(u){window.location.hash="#"+u,t("close")}function a(u){u.key==="Escape"?t("close"):u.key==="ArrowDown"?(u.preventDefault(),i.value=Math.min(i.value+1,r.value.length-1)):u.key==="ArrowUp"?(u.preventDefault(),i.value=Math.max(i.value-1,0)):u.key==="Enter"&&r.value[i.value]&&l(r.value[i.value].path)}return(u,c)=>(on(),cn("div",{class:"search-overlay",onClick:c[2]||(c[2]=qc(d=>t("close"),["self"]))},[j("div",gf,[j("div",$f,[c[3]||(c[3]=j("svg",{class:"search-icon",viewBox:"0 0 24 24",width:"20",height:"20",fill:"none",stroke:"currentColor","stroke-width":"2"},[j("circle",{cx:"11",cy:"11",r:"8"}),j("path",{d:"m21 21-4.35-4.35"})],-1)),aa(j("input",{ref_key:"inputEl",ref:o,"onUpdate:modelValue":c[0]||(c[0]=d=>s.value=d),class:"search-input",placeholder:"搜索文档...",onKeydown:a},null,544),[[Vc,s.value]]),j("button",{class:"search-close",onClick:c[1]||(c[1]=d=>t("close"))},"Esc")]),r.value.length?(on(),cn("div",mf,[(on(!0),cn(Sn,null,Ut(r.value,(d,p)=>(on(),cn("div",{key:d.path,class:Ge(["search-result",{active:p===i.value}]),onClick:$=>l(d.path),onMouseenter:$=>i.value=p},[j("div",bf,de(d.title),1),j("div",xf,de(d.path),1),j("div",vf,de(d.snippet),1)],42,_f))),128))])):s.value?(on(),cn("div",yf," 未找到相关结果 ")):ar("",!0)])]))}},kf=Ye(wf,[["__scopeId","data-v-66966829"]]),Sf=["value"],Rf="/v1.0/",Tf={__name:"VersionSwitcher",setup(n){const e=[{label:"v1.0",path:"/v1.0/"}];function t(s){window.location.hash="#"+s.target.value}return(s,r)=>(on(),cn("select",{class:"version-select",value:Rf,onChange:t},[(on(),cn(Sn,null,Ut(e,i=>j("option",{key:i.path,value:i.path},de(i.label),9,Sf)),64))],32))}},Ef=Ye(Tf,[["__scopeId","data-v-8cf198cc"]]),Af={class:"header"},Of=["title"],Nf={key:0,viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},Pf={key:1,viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},Cf={class:"main"},If={class:"sidebar"},Mf={class:"content"},Lf={__name:"App",setup(n){const{isDark:e,toggle:t}=Qc(),s=Te(!1);function r(i){(i.ctrlKey||i.metaKey)&&i.key==="k"&&(i.preventDefault(),s.value=!0)}return(i,o)=>{const l=Ea("router-view");return on(),cn(Sn,null,[j("div",{class:"app",onKeydown:r},[j("header",Af,[o[6]||(o[6]=j("a",{class:"logo",href:"#/"},"NR 语言参考手册",-1)),gn(Ef),o[7]||(o[7]=j("div",{class:"header-spacer"},null,-1)),j("button",{class:"icon-btn",onClick:o[0]||(o[0]=a=>s.value=!0),title:"搜索 (Ctrl+K)"},[...o[3]||(o[3]=[j("svg",{viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round"},[j("circle",{cx:"11",cy:"11",r:"8"}),j("path",{d:"m21 21-4.35-4.35"})],-1)])]),j("button",{class:"icon-btn",onClick:o[1]||(o[1]=(...a)=>dn(t)&&dn(t)(...a)),title:dn(e)?"浅色模式":"深色模式"},[dn(e)?(on(),cn("svg",Nf,[...o[4]||(o[4]=[j("circle",{cx:"12",cy:"12",r:"5"},null,-1),j("path",{d:"M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"},null,-1)])])):(on(),cn("svg",Pf,[...o[5]||(o[5]=[j("path",{d:"M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"},null,-1)])]))],8,Of)]),j("div",Cf,[j("aside",If,[gn(df)]),j("main",Mf,[gn(l)])])],32),s.value?(on(),So(kf,{key:0,onClose:o[2]||(o[2]=a=>s.value=!1)})):ar("",!0)],64)}}},Df=Ye(Lf,[["__scopeId","data-v-892a6446"]]),Hf={},Ff={class:"home"};function Bf(n,e){return on(),cn("div",Ff,[...e[0]||(e[0]=[lc('<section class="hero" data-v-7da7399d><h1 class="hero-name" data-v-7da7399d>NR 语言</h1><p class="hero-text" data-v-7da7399d>参考手册</p><p class="hero-tagline" data-v-7da7399d>Nebula 词库引擎的领域特定语言</p><a class="hero-btn" href="#/v1.0/" data-v-7da7399d>开始阅读</a></section><section class="features" data-v-7da7399d><div class="feature" data-v-7da7399d><h3 data-v-7da7399d>简洁语法</h3><p data-v-7da7399d>NR 采用直观的触发词-响应模式，头部空行分隔结构，让词库编写像写笔记一样自然。</p></div><div class="feature" data-v-7da7399d><h3 data-v-7da7399d>动态类型</h3><p data-v-7da7399d>支持整数、浮点、字符串、布尔、对象、函数等类型，运行时自动推断，灵活高效。</p></div><div class="feature" data-v-7da7399d><h3 data-v-7da7399d>模块化</h3><p data-v-7da7399d>支持文件/目录引入、跨包调用、热更新，轻松构建大型自动化文本生成系统。</p></div></section><section class="tools" data-v-7da7399d><h2 data-v-7da7399d>工具</h2><p data-v-7da7399d><a href="./vscode-nr/nr-language-1.0.0.vsix" data-v-7da7399d>下载 VS Code 语法高亮扩展 (.vsix)</a></p><p data-v-7da7399d>安装：VS Code → <code data-v-7da7399d>Ctrl+Shift+P</code> → &quot;Install from VSIX...&quot; → 选择下载的文件</p></section><section class="info" data-v-7da7399d><h2 data-v-7da7399d>项目信息</h2><ul data-v-7da7399d><li data-v-7da7399d><strong data-v-7da7399d>引擎</strong>：Nebula 词库引擎</li><li data-v-7da7399d><strong data-v-7da7399d>实现语言</strong>：Rust</li><li data-v-7da7399d><strong data-v-7da7399d>许可证</strong>：Copyright (c) 2025 保留所有权利</li></ul></section>',4)])])}const jf=Ye(Hf,[["render",Bf],["__scopeId","data-v-7da7399d"]]);function hr(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let Ce=hr();function al(n){Ce=n}const cl=/[&<>"']/,Uf=new RegExp(cl.source,"g"),ul=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Vf=new RegExp(ul.source,"g"),zf={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},mi=n=>zf[n];function On(n,e){if(e){if(cl.test(n))return n.replace(Uf,mi)}else if(ul.test(n))return n.replace(Vf,mi);return n}const Gf=/(^|[^\[])\^/g;function nn(n,e){let t=typeof n=="string"?n:n.source;e=e||"";const s={replace:(r,i)=>{let o=typeof i=="string"?i:i.source;return o=o.replace(Gf,"$1"),t=t.replace(r,o),s},getRegex:()=>new RegExp(t,e)};return s}function _i(n){try{n=encodeURI(n).replace(/%25/g,"%")}catch{return null}return n}const gt={exec:()=>null};function bi(n,e){const t=n.replace(/\|/g,(i,o,l)=>{let a=!1,u=o;for(;--u>=0&&l[u]==="\\";)a=!a;return a?"|":" |"}),s=t.split(/ \|/);let r=0;if(s[0].trim()||s.shift(),s.length>0&&!s[s.length-1].trim()&&s.pop(),e)if(s.length>e)s.splice(e);else for(;s.length<e;)s.push("");for(;r<s.length;r++)s[r]=s[r].trim().replace(/\\\|/g,"|");return s}function tt(n,e,t){const s=n.length;if(s===0)return"";let r=0;for(;r<s&&n.charAt(s-r-1)===e;)r++;return n.slice(0,s-r)}function qf(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let s=0;s<n.length;s++)if(n[s]==="\\")s++;else if(n[s]===e[0])t++;else if(n[s]===e[1]&&(t--,t<0))return s;return-1}function xi(n,e,t,s){const r=e.href,i=e.title?On(e.title):null,o=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){s.state.inLink=!0;const l={type:"link",raw:t,href:r,title:i,text:o,tokens:s.inlineTokens(o)};return s.state.inLink=!1,l}return{type:"image",raw:t,href:r,title:i,text:On(o)}}function Kf(n,e){const t=n.match(/^(\s+)(?:```)/);if(t===null)return e;const s=t[1];return e.split(`
...
`,1)[0],$=!d.trim(),y=0;if(this.options.pedantic?(y=2,c=d.trimStart()):$?y=t[1].length+1:(y=t[2].search(/[^ ]/),y=y>4?1:y,c=d.slice(y),y+=t[1].length),$&&/^[ \t]*$/.test(p)&&(u+=p+`
