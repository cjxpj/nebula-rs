...
<dl>
  ...
  <dt>参数</dt><dd>一个字符串</dd>
  <dt>返回值</dt><dd>"1"（全为小写字母）或 "0"（否则）</dd>
</dl>
...
<dl>
  ...
  <dt>参数</dt><dd>一个字符串</dd>
  <dt>返回值</dt><dd>"1"（全为大写字母）或 "0"（否则）</dd>
</dl>
...
<dl>
  <dt>签名</dt><dd><code>$s.居中 [文本] [宽度]$</code></dd>
  <dt>参数</dt><dd>文本、目标宽度</dd>
  <dt>返回值</dt><dd>居中对齐并用空格两侧填充后的字符串</dd>
</dl>
