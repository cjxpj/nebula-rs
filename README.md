...
完整语言参考手册（NR 语言）：[**docs/index.md**](docs/index.md)

| 章节 | 内容 |
|---|---|
| [词法结构](docs/v1.0/lexical.md) | 源文件结构、注释、转义、多行字符串 |
| [类型系统](docs/v1.0/types.md) | 整数/浮点/字符串/布尔/对象/函数 |
| [变量与赋值](docs/v1.0/variables.md) | 作用域、操作符、内置变量 |
| [表达式](docs/v1.0/expressions.md) | 数学运算、比较、逻辑运算 |
| [控制流](docs/v1.0/control-flow.md) | 条件分支、循环、中断与跳转 |
| [词条系统](docs/v1.0/entries.md) | 普通词条、内部词条、类词条 |
| [函数](docs/v1.0/functions.md) | 定义语法、参数、初始化 |
| [JSON 数据处理](docs/v1.0/json.md) | 内联 JSON、导航读写 |
| [面向对象](docs/v1.0/oop.md) | 类定义、实例化、方法调用 |
| [模块与引入](docs/v1.0/modules.md) | 文件/目录引入、热更新 |
| [内置函数](docs/v1.0/flow-output.md) | 流程控制、输出、标准库 |
